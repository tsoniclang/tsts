...
export type Statement = EmptyStatement | IfStatement | DoStatement | WhileStatement | ForStatement | BreakStatement | ContinueStatement | ReturnStatement | WithStatement | SwitchStatement | ThrowStatement | TryStatement | DebuggerStatement | LabeledStatement | ExpressionStatement | Block | VariableStatement | MissingDeclaration | FunctionDeclaration | ClassDeclaration | InterfaceDeclaration | TypeAliasDeclaration | EnumDeclaration | ModuleBlock | NotEmittedStatement | ImportDeclaration | ExportAssignment | NamespaceExportDeclaration | ModuleDeclaration | ImportEqualsDeclaration | ExportDeclaration;
