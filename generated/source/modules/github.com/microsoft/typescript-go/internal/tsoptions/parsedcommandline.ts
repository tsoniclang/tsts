...
export class ParsedCommandLine {
    ...
    public constructor(public ParsedConfig: tsonicTypeScriptRuntime.Location<ParsedOptions__from_core> | undefined, public ConfigFile: {
    ...
    static FileNames(p: tsonicTypeScriptRuntime.Location<ParsedCommandLine> | undefined): RuntimeSlice<gostring> {
        return ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.ParsedConfig ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedOptions__from_core>).value.FileNames;
    }
    static FileNamesByPath(p: tsonicTypeScriptRuntime.Location<ParsedCommandLine> | undefined): GoMapValue<Path__from_tspath, gostring> {
        sync__from_gostdlib.Once.Do(((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.fileNamesByPathOnce, (): void => {
            ...
            const __gotots_range_4 = ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.ParsedConfig ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedOptions__from_core>).value.FileNames;
    ...
    static GetMatchedIncludeSpec(p: tsonicTypeScriptRuntime.Location<ParsedCommandLine> | undefined, fileName: gostring): [
        ...
        if ((((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.ConfigFile ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.configFileSpecs ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<configFileSpecs>).value.validatedIncludeSpecs.length === 0) {
            return ["", false];
        }
        if ((((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.ConfigFile ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.configFileSpecs ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<configFileSpecs>).value.isDefaultIncludeSpec) {
            return [(((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.ConfigFile ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.configFileSpecs ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<configFileSpecs>).value.validatedIncludeSpecs.get(0), true];
        }
    ...
    static GetOutputFileNames(p: tsonicTypeScriptRuntime.Location<ParsedCommandLine> | undefined): iter__from_gostdlib.Seq<gostring> {
        return named_iter.IterSeqValueOperations.$wrap((__go_yield: (($0: gostring) => bool) | undefined): void => {
            const __gotots_range_3 = ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.ParsedConfig ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedOptions__from_core>).value.FileNames;
    ...
    static ProjectReferences(p: tsonicTypeScriptRuntime.Location<ParsedCommandLine> | undefined): RuntimeSlice<tsonicTypeScriptRuntime.Location<ProjectReference__from_core> | undefined> {
    ...
    static WildcardDirectories(p: tsonicTypeScriptRuntime.Location<ParsedCommandLine> | undefined): GoMapValue<gostring, bool> {
        ...
        sync__from_gostdlib.Once.Do(((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.wildcardDirectoriesOnce, (): void => {
            if (((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.wildcardDirectories.isNil()) {
                ((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.wildcardDirectories = getWildcardDirectories((((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.ConfigFile ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.configFileSpecs ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<configFileSpecs>).value.validatedIncludeSpecs, (((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.ConfigFile ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.configFileSpecs ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<configFileSpecs>).value.validatedExcludeSpecs, ComparePathsOptions__from_tspath.$copy(((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.comparePathsOptions));
            }
        });
    ...
    static $go$private$tsoptions$getOutputDeclarationAndSourceFileNames(p: tsonicTypeScriptRuntime.Location<ParsedCommandLine> | undefined): iter__from_gostdlib.Seq2<gostring, gostring> {
        return named_iter.IterSeq2ValueOperations.$wrap((__go_yield: (($0: gostring, $1: gostring) => bool) | undefined): void => {
            const __gotots_range_7 = ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine>).value.ParsedConfig ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedOptions__from_core>).value.FileNames;
...
export function NewParsedCommandLine(compilerOptions: {
    ...
    return tsonicTypeScriptRuntime.location<ParsedCommandLine>(new ParsedCommandLine(tsonicTypeScriptRuntime.location<ParsedOptions__from_core>(new ParsedOptions__from_core(compilerOptions, void 0, void 0, rootFileNames, RuntimeSlice.nil<tsonicTypeScriptRuntime.Location<ProjectReference__from_core> | undefined>())), void 0, RuntimeSlice.nil<tsonicTypeScriptRuntime.Location<Diagnostic__from_ast> | undefined>(), void 0, void 0, ComparePathsOptions__from_tspath.$copy(comparePathsOptions), named_sync.SyncOnceOperations.$zero(), GoMap.nil<gostring, bool>(false), named_sync.SyncOnceOperations.$zero(), RuntimeSlice.nil<{
        value: Glob__from_glob;
