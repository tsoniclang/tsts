    ...
    for (let __gotots_range_index_0 = 0; __gotots_range_index_0 < __gotots_range_0.length; __gotots_range_index_0++) {
        ...
        switch (Node__from_ast.$storageOf(((m ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Kind) {
            case KindPropertySignature$constant__from_ast(): {
                ...
                const __gotots_store_0 = NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(PropertySignatureDeclaration__from_ast.$storageOf(((ps ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertySignatureDeclaration__from_ast>).value).NodeBase)).NodeDefault));
                const __gotots_argument_2 = Node__from_ast.QuestionToken(tsonicTypeScriptRuntime.projectLocation<Node__from_ast$Storage, Node__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_0, "Node"), ($go$storage: Node__from_ast$Storage): Node__from_ast => {
            ...
            case KindMethodSignature$constant__from_ast(): {
                ...
                const __gotots_store_3 = NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(MethodSignatureDeclaration__from_ast.$storageOf(((ms ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<MethodSignatureDeclaration__from_ast>).value).NodeBase)).NodeDefault));
                const __gotots_argument_8 = Node__from_ast.QuestionToken(tsonicTypeScriptRuntime.projectLocation<Node__from_ast$Storage, Node__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_3, "Node"), ($go$storage: Node__from_ast$Storage): Node__from_ast => {
                    return Node__from_ast.$fromStorage($go$storage);
                }, ($go$value: Node__from_ast): Node__from_ast$Storage => {
                    return Node__from_ast.$storageOf($go$value);
                }));
                const __gotots_argument_9 = FunctionLikeBase__from_ast.$storageOf(FunctionLikeBase__from_ast.$fromStorage(MethodSignatureDeclaration__from_ast.$storageOf(((ms ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<MethodSignatureDeclaration__from_ast>).value).FunctionLikeBase)).TypeParameters;
                const __gotots_argument_10 = FunctionLikeBase__from_ast.$storageOf(FunctionLikeBase__from_ast.$fromStorage(MethodSignatureDeclaration__from_ast.$storageOf(((ms ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<MethodSignatureDeclaration__from_ast>).value).FunctionLikeBase)).Parameters;
                const __gotots_argument_11 = FunctionLikeBase__from_ast.$storageOf(FunctionLikeBase__from_ast.$fromStorage(MethodSignatureDeclaration__from_ast.$storageOf(((ms ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<MethodSignatureDeclaration__from_ast>).value).FunctionLikeBase)).Type;
