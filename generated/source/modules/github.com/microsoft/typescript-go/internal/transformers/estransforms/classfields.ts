...
export class privateEnvironment {
    declare private readonly $goType: void;
    public constructor(public data: privateEnvironmentData, public members: GoMapValue<gostring, {
        value: privateIdentifierInfo;
    } | undefined>, public generatedIdentifiers: GoMapValue<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, {
        value: privateIdentifierInfo;
    } | undefined>) {
    }
    declare private readonly then?: never;
...
export class classFieldsTransformer {
    ...
    declare private readonly then?: never;
    static $go$private$estransforms$accessPrivateIdentifier(tx: classFieldsTransformer | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): {
        value: privateIdentifierInfo;
    } | undefined {
            ...
            if (!((env ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).privateEnv === undefined)) {
                {
                    ...
                    if (ok) {
                        if ((info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind.$value === PrivateIdentifierKindUntransformed$constant__from_printer().$value) {
                            return void 0;
                        }
                        return info;
                    }
    ...
    static $go$private$estransforms$addInstanceMethodStatements(tx: classFieldsTransformer | undefined, statements: RuntimeSlice<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined>, methods: RuntimeSlice<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined>, receiver: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): RuntimeSlice<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined> {
        ...
        const __gotots_store_661 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_660, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_argument_466 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_662, "Transformer"));
    ...
    static $go$private$estransforms$addPrivateIdentifierAutoAccessorToEnvironment(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, lex: classLexicalEnvironment | undefined, env: privateEnvironment | undefined, isStatic: bool, isValid: bool): void {
        ...
        classFieldsTransformer.$go$private$estransforms$setPrivateIdentifier(tx, env, name, { value: new privateIdentifierInfo(PrivateIdentifierKindAccessor$constant__from_printer(), brandCheckIdentifier, isStatic, isValid, void 0, void 0, getterName, setterName) });
    }
    static $go$private$estransforms$addPrivateIdentifierGetAccessorToEnvironment(tx: classFieldsTransformer | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, lex: classLexicalEnvironment | undefined, env: privateEnvironment | undefined, isStatic: bool, isValid: bool, previousInfo: {
        value: privateIdentifierInfo;
    } | undefined): void {
        let getterName: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = classFieldsTransformer.$go$private$estransforms$createHoistedVariableForPrivateName(tx, name, "_get");
        let brandCheckIdentifier: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = void 0;
        ...
        if (!(previousInfo === undefined) && (previousInfo ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind.$value === PrivateIdentifierKindAccessor$constant__from_printer().$value && (previousInfo ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.isStatic === isStatic && (previousInfo ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.getterName === undefined) {
            (previousInfo ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.getterName = getterName;
        }
        else {
            classFieldsTransformer.$go$private$estransforms$setPrivateIdentifier(tx, env, name, { value: new privateIdentifierInfo(PrivateIdentifierKindAccessor$constant__from_printer(), brandCheckIdentifier, isStatic, isValid, void 0, void 0, getterName, void 0) });
        }
    }
    static $go$private$estransforms$addPrivateIdentifierMethodToEnvironment(tx: classFieldsTransformer | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, lex: classLexicalEnvironment | undefined, env: privateEnvironment | undefined, isStatic: bool, isValid: bool): void {
        ...
        classFieldsTransformer.$go$private$estransforms$setPrivateIdentifier(tx, env, name, { value: new privateIdentifierInfo(PrivateIdentifierKindMethod$constant__from_printer(), brandCheckIdentifier, isStatic, isValid, void 0, methodName, void 0, void 0) });
    }
    static $go$private$estransforms$addPrivateIdentifierPropertyDeclarationToEnvironment(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): void {
        ...
        if (isStatic) {
            ...
            classFieldsTransformer.$go$private$estransforms$setPrivateIdentifier(tx, env, name, { value: new privateIdentifierInfo(PrivateIdentifierKindField$constant__from_printer(), brandCheckIdentifier, true, isValid, variableName, void 0, void 0, void 0) });
        }
        else {
            ...
            classFieldsTransformer.$go$private$estransforms$setPrivateIdentifier(tx, env, name, { value: new privateIdentifierInfo(PrivateIdentifierKindField$constant__from_printer(), weakMapName, false, isValid, void 0, void 0, void 0, void 0) });
            ...
            const __gotots_receiver_141 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_634, "Transformer"));
            ...
            const __gotots_store_636 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_635, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_store_638 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_637, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_store_640 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_639, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
    ...
    static $go$private$estransforms$addPrivateIdentifierSetAccessorToEnvironment(tx: classFieldsTransformer | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, lex: classLexicalEnvironment | undefined, env: privateEnvironment | undefined, isStatic: bool, isValid: bool, previousInfo: {
        value: privateIdentifierInfo;
    } | undefined): void {
        let setterName: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = classFieldsTransformer.$go$private$estransforms$createHoistedVariableForPrivateName(tx, name, "_set");
        let brandCheckIdentifier: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = void 0;
        ...
        if (!(previousInfo === undefined) && (previousInfo ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind.$value === PrivateIdentifierKindAccessor$constant__from_printer().$value && (previousInfo ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.isStatic === isStatic && (previousInfo ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.setterName === undefined) {
            (previousInfo ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.setterName = setterName;
        }
        else {
            classFieldsTransformer.$go$private$estransforms$setPrivateIdentifier(tx, env, name, { value: new privateIdentifierInfo(PrivateIdentifierKindAccessor$constant__from_printer(), brandCheckIdentifier, isStatic, isValid, void 0, void 0, void 0, setterName) });
        }
    }
    ...
    static $go$private$estransforms$createAccessorPropertyGetRedirector(tx: classFieldsTransformer | undefined, node: {
        ...
        let backingFieldName: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewGeneratedPrivateNameForNodeEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_562, "Transformer")), PropertyDeclaration__from_ast.Name(node), new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(0), "", "_accessor_storage"));
        const __gotots_store_563 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        const __gotots_store_564 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_563, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_566 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_565, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_568 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_567, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_570 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_569, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_572 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_571, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_574 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_573, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
    ...
    static $go$private$estransforms$createAccessorPropertySetRedirector(tx: classFieldsTransformer | undefined, node: {
        ...
        let backingFieldName: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewGeneratedPrivateNameForNodeEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_575, "Transformer")), PropertyDeclaration__from_ast.Name(node), new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(0), "", "_accessor_storage"));
        const __gotots_store_576 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        const __gotots_store_577 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_576, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_579 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_578, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_receiver_131 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_580, "Transformer"));
    ...
    static $go$private$estransforms$createBrandCheckWeakSetForPrivateMethods(tx: classFieldsTransformer | undefined): void {
        ...
        const __gotots_receiver_138 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_627, "Transformer"));
        ...
        const __gotots_store_629 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_628, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_631 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_630, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_633 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_632, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
    ...
    static $go$private$estransforms$createCallBinding(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): [
        ...
        if (IsSuperProperty__from_ast(node)) {
            ...
            const __gotots_results_8 = NodeFactory__from_printer.NewThisExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_371, "Transformer")));
        ...
        if (IsPropertyAccessExpression__from_ast(node)) {
            ...
            if (shouldBeCapturedInTempVariable(PropertyAccessExpression__from_ast.$storageOf(((expr ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).Expression)) {
                ...
                thisArg = NodeFactory__from_printer.NewTempVariable(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_372, "Transformer")));
                const __gotots_store_373 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_373, "Transformer")), thisArg);
                const __gotots_store_374 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                const __gotots_store_375 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_374, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_377 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_376, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_argument_279 = NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_378, "Transformer")), thisArg, PropertyAccessExpression__from_ast.$storageOf(((expr ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).Expression);
        ...
        thisArg = NodeFactory__from_printer.NewVoidZeroExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_379, "Transformer")));
        target = node;
        return [thisArg, target];
    }
    static $go$private$estransforms$createCopiableReceiverExpr(tx: classFieldsTransformer | undefined, receiver: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): [
        ...
        if (!NodeIsSynthesized__from_ast(receiver)) {
            ...
            const __gotots_argument_270 = new $goInterfaceAdapter$PointerTo_Named_printer$NodeFactory(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_347, "Transformer")));
        ...
        readExpression = NodeFactory__from_printer.NewTempVariable(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_348, "Transformer")));
        const __gotots_store_349 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_349, "Transformer")), readExpression);
        const __gotots_store_350 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        initializeExpression = NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_350, "Transformer")), readExpression, clone);
    ...
    static $go$private$estransforms$createHoistedVariableForClass(tx: classFieldsTransformer | undefined, nameText: gostring, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, suffix: gostring): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if (!((env ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data.className === undefined)) {
            ...
            identifier = NodeFactory__from_printer.NewUniqueNameEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_521, "Transformer")), prefix + nameText, new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(24), "", suffix));
        }
        else {
            const __gotots_store_522 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            identifier = NodeFactory__from_printer.NewUniqueNameEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_522, "Transformer")), "_" + nameText, new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(24), "", suffix));
        }
        if (classFieldsTransformer.$go$private$estransforms$requiresBlockScopedVar(tx)) {
            const __gotots_store_523 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AddLexicalDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_523, "Transformer")), identifier);
        }
        else {
            const __gotots_store_524 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_524, "Transformer")), identifier);
        }
        return identifier;
    }
    static $go$private$estransforms$createHoistedVariableForClassFromNode(tx: classFieldsTransformer | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, suffix: gostring): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        let identifier: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewGeneratedNameForNodeEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_739, "Transformer")), name, new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(24), prefix, suffix));
        if (classFieldsTransformer.$go$private$estransforms$requiresBlockScopedVar(tx)) {
            const __gotots_store_740 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AddLexicalDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_740, "Transformer")), identifier);
        }
        else {
            const __gotots_store_741 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_741, "Transformer")), identifier);
        }
        return identifier;
    }
    static $go$private$estransforms$createHoistedVariableForPrivateName(tx: classFieldsTransformer | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, suffix: gostring): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if (EmitContext__from_printer.HasAutoGenerateInfo(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_677, "Transformer")), name)) {
    ...
    static $go$private$estransforms$createPrivateIdentifierAccess(tx: classFieldsTransformer | undefined, info: {
        value: privateIdentifierInfo;
        ...
        receiver = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_339, "Transformer")), receiver);
        return classFieldsTransformer.$go$private$estransforms$createPrivateIdentifierAccessHelper(tx, info, receiver);
    }
    static $go$private$estransforms$createPrivateIdentifierAccessHelper(tx: classFieldsTransformer | undefined, info: {
        value: privateIdentifierInfo;
    } | undefined, receiver: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        const __gotots_store_351 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        EmitContext__from_printer.SetCommentRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_351, "Transformer")), receiver, NewTextRange__from_core(-1, Node__from_ast.End(receiver)));
        switch ((info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind.$value) {
            case "a": {
                ...
                return NodeFactory__from_printer.NewClassPrivateFieldGetHelper(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_352, "Transformer")), receiver, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.brandCheckIdentifier, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.getterName);
                break;
            }
            case "m": {
                const __gotots_store_353 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                return NodeFactory__from_printer.NewClassPrivateFieldGetHelper(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_353, "Transformer")), receiver, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.brandCheckIdentifier, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.methodName);
                break;
            }
            case "f": {
                let f: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = void 0;
                if ((info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.isStatic) {
                    f = (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.variableName;
                }
                const __gotots_store_354 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                return NodeFactory__from_printer.NewClassPrivateFieldGetHelper(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_354, "Transformer")), receiver, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.brandCheckIdentifier, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind, f);
                break;
            }
            case "untransformed": {
    ...
    static $go$private$estransforms$createPrivateIdentifierAssignment(tx: classFieldsTransformer | undefined, info: {
        value: privateIdentifierInfo;
    } | undefined, receiver: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, right: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, operator: Kind__from_ast): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        const __gotots_store_355 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        receiver = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_355, "Transformer")), receiver);
        const __gotots_store_356 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        right = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_356, "Transformer")), right);
        if (IsCompoundAssignment__from_ast(operator)) {
            ...
            const __gotots_store_358 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_357, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_store_360 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_359, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        EmitContext__from_printer.SetCommentRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_361, "Transformer")), receiver, NewTextRange__from_core(-1, Node__from_ast.End(receiver)));
        switch ((info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind.$value) {
            case "a": {
                const __gotots_store_362 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                return NodeFactory__from_printer.NewClassPrivateFieldSetHelper(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_362, "Transformer")), receiver, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.brandCheckIdentifier, right, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.setterName);
                break;
            }
            case "m": {
                const __gotots_store_363 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                return NodeFactory__from_printer.NewClassPrivateFieldSetHelper(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_363, "Transformer")), receiver, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.brandCheckIdentifier, right, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind, void 0);
                break;
            }
            case "f": {
                let f: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = void 0;
                ...
                return NodeFactory__from_printer.NewClassPrivateFieldSetHelper(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_364, "Transformer")), receiver, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.brandCheckIdentifier, right, (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind, f);
                break;
            }
            case "untransformed": {
                Fail__from_debug("Access helpers should not be created for untransformed private elements");
    ...
    static $go$private$estransforms$extractNonStaticNonAccessorModifiers(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<ModifierList__from_ast> | undefined {
        ...
        const __gotots_argument_286 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_391, "Transformer"));
    ...
    static $go$private$estransforms$generateInitializedPropertyExpressionsOrClassStaticBlock(tx: classFieldsTransformer | undefined, propertiesOrClassStaticBlocks: RuntimeSlice<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined>, receiver: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): RuntimeSlice<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined> {
        ...
        for (let __gotots_range_index_11 = 0; __gotots_range_index_11 < __gotots_range_12.length; __gotots_range_index_11++) {
            ...
            EmitContext__from_printer.SetOriginalEx(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_530, "Transformer")), expression, property, true);
            const __gotots_store_531 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AssignCommentAndSourceMapRanges(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_531, "Transformer")), expression, property);
    ...
    static $go$private$estransforms$getClassFacts(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): classFacts {
        ...
        let original: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_525, "Transformer")), node);
        ...
        if (__gotots_logical_result_11) {
            ...
            const __gotots_argument_380 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_526, "Transformer"));
            ...
            if (!__gotots_logical_result_10) {
                ...
                const __gotots_argument_382 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_527, "Transformer"));
            ...
            if (IsStatic__from_ast(member)) {
                if (!(Node__from_ast.Name(member) === undefined) && (IsPrivateIdentifier__from_ast(Node__from_ast.Name(member)) || IsAutoAccessorPropertyDeclaration__from_ast(member)) && (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformPrivateElementsOrClassStaticBlocks) {
                    ...
                    if (__gotots_logical_result_12) {
                        ...
                        __gotots_logical_result_12 = EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_528, "Transformer")), node) === undefined;
                    }
                    if (__gotots_logical_result_12) {
                        facts = new classFacts(facts.$value | 2);
                    }
                ...
                const __gotots_argument_384 = EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_529, "Transformer")), member);
    ...
    static $go$private$estransforms$getHoistedFunctionName(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        let info: {
            value: privateIdentifierInfo;
        } | undefined = classFieldsTransformer.$go$private$estransforms$accessPrivateIdentifier(tx, Node__from_ast.Name(node));
        ...
        if ((info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind.$value === PrivateIdentifierKindMethod$constant__from_printer().$value) {
            return (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.methodName;
        }
        if ((info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind.$value === PrivateIdentifierKindAccessor$constant__from_printer().$value) {
            if (IsGetAccessorDeclaration__from_ast(node)) {
                return (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.getterName;
            }
            if (IsSetAccessorDeclaration__from_ast(node)) {
                return (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.setterName;
            }
        }
        return void 0;
    }
    static $go$private$estransforms$getPrivateIdentifier(tx: classFieldsTransformer | undefined, env: privateEnvironment | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): [
        ...
        if (EmitContext__from_printer.HasAutoGenerateInfo(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_532, "Transformer")), name)) {
            ...
            const __gotots_map_1 = EmitContext__from_printer.GetNodeForGeneratedName(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_533, "Transformer")), name);
    ...
    static $go$private$estransforms$getPropertyNameExpressionIfNeeded(tx: classFieldsTransformer | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, shouldHoist: bool): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        const __gotots_argument_429 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_609, "Transformer"));
        ...
        let expression: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_610, "Transformer")), Node__from_ast.Expression(name));
        ...
        if (!__gotots_logical_result_14) {
            ...
            if (__gotots_logical_result_13) {
                ...
                const __gotots_argument_431 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_611, "Transformer"));
        ...
        if (!alreadyTransformed && !inlinable && shouldHoist) {
            ...
            let generatedName: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewGeneratedNameForNode(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_612, "Transformer")), name);
            if (classFieldsTransformer.$go$private$estransforms$requiresBlockScopedVar(tx)) {
                const __gotots_store_613 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                EmitContext__from_printer.AddLexicalDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_613, "Transformer")), generatedName);
            }
            else {
                const __gotots_store_614 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_614, "Transformer")), generatedName);
            }
            const __gotots_store_615 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            return NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_615, "Transformer")), generatedName, expression);
        }
    ...
    static $go$private$estransforms$injectPendingExpressions(tx: classFieldsTransformer | undefined, expression: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).pendingExpressions.length > 0) {
            if (IsParenthesizedExpression__from_ast(expression)) {
                ...
                const __gotots_argument_311 = NodeFactory__from_printer.InlineExpressions(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_438, "Transformer")), (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).pendingExpressions);
                ...
                expression = NodeFactory__from_printer.InlineExpressions(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_439, "Transformer")), exprs);
            }
    ...
    static $go$private$estransforms$isAnonymousClassNeedingAssignedNameWorker(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): bool {
        if (IsClassExpression__from_ast(node) && Node__from_ast.Name(node) === undefined) {
            ...
            if (Some$PointerTo_Named_ast$Node(staticPropertiesOrClassStaticBlocks, (n: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): bool => {
                ...
                const __gotots_argument_12 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_13, "Transformer"));
    ...
    static $go$private$estransforms$isReservedPrivateName(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): bool {
        ...
        if (__gotots_logical_result_20) {
            ...
            __gotots_logical_result_20 = EmitContext__from_printer.HasAutoGenerateInfo(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_676, "Transformer")), node);
        }
    ...
    static $go$private$estransforms$memberContainsConstructorReference(tx: classFieldsTransformer | undefined, member: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, classDecl: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): bool {
        ...
        let classOriginal: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_623, "Transformer")), classDecl);
        ...
        if (IsClassStaticBlockDeclaration__from_ast(member)) {
            ...
            if (__gotots_logical_result_15) {
                ...
                const __gotots_argument_439 = Node__from_ast.AsNode(body);
    ...
    static $go$private$estransforms$nodeHasTransformPrivateStaticElementsFlag(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): bool {
        ...
        const __gotots_binary_operand_2 = EmitContext__from_printer.EmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_264, "Transformer")), node);
    ...
    static $go$private$estransforms$setCurrentClassElementAndVisitStatements(tx: classFieldsTransformer | undefined, classElement: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, statements: RuntimeSlice<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined>): RuntimeSlice<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined> {
        ...
        const __gotots_results_20 = NodeVisitor__from_ast.VisitSlice(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_678, "Transformer")), statements);
    ...
    static $go$private$estransforms$setPrivateIdentifier(tx: classFieldsTransformer | undefined, env: privateEnvironment | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, info: {
        value: privateIdentifierInfo;
    } | undefined): void {
        const __gotots_store_624 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        if (EmitContext__from_printer.HasAutoGenerateInfo(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_624, "Transformer")), name)) {
            ...
            __gotots_store_626.store(EmitContext__from_printer.GetNodeForGeneratedName(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_625, "Transformer")), name), info);
        }
        else {
    ...
    static $go$private$estransforms$shouldAlwaysTransformPrivateStaticElements(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): bool {
        ...
        if (__gotots_logical_result_7) {
            ...
            const __gotots_binary_operand_4 = EmitContext__from_printer.EmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_392, "Transformer")), node);
    ...
    static $go$private$estransforms$transformAutoAccessor(tx: classFieldsTransformer | undefined, node: {
        ...
        const __gotots_receiver_93 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_393, "Transformer"));
        ...
        const __gotots_argument_289 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_394, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
        ...
        const __gotots_receiver_94 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_395, "Transformer"));
        ...
        const __gotots_argument_290 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_396, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        if (IsComputedPropertyName__from_ast(name) && !IsSimpleInlineableExpression__from_transformers(Node__from_ast.Expression(name))) {
            ...
            const __gotots_argument_291 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_397, "Transformer"));
            ...
            if (!(cacheAssignment === undefined)) {
                ...
                const __gotots_store_399 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_398, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_argument_294 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_400, "Transformer")), Node__from_ast.Expression(name));
                ...
                const __gotots_store_402 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_401, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                let temp: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewTempVariable(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_403, "Transformer")));
                const __gotots_store_404 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                EmitContext__from_printer.SetSourceMapRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_404, "Transformer")), temp, TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(((Node__from_ast.Expression(name) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc)));
                const __gotots_store_405 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_405, "Transformer")), temp);
                const __gotots_store_406 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                let expression: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_406, "Transformer")), Node__from_ast.Expression(name));
                const __gotots_store_407 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                let assignment: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_407, "Transformer")), temp, expression);
                const __gotots_store_408 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                EmitContext__from_printer.SetSourceMapRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_408, "Transformer")), assignment, TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(((Node__from_ast.Expression(name) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc)));
                const __gotots_store_409 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                const __gotots_store_410 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_409, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_412 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_411, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_argument_296 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_414, "Transformer"));
        const __gotots_argument_297 = node;
        const __gotots_argument_298 = modifiers;
        const __gotots_argument_299 = (node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Initializer;
        ...
        const __gotots_receiver_97 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_415, "Transformer"));
        ...
        const __gotots_argument_301 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_416, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_417, "Transformer")), backingField, EFNoComments$constant__from_printer());
        const __gotots_store_418 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        EmitContext__from_printer.SetSourceMapRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_418, "Transformer")), backingField, TextRange__from_core.$copy(sourceMapRange));
        ...
        const __gotots_argument_302 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_419, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        if (IsStatic__from_ast(__gotots_argument_302)) {
            ...
            if (receiver === undefined) {
                ...
                receiver = NodeFactory__from_printer.NewThisExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_420, "Transformer")));
            }
        }
        else {
            const __gotots_store_421 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            receiver = NodeFactory__from_printer.NewThisExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_421, "Transformer")));
        }
        ...
        const __gotots_receiver_98 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_422, "Transformer"));
        ...
        const __gotots_argument_304 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_423, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        EmitContext__from_printer.SetCommentRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_424, "Transformer")), getter, TextRange__from_core.$copy(commentRange));
        const __gotots_store_425 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        EmitContext__from_printer.SetSourceMapRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_425, "Transformer")), getter, TextRange__from_core.$copy(sourceMapRange));
        ...
        if (!(modifiers === undefined)) {
            ...
            const __gotots_store_427 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_426, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_store_429 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_428, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_receiver_101 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_430, "Transformer"));
        ...
        const __gotots_argument_309 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_431, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_432, "Transformer")), setter, EFNoComments$constant__from_printer());
        const __gotots_store_433 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        EmitContext__from_printer.SetSourceMapRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_433, "Transformer")), setter, TextRange__from_core.$copy(sourceMapRange));
        ...
        const __gotots_store_435 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_434, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
    ...
    static $go$private$estransforms$transformClassMembers(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): [
        ...
        const __gotots_binary_operand_6 = EmitContext__from_printer.EmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_487, "Transformer")), node);
            ...
            for (let __gotots_range_index_5 = 0; __gotots_range_index_5 < __gotots_range_6.length; __gotots_range_index_5++) {
                ...
                if (IsPrivateIdentifierClassElementDeclaration__from_ast(member)) {
                    if (classFieldsTransformer.$go$private$estransforms$shouldTransformClassElementToWeakMap(tx, member)) {
                        ...
                        let env: privateEnvironment | undefined = classFieldsTransformer.$go$private$estransforms$getPrivateIdentifierEnvironment(tx);
                        classFieldsTransformer.$go$private$estransforms$setPrivateIdentifier(tx, env, Node__from_ast.Name(member), { value: new privateIdentifierInfo(PrivateIdentifierKindUntransformed$constant__from_printer(), void 0, false, false, void 0, void 0, void 0, void 0) });
                    }
                }
            }
            if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformPrivateElementsOrClassStaticBlocks) {
            ...
            if (classFieldsTransformer.$go$private$estransforms$shouldTransformAutoAccessorsInCurrentClass(tx)) {
                ...
                for (let __gotots_range_index_6 = 0; __gotots_range_index_6 < __gotots_range_7.length; __gotots_range_index_6++) {
                    ...
                    if (IsAutoAccessorPropertyDeclaration__from_ast(member)) {
                        ...
                        let storageName: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewGeneratedPrivateNameForNodeEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_488, "Transformer")), Node__from_ast.Name(member), new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(0), "", "_accessor_storage"));
                        if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformPrivateElementsOrClassStaticBlocks || shouldTransformPrivateStaticElementsInClass && HasStaticModifier__from_ast(member)) {
                            ...
                            let env: privateEnvironment | undefined = classFieldsTransformer.$go$private$estransforms$getPrivateIdentifierEnvironment(tx);
                            {
                                ...
                                if (!ok) {
                                    classFieldsTransformer.$go$private$estransforms$setPrivateIdentifier(tx, env, storageName, { value: new privateIdentifierInfo(PrivateIdentifierKindUntransformed$constant__from_printer(), void 0, false, false, void 0, void 0, void 0, void 0) });
                                }
                            }
                        }
                    }
        ...
        if (!(tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformPrivateElementsOrClassStaticBlocks && (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).pendingExpressions.length > 0) {
            ...
            const __gotots_store_490 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_489, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_argument_358 = NodeFactory__from_printer.InlineExpressions(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_491, "Transformer")), (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).pendingExpressions);
            ...
            if (!((Node__from_ast.SubtreeFacts(statement) & SubtreeContainsLexicalThisOrSuper$constant__from_ast()) >>> 0 === 0)) {
                ...
                let temp: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewTempVariable(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_492, "Transformer")));
                const __gotots_store_493 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_493, "Transformer")), temp);
                const __gotots_store_494 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                const __gotots_store_495 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_494, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_497 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_496, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_499 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_498, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_501 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_500, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_503 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_502, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                prologue = NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_504, "Transformer")), temp, arrow);
                const __gotots_store_505 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                const __gotots_store_506 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_505, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_508 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_507, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_510 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_509, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_store_512 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_511, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_store_514 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_513, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_store_516 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_515, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        if (!(syntheticConstructor === undefined) || !(syntheticStaticBlock === undefined)) {
            ...
            let classThisIdx = IndexFunc$SliceOf_PointerTo_Named_ast$Node$PointerTo_Named_ast$Node(NodeList__from_ast.$storageOf(((members ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<NodeList__from_ast>).value).Nodes, (n: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): bool => {
                ...
                const __gotots_argument_376 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_517, "Transformer"));
            ...
            let namedEvalIdx = IndexFunc$SliceOf_PointerTo_Named_ast$Node$PointerTo_Named_ast$Node(NodeList__from_ast.$storageOf(((members ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<NodeList__from_ast>).value).Nodes, (n: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): bool => {
                ...
                const __gotots_argument_378 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_518, "Transformer"));
            ...
            const __gotots_store_520 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_519, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
    ...
    static $go$private$estransforms$transformClassStaticBlockDeclaration(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformPrivateElementsOrClassStaticBlocks) {
            ...
            const __gotots_argument_456 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_641, "Transformer"));
            ...
            const __gotots_argument_458 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_643, "Transformer"));
            ...
            if (isClassNamedEvaluationHelperBlock(__gotots_argument_458, __gotots_argument_459)) {
                ...
                return NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_644, "Transformer")), Node__from_ast.Expression(NodeList__from_ast.$storageOf(((Block__from_ast.$storageOf(((Node__from_ast.AsBlock((Node__from_ast.AsClassStaticBlockDeclaration(node) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Body) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Block__from_ast>).value).Statements ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<NodeList__from_ast>).value).Nodes.get(0)));
            }
            const __gotots_store_645 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.StartVariableEnvironment(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_645, "Transformer")));
            ...
            statements = EmitContext__from_printer.EndAndMergeVariableEnvironment(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_646, "Transformer")), statements);
            const __gotots_store_647 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            let iife: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewImmediatelyInvokedArrowFunction(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_647, "Transformer")), statements);
            ...
            EmitContext__from_printer.SetOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_648, "Transformer")), arrowFunction, node);
            const __gotots_store_649 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_649, "Transformer")), arrowFunction, EFNoLexicalArguments$constant__from_printer());
            NodeList__from_ast.$storageOf(((Block__from_ast.$storageOf(((Node__from_ast.AsBlock(BodyBase__from_ast.$storageOf(BodyBase__from_ast.$fromStorage(FunctionLikeWithBodyBase__from_ast.$storageOf((Node__from_ast.AsArrowFunction(arrowFunction) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.FunctionLikeWithBodyBase).BodyBase)).Body) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Block__from_ast>).value).Statements ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<NodeList__from_ast>).value).Loc = TextRange__from_core.$storageOf(TextRange__from_core.$copy(TextRange__from_core.$fromStorage(NodeList__from_ast.$storageOf(((Block__from_ast.$storageOf(((Node__from_ast.AsBlock((Node__from_ast.AsClassStaticBlockDeclaration(node) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Body) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Block__from_ast>).value).Statements ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<NodeList__from_ast>).value).Loc)));
            const __gotots_store_650 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.SetOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_650, "Transformer")), iife, node);
            const __gotots_store_651 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AssignSourceMapRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_651, "Transformer")), iife, node);
            const __gotots_store_652 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_652, "Transformer")), arrowFunction, EFNoLexicalThis$constant__from_printer());
            return iife;
        }
        return void 0;
    }
    static $go$private$estransforms$transformConstructor(tx: classFieldsTransformer | undefined, __go_constructor: {
        ...
        if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment === undefined || ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data === undefined || ((void classFacts,
            ...
            if (!(__go_constructor === undefined)) {
                ...
                const __gotots_receiver_91 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_380, "Transformer"));
                ...
                const __gotots_argument_284 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_381, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
        ...
        if (!(__go_constructor === undefined)) {
            ...
            parameters = NodeVisitor__from_ast.VisitNodes(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_382, "Transformer")), FunctionLikeBase__from_ast.$storageOf(FunctionLikeBase__from_ast.$fromStorage(FunctionLikeWithBodyBase__from_ast.$storageOf((__go_constructor ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.FunctionLikeWithBodyBase).FunctionLikeBase)).Parameters);
        }
        ...
        if (body === undefined) {
            if (!(__go_constructor === undefined)) {
                ...
                const __gotots_receiver_92 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_383, "Transformer"));
                ...
                const __gotots_argument_285 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_384, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
        ...
        if (!(__go_constructor === undefined)) {
            ...
            const __gotots_store_386 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_385, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        if (parameters === undefined) {
            ...
            const __gotots_store_388 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_387, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_390 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_389, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
    ...
    static $go$private$estransforms$transformConstructorBody(tx: classFieldsTransformer | undefined, container: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, __go_constructor: {
        ...
        if (__go_constructor === undefined && !needsConstructorBody) {
            ...
            const __gotots_receiver_123 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_534, "Transformer"));
            ...
            const __gotots_argument_386 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_535, "Transformer"));
        ...
        EmitContext__from_printer.StartVariableEnvironment(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_536, "Transformer")));
        ...
        let receiver: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewThisExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_537, "Transformer")));
        ...
        if (!(__go_constructor === undefined)) {
            let parameterProperties = Filter$PointerTo_Named_ast$Node(instanceProperties, (prop: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): bool => {
                ...
                const __gotots_argument_387 = EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_538, "Transformer")), prop);
                ...
                const __gotots_argument_388 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_539, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
            ...
            let nonParameterProperties = Filter$PointerTo_Named_ast$Node(properties, (prop: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): bool => {
                ...
                const __gotots_argument_389 = EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_540, "Transformer")), prop);
                ...
                const __gotots_argument_390 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_541, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
        ...
        if (!(__go_constructor === undefined) && !(BodyBase__from_ast.$storageOf(BodyBase__from_ast.$fromStorage(FunctionLikeWithBodyBase__from_ast.$storageOf((__go_constructor ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.FunctionLikeWithBodyBase).BodyBase)).Body === undefined)) {
            let body: tsonicTypeScriptRuntime.Location<Block__from_ast> | undefined = Node__from_ast.AsBlock(BodyBase__from_ast.$storageOf(BodyBase__from_ast.$fromStorage(FunctionLikeWithBodyBase__from_ast.$storageOf((__go_constructor ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.FunctionLikeWithBodyBase).BodyBase)).Body);
            ...
            if (superPath.length > 0) {
                ...
                for (; statementOffset < NodeList__from_ast.$storageOf(((Block__from_ast.$storageOf(((body ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Block__from_ast>).value).Statements ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<NodeList__from_ast>).value).Nodes.length;) {
                    ...
                    let orig: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_542, "Transformer")), stmt);
                    ...
                    const __gotots_argument_392 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_543, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                        return NodeDefault__from_ast.$fromStorage($go$storage);
                    }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                        return NodeDefault__from_ast.$storageOf($go$value);
                    }));
                ...
                const __gotots_results_14 = NodeVisitor__from_ast.VisitSlice(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_544, "Transformer")), NodeList__from_ast.$storageOf(((Block__from_ast.$storageOf(((body ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Block__from_ast>).value).Statements ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<NodeList__from_ast>).value).Nodes.slice(statementOffset, null, null));
            ...
            if (needsSyntheticConstructor) {
                ...
                const __gotots_store_554 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_553, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_556 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_555, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_561 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_560, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
    ...
    static $go$private$estransforms$transformConstructorBodyWorker(tx: classFieldsTransformer | undefined, statementsOut: RuntimeSlice<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined>, statementsIn: RuntimeSlice<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined>, statementOffset: int, superPath: RuntimeSlice<int>, superPathDepth: int, initializerStatements: RuntimeSlice<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined>, __go_constructor: {
        ...
        const __gotots_results_17 = NodeVisitor__from_ast.VisitSlice(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_663, "Transformer")), statementsIn.slice(statementOffset, superStatementIndex, null));
        ...
        if (IsTryStatement__from_ast(superStatement)) {
            ...
            const __gotots_store_665 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_664, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            let catchClause: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_666, "Transformer")), (Node__from_ast.AsTryStatement(superStatement) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.CatchClause);
            const __gotots_store_667 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            let finallyBlock: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_667, "Transformer")), (Node__from_ast.AsTryStatement(superStatement) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.FinallyBlock);
            const __gotots_store_668 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            const __gotots_store_669 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_668, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_store_671 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_670, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_results_18 = NodeVisitor__from_ast.VisitSlice(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_672, "Transformer")), statementsIn.slice(superStatementIndex, superStatementIndex + 1, null));
            ...
            for (; statementOffset < statementsIn.length;) {
                ...
                let orig: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_673, "Transformer")), stmt);
                ...
                const __gotots_argument_477 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_674, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
        ...
        const __gotots_results_19 = NodeVisitor__from_ast.VisitSlice(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_675, "Transformer")), statementsIn.slice(statementOffset, null, null));
    ...
    static $go$private$estransforms$transformFieldInitializer(tx: classFieldsTransformer | undefined, node: {
        ...
        const __gotots_argument_198 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_231, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        const __gotots_argument_201 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_232, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$transformPrivateFieldInitializer(tx: classFieldsTransformer | undefined, node: {
        ...
        const __gotots_argument_312 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_440, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        if (classFieldsTransformer.$go$private$estransforms$shouldTransformClassElementToWeakMap(__gotots_receiver_103, __gotots_argument_312)) {
            let info: {
                value: privateIdentifierInfo;
            } | undefined = classFieldsTransformer.$go$private$estransforms$accessPrivateIdentifier(tx, PropertyDeclaration__from_ast.Name(node));
            Assert__from_debug(!(info === undefined), RuntimeSlice.literal<GoInterface | undefined>([new GoInterfaceAdapter("Undeclared private name for property declaration.")]));
            if (!(info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.isValid) {
                ...
                return NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_441, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
            }
            if ((info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.isStatic && !(tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformPrivateElementsOrClassStaticBlocks) {
                ...
                const __gotots_argument_313 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_442, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
                const __gotots_store_443 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                const __gotots_argument_314 = NodeFactory__from_printer.NewThisExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_443, "Transformer")));
                ...
                if (!(statement === undefined)) {
                    ...
                    const __gotots_store_447 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_446, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                    ...
                    const __gotots_store_449 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_448, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        if (__gotots_logical_result_8) {
            ...
            const __gotots_argument_319 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_450, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        if (__gotots_logical_result_8 && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment === undefined) && !(((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data === undefined) && !(((void classFacts,
            ...
            const __gotots_store_452 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_451, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_receiver_107 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_453, "Transformer"));
        ...
        const __gotots_argument_327 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_455, "Transformer"));
        ...
        const __gotots_argument_328 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_456, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        if (isNamedEvaluationAnd(__gotots_argument_327, __gotots_argument_328, __gotots_argument_329)) {
            ...
            const __gotots_argument_330 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_457, "Transformer"));
            ...
            const __gotots_argument_331 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_458, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        const __gotots_store_460 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_459, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_argument_340 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_462, "Transformer")), (node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Initializer);
    ...
    static $go$private$estransforms$transformPrivateIdentifierInInExpression(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        let info: {
            value: privateIdentifierInfo;
        } | undefined = classFieldsTransformer.$go$private$estransforms$accessPrivateIdentifier(tx, BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).Left);
        if (!(info === undefined)) {
            const __gotots_store_365 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            let receiver: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_365, "Transformer")), BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).Right);
            const __gotots_store_366 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            let result: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewClassPrivateFieldInHelper(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_366, "Transformer")), (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.brandCheckIdentifier, receiver);
            const __gotots_store_367 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            const __gotots_receiver_87 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_367, "Transformer"));
            const __gotots_argument_276 = result;
            const __gotots_store_368 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase));
            const __gotots_argument_277 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_368, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        const __gotots_receiver_88 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_369, "Transformer"));
        const __gotots_store_370 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase));
        const __gotots_argument_278 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_370, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$transformProperty(tx: classFieldsTransformer | undefined, property: {
        ...
        if (__gotots_logical_result_18) {
            ...
            const __gotots_argument_460 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_653, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        if (__gotots_logical_result_18) {
            ...
            EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_654, "Transformer")), transformed, EFNoLexicalThis$constant__from_printer());
        }
        ...
        if (__gotots_logical_result_19) {
            ...
            const __gotots_argument_461 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_655, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        if (__gotots_logical_result_19 && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment === undefined) && !(((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data === undefined) && !((((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).facts.$value ===
            ...
            const __gotots_receiver_143 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_656, "Transformer"));
            ...
            const __gotots_argument_463 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_657, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
            ...
            const __gotots_receiver_144 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_658, "Transformer"));
            ...
            const __gotots_argument_465 = EmitContext__from_printer.SourceMapRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_659, "Transformer")), PropertyDeclaration__from_ast.Name(property));
    ...
    static $go$private$estransforms$transformPropertyOrClassStaticBlock(tx: classFieldsTransformer | undefined, property: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, receiver: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        EmitContext__from_printer.SetOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_597, "Transformer")), statement, property);
        const __gotots_store_598 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        const __gotots_receiver_134 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_598, "Transformer"));
        ...
        const __gotots_binary_operand_8 = EmitContext__from_printer.EmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_599, "Transformer")), property);
        ...
        if (IsParameterDeclaration__from_ast(propertyOriginalNode)) {
            ...
            EmitContext__from_printer.SetSourceMapRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_602, "Transformer")), statement, TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(((propertyOriginalNode ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc)));
            const __gotots_store_603 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_603, "Transformer")), statement, EFNoComments$constant__from_printer());
        }
        else {
            const __gotots_store_604 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.SetSourceMapRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_604, "Transformer")), statement, MoveRangePastModifiers__from_transformers(property));
        }
        const __gotots_store_605 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        EmitContext__from_printer.SetSyntheticLeadingComments(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_605, "Transformer")), expression, RuntimeSlice.nil<SynthesizedComment__from_printer$Storage>());
        const __gotots_store_606 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        EmitContext__from_printer.SetSyntheticTrailingComments(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_606, "Transformer")), expression, RuntimeSlice.nil<SynthesizedComment__from_printer$Storage>());
        if (HasAccessorModifier__from_ast(propertyOriginalNode)) {
            ...
            EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_607, "Transformer")), statement, EFNoComments$constant__from_printer());
        }
        return statement;
    }
    static $go$private$estransforms$transformPropertyWorker(tx: classFieldsTransformer | undefined, property: {
        ...
        const __gotots_argument_479 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_679, "Transformer"));
        ...
        const __gotots_argument_480 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_680, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        if (isNamedEvaluationAnd(__gotots_argument_479, __gotots_argument_480, __gotots_argument_481)) {
            ...
            const __gotots_argument_482 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_681, "Transformer"));
            ...
            const __gotots_argument_483 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_682, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        const __gotots_argument_486 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_683, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        if (HasAccessorModifier__from_ast(__gotots_argument_486)) {
            ...
            propertyName = NodeFactory__from_printer.NewGeneratedPrivateNameForNodeEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_684, "Transformer")), PropertyDeclaration__from_ast.Name(property), new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(0), "", "_accessor_storage"));
        }
            ...
            const __gotots_store_686 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_685, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_argument_488 = NodeFactory__from_printer.NewGeneratedNameForNode(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_687, "Transformer")), propertyName);
        ...
        const __gotots_argument_489 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_688, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        if (HasStaticModifier__from_ast(__gotots_argument_489)) {
            ...
            (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_689, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        if (__gotots_logical_result_21) {
            ...
            const __gotots_argument_490 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_690, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        if (__gotots_logical_result_21) {
            let info: {
                value: privateIdentifierInfo;
            } | undefined = classFieldsTransformer.$go$private$estransforms$accessPrivateIdentifier(tx, propertyName);
            if (!(info === undefined)) {
                if ((info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.kind.$value === PrivateIdentifierKindField$constant__from_printer().$value) {
                    if (!(info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.isStatic) {
                        const __gotots_store_691 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                        const __gotots_argument_491 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_691, "Transformer"));
                        ...
                        const __gotots_argument_493 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_692, "Transformer")), (property ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Initializer);
                        const __gotots_argument_494 = (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.brandCheckIdentifier;
                    ...
                    const __gotots_argument_495 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_693, "Transformer"));
                    const __gotots_argument_496 = (info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.variableName;
                    const __gotots_store_694 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    const __gotots_argument_497 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_694, "Transformer")), (property ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Initializer);
        ...
        if (!__gotots_logical_result_22) {
            ...
            const __gotots_argument_498 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_695, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        const __gotots_receiver_149 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_696, "Transformer"));
        ...
        const __gotots_argument_499 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_697, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        let initializer: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_698, "Transformer")), (property ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Initializer);
        const __gotots_store_699 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        const __gotots_receiver_150 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_699, "Transformer"));
        ...
        const __gotots_argument_501 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_700, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        if (IsParameterPropertyDeclaration__from_ast(propertyOriginalNode, Node__from_ast.$storageOf(((propertyOriginalNode ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Parent) && IsIdentifier__from_ast(propertyName)) {
            ...
            const __gotots_argument_502 = new $goInterfaceAdapter$PointerTo_Named_printer$NodeFactory(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_701, "Transformer")));
            ...
            if (!(initializer === undefined)) {
                ...
                initializer = NodeFactory__from_printer.InlineExpressions(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_703, "Transformer")), RuntimeSlice.literal<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined>([initializer, localName]));
            }
            else {
                initializer = localName;
            }
            const __gotots_store_704 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_704, "Transformer")), propertyName, 396);
            const __gotots_store_705 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.SetSourceMapRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_705, "Transformer")), localName, TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(((Node__from_ast.Name(propertyOriginalNode) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc)));
            const __gotots_store_706 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_706, "Transformer")), localName, EFNoComments$constant__from_printer());
        }
            ...
            initializer = NodeFactory__from_printer.NewVoidZeroExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_707, "Transformer")));
        }
        if (emitAssignment || IsPrivateIdentifier__from_ast(propertyName)) {
            ...
            const __gotots_argument_503 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_708, "Transformer"));
            const __gotots_store_709 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            const __gotots_argument_504 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_709, "Transformer"));
            ...
            EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_710, "Transformer")), memberAccess, EFNoLeadingComments$constant__from_printer());
            const __gotots_store_711 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            return NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_711, "Transformer")), memberAccess, initializer);
        }
        ...
        if (IsComputedPropertyName__from_ast(propertyName)) {
            ...
            const __gotots_store_713 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_712, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_715 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_714, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_717 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_716, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_719 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_718, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_721 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_720, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_argument_512 = NodeFactory__from_printer.NewTrueExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_722, "Transformer")));
        ...
        const __gotots_store_724 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_723, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_726 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_725, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_argument_517 = NodeFactory__from_printer.NewTrueExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_727, "Transformer")));
        ...
        const __gotots_store_729 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_728, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_731 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_730, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_argument_522 = NodeFactory__from_printer.NewTrueExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_732, "Transformer")));
        ...
        const __gotots_store_734 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_733, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_736 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_735, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        return NodeFactory__from_printer.NewObjectDefinePropertyCall(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_737, "Transformer")), receiver, name, descriptor);
    }
    static $go$private$estransforms$transformPublicFieldInitializer(tx: classFieldsTransformer | undefined, node: {
        ...
        if (__gotots_logical_result_9) {
            ...
            const __gotots_argument_341 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_463, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        if (__gotots_logical_result_9) {
            ...
            const __gotots_argument_342 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_464, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
            if (IsStatic__from_ast(__gotots_argument_342) && !(tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformPrivateElementsOrClassStaticBlocks) {
                ...
                const __gotots_argument_343 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_465, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
                const __gotots_store_466 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                const __gotots_argument_344 = NodeFactory__from_printer.NewThisExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_466, "Transformer")));
                ...
                if (!(initializerStatement === undefined)) {
                    ...
                    const __gotots_store_472 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_471, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                    ...
                    const __gotots_receiver_114 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_473, "Transformer"));
                    ...
                    const __gotots_argument_350 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_474, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                        return NodeDefault__from_ast.$fromStorage($go$storage);
                    }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                        return NodeDefault__from_ast.$storageOf($go$value);
                    }));
        ...
        const __gotots_store_478 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_477, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_argument_357 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_480, "Transformer")), (node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Initializer);
                ...
                __gotots_return_block_0: {
                    ...
                    switch (Node__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Kind) {
                        ...
                        default: {
                            ...
                            __gotots_return_0 = NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_10, "Transformer")), node);
                            break __gotots_return_block_0;
                            break;
                        }
                    }
    ...
    static $go$private$estransforms$visitArrayAssignmentElement(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_11, "Transformer")), node);
    }
    static $go$private$estransforms$visitAssignmentElement(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        const __gotots_argument_202 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_236, "Transformer"));
        ...
        if (isNamedEvaluationAnd(__gotots_argument_202, __gotots_argument_203, __gotots_argument_204)) {
            ...
            const __gotots_argument_205 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_237, "Transformer"));
    ...
    static $go$private$estransforms$visitAssignmentProperty(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        let name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_247, "Transformer")), PropertyAssignment__from_ast.Name(prop));
        ...
        return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_252, "Transformer")), node);
    }
    static $go$private$estransforms$visitAssignmentRestElement(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if (IsLeftHandSideExpression__from_ast((spread ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Expression)) {
            ...
            const __gotots_store_234 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_233, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_235, "Transformer")), node);
    }
    static $go$private$estransforms$visitAssignmentRestProperty(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if (IsLeftHandSideExpression__from_ast((spread ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Expression)) {
            ...
            const __gotots_store_242 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_241, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_243, "Transformer")), node);
    }
    ...
    static $go$private$estransforms$visitBinaryExpression(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast> | undefined, discarded: bool): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        const __gotots_store_103 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase));
        const __gotots_argument_89 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_103, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        if (IsDestructuringAssignment__from_ast(__gotots_argument_89)) {
            ...
            const __gotots_argument_95 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_106, "Transformer")), BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).Right);
            ...
            if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).pendingExpressions.length > 0) {
                ...
                result = NodeFactory__from_printer.InlineExpressions(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_107, "Transformer")), exprs);
            }
            else {
                result = updated;
            }
        ...
        if (IsAssignmentExpression__from_ast(__gotots_argument_96, __gotots_argument_97)) {
            ...
            const __gotots_argument_98 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_109, "Transformer"));
            const __gotots_store_110 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase));
            const __gotots_argument_99 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_110, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
            ...
            if (isNamedEvaluationAnd(__gotots_argument_98, __gotots_argument_99, __gotots_argument_100)) {
                ...
                const __gotots_argument_101 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_111, "Transformer"));
                const __gotots_store_112 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase));
                const __gotots_argument_102 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_112, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
                ...
                const __gotots_store_113 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase));
                let __gotots_logical_result_2 = !(NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_113, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                })) === undefined);
                if (__gotots_logical_result_2) {
                    const __gotots_store_114 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase));
                    const __gotots_argument_105 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_114, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                        return NodeDefault__from_ast.$fromStorage($go$storage);
                    }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                        return NodeDefault__from_ast.$storageOf($go$value);
                    }));
            ...
            if (IsPropertyAccessExpression__from_ast(left) && IsPrivateIdentifier__from_ast(Node__from_ast.Name(left))) {
                let info: {
                    value: privateIdentifierInfo;
                } | undefined = classFieldsTransformer.$go$private$estransforms$accessPrivateIdentifier(tx, Node__from_ast.Name(left));
                if (!(info === undefined)) {
                    ...
                    const __gotots_receiver_41 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_115, "Transformer"));
                    const __gotots_argument_109 = result;
                    const __gotots_store_116 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase));
                    const __gotots_argument_110 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_116, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                        return NodeDefault__from_ast.$fromStorage($go$storage);
                    }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                        return NodeDefault__from_ast.$storageOf($go$value);
                    }));
                    EmitContext__from_printer.SetOriginal(__gotots_receiver_41, __gotots_argument_109, __gotots_argument_110);
                    Node__from_ast.$storageOf(((result ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc = TextRange__from_core.$storageOf(TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(Node__from_ast.$fromStorage(NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase)).NodeDefault)).Node)).Loc)));
                    return result;
                }
            }
                ...
                if (!(((void classFacts,
                    ...
                    const __gotots_store_118 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_117, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                    ...
                    const __gotots_argument_116 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_119, "Transformer")), BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).Right);
                ...
                if (!((data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor === undefined) && !((data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).superClassReference === undefined)) {
                    ...
                    if (IsElementAccessExpression__from_ast(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).Left)) {
                        ...
                        setterName = NodeFactory__from_printer.NewStringLiteralFromNode(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_121, "Transformer")), PropertyAccessExpression__from_ast.Name(Node__from_ast.AsPropertyAccessExpression(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).Left)));
                    }
                    if (!(setterName === undefined)) {
                        ...
                        if (IsCompoundAssignment__from_ast(Node__from_ast.$storageOf(((BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).OperatorToken ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Kind)) {
                            ...
                            if (!IsSimpleInlineableExpression__from_transformers(setterName)) {
                                ...
                                getterName = NodeFactory__from_printer.NewTempVariable(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_123, "Transformer")));
                                const __gotots_store_124 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                                EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_124, "Transformer")), getterName);
                                const __gotots_store_125 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                                setterName = NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_125, "Transformer")), getterName, setterName);
                            }
                            const __gotots_store_126 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                            let superPropertyGet: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewReflectGetCall(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_126, "Transformer")), (data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).superClassReference, getterName, (data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor);
                            const __gotots_store_127 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                            EmitContext__from_printer.SetOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_127, "Transformer")), superPropertyGet, BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).Left);
                            ...
                            const __gotots_store_131 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_130, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                        ...
                        if (!discarded) {
                            ...
                            temp = NodeFactory__from_printer.NewTempVariable(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_132, "Transformer")));
                            const __gotots_store_133 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                            EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_133, "Transformer")), temp);
                        }
                        if (!(temp === undefined)) {
                            const __gotots_store_134 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                            expression = NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_134, "Transformer")), temp, expression);
                            Node__from_ast.$storageOf(((expression ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc = TextRange__from_core.$storageOf(TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(Node__from_ast.$fromStorage(NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase)).NodeDefault)).Node)).Loc)));
                        }
                        const __gotots_store_135 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                        expression = NodeFactory__from_printer.NewReflectSetCall(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_135, "Transformer")), (data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).superClassReference, setterName, expression, (data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor);
                        const __gotots_store_136 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                        const __gotots_receiver_44 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_136, "Transformer"));
                        const __gotots_argument_122 = expression;
                        const __gotots_store_137 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase));
                        const __gotots_argument_123 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_137, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                            return NodeDefault__from_ast.$fromStorage($go$storage);
                        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                            return NodeDefault__from_ast.$storageOf($go$value);
                        }));
                        ...
                        if (!(temp === undefined)) {
                            ...
                            expression = NodeFactory__from_printer.NewCommaExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_138, "Transformer")), expression, temp);
                            Node__from_ast.$storageOf(((expression ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc = TextRange__from_core.$storageOf(TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(Node__from_ast.$fromStorage(NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase)).NodeDefault)).Node)).Loc)));
                        }
                        return expression;
                    }
        ...
        const __gotots_receiver_45 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_139, "Transformer"));
        const __gotots_store_140 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(BinaryExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast>).value).ExpressionBase)).NodeBase));
        const __gotots_argument_124 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_140, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitBindingElement(tx: classFieldsTransformer | undefined, node: {
        ...
        const __gotots_argument_47 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_47, "Transformer"));
        ...
        const __gotots_argument_48 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_48, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        if (isNamedEvaluationAnd(__gotots_argument_47, __gotots_argument_48, __gotots_argument_49)) {
            ...
            const __gotots_argument_50 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_49, "Transformer"));
            ...
            const __gotots_argument_51 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_50, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        const __gotots_receiver_30 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_51, "Transformer"));
        ...
        const __gotots_argument_54 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_52, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitCallExpression(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<CallExpression__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        if (IsPropertyAccessExpression__from_ast(CallExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<CallExpression__from_ast>).value).Expression) && IsPrivateIdentifier__from_ast(PropertyAccessExpression__from_ast.Name(Node__from_ast.AsPropertyAccessExpression(CallExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<CallExpression__from_ast>).value).Expression))) && !(classFieldsTransformer.$go$private$estransforms$accessPrivateIdentifier(tx, PropertyAccessExpression__from_ast.Name(Node__from_ast.AsPropertyAccessExpression(CallExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<CallExpression__from_ast>).value).Expression))) === undefined)) {
            ...
            let visitedTarget: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_146, "Transformer")), target);
            const __gotots_store_147 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            let visitedThisArg: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_147, "Transformer")), thisArg);
            const __gotots_store_148 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            let visitedArgs: tsonicTypeScriptRuntime.Location<NodeList__from_ast> | undefined = NodeVisitor__from_ast.VisitNodes(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_148, "Transformer")), CallExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<CallExpression__from_ast>).value).Arguments);
            ...
            if (!((Node__from_ast.$storageOf(Node__from_ast.$fromStorage(NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(CallExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<CallExpression__from_ast>).value).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase)).NodeDefault)).Node)).Flags & NodeFlagsOptionalChain$constant__from_ast()) >>> 0 === 0)) {
                ...
                const __gotots_store_150 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_149, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_152 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_151, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_154 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_153, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_argument_134 = Node__from_ast.$storageOf(Node__from_ast.$fromStorage(NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(CallExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<CallExpression__from_ast>).value).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase)).NodeDefault)).Node)).Flags;
            ...
            const __gotots_argument_144 = Node__from_ast.$storageOf(Node__from_ast.$fromStorage(NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(CallExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<CallExpression__from_ast>).value).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase)).NodeDefault)).Node)).Flags;
        ...
        if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformSuperInStaticInitializers && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement === undefined) && IsSuperProperty__from_ast(CallExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<CallExpression__from_ast>).value).Expression) && isStaticPropertyDeclarationOrClassStaticBlock((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement) && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment === undefined) && !(((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data === undefined) && !((((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor === undefined)) {
            ...
            const __gotots_receiver_50 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_165, "Transformer"));
            const __gotots_store_166 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            const __gotots_argument_145 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_166, "Transformer")), CallExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<CallExpression__from_ast>).value).Expression);
            ...
            const __gotots_receiver_51 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_168, "Transformer"));
            const __gotots_argument_148 = invocation;
            const __gotots_store_169 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(CallExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<CallExpression__from_ast>).value).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
            const __gotots_argument_149 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_169, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        const __gotots_receiver_52 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_170, "Transformer"));
        const __gotots_store_171 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(CallExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<CallExpression__from_ast>).value).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
        const __gotots_argument_150 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_171, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitClassDeclaration(tx: classFieldsTransformer | undefined, node: {
        ...
        const __gotots_store_23 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(StatementBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.StatementBase).NodeBase));
        const __gotots_argument_18 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_23, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitClassDeclarationInNewClassLexicalEnvironment(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, facts: classFacts): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if (!(((void classFacts,
            ...
            if (__gotots_logical_result_4) {
                ...
                __gotots_logical_result_4 = !(EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_267, "Transformer")), node) === undefined);
            }
            if (__gotots_logical_result_4) {
                const __gotots_store_268 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                let classThis: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_268, "Transformer")), node);
                ...
                const __gotots_receiver_70 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_269, "Transformer"));
                ...
                const __gotots_argument_220 = NodeFactory__from_printer.GetLocalName(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_270, "Transformer")), node);
                ...
                const __gotots_argument_221 = new $goInterfaceAdapter$PointerTo_Named_printer$NodeFactory(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_273, "Transformer")));
                ...
                const __gotots_receiver_72 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_274, "Transformer"));
                ...
                const __gotots_argument_223 = NodeFactory__from_printer.GetLocalName(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_275, "Transformer")), node);
        ...
        if (!(EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_276, "Transformer")), node) === undefined)) {
            const __gotots_store_277 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            (classFieldsTransformer.$go$private$estransforms$getClassLexicalEnvironment(tx) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classThis = EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_277, "Transformer")), node);
        }
        ...
        if (isClassWithConstructorReference && !(alias === undefined)) {
            ...
            __gotots_store_279.store(EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_278, "Transformer")), node), alias);
        }
        const __gotots_receiver_73 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).modifierVisitor;
        const __gotots_store_280 = (classDecl ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.ClassLikeBase;
        ...
        if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).pendingExpressions.length > 0) {
            ...
            const __gotots_store_282 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_281, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_argument_225 = NodeFactory__from_printer.InlineExpressions(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_283, "Transformer")), (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).pendingExpressions);
        ...
        if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformInitializersUsingSet || (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformPrivateElementsOrClassStaticBlocks) {
            ...
            if (staticProperties.length > 0) {
                if (name === undefined) {
                    ...
                    name = NodeFactory__from_printer.NewGeneratedNameForNode(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_284, "Transformer")), node);
                }
                ...
                const __gotots_argument_230 = NodeFactory__from_printer.GetLocalName(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_285, "Transformer")), node);
        ...
        if (statements.length > 0 && isExport && isDefault) {
            ...
            const __gotots_argument_231 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_286, "Transformer"));
            ...
            const __gotots_store_288 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_287, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_argument_237 = NodeFactory__from_printer.GetLocalName(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_289, "Transformer")), node);
        ...
        if (!(membersPrologue === undefined)) {
            ...
            const __gotots_store_293 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_292, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
    ...
    static $go$private$estransforms$visitClassExpressionInNewClassLexicalEnvironment(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, facts: classFacts): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if (!(EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_303, "Transformer")), node) === undefined)) {
            const __gotots_store_304 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            (classFieldsTransformer.$go$private$estransforms$getClassLexicalEnvironment(tx) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classThis = EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_304, "Transformer")), node);
        }
        let temp: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = void 0;
        if (!(((void classFacts,
            facts.$value & classFactsNeedsClassConstructorReference$constant().$value) as int)
            ...
            if (__gotots_logical_result_5) {
                ...
                __gotots_logical_result_5 = !(EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_305, "Transformer")), node) === undefined);
            }
            if (__gotots_logical_result_5) {
                const __gotots_store_306 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                let classThis: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_306, "Transformer")), node);
                (classFieldsTransformer.$go$private$estransforms$getClassLexicalEnvironment(tx) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor = classThis;
                temp = classThis;
            }
            else {
                const __gotots_store_307 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                temp = NodeFactory__from_printer.NewTempVariableEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_307, "Transformer")), new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(GeneratedIdentifierFlagsReservedInNestedScopes$int__from_printer), "", ""));
                if (classFieldsTransformer.$go$private$estransforms$classExpressionNeedsBlockScopedTemp(tx)) {
                    ...
                    EmitContext__from_printer.AddLexicalDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_308, "Transformer")), temp);
                }
                else {
                    const __gotots_store_309 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_309, "Transformer")), temp);
                }
                ...
                const __gotots_argument_243 = new $goInterfaceAdapter$PointerTo_Named_printer$NodeFactory(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_310, "Transformer")));
        ...
        if (!isDecoratedClassDeclaration) {
            ...
            if (isClassWithConstructorReference && willNeedTempWrapper && (classFieldsTransformer.$go$private$estransforms$getClassLexicalEnvironment(tx) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor === undefined) {
                ...
                temp = NodeFactory__from_printer.NewTempVariableEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_311, "Transformer")), new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(GeneratedIdentifierFlagsReservedInNestedScopes$int__from_printer), "", ""));
                ...
                const __gotots_argument_244 = new $goInterfaceAdapter$PointerTo_Named_printer$NodeFactory(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_312, "Transformer")));
            ...
            }
            {
                ...
                if (isClassWithConstructorReference && willNeedTempWrapper && !(alias === undefined)) {
                    ...
                    __gotots_store_314.store(EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_313, "Transformer")), node), alias);
                }
            }
        }
        const __gotots_receiver_79 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).modifierVisitor;
        const __gotots_store_315 = (classExpr ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.ClassLikeBase;
        ...
        if (deferTempDeclaration) {
            if (classFieldsTransformer.$go$private$estransforms$classExpressionNeedsBlockScopedTemp(tx)) {
                ...
                EmitContext__from_printer.AddLexicalDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_316, "Transformer")), temp);
            }
            else {
                const __gotots_store_317 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_317, "Transformer")), temp);
            }
        }
        const __gotots_store_318 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        const __gotots_store_319 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_318, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        if (!isDecoratedClassDeclaration) {
            if (hasTransformableStatics || (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).pendingExpressions.length > 0) {
                if (temp === undefined) {
                    ...
                    temp = NodeFactory__from_printer.NewTempVariableEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_320, "Transformer")), new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(GeneratedIdentifierFlagsReservedInNestedScopes$int__from_printer), "", ""));
                    if (classFieldsTransformer.$go$private$estransforms$classExpressionNeedsBlockScopedTemp(tx)) {
                        const __gotots_store_321 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                        EmitContext__from_printer.AddLexicalDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_321, "Transformer")), temp);
                    }
                    else {
                        const __gotots_store_322 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                        EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_322, "Transformer")), temp);
                    }
                    ...
                    const __gotots_argument_246 = new $goInterfaceAdapter$PointerTo_Named_printer$NodeFactory(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_323, "Transformer")));
                ...
                const __gotots_argument_248 = NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_326, "Transformer")), temp, classExpression);
                ...
                const __gotots_argument_249 = new $goInterfaceAdapter$PointerTo_Named_printer$NodeFactory(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_327, "Transformer")));
            ...
            if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).pendingExpressions.length > 0) {
                ...
                for (let __gotots_range_index_2 = 0; __gotots_range_index_2 < __gotots_range_2.length; __gotots_range_index_2++) {
                    ...
                    const __gotots_store_329 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_328, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            if (staticPropertiesOrClassStaticBlocks.length > 0) {
                ...
                let classThisOrName: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_330, "Transformer")), node);
                if (classThisOrName === undefined) {
                    ...
                    classThisOrName = NodeFactory__from_printer.GetLocalName(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_331, "Transformer")), node);
                }
            ...
            if (!(temp === undefined)) {
                ...
                const __gotots_argument_255 = NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_332, "Transformer")), temp, classExpression);
                ...
                if (__gotots_logical_result_6) {
                    ...
                    __gotots_logical_result_6 = !(EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_333, "Transformer")), node) === undefined);
                }
                if (__gotots_logical_result_6) {
                    ...
                    const __gotots_receiver_82 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_334, "Transformer"));
                    const __gotots_store_335 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    const __gotots_argument_256 = EmitContext__from_printer.ClassThis(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_335, "Transformer")), node);
        ...
        if (expressions.length > 1) {
            ...
            EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_336, "Transformer")), classExpression, EFIndented$constant__from_printer());
            ...
            for (let __gotots_range_index_3 = 0; __gotots_range_index_3 < __gotots_range_3.length; __gotots_range_index_3++) {
                ...
                EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_337, "Transformer")), expr, EFStartOnNewLine$constant__from_printer());
            }
        }
        const __gotots_store_338 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        return NodeFactory__from_printer.InlineExpressions(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_338, "Transformer")), expressions);
    }
    static $go$private$estransforms$visitClassStaticBlockDeclaration(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        if (!(tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformPrivateElementsOrClassStaticBlocks) {
            ...
            return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_227, "Transformer")), node);
        }
        return void 0;
    }
    static $go$private$estransforms$visitComputedPropertyName(tx: classFieldsTransformer | undefined, node: {
        ...
        let expression: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_228, "Transformer")), (node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Expression);
        (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment = savedLexicalEnvironment;
        (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).insideComputedPropertyName = savedInsideComputedPropertyName;
        const __gotots_store_229 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        const __gotots_store_230 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_229, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
    ...
    static $go$private$estransforms$visitConstructorDeclaration(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_219, "Transformer")), node);
    }
        ...
        if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformSuperInStaticInitializers && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement === undefined) && IsSuperProperty__from_ast(node) && isStaticPropertyDeclarationOrClassStaticBlock((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement) && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment === undefined) && !(((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data === undefined)) {
            ...
            if (!((data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor === undefined) && !((data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).superClassReference === undefined)) {
                ...
                if (IsElementAccessExpression__from_ast(node)) {
                    ...
                    name = NodeFactory__from_printer.NewStringLiteralFromNode(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_482, "Transformer")), PropertyAccessExpression__from_ast.Name(Node__from_ast.AsPropertyAccessExpression(node)));
                }
                if (!(name === undefined)) {
                    const __gotots_store_483 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    let temp: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewTempVariable(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_483, "Transformer")));
                    const __gotots_store_484 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    let setExpr: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewReflectSetCall(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_484, "Transformer")), (data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).superClassReference, name, temp, (data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor);
                    const __gotots_store_485 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    return NodeFactory__from_printer.NewAssignmentTargetWrapper(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_485, "Transformer")), temp, setExpr);
                }
            }
        }
        const __gotots_store_486 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_486, "Transformer")), node);
    }
    ...
    static $go$private$estransforms$visitEachChildOfNode(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_202, "Transformer")), node);
    }
    static $go$private$estransforms$visitElementAccessExpression(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<ElementAccessExpression__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if (__gotots_logical_result_1) {
            const __gotots_store_71 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(ElementAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ElementAccessExpression__from_ast>).value).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
            const __gotots_argument_71 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_71, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        if (__gotots_logical_result_1 && isStaticPropertyDeclarationOrClassStaticBlock((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement) && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment === undefined) && !(((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data === undefined)) {
            ...
            if (!(((void classFacts,
                ...
                const __gotots_store_72 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(ElementAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ElementAccessExpression__from_ast>).value).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
                const __gotots_argument_72 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_72, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
            ...
            if (!((data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor === undefined) && !((data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).superClassReference === undefined)) {
                ...
                const __gotots_receiver_37 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_73, "Transformer"));
                ...
                const __gotots_argument_74 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_74, "Transformer")), ElementAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ElementAccessExpression__from_ast>).value).ArgumentExpression);
                ...
                EmitContext__from_printer.SetOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_75, "Transformer")), superProperty, ElementAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ElementAccessExpression__from_ast>).value).Expression);
        ...
        const __gotots_receiver_38 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_76, "Transformer"));
        const __gotots_store_77 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(ElementAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ElementAccessExpression__from_ast>).value).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
        const __gotots_argument_76 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_77, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitExportAssignment(tx: classFieldsTransformer | undefined, node: {
        ...
        const __gotots_argument_55 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_53, "Transformer"));
        const __gotots_store_54 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(StatementBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.StatementBase).NodeBase));
        const __gotots_argument_56 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_54, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        if (isNamedEvaluationAnd(__gotots_argument_55, __gotots_argument_56, __gotots_argument_57)) {
            ...
            const __gotots_argument_58 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_55, "Transformer"));
            const __gotots_store_56 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(StatementBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.StatementBase).NodeBase));
            const __gotots_argument_59 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_56, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        const __gotots_receiver_31 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_57, "Transformer"));
        const __gotots_store_58 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(StatementBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.StatementBase).NodeBase));
        const __gotots_argument_62 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_58, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitExpressionStatement(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<ExpressionStatement__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        if (IsPrivateIdentifier__from_ast(ExpressionStatement__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ExpressionStatement__from_ast>).value).Expression) && (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformPrivateElementsOrClassStaticBlocks) {
            const __gotots_store_172 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(StatementBase__from_ast.$storageOf(StatementBase__from_ast.$fromStorage(ExpressionStatement__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ExpressionStatement__from_ast>).value).StatementBase)).NodeBase));
            return NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_172, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
    ...
    static $go$private$estransforms$visitExpressionWithTypeArgumentsInHeritageClause(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<ExpressionWithTypeArguments__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if (!(((void classFacts,
            ...
            let temp: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewTempVariableEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_208, "Transformer")), new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(GeneratedIdentifierFlagsReservedInNestedScopes$int__from_printer), "", ""));
            const __gotots_store_209 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_209, "Transformer")), temp);
            ...
            const __gotots_store_211 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_210, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_receiver_63 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_212, "Transformer"));
            ...
            const __gotots_argument_187 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_213, "Transformer")), ExpressionWithTypeArguments__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ExpressionWithTypeArguments__from_ast>).value).Expression);
        ...
        const __gotots_store_214 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(ExpressionWithTypeArguments__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ExpressionWithTypeArguments__from_ast>).value).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
        const __gotots_argument_191 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_214, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitForStatement(tx: classFieldsTransformer | undefined, node: {
        ...
        let condition: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_197, "Transformer")), (node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Condition);
        ...
        const __gotots_receiver_61 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_198, "Transformer"));
        ...
        const __gotots_argument_180 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_199, "Transformer"));
    ...
    static $go$private$estransforms$visitFunctionExpressionOrDeclaration(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        if (!((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement === undefined)) {
            ...
            let original: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_206, "Transformer")), node);
            if (!tsonicTypeScriptRuntime.sameLocation(original, node) && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassContainer === undefined)) {
                ...
                for (let __gotots_range_index_0 = 0; __gotots_range_index_0 < __gotots_range_0.length; __gotots_range_index_0++) {
                    ...
                    if (tsonicTypeScriptRuntime.sameLocation(EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_207, "Transformer")), member), original)
    ...
    static $go$private$estransforms$visitIdentifier(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Identifier__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        const __gotots_receiver_67 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_253, "Transformer"));
        const __gotots_store_254 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(PrimaryExpressionBase__from_ast.$storageOf(PrimaryExpressionBase__from_ast.$fromStorage(Identifier__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Identifier__from_ast>).value).PrimaryExpressionBase)).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
        const __gotots_argument_216 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_254, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        if (!(declaration === undefined)) {
            {
                ...
                if (__gotots_logical_result_3) {
                    ...
                    const __gotots_argument_218 = new $goInterfaceAdapter$PointerTo_Named_printer$NodeFactory(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_256, "Transformer")));
                    ...
                    EmitContext__from_printer.SetSourceMapRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_257, "Transformer")), clone, TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(Node__from_ast.$fromStorage(NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(PrimaryExpressionBase__from_ast.$storageOf(PrimaryExpressionBase__from_ast.$fromStorage(Identifier__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Identifier__from_ast>).value).PrimaryExpressionBase)).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase)).NodeDefault)).Node)).Loc)));
                    const __gotots_store_258 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    EmitContext__from_printer.SetCommentRange(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_258, "Transformer")), clone, TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(Node__from_ast.$fromStorage(NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(PrimaryExpressionBase__from_ast.$storageOf(PrimaryExpressionBase__from_ast.$fromStorage(Identifier__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Identifier__from_ast>).value).PrimaryExpressionBase)).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase)).NodeDefault)).Node)).Loc)));
                    return clone;
                }
            }
        }
        const __gotots_store_259 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(PrimaryExpressionBase__from_ast.$storageOf(PrimaryExpressionBase__from_ast.$fromStorage(Identifier__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Identifier__from_ast>).value).PrimaryExpressionBase)).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
        return NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_259, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitInNewClassLexicalEnvironment(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, visitor: (($0: classFieldsTransformer | undefined, $1: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, $2: classFacts) => tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined) | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        let original: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = EmitContext__from_printer.MostOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_296, "Transformer")), node);
        ...
        if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformPrivateElementsOrClassStaticBlocks || classFieldsTransformer.$go$private$estransforms$nodeHasTransformPrivateStaticElementsFlag(tx, node)) {
            ...
            if (!(name === undefined) && IsIdentifier__from_ast(name)) {
                ...
                let assignedName: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = EmitContext__from_printer.AssignedName(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_298, "Transformer")), node);
                    ...
                    if (IsStringLiteral__from_ast(assignedName)) {
                        {
                            ...
                            let textSourceNode: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = EmitContext__from_printer.TextSource(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_299, "Transformer")), assignedName);
                            if (!(textSourceNode === undefined) && IsIdentifier__from_ast(textSourceNode)) {
                                ...
                                const __gotots_store_301 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_300, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
    ...
    static $go$private$estransforms$visitInvalidSuperProperty(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        if (IsPropertyAccessExpression__from_ast(node)) {
            ...
            const __gotots_store_341 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_340, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_argument_261 = NodeFactory__from_printer.NewVoidZeroExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_342, "Transformer")));
        ...
        const __gotots_argument_266 = NodeFactory__from_printer.NewVoidZeroExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_345, "Transformer")));
        ...
        const __gotots_argument_268 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_346, "Transformer")), ElementAccessExpression__from_ast.$storageOf(((Node__from_ast.AsElementAccessExpression(node) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ElementAccessExpression__from_ast>).value).ArgumentExpression);
    ...
    static $go$private$estransforms$visitMethodOrAccessorDeclaration(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if (!(functionName === undefined)) {
            ...
            EmitContext__from_printer.StartVariableEnvironment(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_220, "Transformer")));
            let saved = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).inIterationStatement;
            ...
            const __gotots_receiver_66 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_221, "Transformer"));
            ...
            const __gotots_argument_197 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_222, "Transformer"));
            ...
            let params: tsonicTypeScriptRuntime.Location<NodeList__from_ast> | undefined = NodeVisitor__from_ast.VisitNodes(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_223, "Transformer")), Node__from_ast.ParameterList(node));
            (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).inIterationStatement = saved;
            const __gotots_store_224 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            const __gotots_store_225 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_224, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            let assignment: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_226, "Transformer")), functionName, funcExpr);
    ...
    static $go$private$estransforms$visitObjectAssignmentElement(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_12, "Transformer")), node);
    }
    static $go$private$estransforms$visitParameterDeclaration(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<ParameterDeclaration__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        const __gotots_argument_39 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_41, "Transformer"));
        const __gotots_store_42 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ParameterDeclaration__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParameterDeclaration__from_ast>).value).NodeBase));
        const __gotots_argument_40 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_42, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        if (isNamedEvaluationAnd(__gotots_argument_39, __gotots_argument_40, __gotots_argument_41)) {
            ...
            const __gotots_argument_42 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_43, "Transformer"));
            const __gotots_store_44 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ParameterDeclaration__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParameterDeclaration__from_ast>).value).NodeBase));
            const __gotots_argument_43 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_44, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        const __gotots_receiver_29 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_45, "Transformer"));
        const __gotots_store_46 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ParameterDeclaration__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParameterDeclaration__from_ast>).value).NodeBase));
        const __gotots_argument_46 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_46, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitParenthesizedExpression(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<ParenthesizedExpression__from_ast> | undefined, discarded: bool): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        let expression: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_143, "Transformer")), ParenthesizedExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParenthesizedExpression__from_ast>).value).Expression);
    ...
    static $go$private$estransforms$visitPreOrPostfixUnaryExpression(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, discarded: bool): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if (operator === KindPlusPlusToken$constant__from_ast() || operator === KindMinusMinusToken$constant__from_ast()) {
            ...
            if (IsPropertyAccessExpression__from_ast(operandSkipped) && IsPrivateIdentifier__from_ast(Node__from_ast.Name(operandSkipped))) {
                let info: {
                    value: privateIdentifierInfo;
                } | undefined = classFieldsTransformer.$go$private$estransforms$accessPrivateIdentifier(tx, Node__from_ast.Name(operandSkipped));
                if (!(info === undefined)) {
                    const __gotots_store_78 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    let receiver: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_78, "Transformer")), Node__from_ast.Expression(operandSkipped));
                    ...
                    if (!IsPrefixUnaryExpression__from_ast(node) && !discarded) {
                        ...
                        temp = NodeFactory__from_printer.NewTempVariable(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_79, "Transformer")));
                        const __gotots_store_80 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                        EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_80, "Transformer")), temp);
                    }
                    const __gotots_store_81 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    const __gotots_argument_77 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_81, "Transformer"));
                    const __gotots_store_82 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    const __gotots_argument_78 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_82, "Transformer"));
                    ...
                    EmitContext__from_printer.SetOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_83, "Transformer")), expression, node);
                    ...
                    if (!(temp === undefined)) {
                        ...
                        expression = NodeFactory__from_printer.NewCommaExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_84, "Transformer")), expression, temp);
                        Node__from_ast.$storageOf(((expression ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc = TextRange__from_core.$storageOf(TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc)));
                    }
                    return expression;
                }
                ...
                if (!(((void classFacts,
                    ...
                    const __gotots_store_88 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_87, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                if (!((data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor === undefined) && !((data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).superClassReference === undefined)) {
                    ...
                    if (IsPropertyAccessExpression__from_ast(operandSkipped)) {
                        if (IsIdentifier__from_ast(Node__from_ast.Name(operandSkipped))) {
                            ...
                            getterName = NodeFactory__from_printer.NewStringLiteralFromNode(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_89, "Transformer")), Node__from_ast.Name(operandSkipped));
                        ...
                        if (IsSimpleInlineableExpression__from_transformers(ElementAccessExpression__from_ast.$storageOf(((Node__from_ast.AsElementAccessExpression(operandSkipped) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ElementAccessExpression__from_ast>).value).ArgumentExpression)) {
                            ...
                            getterName = NodeFactory__from_printer.NewTempVariable(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_90, "Transformer")));
                            const __gotots_store_91 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                            EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_91, "Transformer")), getterName);
                            const __gotots_store_92 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                            const __gotots_receiver_39 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_92, "Transformer"));
                            ...
                            const __gotots_argument_83 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_93, "Transformer")), ElementAccessExpression__from_ast.$storageOf(((Node__from_ast.AsElementAccessExpression(operandSkipped) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ElementAccessExpression__from_ast>).value).ArgumentExpression);
                    ...
                    if (!(setterName === undefined) && !(getterName === undefined)) {
                        ...
                        let expression: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewReflectGetCall(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_94, "Transformer")), (data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).superClassReference, getterName, (data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor);
                        ...
                        if (!discarded) {
                            ...
                            temp = NodeFactory__from_printer.NewTempVariable(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_95, "Transformer")));
                            const __gotots_store_96 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                            EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_96, "Transformer")), temp);
                        }
                        const __gotots_store_97 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                        const __gotots_argument_84 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_97, "Transformer"));
                        const __gotots_store_98 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                        const __gotots_argument_85 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_98, "Transformer"));
                        ...
                        EmitContext__from_printer.SetOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_100, "Transformer")), expression, node);
                        Node__from_ast.$storageOf(((expression ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc = TextRange__from_core.$storageOf(TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc)));
                        if (!(temp === undefined)) {
                            const __gotots_store_101 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                            expression = NodeFactory__from_printer.NewCommaExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_101, "Transformer")), expression, temp);
                            Node__from_ast.$storageOf(((expression ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc = TextRange__from_core.$storageOf(TextRange__from_core.$copy(TextRange__from_core.$fromStorage(Node__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Loc)));
                        }
                        return expression;
                    }
        ...
        return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_102, "Transformer")), node);
    }
    static $go$private$estransforms$visitPrivateIdentifier(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        const __gotots_store_60 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_59, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        EmitContext__from_printer.SetOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_61, "Transformer")), result, node);
        return result;
    }
    static $go$private$estransforms$visitPropertyAccessExpression(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        if (IsPrivateIdentifier__from_ast(PropertyAccessExpression__from_ast.Name(node))) {
            let info: {
                value: privateIdentifierInfo;
            } | undefined = classFieldsTransformer.$go$private$estransforms$accessPrivateIdentifier(tx, PropertyAccessExpression__from_ast.Name(node));
            if (!(info === undefined)) {
                ...
                const __gotots_receiver_32 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_62, "Transformer"));
                const __gotots_argument_63 = result;
                const __gotots_store_63 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(PropertyAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
                const __gotots_argument_64 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_63, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
        ...
        if (__gotots_logical_result_0) {
            const __gotots_store_64 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(PropertyAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
            const __gotots_argument_65 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_64, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        if (__gotots_logical_result_0 && IsIdentifier__from_ast(PropertyAccessExpression__from_ast.Name(node)) && isStaticPropertyDeclarationOrClassStaticBlock((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement) && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment === undefined) && !(((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data === undefined)) {
            ...
            if (!(((void classFacts,
                ...
                const __gotots_store_65 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(PropertyAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
                const __gotots_argument_66 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_65, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                    return NodeDefault__from_ast.$fromStorage($go$storage);
                }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                    return NodeDefault__from_ast.$storageOf($go$value);
                }));
            ...
            if (!((data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor === undefined) && !((data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).superClassReference === undefined)) {
                ...
                const __gotots_receiver_34 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_66, "Transformer"));
                ...
                const __gotots_argument_68 = NodeFactory__from_printer.NewStringLiteralFromNode(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_67, "Transformer")), PropertyAccessExpression__from_ast.Name(node));
                ...
                EmitContext__from_printer.SetOriginal(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_68, "Transformer")), superProperty, PropertyAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).Expression);
        ...
        const __gotots_receiver_35 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_69, "Transformer"));
        const __gotots_store_70 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(PropertyAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
        const __gotots_argument_70 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_70, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitPropertyAccessExpressionForSubstitution(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        let expression: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_260, "Transformer")), PropertyAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).Expression);
        if (!tsonicTypeScriptRuntime.sameLocation(expression, PropertyAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).Expression)) {
            ...
            const __gotots_store_262 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_261, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        const __gotots_store_263 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf(MemberExpressionBase__from_ast.$fromStorage(PropertyAccessExpression__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).MemberExpressionBase)).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
        return NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_263, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitPropertyAssignment(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<PropertyAssignment__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        const __gotots_argument_22 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_25, "Transformer"));
        const __gotots_store_26 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(PropertyAssignment__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAssignment__from_ast>).value).NodeBase));
        const __gotots_argument_23 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_26, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        if (isNamedEvaluationAnd(__gotots_argument_22, __gotots_argument_23, __gotots_argument_24)) {
            ...
            const __gotots_argument_25 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_27, "Transformer"));
            const __gotots_store_28 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(PropertyAssignment__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAssignment__from_ast>).value).NodeBase));
            const __gotots_argument_26 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_28, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        const __gotots_receiver_26 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_29, "Transformer"));
        const __gotots_store_30 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(PropertyAssignment__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAssignment__from_ast>).value).NodeBase));
        const __gotots_argument_29 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_30, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitPropertyName(tx: classFieldsTransformer | undefined, name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        return NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_608, "Transformer")), name);
    }
    static $go$private$estransforms$visitShorthandAssignmentProperty(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        const __gotots_argument_209 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_244, "Transformer"));
        ...
        if (isNamedEvaluationAnd(__gotots_argument_209, __gotots_argument_210, __gotots_argument_211)) {
            ...
            const __gotots_argument_212 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_245, "Transformer"));
        ...
        return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_246, "Transformer")), node);
    }
    static $go$private$estransforms$visitSourceFile(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<SourceFile__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        if (((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<SourceFile__from_ast>).value.IsDeclarationFile) {
            ...
            return NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_14, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        const __gotots_receiver_21 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_15, "Transformer"));
        ...
        const __gotots_argument_14 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_16, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        const __gotots_receiver_22 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_18, "Transformer"));
        ...
        const __gotots_argument_15 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_19, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        const __gotots_receiver_23 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_20, "Transformer"));
        ...
        const __gotots_argument_17 = EmitContext__from_printer.ReadEmitHelpers(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_21, "Transformer")));
    ...
    static $go$private$estransforms$visitTaggedTemplateExpression(tx: classFieldsTransformer | undefined, node: {
        ...
        if (IsPropertyAccessExpression__from_ast((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Tag) && IsPrivateIdentifier__from_ast(PropertyAccessExpression__from_ast.Name(Node__from_ast.AsPropertyAccessExpression((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Tag))) && !(classFieldsTransformer.$go$private$estransforms$accessPrivateIdentifier(tx, PropertyAccessExpression__from_ast.Name(Node__from_ast.AsPropertyAccessExpression((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Tag))) === undefined)) {
            ...
            const __gotots_argument_151 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_179, "Transformer")), target);
            ...
            const __gotots_slice_element_0 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_184, "Transformer")), thisArg);
            ...
            const __gotots_argument_165 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_187, "Transformer")), (node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Template);
            const __gotots_argument_166 = Node__from_ast.$storageOf(Node__from_ast.$fromStorage(NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.MemberExpressionBase).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase)).NodeDefault)).Node)).Flags;
        ...
        if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformSuperInStaticInitializers && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement === undefined) && IsSuperProperty__from_ast((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Tag) && isStaticPropertyDeclarationOrClassStaticBlock((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement) && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment === undefined) && !(((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data === undefined) && !((((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).classConstructor === undefined)) {
            ...
            const __gotots_receiver_57 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_188, "Transformer"));
            const __gotots_store_189 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            const __gotots_argument_167 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_189, "Transformer")), (node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Tag);
            ...
            const __gotots_receiver_58 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_190, "Transformer"));
            const __gotots_argument_170 = invocation;
            const __gotots_store_191 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.MemberExpressionBase).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
            const __gotots_argument_171 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_191, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
            ...
            const __gotots_store_193 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_192, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
            ...
            const __gotots_argument_176 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_194, "Transformer")), (node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Template);
            const __gotots_argument_177 = Node__from_ast.$storageOf(Node__from_ast.$fromStorage(NodeDefault__from_ast.$storageOf(NodeDefault__from_ast.$fromStorage(NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.MemberExpressionBase).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase)).NodeDefault)).Node)).Flags;
        ...
        const __gotots_receiver_60 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_195, "Transformer"));
        const __gotots_store_196 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(ExpressionBase__from_ast.$storageOf(ExpressionBase__from_ast.$fromStorage(UnaryExpressionBase__from_ast.$storageOf(UnaryExpressionBase__from_ast.$fromStorage(UpdateExpressionBase__from_ast.$storageOf(UpdateExpressionBase__from_ast.$fromStorage(LeftHandSideExpressionBase__from_ast.$storageOf(LeftHandSideExpressionBase__from_ast.$fromStorage(MemberExpressionBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.MemberExpressionBase).LeftHandSideExpressionBase)).UpdateExpressionBase)).UnaryExpressionBase)).ExpressionBase)).NodeBase));
        const __gotots_argument_178 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_196, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitThisExpression(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if ((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).shouldTransformThisInStaticInitializers && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement === undefined) && (IsClassStaticBlockDeclaration__from_ast((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement) || (IsPropertyDeclaration__from_ast((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement) && HasStaticModifier__from_ast((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).currentClassElement))) && !((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment === undefined) && !(((tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).lexicalEnvironment ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).data === undefined)) {
            ...
            if (!(((void classFacts,
                ...
                const __gotots_store_204 = (Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_203, "Transformer")) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_argument_185 = NodeFactory__from_printer.NewVoidZeroExpression(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_205, "Transformer")));
    ...
    static $go$private$estransforms$visitVariableDeclaration(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<VariableDeclaration__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        const __gotots_argument_31 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_35, "Transformer"));
        const __gotots_store_36 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(VariableDeclaration__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<VariableDeclaration__from_ast>).value).NodeBase));
        const __gotots_argument_32 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_36, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
        ...
        if (isNamedEvaluationAnd(__gotots_argument_31, __gotots_argument_32, __gotots_argument_33)) {
            ...
            const __gotots_argument_34 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_37, "Transformer"));
            const __gotots_store_38 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(VariableDeclaration__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<VariableDeclaration__from_ast>).value).NodeBase));
            const __gotots_argument_35 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_38, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
                return NodeDefault__from_ast.$fromStorage($go$storage);
            }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
                return NodeDefault__from_ast.$storageOf($go$value);
            }));
        ...
        const __gotots_receiver_28 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_39, "Transformer"));
        const __gotots_store_40 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(VariableDeclaration__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<VariableDeclaration__from_ast>).value).NodeBase));
        const __gotots_argument_38 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_40, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$visitVariableStatement(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<VariableStatement__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        const __gotots_receiver_27 = Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_31, "Transformer"));
        const __gotots_store_32 = NodeBase__from_ast.$storageOf(NodeBase__from_ast.$fromStorage(StatementBase__from_ast.$storageOf(StatementBase__from_ast.$fromStorage(VariableStatement__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<VariableStatement__from_ast>).value).StatementBase)).NodeBase));
        const __gotots_argument_30 = NodeDefault__from_ast.AsNode(tsonicTypeScriptRuntime.projectLocation<NodeDefault__from_ast$Storage, NodeDefault__from_ast>(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_32, "NodeDefault"), ($go$storage: NodeDefault__from_ast$Storage): NodeDefault__from_ast => {
            return NodeDefault__from_ast.$fromStorage($go$storage);
        }, ($go$value: NodeDefault__from_ast): NodeDefault__from_ast$Storage => {
            return NodeDefault__from_ast.$storageOf($go$value);
        }));
    ...
    static $go$private$estransforms$wrapPrivateIdentifierForDestructuringTarget(tx: classFieldsTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        let parameter: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewGeneratedNameForNode(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_616, "Transformer")), node);
        let info: {
            value: privateIdentifierInfo;
        } | undefined = classFieldsTransformer.$go$private$estransforms$accessPrivateIdentifier(tx, PropertyAccessExpression__from_ast.Name(prop));
        if (info === undefined) {
            const __gotots_store_617 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            return NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_617, "Transformer")), node);
        }
        ...
        if (isThisOrSuperProperty || !IsSimpleCopiableExpression__from_transformers(PropertyAccessExpression__from_ast.$storageOf(((prop ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).Expression)) {
            ...
            receiver = NodeFactory__from_printer.NewTempVariableEx(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_618, "Transformer")), new AutoGenerateOptions__from_printer(new GeneratedIdentifierFlags__from_printer(GeneratedIdentifierFlagsReservedInNestedScopes$int__from_printer), "", ""));
            const __gotots_store_619 = (tx ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
            EmitContext__from_printer.AddVariableDeclaration(Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_619, "Transformer")), receiver);
            ...
            const __gotots_receiver_135 = Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_620, "Transformer"));
            ...
            const __gotots_argument_434 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_621, "Transformer")), PropertyAccessExpression__from_ast.$storageOf(((prop ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<PropertyAccessExpression__from_ast>).value).Expression);
        ...
        return NodeFactory__from_printer.NewAssignmentTargetWrapper(Transformer__from_transformers.Factory(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_622, "Transformer")), parameter, assignExpr);
    }
}
export function newClassFieldsTransformer(opts: TransformOptions__from_transformers | undefined): tsonicTypeScriptRuntime.Location<Transformer__from_transformers> | undefined {
    ...
    const __gotots_receiver_3 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_1, "Transformer"));
    ...
    const __gotots_receiver_5 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_2, "Transformer"));
    ...
    const __gotots_receiver_7 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_3, "Transformer"));
    ...
    const __gotots_receiver_9 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_4, "Transformer"));
    ...
    const __gotots_receiver_11 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_5, "Transformer"));
    ...
    const __gotots_receiver_15 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_7, "Transformer"));
    ...
    const __gotots_receiver_17 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_8, "Transformer"));
    ...
    const __gotots_receiver_19 = Transformer__from_transformers.EmitContext(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_9, "Transformer"));
...
export function flattenCommaListWorker(node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, __go_yield: (($0: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined) => bool) | undefined): bool {
    ...
    else if (IsCommaExpression__from_ast(Node__from_ast.AsNode(node))) {
