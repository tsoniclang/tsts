...
export class objectRestSpreadTransformer {
    ...
    static $go$private$estransforms$chunkObjectLiteralElements(ch: objectRestSpreadTransformer | undefined, list: tsonicTypeScriptRuntime.Location<NodeList__from_ast> | undefined): RuntimeSlice<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined> {
        ...
        for (let __gotots_range_index_2 = 0; __gotots_range_index_2 < __gotots_range_2.length; __gotots_range_index_2++) {
            ...
            if (Node__from_ast.$storageOf(((e ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Kind === KindSpreadAssignment$constant__from_ast()) {
                ...
                const __gotots_argument_130 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_136.Transformer), target);
                ...
                if (Node__from_ast.$storageOf(((e ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Kind === KindPropertyAssignment$constant__from_ast()) {
                    ...
                    const __gotots_argument_135 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_139.Transformer), Node__from_ast.Initializer(e));
                    ...
                    elem = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_140.Transformer), e);
                }
            ...
            if (containsPrecedingObjectRestOrSpread) {
                if (IsBindingPattern__from_ast(Node__from_ast.Name(parameter))) {
                    if (Node__from_ast.Elements(Node__from_ast.Name(parameter)).length > 0) {
                        ...
                        const __gotots_argument_149 = __gotots_store_170.Transformer;
                        ...
                        const __gotots_argument_151 = NodeFactory__from_printer.NewGeneratedNameForNode(Transformer__from_transformers.Factory(__gotots_store_171.Transformer), parameter);
                        ...
                        if (!(declarations === undefined)) {
                            ...
                            EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(__gotots_store_178.Transformer), statement, EFCustomPrologue$constant__from_printer());
                        ...
                        let name: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewGeneratedNameForNode(Transformer__from_transformers.Factory(__gotots_store_179.Transformer), parameter);
                        const __gotots_store_180 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                        let initializer: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_180.Transformer), Node__from_ast.Initializer(parameter));
                        const __gotots_store_181 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                        let assignment: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(__gotots_store_181.Transformer), name, initializer);
                        ...
                        EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(__gotots_store_184.Transformer), statement, EFCustomPrologue$constant__from_printer());
                        results = results.append(void 0, [statement]);
                    }
                }
                else if (!(Node__from_ast.Initializer(parameter) === undefined)) {
                    ...
                    const __gotots_argument_157 = new GoInterfaceAdapter(Transformer__from_transformers.Factory(__gotots_store_185.Transformer));
                    ...
                    EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(__gotots_store_186.Transformer), name, EFNoSourceMap$constant__from_printer());
                    const __gotots_store_187 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    let initializer: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_187.Transformer), Node__from_ast.Initializer(parameter));
                    const __gotots_store_188 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(__gotots_store_188.Transformer), initializer, 396);
                    const __gotots_store_189 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    let assignment: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewAssignmentExpression(Transformer__from_transformers.Factory(__gotots_store_189.Transformer), name, initializer);
                    ...
                    EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(__gotots_store_190.Transformer), assignment, EFNoComments$constant__from_printer());
                    ...
                    EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(__gotots_store_197.Transformer), block, 489);
                    const __gotots_store_198 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                    const __gotots_receiver_52 = Transformer__from_transformers.Factory(__gotots_store_198.Transformer);
                    ...
                    const __gotots_argument_161 = new GoInterfaceAdapter(Transformer__from_transformers.Factory(__gotots_store_199.Transformer));
                    ...
                    EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(__gotots_store_202.Transformer), statement, 590312);
                    results = results.append(void 0, [statement]);
                }
            }
                ...
                const __gotots_argument_164 = __gotots_store_203.Transformer;
                ...
                const __gotots_argument_166 = NodeFactory__from_printer.NewGeneratedNameForNode(Transformer__from_transformers.Factory(__gotots_store_204.Transformer), parameter);
                ...
                if (!(declarations === undefined)) {
                    ...
                    const __gotots_store_206 = (Transformer__from_transformers.Factory(__gotots_store_205.Transformer) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                    ...
                    EmitContext__from_printer.AddEmitFlags(Transformer__from_transformers.EmitContext(__gotots_store_211.Transformer), statement, EFCustomPrologue$constant__from_printer());
                    results = results.append(void 0, [statement]);
                }
            }
        }
    ...
    static $go$private$estransforms$transformFunctionBody(ch: objectRestSpreadTransformer | undefined, node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        EmitContext__from_printer.StartVariableEnvironment(Transformer__from_transformers.EmitContext(__gotots_store_150.Transformer));
        const __gotots_store_151 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        let body: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_151.Transformer), Node__from_ast.Body(node));
        const __gotots_store_152 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        let extras = EmitContext__from_printer.EndVariableEnvironment(Transformer__from_transformers.EmitContext(__gotots_store_152.Transformer));
        const __gotots_store_153 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        EmitContext__from_printer.StartVariableEnvironment(Transformer__from_transformers.EmitContext(__gotots_store_153.Transformer));
        ...
        extras = EmitContext__from_printer.EndAndMergeVariableEnvironment(Transformer__from_transformers.EmitContext(__gotots_store_154.Transformer), extras);
        ...
        if (IsBlock__from_ast(body)) {
            ...
            for (let __gotots_range_index_3 = 0; __gotots_range_index_3 < __gotots_range_3.length; __gotots_range_index_3++) {
                ...
                if (!custom && IsPrologueDirective__from_ast(statement)) {
                    ...
                    const __gotots_binary_operand_6 = EmitContext__from_printer.EmitFlags(Transformer__from_transformers.EmitContext(__gotots_store_159.Transformer), statement);
                ...
                __gotots_return_block_0: {
                    ...
                    switch (Node__from_ast.$storageOf(((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Kind) {
                        ...
                        default: {
                            ...
                            __gotots_return_0 = NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(__gotots_store_3.Transformer), node);
                            break __gotots_return_block_0;
                            break;
                        }
                    }
        ...
        try {
            try {
                __gotots_return_block_0: {
                    ...
                    const __gotots_argument_110 = NodeVisitor__from_ast.VisitNodes(Transformer__from_transformers.Visitor(__gotots_store_123.Transformer), (void FunctionLikeBase__from_ast.$storageOf, (void FunctionLikeBase__from_ast.$fromStorage,
    ...
    static $go$private$estransforms$visitBinaryExpression(ch: objectRestSpreadTransformer | undefined, node: tsonicTypeScriptRuntime.Location<BinaryExpression__from_ast> | undefined, expressionResultIsUnused: bool): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        const __gotots_receiver_6 = Transformer__from_transformers.Visitor(__gotots_store_24.Transformer);
    ...
    static $go$private$estransforms$visitCatchClause(ch: objectRestSpreadTransformer | undefined, node: {
        ...
        if (!((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.VariableDeclaration === undefined) && IsBindingPattern__from_ast(Node__from_ast.Name((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.VariableDeclaration)) && !((Node__from_ast.SubtreeFacts(Node__from_ast.Name((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.VariableDeclaration)) & SubtreeContainsObjectRestOrSpread$constant__from_ast()) >>> 0 === 0)) {
            ...
            const __gotots_argument_28 = __gotots_store_54.Transformer;
            ...
            let block: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_55.Transformer), (node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Block);
            if (!(visitedBindings === undefined)) {
                ...
                const __gotots_store_59 = (Transformer__from_transformers.Factory(__gotots_store_58.Transformer) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
                ...
                const __gotots_store_63 = (Transformer__from_transformers.Factory(__gotots_store_62.Transformer) ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        ...
        try {
            try {
                __gotots_return_block_0: {
                    ...
                    const __gotots_argument_58 = NodeVisitor__from_ast.VisitNodes(Transformer__from_transformers.Visitor(__gotots_store_89.Transformer), (void FunctionLikeBase__from_ast.$storageOf, (void FunctionLikeBase__from_ast.$fromStorage,
                        FunctionLikeWithBodyBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.FunctionLikeWithBodyBase).FunctionLikeBase)).Parameters);
    ...
    static $go$private$estransforms$visitForOftatement(ch: objectRestSpreadTransformer | undefined, node: {
        ...
        if (!((Node__from_ast.SubtreeFacts((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Initializer) & SubtreeContainsObjectRestOrSpread$constant__from_ast()) >>> 0 === 0) || (IsAssignmentPattern__from_ast((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Initializer) && ContainsObjectRestOrSpread__from_ast((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Initializer))) {
            ...
            if (IsVariableDeclarationList__from_ast(initializerWithoutParens) || IsAssignmentPattern__from_ast(initializerWithoutParens)) {
                ...
                let temp: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeFactory__from_printer.NewTempVariable(Transformer__from_transformers.Factory(__gotots_store_26.Transformer));
                const __gotots_store_27 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                const __gotots_receiver_7 = Transformer__from_transformers.Visitor(__gotots_store_27.Transformer);
                const __gotots_store_28 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
                const __gotots_argument_17 = NodeFactory__from_printer.CreateForOfBindingStatement(Transformer__from_transformers.Factory(__gotots_store_28.Transformer), initializerWithoutParens, temp);
                ...
                if (IsBlock__from_ast((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Statement)) {
                    ...
                    for (let __gotots_range_index_1 = 0; __gotots_range_index_1 < __gotots_range_1.length; __gotots_range_index_1++) {
                        ...
                        let visited: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(__gotots_store_29.Transformer), statement);
                    ...
                    const __gotots_argument_19 = NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(__gotots_store_30.Transformer), (node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Statement);
                ...
                let expr: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeVisitor__from_ast.VisitEachChild(Transformer__from_transformers.Visitor(__gotots_store_37.Transformer), (node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.Expression);
        ...
        try {
            try {
                __gotots_return_block_0: {
                    ...
                    const __gotots_argument_99 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_116.Transformer), FunctionDeclaration__from_ast.Name(node));
                    ...
                    const __gotots_argument_101 = NodeVisitor__from_ast.VisitNodes(Transformer__from_transformers.Visitor(__gotots_store_117.Transformer), (void FunctionLikeBase__from_ast.$storageOf, (void FunctionLikeBase__from_ast.$fromStorage,
                        (void FunctionLikeWithBodyBase__from_ast.$storageOf, (void FunctionLikeWithBodyBase__from_ast.$fromStorage,
        ...
        try {
            try {
                __gotots_return_block_0: {
                    ...
                    const __gotots_argument_120 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_129.Transformer), FunctionExpression__from_ast.Name(node));
                    ...
                    const __gotots_argument_122 = NodeVisitor__from_ast.VisitNodes(Transformer__from_transformers.Visitor(__gotots_store_130.Transformer), (void FunctionLikeBase__from_ast.$storageOf, (void FunctionLikeBase__from_ast.$fromStorage,
                        FunctionLikeWithBodyBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.FunctionLikeWithBodyBase).FunctionLikeBase)).Parameters);
        ...
        try {
            try {
                __gotots_return_block_0: {
                    ...
                    const __gotots_argument_66 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_95.Transformer), GetAccessorDeclaration__from_ast.Name(node));
                    ...
                    const __gotots_argument_68 = NodeVisitor__from_ast.VisitNodes(Transformer__from_transformers.Visitor(__gotots_store_96.Transformer), (void FunctionLikeBase__from_ast.$storageOf, (void FunctionLikeBase__from_ast.$fromStorage,
        ...
        try {
            try {
                __gotots_return_block_0: {
                    ...
                    const __gotots_argument_87 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_109.Transformer), MethodDeclaration__from_ast.Name(node));
                    ...
                    const __gotots_argument_90 = NodeVisitor__from_ast.VisitNodes(Transformer__from_transformers.Visitor(__gotots_store_110.Transformer), (void FunctionLikeBase__from_ast.$storageOf, (void FunctionLikeBase__from_ast.$fromStorage,
                        FunctionLikeWithBodyBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.FunctionLikeWithBodyBase).FunctionLikeBase)).Parameters);
    ...
    static $go$private$estransforms$visitObjectLiteralExpression(ch: objectRestSpreadTransformer | undefined, node: {
        ...
        if (((__gotots_binary_operand_0 & __gotots_binary_operand_1) >>> 0) === 0) {
            ...
            const __gotots_receiver_4 = Transformer__from_transformers.Visitor(__gotots_store_9.Transformer);
        ...
        if (objects.length > 1) {
            ...
            for (let __gotots_range_index_0 = 0; __gotots_range_index_0 < __gotots_range_0.length; __gotots_range_index_0++) {
                ...
                expression = NodeFactory__from_printer.NewAssignHelper(Transformer__from_transformers.Factory(__gotots_store_15.Transformer), RuntimeSlice.literal<tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined>([expression, obj]), CompilerOptions__from_core.GetEmitScriptTarget((ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).compilerOptions));
            }
            return expression;
        }
        const __gotots_store_16 = (ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference"));
        return NodeFactory__from_printer.NewAssignHelper(Transformer__from_transformers.Factory(__gotots_store_16.Transformer), objects, CompilerOptions__from_core.GetEmitScriptTarget((ch ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).compilerOptions));
    }
        ...
        try {
            try {
                __gotots_return_block_0: {
                    ...
                    const __gotots_argument_76 = NodeVisitor__from_ast.VisitNode(Transformer__from_transformers.Visitor(__gotots_store_102.Transformer), SetAccessorDeclaration__from_ast.Name(node));
                    ...
                    const __gotots_argument_78 = NodeVisitor__from_ast.VisitNodes(Transformer__from_transformers.Visitor(__gotots_store_103.Transformer), (void FunctionLikeBase__from_ast.$storageOf, (void FunctionLikeBase__from_ast.$fromStorage,
                        FunctionLikeWithBodyBase__from_ast.$storageOf((node ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.AccessorDeclarationBase.FunctionLikeWithBodyBase).FunctionLikeBase)).Parameters);
    ...
    static $go$private$estransforms$visitVariableStatement(ch: objectRestSpreadTransformer | undefined, node: tsonicTypeScriptRuntime.Location<VariableStatement__from_ast> | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
        ...
        if (HasSyntacticModifier__from_ast(__gotots_argument_24, __gotots_argument_25)) {
            ...
            const __gotots_receiver_11 = Transformer__from_transformers.Visitor(__gotots_store_47.Transformer);
        ...
        const __gotots_receiver_12 = Transformer__from_transformers.Visitor(__gotots_store_49.Transformer);
...
export function newObjectRestSpreadTransformer(opts: TransformOptions__from_transformers | undefined): Transformer__from_transformers | undefined {
