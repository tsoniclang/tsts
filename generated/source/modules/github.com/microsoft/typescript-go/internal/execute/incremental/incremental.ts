...
export interface BuildInfoReader extends GoInterfaceValue {
    ReadBuildInfo($argument0: tsonicTypeScriptRuntime.Location<ParsedCommandLine__from_tsoptions> | undefined): BuildInfo | undefined;
}
...
export class buildInfoReader {
    ...
    static ReadBuildInfo(r: buildInfoReader | undefined, config: tsonicTypeScriptRuntime.Location<ParsedCommandLine__from_tsoptions> | undefined): BuildInfo | undefined {
        ...
        const __gotots_argument_3 = new $goInterfaceAdapter$PointerTo_Named_incremental$BuildInfo(buildInfo);
...
export function ReadBuildInfoProgram(config: tsonicTypeScriptRuntime.Location<ParsedCommandLine__from_tsoptions> | undefined, reader: BuildInfoReader | undefined, host__shadow_1: CompilerHost__from_compiler | undefined): {
    ...
    let buildInfo: BuildInfo | undefined = goInterfaceNonNil<BuildInfoReader>(__gotots_receiver_0).ReadBuildInfo(__gotots_argument_0);
