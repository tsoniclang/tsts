...
export function getEnclosingDeclarationFromInvocation(invocation__shadow_1: {
    ...
    if (!((invocation__shadow_1 ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.callInvocation === undefined)) {
        ...
        return NodeDefault__from_ast.AsNode(new $ProjectedPropertyLocation(__gotots_store_4, "NodeDefault", NodeDefault__from_ast.$fromStorage, NodeDefault__from_ast.$storageOf));
    }
    else {
...
export function getExpressionFromInvocation(argumentInfo: argumentListInfo | undefined): tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined {
    ...
    return NodeDefault__from_ast.AsNode(new $ProjectedPropertyLocation(__gotots_store_5, "NodeDefault", NodeDefault__from_ast.$fromStorage, NodeDefault__from_ast.$storageOf));
}
...
export function getCandidateOrTypeInfo(info: argumentListInfo | undefined, c: {
    ...
    if (!(((info ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).invocation ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.typeArgsInvocation === undefined)) {
        ...
        let called: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined = NodeDefault__from_ast.AsNode(new $ProjectedPropertyLocation(__gotots_store_3, "NodeDefault", NodeDefault__from_ast.$fromStorage, NodeDefault__from_ast.$storageOf));
...
export function getChildListThatStartsWithOpenerToken(parent: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, openerToken: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined): tsonicTypeScriptRuntime.Location<NodeList__from_ast> | undefined {
    if (IsCallExpression__from_ast(parent)) {
        ...
        if (Node__from_ast.$storageOf(((openerToken ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Kind === KindLessThanToken$constant__from_ast()) {
            ...
            return Node__from_ast.TypeArgumentList(new $ProjectedPropertyLocation(__gotots_store_1, "Node", Node__from_ast.$fromStorage, Node__from_ast.$storageOf));
        }
        ...
        if (Node__from_ast.$storageOf(((openerToken ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Kind === KindLessThanToken$constant__from_ast()) {
            ...
            return Node__from_ast.TypeArgumentList(new $ProjectedPropertyLocation(__gotots_store_2, "Node", Node__from_ast.$fromStorage, Node__from_ast.$storageOf));
        }
...
export function getContextualSignatureLocationInfo(node: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, sourceFile: tsonicTypeScriptRuntime.Location<SourceFile__from_ast> | undefined, c: {
    ...
    switch (Node__from_ast.$storageOf(((parent ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<Node__from_ast>).value).Kind) {
        ...
        case KindBinaryExpression$constant__from_ast(): {
            ...
            const __gotots_argument_0 = NodeDefault__from_ast.AsNode(new $ProjectedPropertyLocation(__gotots_store_6, "NodeDefault", NodeDefault__from_ast.$fromStorage, NodeDefault__from_ast.$storageOf));
...
export function getArgumentListInfoForTemplate(tagExpression: {
    ...
    const __gotots_field_0 = NodeDefault__from_ast.AsNode(new $ProjectedPropertyLocation(__gotots_store_0, "NodeDefault", NodeDefault__from_ast.$fromStorage, NodeDefault__from_ast.$storageOf));
