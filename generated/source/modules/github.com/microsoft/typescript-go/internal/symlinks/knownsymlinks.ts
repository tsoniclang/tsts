...
export class KnownSymlinks {
    ...
    static SetSymlinksFromResolutions(cache: tsonicTypeScriptRuntime.Location<KnownSymlinks> | undefined, forEachResolvedModule: (($0: (($0: tsonicTypeScriptRuntime.Location<ResolvedModule__from___go_module> | undefined, $1: gostring, $2: ModuleKind__from_core, $3: Path__from_tspath) => void) | undefined, $1: tsonicTypeScriptRuntime.Location<SourceFile__from_ast> | undefined) => void) | undefined, forEachResolvedTypeReferenceDirective: (($0: (($0: tsonicTypeScriptRuntime.Location<ResolvedTypeReferenceDirective__from___go_module> | undefined, $1: gostring, $2: ModuleKind__from_core, $3: Path__from_tspath) => void) | undefined, $1: tsonicTypeScriptRuntime.Location<SourceFile__from_ast> | undefined) => void) | undefined): void {
        const __gotots_callee_0 = forEachResolvedModule;
        const __gotots_argument_0 = (resolution: tsonicTypeScriptRuntime.Location<ResolvedModule__from___go_module> | undefined, moduleName: gostring, mode: ModuleKind__from_core, filePath: Path__from_tspath): void => {
            KnownSymlinks.ProcessResolution(cache, ((resolution ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ResolvedModule__from___go_module>).value.OriginalPath, ((resolution ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ResolvedModule__from___go_module>).value.ResolvedFileName);
        };
        ...
        const __gotots_argument_2 = (resolution: tsonicTypeScriptRuntime.Location<ResolvedTypeReferenceDirective__from___go_module> | undefined, moduleName: gostring, mode: ModuleKind__from_core, filePath: Path__from_tspath): void => {
            KnownSymlinks.ProcessResolution(cache, ((resolution ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ResolvedTypeReferenceDirective__from___go_module>).value.OriginalPath, ((resolution ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ResolvedTypeReferenceDirective__from___go_module>).value.ResolvedFileName);
        };
