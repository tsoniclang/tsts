        ...
        try {
            try {
                __gotots_return_block_0: {
                    let loader: tsonicTypeScriptRuntime.Location<fileLoader> | undefined = (projectReferenceParser__shadow_1 ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader;
                    {
                        let tr: {
                            value: Tracing__from_tracing;
                        } | undefined = ((loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.opts.Tracing;
                        if (!(tr === undefined)) {
...
export class projectReferenceParser {
    declare private readonly $goType: void;
    public constructor(public loader: tsonicTypeScriptRuntime.Location<fileLoader> | undefined, public wg: WorkGroup__from_core | undefined, public tasksByFileName: SyncMap__from_collections<Path__from_tspath, {
        value: projectReferenceParseTask;
    } | undefined>) {
    }
    declare private readonly then?: never;
    static $go$private$compiler$initMapper(p: projectReferenceParser | undefined, tasks: RuntimeSlice<{
        ...
        ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.configToProjectReference = GoMap.make(totalReferences, []);
        ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.referencesInConfigFile = $goMap$MapOf_Named_tspath$Path_To_SliceOf_Named_tspath$Path.make(totalReferences, []);
        ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.sourceToProjectReference = $goMap$MapOf_Named_tspath$Path_To_PointerTo_Named_tsoptions$SourceOutputAndProjectReference.make(0, []);
        ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.outputDtsToProjectReference = $goMap$MapOf_Named_tspath$Path_To_PointerTo_Named_tsoptions$SourceOutputAndProjectReference.make(0, []);
        ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.referencesInConfigFile.store(SourceFile__from_ast.Path(((((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.opts.Config ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine__from_tsoptions>).value.ConfigFile ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.SourceFile), projectReferenceParser.$go$private$compiler$initMapperWorker(p, tasks, tsonicTypeScriptRuntime.location<Set__from_collections<{
            value: projectReferenceParseTask;
        ...
        const __gotots_store_2 = ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value;
        if (ProgramOptions.$go$private$compiler$canUseProjectReferenceSource(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_2, "opts")) && ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.outputDtsToProjectReference.length() !== 0) {
            ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.host = newProjectReferenceDtsFakingHost((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader);
        }
    }
    static $go$private$compiler$initMapperWorker(p: projectReferenceParser | undefined, tasks: RuntimeSlice<{
        ...
        for (let __gotots_range_index_1 = 0; __gotots_range_index_1 < __gotots_range_1.length; __gotots_range_index_1++) {
            ...
            ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.configToProjectReference.store(path, (task ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.resolved);
            if (!((task ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.resolved === undefined) && !(((((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.opts.Config ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ParsedCommandLine__from_tsoptions>).value.ConfigFile
                ===
                ...
                Copy$MapOf_Named_tspath$Path_To_PointerTo_Named_tsoptions$SourceOutputAndProjectReference$MapOf_Named_tspath$Path_To_PointerTo_Named_tsoptions$SourceOutputAndProjectReference$Named_tspath$Path$PointerTo_Named_tsoptions$SourceOutputAndProjectReference(((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.sourceToProjectReference, ParsedCommandLine__from_tsoptions.SourceToProjectReference((task ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.resolved));
                ...
                if (ProgramOptions.$go$private$compiler$canUseProjectReferenceSource(tsonicTypeScriptRuntime.propertyLocation(__gotots_store_3, "opts"))) {
                    ...
                    if (declDir !== "") {
                        const __gotots_store_4 = (((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value;
            ...
            ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.referencesInConfigFile.store(path, referencesInConfig);
        }
        return results;
    }
    static $go$private$compiler$parse(p: projectReferenceParser | undefined, tasks: RuntimeSlice<{
        ...
        ((((p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<fileLoader>).value.projectReferenceFileMapper ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).value.loader = (p ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")).loader;
