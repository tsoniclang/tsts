...
export function ResolveProjectReferencePath(ref: tsonicTypeScriptRuntime.Location<ProjectReference> | undefined): gostring {
    return ResolveConfigFileNameOfProjectReference(((ref ?? GoPanic.raiseRuntime("invalid memory address or nil pointer dereference")) as tsonicTypeScriptRuntime.Location<ProjectReference>).value.Path);
}
