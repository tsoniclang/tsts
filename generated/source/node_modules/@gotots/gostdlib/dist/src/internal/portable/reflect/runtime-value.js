...
export function registerRuntimeStructValueOperations(type, resolveAdapter, fields, clone) {
...
export function registerRuntimePointerValueOperations(type, resolveAdapter, descriptor) {
    registerRuntimeValueOperations(type, () => {
        const adapter = resolveAdapter();
