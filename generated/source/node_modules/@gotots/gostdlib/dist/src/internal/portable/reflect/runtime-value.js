...
export function registerRuntimeStructValueOperations(type, resolveAdapter, resolveStorage, createFields, clone) {
    registerRuntimeValueOperations(type, () => {
        const adapter = resolveAdapter();
        const fields = createFields(createRuntimeStructFieldBuilder(resolveStorage));
