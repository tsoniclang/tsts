...
export function MultiMap$Len$string$PointerTo_Named_ast$ExportSpecifier($argument0: tsonicTypeScriptRuntime.Location<MultiMap__from_collections<gostring, {
