...
export function hashWrite64$Named_ast$NodeId($argument0: Hasher__from_xxh3 | undefined, $argument1: NodeId__from_ast): void {
    return hashWrite64$kernel<NodeId__from_ast>(($argument0: NodeId__from_ast): uint64 => {
        return $argument0.$value;
    }, $argument0, $argument1);
}
export function hashWrite64$Named_ast$SymbolId($argument0: Hasher__from_xxh3 | undefined, $argument1: SymbolId__from_ast): void {
    return hashWrite64$kernel<SymbolId__from_ast>(($argument0: SymbolId__from_ast): uint64 => {
        return $argument0.$value;
    }, $argument0, $argument1);
}
export function hashWrite64$int($argument0: Hasher__from_xxh3 | undefined, $argument1: int): void {
