...
export function MapEntry$Change$Named_tspath$Path$Named_dirty$CloneableMapOf_Named_tspath$Path_And_string($argument0: tsonicTypeScriptRuntime.Location<MapEntry__from_dirty<Path__from_tspath, CloneableMap__from_dirty<Path__from_tspath, gostring>>> | undefined, $argument1: (($0: CloneableMap__from_dirty<Path__from_tspath, gostring>) => void) | undefined): void {
...
export function MapEntry$Change$Named_tspath$Path$PointerTo_Named_autoimport$RegistryBucket($argument0: tsonicTypeScriptRuntime.Location<MapEntry__from_dirty<Path__from_tspath, tsonicTypeScriptRuntime.Location<RegistryBucket__from_autoimport> | undefined>> | undefined, $argument1: (($0: tsonicTypeScriptRuntime.Location<RegistryBucket__from_autoimport> | undefined) => void) | undefined): void {
    return MapEntry__from_dirty.Change$kernel<Path__from_tspath, tsonicTypeScriptRuntime.Location<RegistryBucket__from_autoimport> | undefined>($argument0, $go$constraint_method$dirty$Clone$PointerTo_Named_autoimport$RegistryBucket_to_PointerTo_Named_autoimport$RegistryBucket, ($argument0: tsonicTypeScriptRuntime.Location<RegistryBucket__from_autoimport> | undefined): tsonicTypeScriptRuntime.Location<RegistryBucket__from_autoimport> | undefined => {
        return $argument0;
...
export function MapEntry$Change$Named_tspath$Path$PointerTo_Named_project$configFileNames($argument0: tsonicTypeScriptRuntime.Location<MapEntry__from_dirty<Path__from_tspath, tsonicTypeScriptRuntime.Location<configFileNames__from_project> | undefined>> | undefined, $argument1: (($0: tsonicTypeScriptRuntime.Location<configFileNames__from_project> | undefined) => void) | undefined): void {
    return MapEntry__from_dirty.Change$kernel<Path__from_tspath, tsonicTypeScriptRuntime.Location<configFileNames__from_project> | undefined>($argument0, $go$constraint_method$dirty$Clone$PointerTo_Named_project$configFileNames_to_PointerTo_Named_project$configFileNames, ($argument0: tsonicTypeScriptRuntime.Location<configFileNames__from_project> | undefined): tsonicTypeScriptRuntime.Location<configFileNames__from_project> | undefined => {
        return $argument0;
    }, ($argument0: tsonicTypeScriptRuntime.Location<configFileNames__from_project> | undefined): tsonicTypeScriptRuntime.Location<configFileNames__from_project> | undefined => {
        return $argument0;
    }, ($argument0: gostring): Path__from_tspath => {
