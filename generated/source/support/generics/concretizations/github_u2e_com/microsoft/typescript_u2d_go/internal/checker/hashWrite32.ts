...
export function hashWrite32$Named_checker$AccessFlags($argument0: tsonicTypeScriptRuntime.Location<Hasher__from_xxh3> | undefined, $argument1: AccessFlags__from_checker): void {
    return hashWrite32$kernel<AccessFlags__from_checker>(($argument0: AccessFlags__from_checker): uint32 => {
        return $argument0;
    }, $argument0, $argument1);
}
export function hashWrite32$Named_checker$IntersectionState($argument0: tsonicTypeScriptRuntime.Location<Hasher__from_xxh3> | undefined, $argument1: IntersectionState__from_checker): void {
    return hashWrite32$kernel<IntersectionState__from_checker>(($argument0: IntersectionState__from_checker): uint32 => {
        return $argument0;
    }, $argument0, $argument1);
}
export function hashWrite32$Named_checker$TypeId($argument0: tsonicTypeScriptRuntime.Location<Hasher__from_xxh3> | undefined, $argument1: TypeId__from_checker): void {
