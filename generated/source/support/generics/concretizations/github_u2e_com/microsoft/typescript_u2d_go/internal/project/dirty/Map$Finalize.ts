...
export function Map$Finalize$Named_tspath$Path$Named_dirty$CloneableMapOf_Named_tspath$Path_And_string($argument0: {
    ...
    }, ($argument0: GoMapValue<Path__from_tspath, MapEntry__from_dirty<Path__from_tspath, CloneableMap__from_dirty<Path__from_tspath, gostring>> | undefined>): int => {
...
export function Map$Finalize$Named_tspath$Path$PointerTo_Named_autoimport$RegistryBucket($argument0: {
    ...
    GoMapValue<Path__from_tspath, RegistryBucket__from_autoimport | undefined>,
    bool
] {
    return Map__from_dirty.Finalize$kernel<Path__from_tspath, RegistryBucket__from_autoimport | undefined>($argument0, ($argument0: GoMapValue<Path__from_tspath, RegistryBucket__from_autoimport | undefined>): GoMapValue<Path__from_tspath, RegistryBucket__from_autoimport | undefined> => {
        return $argument0;
        ...
        return $argument0;
    }, ($argument0: GoMapValue<Path__from_tspath, MapEntry__from_dirty<Path__from_tspath, RegistryBucket__from_autoimport | undefined> | undefined>): int => {
        return $argument0.length();
    }, ($argument0: RegistryBucket__from_autoimport | undefined): GoMapValue<Path__from_tspath, RegistryBucket__from_autoimport | undefined> => {
        return $goMap$MapOf_Named_tspath$Path_To_PointerTo_Named_autoimport$RegistryBucket.make(0, []);
    }, ($argument0: RegistryBucket__from_autoimport | undefined, $argument1: int): GoMapValue<Path__from_tspath, RegistryBucket__from_autoimport | undefined> => {
...
export function Map$Finalize$Named_tspath$Path$PointerTo_Named_autoimport$directory($argument0: {
    ...
    GoMapValue<Path__from_tspath, directory__from_autoimport | undefined>,
    bool
] {
    return Map__from_dirty.Finalize$kernel<Path__from_tspath, directory__from_autoimport | undefined>($argument0, ($argument0: GoMapValue<Path__from_tspath, directory__from_autoimport | undefined>): GoMapValue<Path__from_tspath, directory__from_autoimport | undefined> => {
        return $argument0;
        ...
        return $argument0;
    }, ($argument0: GoMapValue<Path__from_tspath, MapEntry__from_dirty<Path__from_tspath, directory__from_autoimport | undefined> | undefined>): int => {
        return $argument0.length();
    }, ($argument0: directory__from_autoimport | undefined): GoMapValue<Path__from_tspath, directory__from_autoimport | undefined> => {
        return $goMap$MapOf_Named_tspath$Path_To_PointerTo_Named_autoimport$directory.make(0, []);
    }, ($argument0: directory__from_autoimport | undefined, $argument1: int): GoMapValue<Path__from_tspath, directory__from_autoimport | undefined> => {
...
export function Map$Finalize$Named_tspath$Path$PointerTo_Named_project$configFileNames($argument0: {
    ...
    GoMapValue<Path__from_tspath, configFileNames__from_project | undefined>,
    bool
] {
    return Map__from_dirty.Finalize$kernel<Path__from_tspath, configFileNames__from_project | undefined>($argument0, ($argument0: GoMapValue<Path__from_tspath, configFileNames__from_project | undefined>): GoMapValue<Path__from_tspath, configFileNames__from_project | undefined> => {
        return $argument0;
        ...
        return $argument0;
    }, ($argument0: GoMapValue<Path__from_tspath, MapEntry__from_dirty<Path__from_tspath, configFileNames__from_project | undefined> | undefined>): int => {
        return $argument0.length();
    }, ($argument0: configFileNames__from_project | undefined): GoMapValue<Path__from_tspath, configFileNames__from_project | undefined> => {
        return GoMap.make(0, []);
    }, ($argument0: configFileNames__from_project | undefined, $argument1: int): GoMapValue<Path__from_tspath, configFileNames__from_project | undefined> => {
