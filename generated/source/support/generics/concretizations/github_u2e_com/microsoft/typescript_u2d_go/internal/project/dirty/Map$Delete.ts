...
export function Map$Delete$Named_tspath$Path$PointerTo_Named_autoimport$RegistryBucket($argument0: {
    ...
    return Map__from_dirty.Delete$kernel<Path__from_tspath, RegistryBucket__from_autoimport | undefined>($argument0, ($argument0: RegistryBucket__from_autoimport | undefined): RegistryBucket__from_autoimport | undefined => {
        return $argument0;
...
export function Map$Delete$Named_tspath$Path$PointerTo_Named_autoimport$directory($argument0: {
    ...
    return Map__from_dirty.Delete$kernel<Path__from_tspath, directory__from_autoimport | undefined>($argument0, ($argument0: directory__from_autoimport | undefined): directory__from_autoimport | undefined => {
        return $argument0;
    }, ($argument0: Path__from_tspath): Path__from_tspath => {
        return $argument0;
    }, ($argument0: gostring): Path__from_tspath => {
...
export function Map$Delete$Named_tspath$Path$PointerTo_Named_project$configFileNames($argument0: {
    ...
    return Map__from_dirty.Delete$kernel<Path__from_tspath, configFileNames__from_project | undefined>($argument0, ($argument0: configFileNames__from_project | undefined): configFileNames__from_project | undefined => {
        return $argument0;
    }, ($argument0: Path__from_tspath): Path__from_tspath => {
        return $argument0;
    }, ($argument0: gostring): Path__from_tspath => {
