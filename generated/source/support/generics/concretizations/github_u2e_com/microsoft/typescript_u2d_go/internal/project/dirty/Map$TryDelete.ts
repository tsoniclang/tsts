...
export function Map$TryDelete$Named_tspath$Path$PointerTo_Named_autoimport$RegistryBucket($argument0: {
    ...
    return Map__from_dirty.TryDelete$kernel<Path__from_tspath, RegistryBucket__from_autoimport | undefined>($argument0, ($argument0: RegistryBucket__from_autoimport | undefined): RegistryBucket__from_autoimport | undefined => {
        return $argument0;
