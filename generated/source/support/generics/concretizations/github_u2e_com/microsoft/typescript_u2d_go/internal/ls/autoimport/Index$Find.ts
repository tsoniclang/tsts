...
export function Index$Find$PointerTo_Named_autoimport$Export($argument0: Index__from_autoimport<{
    value: Export__from_autoimport;
} | undefined> | undefined, $argument1: gostring, $argument2: bool): RuntimeSlice<{
    value: Export__from_autoimport;
} | undefined> {
    return Index__from_autoimport.Find$kernel<{
        value: Export__from_autoimport;
