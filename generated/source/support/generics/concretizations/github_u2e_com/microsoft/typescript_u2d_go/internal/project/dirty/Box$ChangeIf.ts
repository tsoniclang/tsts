...
export function Box$ChangeIf$PointerTo_Named_project$Project($argument0: {
    value: Box__from_dirty<tsonicTypeScriptRuntime.Location<Project__from_project> | undefined>;
} | undefined, $argument1: (($0: tsonicTypeScriptRuntime.Location<Project__from_project> | undefined) => bool) | undefined, $argument2: (($0: tsonicTypeScriptRuntime.Location<Project__from_project> | undefined) => void) | undefined): bool {
    return Box__from_dirty.ChangeIf$kernel<tsonicTypeScriptRuntime.Location<Project__from_project> | undefined>($argument0, $go$constraint_method$dirty$Clone$PointerTo_Named_project$Project_to_PointerTo_Named_project$Project, ($argument0: tsonicTypeScriptRuntime.Location<Project__from_project> | undefined): tsonicTypeScriptRuntime.Location<Project__from_project> | undefined => {
        return $argument0;
