...
export function MapEntry$Delete$Named_tspath$Path$Named_dirty$CloneableMapOf_Named_tspath$Path_And_string($argument0: tsonicTypeScriptRuntime.Location<MapEntry__from_dirty<Path__from_tspath, CloneableMap__from_dirty<Path__from_tspath, gostring>>> | undefined): void {
...
export function MapEntry$Delete$Named_tspath$Path$PointerTo_Named_project$configFileNames($argument0: tsonicTypeScriptRuntime.Location<MapEntry__from_dirty<Path__from_tspath, tsonicTypeScriptRuntime.Location<configFileNames__from_project> | undefined>> | undefined): void {
    return MapEntry__from_dirty.Delete$kernel<Path__from_tspath, tsonicTypeScriptRuntime.Location<configFileNames__from_project> | undefined>($argument0, ($argument0: gostring): Path__from_tspath => {
        return new Path__from_tspath($argument0);
    });
}
