...
export function SyncMapEntry$ChangeIf$Named_tspath$Path$PointerTo_Named_project$Project($argument0: {
    ...
    return SyncMapEntry__from_dirty.ChangeIf$kernel<Path__from_tspath, {
        value: Project__from_project;
...
export function SyncMapEntry$ChangeIf$Named_tspath$Path$PointerTo_Named_project$configFileEntry($argument0: {
    value: SyncMapEntry__from_dirty<Path__from_tspath, {
