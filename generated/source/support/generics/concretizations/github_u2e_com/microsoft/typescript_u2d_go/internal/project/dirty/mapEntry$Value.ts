...
export function mapEntry$Value$Named_tspath$Path$PointerTo_Named_autoimport$RegistryBucket($argument0: tsonicTypeScriptRuntime.Location<mapEntry__from_dirty<Path__from_tspath, RegistryBucket__from_autoimport | undefined>> | undefined): RegistryBucket__from_autoimport | undefined {
    return mapEntry__from_dirty.Value$kernel<Path__from_tspath, RegistryBucket__from_autoimport | undefined>($argument0, ($argument0: RegistryBucket__from_autoimport | undefined): RegistryBucket__from_autoimport | undefined => {
        return $argument0;
...
export function mapEntry$Value$Named_tspath$Path$PointerTo_Named_autoimport$directory($argument0: tsonicTypeScriptRuntime.Location<mapEntry__from_dirty<Path__from_tspath, directory__from_autoimport | undefined>> | undefined): directory__from_autoimport | undefined {
    return mapEntry__from_dirty.Value$kernel<Path__from_tspath, directory__from_autoimport | undefined>($argument0, ($argument0: directory__from_autoimport | undefined): directory__from_autoimport | undefined => {
        return $argument0;
...
export function mapEntry$Value$Named_tspath$Path$PointerTo_Named_project$configFileNames($argument0: tsonicTypeScriptRuntime.Location<mapEntry__from_dirty<Path__from_tspath, configFileNames__from_project | undefined>> | undefined): configFileNames__from_project | undefined {
    return mapEntry__from_dirty.Value$kernel<Path__from_tspath, configFileNames__from_project | undefined>($argument0, ($argument0: configFileNames__from_project | undefined): configFileNames__from_project | undefined => {
        return $argument0;
