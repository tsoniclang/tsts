...
export function Stack$Pop$Named_printer$detachedCommentsInfo($argument0: tsonicTypeScriptRuntime.Location<Stack__from_core<detachedCommentsInfo__from_printer>> | undefined): detachedCommentsInfo__from_printer {
    return Stack__from_core.Pop$kernel<detachedCommentsInfo__from_printer>($argument0, ($argument0: detachedCommentsInfo__from_printer): detachedCommentsInfo__from_printer => {
...
export function Stack$Pop$PointerTo_Named_printer$varScope($argument0: tsonicTypeScriptRuntime.Location<Stack__from_core<{
    value: varScope__from_printer;
} | undefined>> | undefined): {
    value: varScope__from_printer;
} | undefined {
    return Stack__from_core.Pop$kernel<{
        value: varScope__from_printer;
