...
export function NewBox$PointerTo_Named_project$Project($argument0: tsonicTypeScriptRuntime.Location<Project__from_project> | undefined): {
    value: Box__from_dirty<tsonicTypeScriptRuntime.Location<Project__from_project> | undefined>;
} | undefined {
    return NewBox$kernel<tsonicTypeScriptRuntime.Location<Project__from_project> | undefined>(($argument0: tsonicTypeScriptRuntime.Location<Project__from_project> | undefined): tsonicTypeScriptRuntime.Location<Project__from_project> | undefined => {
        return $argument0;
    }, $argument0);
}
