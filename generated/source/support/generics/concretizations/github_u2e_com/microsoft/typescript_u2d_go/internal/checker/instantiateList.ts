...
export function instantiateList$PointerTo_Named_ast$Symbol($argument0: {
    value: Checker__from_checker;
} | undefined, $argument1: RuntimeSlice<tsonicTypeScriptRuntime.Location<Symbol__from_ast> | undefined>, $argument2: tsonicTypeScriptRuntime.Location<TypeMapper__from_checker> | undefined, $argument3: (($0: {
    value: Checker__from_checker;
} | undefined, $1: tsonicTypeScriptRuntime.Location<Symbol__from_ast> | undefined, $2: tsonicTypeScriptRuntime.Location<TypeMapper__from_checker> | undefined) => tsonicTypeScriptRuntime.Location<Symbol__from_ast> | undefined) | undefined): RuntimeSlice<tsonicTypeScriptRuntime.Location<Symbol__from_ast> | undefined> {
...
export function instantiateList$PointerTo_Named_checker$IndexInfo($argument0: {
    value: Checker__from_checker;
} | undefined, $argument1: RuntimeSlice<tsonicTypeScriptRuntime.Location<IndexInfo__from_checker> | undefined>, $argument2: tsonicTypeScriptRuntime.Location<TypeMapper__from_checker> | undefined, $argument3: (($0: {
    value: Checker__from_checker;
} | undefined, $1: tsonicTypeScriptRuntime.Location<IndexInfo__from_checker> | undefined, $2: tsonicTypeScriptRuntime.Location<TypeMapper__from_checker> | undefined) => tsonicTypeScriptRuntime.Location<IndexInfo__from_checker> | undefined) | undefined): RuntimeSlice<tsonicTypeScriptRuntime.Location<IndexInfo__from_checker> | undefined> {
...
export function instantiateList$PointerTo_Named_checker$Signature($argument0: {
    value: Checker__from_checker;
} | undefined, $argument1: RuntimeSlice<tsonicTypeScriptRuntime.Location<Signature__from_checker> | undefined>, $argument2: tsonicTypeScriptRuntime.Location<TypeMapper__from_checker> | undefined, $argument3: (($0: {
    value: Checker__from_checker;
} | undefined, $1: tsonicTypeScriptRuntime.Location<Signature__from_checker> | undefined, $2: tsonicTypeScriptRuntime.Location<TypeMapper__from_checker> | undefined) => tsonicTypeScriptRuntime.Location<Signature__from_checker> | undefined) | undefined): RuntimeSlice<tsonicTypeScriptRuntime.Location<Signature__from_checker> | undefined> {
...
export function instantiateList$PointerTo_Named_checker$Type($argument0: {
    value: Checker__from_checker;
} | undefined, $argument1: RuntimeSlice<tsonicTypeScriptRuntime.Location<Type__from_checker> | undefined>, $argument2: tsonicTypeScriptRuntime.Location<TypeMapper__from_checker> | undefined, $argument3: (($0: {
    value: Checker__from_checker;
} | undefined, $1: tsonicTypeScriptRuntime.Location<Type__from_checker> | undefined, $2: tsonicTypeScriptRuntime.Location<TypeMapper__from_checker> | undefined) => tsonicTypeScriptRuntime.Location<Type__from_checker> | undefined) | undefined): RuntimeSlice<tsonicTypeScriptRuntime.Location<Type__from_checker> | undefined> {
