...
export function OwnerCache$AddOwner$Named_tspath$Path$PointerTo_Named_project$ExtendedConfigCacheEntry$Named_project$ExtendedConfigParseArgs($argument0: {
    ...
    return OwnerCache__from_project.AddOwner$kernel<Path__from_tspath, {
        value: ExtendedConfigCacheEntry__from_project;
