...
export function runWithoutResolvedSignatureCaching$SliceOf_PointerTo_Named_checker$Signature($argument0: tsonicTypeScriptRuntime.Location<Checker__from_checker> | undefined, $argument1: tsonicTypeScriptRuntime.Location<Node__from_ast> | undefined, $argument2: (() => RuntimeSlice<tsonicTypeScriptRuntime.Location<Signature__from_checker> | undefined>) | undefined): RuntimeSlice<tsonicTypeScriptRuntime.Location<Signature__from_checker> | undefined> {
