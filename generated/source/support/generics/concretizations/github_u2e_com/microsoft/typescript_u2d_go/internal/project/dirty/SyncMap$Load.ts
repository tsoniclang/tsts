...
import { $goInterfaceAdapter$PointerTo_Named_dirty$SyncMapEntryOf_Named_tspath$Path_And_PointerTo_Named_project$Project, $goInterfaceAdapter$PointerTo_Named_dirty$SyncMapEntryOf_Named_tspath$Path_And_PointerTo_Named_project$configFileEntry, $goInterfaceAdapter$PointerTo_Named_dirty$SyncMapEntryOf_Named_tspath$Path_And_PointerTo_Named_project$diskFile, $goInterfaceAdapter$PointerTo_Named_dirty$SyncMapEntryOf_Named_tspath$Path_And_PointerTo_Named_project$realpathAliasSet, $goInterfaceAdapter$Named_tspath$Path as GoInterfaceAdapter } from "../../../../../../../../interface-adapters.js";
import { GoPanic } from "@gotots/runtime/panic.js";
export function SyncMap$Load$Named_tspath$Path$PointerTo_Named_project$Project($argument0: {
...
export function SyncMap$Load$Named_tspath$Path$PointerTo_Named_project$configFileEntry($argument0: {
...
export function SyncMap$Load$Named_tspath$Path$PointerTo_Named_project$diskFile($argument0: {
...
export function SyncMap$Load$Named_tspath$Path$PointerTo_Named_project$realpathAliasSet($argument0: {
