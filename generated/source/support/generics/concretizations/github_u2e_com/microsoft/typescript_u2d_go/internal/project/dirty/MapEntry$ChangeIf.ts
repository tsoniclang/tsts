...
export function MapEntry$ChangeIf$Named_tspath$Path$PointerTo_Named_autoimport$directory($argument0: MapEntry__from_dirty<Path__from_tspath, directory__from_autoimport | undefined> | undefined, $argument1: (($0: directory__from_autoimport | undefined) => bool) | undefined, $argument2: (($0: directory__from_autoimport | undefined) => void) | undefined): bool {
    return MapEntry__from_dirty.ChangeIf$kernel<Path__from_tspath, directory__from_autoimport | undefined>($argument0, $go$constraint_method$dirty$Clone$PointerTo_Named_autoimport$directory_to_PointerTo_Named_autoimport$directory, ($argument0: directory__from_autoimport | undefined): directory__from_autoimport | undefined => {
        return $argument0;
