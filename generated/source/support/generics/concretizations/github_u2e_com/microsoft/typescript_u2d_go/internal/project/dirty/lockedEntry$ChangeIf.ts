...
export function lockedEntry$ChangeIf$Named_tspath$Path$PointerTo_Named_project$diskFile($argument0: lockedEntry__from_dirty<Path__from_tspath, tsonicTypeScriptRuntime.Location<diskFile__from_project> | undefined> | undefined, $argument1: (($0: tsonicTypeScriptRuntime.Location<diskFile__from_project> | undefined) => bool) | undefined, $argument2: (($0: tsonicTypeScriptRuntime.Location<diskFile__from_project> | undefined) => void) | undefined): bool {
...
export function lockedEntry$ChangeIf$Named_tspath$Path$PointerTo_Named_project$realpathAliasSet($argument0: lockedEntry__from_dirty<Path__from_tspath, tsonicTypeScriptRuntime.Location<realpathAliasSet__from_project> | undefined> | undefined, $argument1: (($0: tsonicTypeScriptRuntime.Location<realpathAliasSet__from_project> | undefined) => bool) | undefined, $argument2: (($0: tsonicTypeScriptRuntime.Location<realpathAliasSet__from_project> | undefined) => void) | undefined): bool {
