...
export function NewMultiMapWithSizeHint$Named_autoimport$ModuleID$Named_autoimport$existingImport($argument0: int): MultiMap__from_collections<ModuleID__from_autoimport, existingImport__from_autoimport> | undefined {
