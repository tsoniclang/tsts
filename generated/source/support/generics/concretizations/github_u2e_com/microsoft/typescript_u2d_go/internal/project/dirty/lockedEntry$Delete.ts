...
export function lockedEntry$Delete$Named_tspath$Path$PointerTo_Named_project$Project($argument0: lockedEntry__from_dirty<Path__from_tspath, {
    value: Project__from_project;
} | undefined> | undefined): void {
    return lockedEntry__from_dirty.Delete$kernel<Path__from_tspath, {
        value: Project__from_project;
...
export function lockedEntry$Delete$Named_tspath$Path$PointerTo_Named_project$diskFile($argument0: lockedEntry__from_dirty<Path__from_tspath, {
...
export function lockedEntry$Delete$Named_tspath$Path$PointerTo_Named_project$realpathAliasSet($argument0: lockedEntry__from_dirty<Path__from_tspath, {
