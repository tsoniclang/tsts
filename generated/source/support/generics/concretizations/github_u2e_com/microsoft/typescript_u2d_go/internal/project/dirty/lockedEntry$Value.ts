...
export function lockedEntry$Value$Named_tspath$Path$PointerTo_Named_project$Project($argument0: lockedEntry__from_dirty<Path__from_tspath, {
    value: Project__from_project;
} | undefined> | undefined): {
    value: Project__from_project;
} | undefined {
    return lockedEntry__from_dirty.Value$kernel<Path__from_tspath, {
        value: Project__from_project;
...
export function lockedEntry$Value$Named_tspath$Path$PointerTo_Named_project$diskFile($argument0: lockedEntry__from_dirty<Path__from_tspath, {
