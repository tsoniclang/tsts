...
export function SyncMap$FinalizeWith$Named_tspath$Path$PointerTo_Named_project$diskFile($argument0: {
...
} | undefined, $argument1: FinalizationHooks__from_dirty<Path__from_tspath, {
    value: diskFile__from_project;
} | undefined>): [
    ...
    return SyncMap__from_dirty.FinalizeWith$kernel<Path__from_tspath, {
        value: diskFile__from_project;
    } | undefined>($argument0, ($argument0: GoMapValue<Path__from_tspath, {
        value: diskFile__from_project;
