...
import type { FinalizationHooks as FinalizationHooks__from_dirty, SyncMapEntry as SyncMapEntry__from_dirty } from "../../../../../../../../../modules/github.com/microsoft/typescript-go/internal/project/dirty/syncmap.js";
...
import { $goInterfaceAdapter$PointerTo_Named_dirty$SyncMapEntryOf_Named_tspath$Path_And_PointerTo_Named_project$diskFile, $goInterfaceAdapter$Named_tspath$Path as GoInterfaceAdapter } from "../../../../../../../../interface-adapters.js";
import { $goMap$MapOf_Named_tspath$Path_To_PointerTo_Named_project$diskFile as GoMap } from "../../../../../../../../maps.js";
import { GoPanic } from "@gotots/runtime/panic.js";
export function SyncMap$FinalizeWith$Named_tspath$Path$PointerTo_Named_project$diskFile($argument0: {
    value: SyncMap__from_dirty<Path__from_tspath, tsonicTypeScriptRuntime.Location<diskFile__from_project> | undefined>;
} | undefined, $argument1: FinalizationHooks__from_dirty<Path__from_tspath, tsonicTypeScriptRuntime.Location<diskFile__from_project> | undefined>): [
    GoMapValue<Path__from_tspath, tsonicTypeScriptRuntime.Location<diskFile__from_project> | undefined>,
    bool
] {
    return SyncMap__from_dirty.FinalizeWith$kernel<Path__from_tspath, tsonicTypeScriptRuntime.Location<diskFile__from_project> | undefined>($argument0, ($argument0: GoMapValue<Path__from_tspath, tsonicTypeScriptRuntime.Location<diskFile__from_project> | undefined>): GoMapValue<Path__from_tspath, tsonicTypeScriptRuntime.Location<diskFile__from_project> | undefined> => {
        return $argument0;
    ...
    }, ($argument0: tsonicTypeScriptRuntime.Location<diskFile__from_project> | undefined): GoMapValue<Path__from_tspath, tsonicTypeScriptRuntime.Location<diskFile__from_project> | undefined> => {
        return GoMap.make(0, []);
