...
export function SyncMapEntry$DeleteIf$Named_tspath$Path$PointerTo_Named_project$configFileEntry($argument0: {
    ...
    return SyncMapEntry__from_dirty.DeleteIf$kernel<Path__from_tspath, {
        value: configFileEntry__from_project;
