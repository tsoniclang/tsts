...
export function $initialize(): void {
    ...
    $state.CallHierarchyIncomingCallsInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CallHierarchyIncomingCallsParams> | undefined, CallHierarchyIncomingCallsOrNull>();
    $state.CallHierarchyOutgoingCallsInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CallHierarchyOutgoingCallsParams> | undefined, CallHierarchyOutgoingCallsOrNull>();
    $state.CancelRequestInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CancelParams> | undefined>();
    $state.ClientRegisterCapabilityInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<RegistrationParams> | undefined, Null>();
    $state.ClientUnregisterCapabilityInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<UnregistrationParams> | undefined, Null>();
    $state.CodeActionResolveInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CodeAction> | undefined, tsonicTypeScriptRuntime.Location<CodeAction> | undefined>();
    $state.CodeLensResolveInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CodeLens> | undefined, tsonicTypeScriptRuntime.Location<CodeLens> | undefined>();
    $state.CompletionItemResolveInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CompletionItem> | undefined, tsonicTypeScriptRuntime.Location<CompletionItem> | undefined>();
    $state.CustomInitializeAPISessionInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<InitializeAPISessionParams> | undefined, {
        value: InitializeAPISessionResult;
    } | undefined>();
    $state.CustomProjectInfoInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ProjectInfoParams> | undefined, {
        value: ProjectInfoResult;
    } | undefined>();
    $state.CustomRunGCInfo = RequestInfo.$zeroStorage<NoParams, Null>();
    $state.CustomSaveAllocProfileInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ProfileParams> | undefined, {
        value: ProfileResult;
    } | undefined>();
    $state.CustomSaveHeapProfileInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ProfileParams> | undefined, {
        value: ProfileResult;
    } | undefined>();
    $state.CustomSetLogVerbosityInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<SetLogVerbosityParams> | undefined>();
    $state.CustomStartCPUProfileInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ProfileParams> | undefined, Null>();
    $state.CustomStopCPUProfileInfo = RequestInfo.$zeroStorage<NoParams, {
        value: ProfileResult;
    } | undefined>();
    $state.CustomTextDocumentMultiDocumentHighlightInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<MultiDocumentHighlightParams> | undefined, MultiDocumentHighlightsOrNull>();
    $state.CustomTextDocumentSourceDefinitionInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<TextDocumentPositionParams> | undefined, tsonicTypeScriptRuntime.Location<LocationOrLocationsOrDefinitionLinksOrNull> | undefined>();
    $state.DocumentLinkResolveInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DocumentLink> | undefined, tsonicTypeScriptRuntime.Location<DocumentLink> | undefined>();
    $state.ExitInfo = NotificationInfo.$zeroStorage<NoParams>();
    $state.InitializeInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<InitializeParams> | undefined, {
        value: InitializeResult;
    } | undefined>();
    $state.InitializedInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<InitializedParams> | undefined>();
    $state.InlayHintResolveInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<InlayHint> | undefined, tsonicTypeScriptRuntime.Location<InlayHint> | undefined>();
    $state.LogTraceInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<LogTraceParams> | undefined>();
    $state.ProgressInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ProgressParams> | undefined>();
    $state.SetTraceInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<SetTraceParams> | undefined>();
    $state.ShutdownInfo = RequestInfo.$zeroStorage<NoParams, Null>();
    $state.TelemetryEventInfo = NotificationInfo.$zeroStorage<RequestFailureTelemetryEventOrPerformanceStatsTelemetryEventOrProjectInfoTelemetryEventOrNull>();
    $state.TextDocumentCodeActionInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CodeActionParams> | undefined, CommandOrCodeActionArrayOrNull>();
    $state.TextDocumentCodeLensInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CodeLensParams> | undefined, CodeLensesOrNull>();
    $state.TextDocumentColorPresentationInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ColorPresentationParams> | undefined, RuntimeSlice<tsonicTypeScriptRuntime.Location<ColorPresentation> | undefined>>();
    $state.TextDocumentCompletionInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CompletionParams> | undefined, CompletionItemsOrListOrNull>();
    $state.TextDocumentDeclarationInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DeclarationParams> | undefined, LocationOrLocationsOrDeclarationLinksOrNull>();
    $state.TextDocumentDefinitionInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DefinitionParams> | undefined, LocationOrLocationsOrDefinitionLinksOrNull>();
    $state.TextDocumentDiagnosticInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DocumentDiagnosticParams> | undefined, RelatedFullDocumentDiagnosticReportOrUnchangedDocumentDiagnosticReport>();
    $state.TextDocumentDidChangeInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DidChangeTextDocumentParams> | undefined>();
    $state.TextDocumentDidCloseInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DidCloseTextDocumentParams> | undefined>();
    $state.TextDocumentDidOpenInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DidOpenTextDocumentParams> | undefined>();
    $state.TextDocumentDidSaveInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DidSaveTextDocumentParams> | undefined>();
    $state.TextDocumentDocumentColorInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DocumentColorParams> | undefined, RuntimeSlice<tsonicTypeScriptRuntime.Location<ColorInformation> | undefined>>();
    $state.TextDocumentDocumentHighlightInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DocumentHighlightParams> | undefined, DocumentHighlightsOrNull>();
    $state.TextDocumentDocumentLinkInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DocumentLinkParams> | undefined, DocumentLinksOrNull>();
    $state.TextDocumentDocumentSymbolInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DocumentSymbolParams> | undefined, SymbolInformationsOrDocumentSymbolsOrNull>();
    $state.TextDocumentFoldingRangeInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<FoldingRangeParams> | undefined, FoldingRangesOrNull>();
    $state.TextDocumentFormattingInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DocumentFormattingParams> | undefined, TextEditsOrNull>();
    $state.TextDocumentHoverInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<HoverParams> | undefined, HoverOrNull>();
    $state.TextDocumentImplementationInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ImplementationParams> | undefined, LocationOrLocationsOrDefinitionLinksOrNull>();
    $state.TextDocumentInlayHintInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<InlayHintParams> | undefined, InlayHintsOrNull>();
    $state.TextDocumentInlineCompletionInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<InlineCompletionParams> | undefined, InlineCompletionListOrItemsOrNull>();
    $state.TextDocumentInlineValueInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<InlineValueParams> | undefined, InlineValuesOrNull>();
    $state.TextDocumentLinkedEditingRangeInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<LinkedEditingRangeParams> | undefined, LinkedEditingRangesOrNull>();
    $state.TextDocumentMonikerInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<MonikerParams> | undefined, MonikersOrNull>();
    $state.TextDocumentOnTypeFormattingInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DocumentOnTypeFormattingParams> | undefined, TextEditsOrNull>();
    $state.TextDocumentPrepareCallHierarchyInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CallHierarchyPrepareParams> | undefined, CallHierarchyItemsOrNull>();
    $state.TextDocumentPrepareRenameInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<PrepareRenameParams> | undefined, RangeOrPrepareRenamePlaceholderOrPrepareRenameDefaultBehaviorOrNull>();
    $state.TextDocumentPrepareTypeHierarchyInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<TypeHierarchyPrepareParams> | undefined, TypeHierarchyItemsOrNull>();
    $state.TextDocumentPublishDiagnosticsInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<PublishDiagnosticsParams> | undefined>();
    $state.TextDocumentRangeFormattingInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DocumentRangeFormattingParams> | undefined, TextEditsOrNull>();
    $state.TextDocumentRangesFormattingInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DocumentRangesFormattingParams> | undefined, TextEditsOrNull>();
    $state.TextDocumentReferencesInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ReferenceParams> | undefined, LocationsOrNull>();
    $state.TextDocumentRenameInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<RenameParams> | undefined, WorkspaceEditOrNull>();
    $state.TextDocumentSelectionRangeInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<SelectionRangeParams> | undefined, SelectionRangesOrNull>();
    $state.TextDocumentSemanticTokensFullDeltaInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<SemanticTokensDeltaParams> | undefined, SemanticTokensOrSemanticTokensDeltaOrNull>();
    $state.TextDocumentSemanticTokensFullInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<SemanticTokensParams> | undefined, SemanticTokensOrNull>();
    $state.TextDocumentSemanticTokensRangeInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<SemanticTokensRangeParams> | undefined, SemanticTokensOrNull>();
    $state.TextDocumentSignatureHelpInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<SignatureHelpParams> | undefined, SignatureHelpOrNull>();
    $state.TextDocumentTypeDefinitionInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<TypeDefinitionParams> | undefined, LocationOrLocationsOrDefinitionLinksOrNull>();
    $state.TextDocumentVSOnAutoInsertInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<VSOnAutoInsertParams> | undefined, VSOnAutoInsertResponseItemOrNull>();
    $state.TextDocumentVSReferencesInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ReferenceParams> | undefined, VSReferenceItemsOrNull>();
    $state.TextDocumentWillSaveInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<WillSaveTextDocumentParams> | undefined>();
    $state.TextDocumentWillSaveWaitUntilInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<WillSaveTextDocumentParams> | undefined, TextEditsOrNull>();
    $state.TypeHierarchySubtypesInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<TypeHierarchySubtypesParams> | undefined, TypeHierarchyItemsOrNull>();
    $state.TypeHierarchySupertypesInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<TypeHierarchySupertypesParams> | undefined, TypeHierarchyItemsOrNull>();
    $state.WindowLogMessageInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<LogMessageParams> | undefined>();
    $state.WindowShowDocumentInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ShowDocumentParams> | undefined, tsonicTypeScriptRuntime.Location<ShowDocumentResult> | undefined>();
    $state.WindowShowMessageInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ShowMessageParams> | undefined>();
    $state.WindowShowMessageRequestInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ShowMessageRequestParams> | undefined, MessageActionItemOrNull>();
    $state.WindowWorkDoneProgressCancelInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<WorkDoneProgressCancelParams> | undefined>();
    $state.WindowWorkDoneProgressCreateInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<WorkDoneProgressCreateParams> | undefined, Null>();
    $state.WorkspaceApplyEditInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ApplyWorkspaceEditParams> | undefined, tsonicTypeScriptRuntime.Location<ApplyWorkspaceEditResult> | undefined>();
    $state.WorkspaceCodeLensRefreshInfo = RequestInfo.$zeroStorage<NoParams, Null>();
    $state.WorkspaceConfigurationInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ConfigurationParams> | undefined, RuntimeSlice<GoInterface | undefined>>();
    $state.WorkspaceDiagnosticInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<WorkspaceDiagnosticParams> | undefined, tsonicTypeScriptRuntime.Location<WorkspaceDiagnosticReport> | undefined>();
    $state.WorkspaceDiagnosticRefreshInfo = RequestInfo.$zeroStorage<NoParams, Null>();
    $state.WorkspaceDidChangeConfigurationInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DidChangeConfigurationParams> | undefined>();
    $state.WorkspaceDidChangeWatchedFilesInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DidChangeWatchedFilesParams> | undefined>();
    $state.WorkspaceDidChangeWorkspaceFoldersInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DidChangeWorkspaceFoldersParams> | undefined>();
    $state.WorkspaceDidCreateFilesInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CreateFilesParams> | undefined>();
    $state.WorkspaceDidDeleteFilesInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DeleteFilesParams> | undefined>();
    $state.WorkspaceDidRenameFilesInfo = NotificationInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<RenameFilesParams> | undefined>();
    $state.WorkspaceExecuteCommandInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<ExecuteCommandParams> | undefined, LSPAnyOrNull>();
    $state.WorkspaceFoldingRangeRefreshInfo = RequestInfo.$zeroStorage<NoParams, Null>();
    $state.WorkspaceInlayHintRefreshInfo = RequestInfo.$zeroStorage<NoParams, Null>();
    $state.WorkspaceInlineValueRefreshInfo = RequestInfo.$zeroStorage<NoParams, Null>();
    $state.WorkspaceSemanticTokensRefreshInfo = RequestInfo.$zeroStorage<NoParams, Null>();
    $state.WorkspaceSymbolInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<WorkspaceSymbolParams> | undefined, SymbolInformationsOrWorkspaceSymbolsOrNull>();
    $state.WorkspaceSymbolResolveInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<WorkspaceSymbol> | undefined, tsonicTypeScriptRuntime.Location<WorkspaceSymbol> | undefined>();
    $state.WorkspaceTextDocumentContentInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<TextDocumentContentParams> | undefined, tsonicTypeScriptRuntime.Location<TextDocumentContentResult> | undefined>();
    $state.WorkspaceTextDocumentContentRefreshInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<TextDocumentContentRefreshParams> | undefined, Null>();
    $state.WorkspaceWillCreateFilesInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<CreateFilesParams> | undefined, WorkspaceEditOrNull>();
    $state.WorkspaceWillDeleteFilesInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<DeleteFilesParams> | undefined, WorkspaceEditOrNull>();
    $state.WorkspaceWillRenameFilesInfo = RequestInfo.$zeroStorage<tsonicTypeScriptRuntime.Location<RenameFilesParams> | undefined, WorkspaceEditOrNull>();
    $state.WorkspaceWorkspaceFoldersInfo = RequestInfo.$zeroStorage<NoParams, WorkspaceFoldersOrNull>();
