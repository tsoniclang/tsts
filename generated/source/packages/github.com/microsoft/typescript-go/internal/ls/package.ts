...
import { $goMap$MapOf_Named_ast$Kind_To_bool as GoMap } from "../../../../../../support/maps.js";
...
export function $initialize(): void {
    ...
    $state.canHaveTypeAnnotationKinds = GoMap.nil();
    ...
    {
        $state.canHaveTypeAnnotationKinds = GoMap.make(12, [[KindGetAccessor$constant__from_ast(), true], [KindMethodDeclaration$constant__from_ast(), true], [KindPropertyDeclaration$constant__from_ast(), true], [KindFunctionDeclaration$constant__from_ast(), true], [KindFunctionExpression$constant__from_ast(), true], [KindArrowFunction$constant__from_ast(), true], [KindVariableDeclaration$constant__from_ast(), true], [KindParameter$constant__from_ast(), true], [KindExportAssignment$constant__from_ast(), true], [KindClassDeclaration$constant__from_ast(), true], [KindObjectBindingPattern$constant__from_ast(), true], [KindArrayBindingPattern$constant__from_ast(), true]]);
    }
    {
