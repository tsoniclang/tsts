...
export function $initialize(): void {
    ...
    $state.LanguageFeatureMinimumTarget = LanguageFeatureMinimumTargetMap.$zeroStorage();
    ...
    $state.SignatureKeyBase = CacheHashKey.$zeroStorage();
    $state.SignatureKeyCanonical = CacheHashKey.$zeroStorage();
    $state.SignatureKeyErased = CacheHashKey.$zeroStorage();
    $state.SignatureKeyInner = CacheHashKey.$zeroStorage();
    $state.SignatureKeyOuter = CacheHashKey.$zeroStorage();
    ...
    $state.nonDottedNameCacheKey = CacheHashKey.$zeroStorage();
