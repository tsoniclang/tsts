...
export function $initialize(): void {
    ...
    {
        $state.und = Tag.$storageOf(Tag.$fromStorage({
            language: 0,
            locale: 0,
            full: void 0
        }));
    ...
    {
        $state.Afrikaans = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Amharic = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Arabic = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.ModernStandardArabic = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Azerbaijani = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Bulgarian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Bengali = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Catalan = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Czech = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Danish = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.German = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Greek = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.English = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.AmericanEnglish = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.BritishEnglish = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Spanish = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.EuropeanSpanish = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.LatinAmericanSpanish = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Estonian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Persian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Finnish = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Filipino = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.French = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.CanadianFrench = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Gujarati = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Hebrew = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Hindi = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Croatian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Hungarian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Armenian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Indonesian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Icelandic = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Italian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Japanese = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Georgian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Kazakh = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Khmer = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Kannada = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Korean = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Kirghiz = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Lao = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Lithuanian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Latvian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Macedonian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Malayalam = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Mongolian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Marathi = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Malay = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Burmese = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Nepali = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Dutch = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Norwegian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Punjabi = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Polish = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Portuguese = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.BrazilianPortuguese = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.EuropeanPortuguese = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Romanian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Russian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Sinhala = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Slovak = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Slovenian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Albanian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Serbian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.SerbianLatin = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Swedish = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Swahili = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Tamil = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Telugu = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Thai = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Turkish = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Ukrainian = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Urdu = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Uzbek = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Vietnamese = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Chinese = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.SimplifiedChinese = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.TraditionalChinese = Tag.$storageOf(Tag.$fromStorage({
    ...
    {
        $state.Zulu = Tag.$storageOf(Tag.$fromStorage({
