// Committed checker-gate scaffolding (M5a). Stand-in for `xunit-types/Xunit.js`
// so the compiled checker.test.js Fact suite runs under plain node. Same
// assertion surface as the binder gate (NotNull / Null / Same / True / False);
// Assert.Equal compares via JSON.stringify.
export const Assert = {
