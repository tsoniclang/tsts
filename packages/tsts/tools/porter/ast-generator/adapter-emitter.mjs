import { NODE_DATA_METHODS, generatedOverrideMethodsFor, resolveAdapterTarget } from "./adapter-model.mjs";

export function emitGeneratedVisitHelpers(lines) {
...
export function emitConcreteInterface(schema, node, lines) {
...
export function emitOverrideFreeFns(schema, node, lines) {
...
export function emitAdapter(schema, node, lines) {
