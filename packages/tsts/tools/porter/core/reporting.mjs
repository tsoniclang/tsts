...
export function printStatus(config, status) {
  ...
  console.log(`Generated source mechanisms files/mechanisms/issues: ${status.generatedSourcePolicies?.relevantFileCount ?? 0}/${status.generatedSourcePolicies?.mechanismCount ?? 0}/${status.counts.generatedSourcePolicyIssues ?? 0}`);
  console.log(`Generated source coverage issues: ${status.counts.generatedSourceCoverageIssues ?? 0}`);
  console.log(`Source pin/provenance issues: ${status.counts.sourcePinIssues ?? 0}`);
  console.log(`Invalid @tsgo-unit metadata: ${status.counts.invalidTsMetadata ?? 0}`);
  console.log(`Global generated-artifact providers/issues: ${status.globalGeneratedArtifacts?.providerCount ?? 0}/${status.counts.globalGeneratedArtifactIssues ?? 0}`);
  console.log(`Go source interpretation issues: ${status.counts.sourceInterpretationIssues ?? 0}`);
  ...
  console.log(`Unresolved generated facade obligations: ${status.counts.unresolvedGeneratedFacadeObligations ?? 0}`);
...
export function renderStatusMarkdown(status) {
  ...
  lines.push(`- Generated source mechanisms files/mechanisms/issues: ${status.generatedSourcePolicies?.relevantFileCount ?? 0}/${status.generatedSourcePolicies?.mechanismCount ?? 0}/${status.counts.generatedSourcePolicyIssues ?? 0}`);
  lines.push(`- Generated source coverage issues: ${status.counts.generatedSourceCoverageIssues ?? 0}`);
  lines.push(`- Source pin/provenance issues: ${status.counts.sourcePinIssues ?? 0}`);
  lines.push(`- Invalid @tsgo-unit metadata: ${status.counts.invalidTsMetadata ?? 0}`);
  lines.push(`- Global generated-artifact providers/issues: ${status.globalGeneratedArtifacts?.providerCount ?? 0}/${status.counts.globalGeneratedArtifactIssues ?? 0}`);
  lines.push(`- Go source interpretation issues: ${status.counts.sourceInterpretationIssues ?? 0}`);
  ...
  lines.push(`- Unresolved generated facade obligations: ${status.counts.unresolvedGeneratedFacadeObligations ?? 0}`);
