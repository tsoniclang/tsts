export const DECLARATION_AUDIT_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({ key: "go-value-operation-providers", label: "Go value-operation provider audit", path: Object.freeze(["signatureCheck", "valueOperationProviders"]) }),
...
export function declarationAuditsNotRun(subject = "This command") {
  ...
  return {
    signatureCheck: {
      ...
      valueOperationProviders: skipped("Go value-operation provider audit"),
