...
const semanticBasicNames = new Set([
  "Pointer", "bool", "complex128", "complex64", "float32", "float64", "int", "int16", "int32", "int64", "int8",
  "string", "uint", "uint16", "uint32", "uint64", "uint8", "uintptr", "untyped bool", "untyped complex", "untyped float",
...
function declarationObjectId(semantic, kind, unit) {
  if (kind === "func") return objectId(semantic?.packagePath, "func", unit?.name);
