...
This file records the exact existing TS-Go and Go-toolchain inputs used to
validate Porter itself. Updating TS-Go is a separate product change and must
update this evidence deliberately after the Porter-only change is merged.
...
| Nested TypeScript commit | `c3bd12d888b86f676718b16e64d7d2abcb423514` |
