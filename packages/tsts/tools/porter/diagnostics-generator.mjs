...
export function diagnosticsConfig(config) {
  ...
  return {
    tsRoot,
    generatedDir: "internal/diagnostics/generated",
...
function generatedFile(relativePath, body, sourceRevision, inputs) {
  return renderGeneratedArtifactEnvelope({
    body,
    header: "// Code generated by TSTS diagnostics generator. DO NOT EDIT.",
    inputs,
    kind: GENERATED_KIND,
    path: relativePath,
...
export function buildDiagnosticsGeneratedFiles(config, sourceRevision) {
  ...
  for (const emitter of EMITTERS) {
    ...
    files.set(relativePath, generatedFile(relativePath, body, sourceRevision, emitter.inputs(dc)));
  }
  return files;
}
...
export function buildDiagnosticsGeneratedArtifactStatus(config, sourceRevision) {
  ...
  const inventory = inventoryGeneratedArtifactsForProvider(resolveRepo(dc.tsRoot), GENERATOR);
