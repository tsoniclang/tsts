...
// (`src/diagnostics/diagnostics.generated.ts`).
//
...
// (`checkSchema.ts`, `checkCompleteness.ts`): honor TSGO_REPO, else default
 ...
 *
 * Regenerate via \`tools/generateDiagnostics.ts\` (run \`npm run diagnostics:generate\`).
 *
...
async function main(): Promise<void> {
  ...
  await writeGenerated("src/diagnostics/diagnostics.generated.ts", generateCatalog(entries, upstreamRelative));
