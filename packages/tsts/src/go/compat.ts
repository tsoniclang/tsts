...
// @tsgo-generated {"schemaVersion":1,"kind":"go-compat","generator":"porter:facades","sourceRevision":"c78d39e7075b4fc641b12b1f35d905c54cdc13ef","path":"go/compat.ts","contentHash":"d75a8b84fcaf049ac1436e1c02f0fc4aa7aaffcb1ac66447cb3f8397435a67d3"}
...
export function GoAppend<T>(slice: GoSlice<T>, ...items: T[]): GoSlice<T> {
  return [...(slice ?? []), ...items];
}
