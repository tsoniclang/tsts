...
test("provider export contracts include every provider type-expression field", () => {
  const pairs: readonly [string, ProviderTypeExpression, ProviderTypeExpression][] = [
    ...
    ["function parameter", { kind: "function", parameters: [{ name: "value", type: { kind: "string" } }], returnType: { kind: "void" } }, { kind: "function", parameters: [{ name: "value", type: { kind: "number" } }], returnType: { kind: "void" } }],
    ["function return", { kind: "function", parameters: [], returnType: { kind: "string" } }, { kind: "function", parameters: [], returnType: { kind: "number" } }],
    ["function type parameters", { kind: "function", parameters: [], returnType: { kind: "void" }, typeParameters: [{ name: "T" }] }, { kind: "function", parameters: [], returnType: { kind: "void" }, typeParameters: [{ name: "U" }] }],
