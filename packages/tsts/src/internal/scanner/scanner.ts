 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"ScanTrivia calls scanConflictMarkerTrivia with nil when trivia is being classified without diagnostics, while Scanner.Scan supplies its error reporter. scanConflictMarkerTrivia tests that exact no-report sentinel before emitting a conflict-marker diagnostic and advances over the marker identically in both modes.","goSignature":"func(string,packages/tsts/src/go/scalars.ts::int,(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/diagnostics/diagnostics.ts::Message>,packages/tsts/src/go/scalars.ts::int,packages/tsts/src/go/scalars.ts::int,...unknown[])=>void)=>packages/tsts/src/go/scalars.ts::int","tsSignature":"func(string,packages/tsts/src/go/scalars.ts::int,(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/diagnostics/diagnostics.ts::Message>,packages/tsts/src/go/scalars.ts::int,packages/tsts/src/go/scalars.ts::int,...unknown[])=>void|undefined)=>packages/tsts/src/go/scalars.ts::int"}
 *
 * Go source:
