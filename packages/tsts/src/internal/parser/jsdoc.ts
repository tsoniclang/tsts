...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/jsdoc.go::func::parseJSDocForNode","kind":"func","status":"implemented","sigHash":"9fdd6567e9d47623c52d1633c41d80312177c8cef165ff2dbcc8af05d63a6d9e"}
 *
 * Go source:
...
export function parseJSDocForNode(sourceFile: GoPtr<SourceFile>, node: GoPtr<Node>): GoSlice<GoPtr<Node>> {
  ...
  try {
    ...
    for (const comment of ranges) {
      ...
      if (parsed !== undefined) {
        parsed!.Parent = node;
        jsdoc = GoSliceAppend(jsdoc, parsed, GoPointerValueOps<Node>());
        pos = Node_End(parsed);
      }
    }
    return jsdoc;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/jsdoc.go::type::jsdocState","kind":"type","status":"implemented","sigHash":"390d1787ac3c3cd74f6b2061bb9976cf7800cbdbcdf4f7e50480f1cb5c43d222"}
 *
 * Go source:
 * jsdocState int32
 */
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/jsdoc.go::constGroup::jsdocStateBeginningOfLine+jsdocStateSawAsterisk+jsdocStateSavingComments+jsdocStateSavingBackticks","kind":"constGroup","status":"implemented","sigHash":"d8e5e7d2728f73da6a017a91f95f7f03d70eedb7f73526a70b2169137852cd05"}
 *
 * Go source:
 * const (
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/jsdoc.go::type::propertyLikeParse","kind":"type","status":"implemented","sigHash":"c9afe9ed8f0d9da867930b487b6752957f3d7e4c8b91e01e720c2f1a256c3769"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/jsdoc.go::constGroup::propertyLikeParseProperty+propertyLikeParseParameter+propertyLikeParseCallbackParameter","kind":"constGroup","status":"implemented","sigHash":"c02b7eba68870088417b496af15ebd24b9df12d8d5a0fa3175dd920558c8356e"}
 *
 * Go source:
 * const (
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/jsdoc.go::method::Parser.parseJSDocComment","kind":"method","status":"implemented","sigHash":"345678c06506dfeee662b83c8a4a415aab6b0497649cd72f4c955330083bb86f"}
 *
 * Go source:
...
export function Parser_parseJSDocComment(receiver: GoPtr<Parser>, parent: GoPtr<Node>, start: int, end: int, fullStart: int): GoPtr<Node> {
  ...
  if ((receiver!.contextFlags & NodeFlagsJavaScriptFile) !== 0) {
    receiver!.jsdocDiagnostics = GoSliceAppendSlice(receiver!.jsdocDiagnostics, receiver!.diagnostics.slice(saveDiagnosticsLength), GoPointerValueOps<Diagnostic>());
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/jsdoc.go::method::Parser.parseJSDocCommentWorker","kind":"method","status":"implemented","sigHash":"58c884abf0456864f93050c844de7516559e15c123cd4939ac5397d8e39beca5"}
 *
 * Go source:
...
export function Parser_parseJSDocCommentWorker(receiver: GoPtr<Parser>, start: int, end: int, fullStart: int, indent: int): GoPtr<Node> {
  ...
  const pushComment = (text: string): void => {
    ...
    comments = GoSliceAppend(comments, text, GoStringValueOps);
    indent += text.length;
  };
    ...
    switch (receiver!.token) {
      case KindAtToken:
        ...
        }
        {
          ...
          tags = GoSliceAppend(tags, tag, GoPointerValueOps<Node>());
      ...
      case KindNewLineTrivia:
        comments = GoSliceAppend(comments, Scanner_TokenText(receiver!.scanner), GoStringValueOps);
        state = jsdocStateBeginningOfLine;
        indent = 0;
        break;
      ...
      case KindWhitespaceTrivia: {
        ...
        if (margin > -1 && indent + whitespace.length > margin) {
          ...
          comments = GoSliceAppend(comments, whitespace.slice(existingIndent), GoStringValueOps);
        }
      ...
      case KindOpenBraceToken: {
        ...
        if (link !== undefined) {
          ...
          commentParts = GoSliceAppendSlice(commentParts, GoSliceBuild(2, 2, GoPointerValueOps<Node>(), (__goSliceLiteral_6bd5) => { GoSliceStore(__goSliceLiteral_6bd5, 0, jsdocText!, GoPointerValueOps<Node>()); GoSliceStore(__goSliceLiteral_6bd5, 1, link!, GoPointerValueOps<Node>()); }), GoPointerValueOps<Node>());
  ...
  loop: for (;;) {
    ...
    switch (tok) {
      ...
      case KindWhitespaceTrivia: {
        ...
        if (margin > -1 && indent + whitespace.length > margin) {
          comments = GoSliceAppend(comments, whitespace.slice(Math.max(margin - indent, 0)), GoStringValueOps);
          if (inFencedCodeBlock) {
            state = jsdocStateSavingBackticks;
          } else {
            state = jsdocStateSavingComments;
      ...
      case KindOpenBraceToken: {
        ...
        if (link !== undefined) {
          ...
          parts = GoSliceAppend(parts, text!, GoPointerValueOps<Node>());
          parts = GoSliceAppend(parts, link!, GoPointerValueOps<Node>());
          comments = GoSliceToZeroLength(comments);
          linkEnd = Scanner_TokenEnd(receiver!.scanner);
        } else {
          pushComment(Scanner_TokenText(receiver!.scanner));
...
export function Parser_parseJSDocLink(receiver: GoPtr<Parser>, start: int): GoPtr<Node> {
  ...
  while (receiver!.token !== KindCloseBraceToken && receiver!.token !== KindNewLineTrivia && receiver!.token !== KindEndOfFile) {
    text = GoSliceAppend(text, Scanner_TokenText(receiver!.scanner), GoStringValueOps);
    ...
    for (;;) {
      ...
      switch (child!.Kind) {
        ...
        case KindJSDocPropertyTag:
          children = GoSliceAppend(children, child, GoPointerValueOps<Node>());
          break;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/jsdoc.go::method::Parser.parseTypeTag","kind":"method","status":"implemented","sigHash":"f282834acd1d44bf286b9ff3697e4dcbe5f968b2cd3f961d8c75603aceac47da"}
 *
 * Port note: (uses tagName.Text() and parseTrailingTagComments)
 */
    ...
    for (;;) {
      ...
      switch (child!.Kind) {
        ...
        case KindJSDocTypeTag:
          ...
          break;
        default:
          jsdocPropertyTags = GoSliceAppend(jsdocPropertyTags, child!, GoPointerValueOps<Node>());
          break;
      }
    }
    if (hasChildren) {
...
export function Parser_parseCallbackTagParameters(receiver: GoPtr<Parser>, indent: int): GoPtr<NodeList> {
  ...
  for (;;) {
    ...
    if (child.Kind === KindJSDocTemplateTag) {
      ...
      parameters = GoSliceAppend(parameters, child, GoPointerValueOps<Node>());
    }
  }
...
export function Parser_parseTemplateTagTypeParameters(receiver: GoPtr<Parser>): GoPtr<TypeParameterList> {
  ...
  do {
    ...
    if (node !== undefined) {
      nodes = GoSliceAppend(nodes, node, GoPointerValueOps<Node>());
    }
    Parser_skipWhitespaceOrAsterisk(receiver);
