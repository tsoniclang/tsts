...
import { GoNilSlice, GoSliceIsNil, GoZeroPointer } from "../../go/compat.js";
...
import { IsValidIdentifier, IsIdentifierStart, IsIdentifierPart } from "../scanner/scanner.js";
import { Identifier_expected } from "../diagnostics/generated/messages.js";
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.finishMutatedNode","kind":"method","status":"implemented","sigHash":"096abd4f1a06b0bf66559823d1a15e3f624b269a7d37bd67dca0af3f5982b471"}
 *
 * Go source:
...
export function Parser_addDeepCloneReparse(receiver: GoPtr<Parser>, node: GoPtr<Node>): GoPtr<Node> {
  ...
  if (clone !== undefined) {
    receiver!.reparsedClones = GoSliceAppend(receiver!.reparsedClones, clone, GoPointerValueOps<Node>());
  }
  return clone;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.addTransformedReparse","kind":"method","status":"implemented","sigHash":"5a73a6a719713469d73532310de50511a78489b42fd79033745495db79c91f63"}
 *
 * Go source:
...
export function Parser_addTransformedReparse(receiver: GoPtr<Parser>, newNode: GoPtr<Node>, old: GoPtr<Node>): GoPtr<Node> {
  ...
  receiver!.reparsedClones = GoSliceAppend(receiver!.reparsedClones, newNode, GoPointerValueOps<Node>());
  return newNode;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.checkNonIdentifierName","kind":"method","status":"implemented","sigHash":"dbe0e31801de661103c2a579256d3c281374e82f221b2050a3a5ef6cc8438cbb"}
 *
 * Go source:
 ...
 * }
 */
export function Parser_checkNonIdentifierName(receiver: GoPtr<Parser>, name: GoPtr<Node>): GoPtr<Node> {
  if (IsIdentifier(name) && !IsValidIdentifier(AsIdentifier(name)!.Text)) {
    let errLoc: TextRange = name!.Loc;
    if (TextRange_Len(errLoc) === 0) { // missing name, emit error on the character before the missing name node
      errLoc = NewTextRange(name!.Loc.pos - 1, name!.Loc.pos);
    }
    Parser_parseErrorAtRange(receiver, errLoc, Identifier_expected);
  }
  return name;
}
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.reparseUnhosted","kind":"method","status":"implemented","sigHash":"dde604f1c50ebedb28ab84d37632a0d54944cffb728423ba5b489b46c172cdce"}
 *
 * Go source:
...
export function Parser_reparseUnhosted(receiver: GoPtr<Parser>, tag: GoPtr<Node>, parent: GoPtr<Node>, jsDoc: GoPtr<Node>): void {
  switch (tag!.Kind) {
    case KindJSDocTypedefTag: {
      ...
      const typeAlias = NewJSTypeAliasDeclaration(receiver!.factory, modifiers, Parser_addDeepCloneReparse(receiver, Parser_checkNonIdentifierName(receiver, Parser_getInnermostNameOfJSDocNamespace(receiver, fullName))), undefined, undefined);
      ...
      receiver!.reparseList = GoSliceAppend(receiver!.reparseList, result, GoPointerValueOps<Node>());
      break;
    }
    ...
    case KindJSDocImportTag: {
      ...
      receiver!.reparseList = GoSliceAppend(receiver!.reparseList, importDeclaration, GoPointerValueOps<Node>());
      break;
    }
    case KindJSDocOverloadTag: {
      if ((IsFunctionDeclaration(parent) || IsMethodDeclaration(parent) || IsConstructorDeclaration(parent)) && (receiver!.parsingContexts & (1 << PCObjectLiteralMembers)) === 0) {
        receiver!.reparseList = GoSliceAppend(receiver!.reparseList, Parser_reparseJSDocSignature(receiver, AsJSDocOverloadTag(tag)!.TypeExpression, parent, jsDoc, tag, Node_Modifiers(parent)), GoPointerValueOps<Node>());
      }
      break;
    }
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.reparseJSDocSignature","kind":"method","status":"implemented","sigHash":"881a921d17f7c9183951c1d845aeb86c49ccdf85c86b24464694aa2349c35fd2"}
 *
 * Go source:
...
export function Parser_reparseJSDocSignature(receiver: GoPtr<Parser>, jsSignature: GoPtr<Node>, fun: GoPtr<Node>, jsDoc: GoPtr<Node>, tag: GoPtr<Node>, modifiers: GoPtr<ModifierList>): GoPtr<Node> {
  ...
  switch (fun!.Kind) {
    case KindFunctionDeclaration:
      signature = NewFunctionDeclaration(receiver!.factory, clonedModifiers, undefined, NodeFactory_DeepCloneReparse(receiver!.factory, Parser_checkNonIdentifierName(receiver, Node_Name(fun))), undefined, undefined, undefined, undefined, undefined);
      break;
    case KindMethodDeclaration:
      signature = NewMethodDeclaration(receiver!.factory, clonedModifiers, undefined, NodeFactory_DeepCloneReparse(receiver!.factory, Parser_checkNonIdentifierName(receiver, Node_Name(fun))), undefined, undefined, undefined, undefined, undefined, undefined);
      break;
  ...
  for (let pi: int = 0; pi < jsSignatureParameters.length; pi++) {
    ...
    if (param!.Kind === KindJSDocThisTag) {
      ...
      if (IsIdentifier(name) && !IsValidIdentifier(AsIdentifier(name)!.Text)) {
        ...
        if (result.Len() === 0) {
          result.WriteRune("_".charCodeAt(0) as GoRune);
          result.WriteString(Itoa(pi));
        }
        name = Parser_addTransformedReparse(receiver, NewIdentifier(receiver!.factory, result.String()), name);
      } else {
        name = Parser_addDeepCloneReparse(receiver, name);
      }
      parameter = NewParameterDeclaration(receiver!.factory, undefined, dotDotDotToken, name, Parser_makeQuestionIfOptional(receiver, jsparam), paramType, undefined);
    } else {
      continue;
    }
    Parser_finishReparsedNode(receiver, parameter, param);
    parameters = GoSliceAppend(parameters, parameter, GoPointerValueOps<Node>());
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.reparseJSDocTypeLiteral","kind":"method","status":"implemented","sigHash":"a4682e2befe712409f58292eb3e2e7bdfcd956b87fb6e48257915874b23e5898"}
 *
 * Go source:
...
export function Parser_reparseJSDocTypeLiteral(receiver: GoPtr<Parser>, t: GoPtr<TypeNode>): GoPtr<Node> {
  ...
  if (t!.Kind === KindJSDocTypeLiteral) {
    ...
    for (
      ...
      if (IsIdentifier(name) && !IsValidIdentifier(AsIdentifier(name)!.Text)) {
        name = Parser_addTransformedReparse(receiver, NewStringLiteral(receiver!.factory, AsIdentifier(name)!.Text, TokenFlagsNone), name);
      } else {
        name = Parser_addDeepCloneReparse(receiver, name);
      }
      const property = NewPropertySignatureDeclaration(receiver!.factory, undefined, name, Parser_makeQuestionIfOptional(receiver, jsprop), undefined, undefined);
      ...
      properties = GoSliceAppend(properties, property, GoPointerValueOps<Node>());
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.reparseJSDocComment","kind":"method","status":"implemented","sigHash":"1b89b82a4a8e5627bb168423057de736be8c1037bc00868867f2b458895009ab"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.gatherTypeParameters","kind":"method","status":"implemented","sigHash":"43f0d6f493087eed5129a7a79dffa8a85837816d7f074838dfcd6cd082d5f4b0"}
 *
 * Go source:
    ...
    for (
      ...
      if (constraint !== undefined && firstTypeParameter) {
        reparse = NewTypeParameterDeclaration(
          ...
          Parser_addDeepCloneReparse(receiver, Parser_checkNonIdentifierName(receiver, Node_Name(tp))),
      ...
      typeParameters = GoSliceAppend(typeParameters, reparse, GoPointerValueOps<Node>());
      firstTypeParameter = false;
    }
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.reparseHosted","kind":"method","status":"implemented","sigHash":"58c0beaf2d77b4b5417d21aa21df5af9e683885ced520fefffc94702c21dffea"}
 *
 * Go source:
    ...
    case KindJSDocTemplateTag: {
      ...
      if (fun !== undefined) {
        ...
        if (cls!.TypeParameters === undefined) {
          cls!.TypeParameters = Parser_gatherTypeParameters(receiver, jsDoc, false as bool);
          Parser_finishMutatedNode(receiver, parent);
        }
      ...
      if (cls !== undefined) {
        ...
        if (cls!.HeritageClauses !== undefined) {
          ...
          if (implementsClause !== undefined) {
            AsHeritageClause(implementsClause)!.Types!.Nodes = GoSliceAppend(AsHeritageClause(implementsClause)!.Types!.Nodes, Parser_addDeepCloneReparse(receiver, implementsTag!.ClassName), GoPointerValueOps<Node>());
        ...
        if (cls!.HeritageClauses === undefined) {
          ...
          cls!.HeritageClauses!.Nodes = GoSliceAppend(cls!.HeritageClauses!.Nodes, heritageClause, GoPointerValueOps<Node>());
        }
        Parser_finishMutatedNode(receiver, parent);
      }
      break;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.makeQuestionIfOptional","kind":"method","status":"implemented","sigHash":"f9013aff64b81e1ab037bb03d2040bdb4dd13a70f164a79121dee270d156ca2b"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::func::findMatchingParameter","kind":"func","status":"implemented","sigHash":"6896d32d45ce17714e39b6bb9fc480642f5d9384d208a3451965710159c2dce7"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::func::skipSatisfiesExpressions","kind":"func","status":"implemented","sigHash":"3f87a14e41b7b52a06015c68a0acf5ff4c16ae9bb20e0bceb2e16d7b09749439"}
 *
 * Go source:
 ...
 * }
 */
export function skipSatisfiesExpressions(node: GoPtr<Node>): GoPtr<Node> {
  let current: GoPtr<Node> = node;
  while (current !== undefined && current!.Kind === KindSatisfiesExpression) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::func::getFunctionLikeHost","kind":"func","status":"implemented","sigHash":"e903b09f9d78eb4f62c4bd055e03147abe72b6be14628ae8746d6b00f18265c6"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.makeNewCast","kind":"method","status":"implemented","sigHash":"5ff33fdd9fdba0845585d01a806e43db99a2e9eef89bbf092761298104a2c32b"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::func::getClassLikeData","kind":"func","status":"implemented","sigHash":"f5b050cea08cf21dbcfb7234f0bdcd87842be15166d32dcca70319d727b19b14"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/parser/reparser.go::method::Parser.createExportModifier","kind":"method","status":"implemented","sigHash":"8a681798c73d7510f8f21da461a1904d3a7f52cf3cf7087e256ee55e6f18b73a"}
 *
 * Go source:
 ...
 * }
 */
export function Parser_createExportModifier(receiver: GoPtr<Parser>, locationNode: GoPtr<Node>): GoPtr<ModifierList> {
  const exportModifier = NodeFactory_NewModifier(receiver!.factory, KindExportKeyword);
  exportModifier!.Loc = locationNode!.Loc;
 ...
 * }
 */
export function Parser_getInnermostNameOfJSDocNamespace(receiver: GoPtr<Parser>, fullName: GoPtr<Node>): GoPtr<Node> {
  if (fullName === undefined) {
    return undefined;
  }
  let current: GoPtr<Node> = fullName;
  while (current!.Kind === KindModuleDeclaration) {
 ...
 * }
 */
export function Parser_wrapInJSDocNamespace(receiver: GoPtr<Parser>, fullName: GoPtr<Node>, statement: GoPtr<Node>, nested: bool): GoPtr<Node> {
  ...
  // exported only in module files via IsImplicitlyExportedJSDocDeclaration (in the binder), so it
  // does not get an explicit export modifier here.
  const wrapped = Parser_wrapInJSDocNamespace(receiver, Node_Body(fullName), statement, true as bool);
  ...
  receiver!.reparsedClones = GoSliceAppend(receiver!.reparsedClones, result, GoPointerValueOps<Node>());
  return result;
}
