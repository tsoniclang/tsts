 ...
 * }
 */
export function FailBadSyntaxKind(node: GoInterface<{ KindString(): string }>, message: GoSlice<GoInterface<unknown>>): void {
 ...
 * }
 */
export function AssertNever(member: GoInterface<unknown>, message: GoSlice<GoInterface<unknown>>): void {
 ...
 * }
 */
export function Assert(value: bool, message: GoSlice<GoInterface<unknown>>): void {
  if (value) {
    return;
  }
  assertSlow(...message);
 ...
 * }
 */
export function assertSlow(message: GoSlice<GoInterface<unknown>>): void {
  // See https://dave.cheney.net/2020/05/02/mid-stack-inlining-in-go
