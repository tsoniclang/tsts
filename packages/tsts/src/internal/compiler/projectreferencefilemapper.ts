 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"projectReferenceFileMapper.host is required while project references, redirects, and symlink mappings are populated, then fileLoader deliberately clears it after transferring the host into the resolver to release that lifecycle dependency. Mapper methods that dereference host run before the clear; TypeScript undefined preserves the explicit post-initialization released state.","goSignature":"interface{configToProjectReference:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::ParsedCommandLine>>;host:packages/tsts/src/internal/module/types.ts::ResolutionHost;loader:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/compiler/fileloader.ts::fileLoader>;opts:packages/tsts/src/internal/compiler/program.ts::ProgramOptions;outputDtsToProjectReference:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::SourceOutputAndProjectReference>>;realpathDtsToSource:packages/tsts/src/internal/collections/syncmap.ts::SyncMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::SourceOutputAndProjectReference>>;referencesInConfigFile:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/tspath/path.ts::Path>>;sourceToProjectReference:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::SourceOutputAndProjectReference>>}","tsSignature":"interface{configToProjectReference:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::ParsedCommandLine>>;host:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/module/types.ts::ResolutionHost>;loader:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/compiler/fileloader.ts::fileLoader>;opts:packages/tsts/src/internal/compiler/program.ts::ProgramOptions;outputDtsToProjectReference:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::SourceOutputAndProjectReference>>;realpathDtsToSource:packages/tsts/src/internal/collections/syncmap.ts::SyncMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::SourceOutputAndProjectReference>>;referencesInConfigFile:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/tspath/path.ts::Path>>;sourceToProjectReference:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::SourceOutputAndProjectReference>>}"}
 *
 * Go source:
