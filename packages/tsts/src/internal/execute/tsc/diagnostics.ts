 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"CreateBuilderStatusReporter receives a nil Go CommandLineTesting interface outside tests and conditionally emits testing callbacks only when present; TypeScript represents that argument with undefined.","goSignature":"func(packages/tsts/src/internal/execute/tsc/compile.ts::System,packages/tsts/src/go/io.ts::Writer,packages/tsts/src/internal/locale/locale.ts::Locale,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>,packages/tsts/src/internal/execute/tsc/compile.ts::CommandLineTesting)=>packages/tsts/src/internal/execute/tsc/diagnostics.ts::DiagnosticReporter","tsSignature":"func(packages/tsts/src/internal/execute/tsc/compile.ts::System,packages/tsts/src/go/io.ts::Writer,packages/tsts/src/internal/locale/locale.ts::Locale,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>,packages/tsts/src/internal/execute/tsc/compile.ts::CommandLineTesting|undefined)=>packages/tsts/src/internal/execute/tsc/diagnostics.ts::DiagnosticReporter"}
 *
 * Go source:
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"CreateWatchStatusReporter receives a nil Go CommandLineTesting interface outside tests and conditionally emits testing callbacks only when present; TypeScript represents that argument with undefined.","goSignature":"func(packages/tsts/src/internal/execute/tsc/compile.ts::System,packages/tsts/src/internal/locale/locale.ts::Locale,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>,packages/tsts/src/internal/execute/tsc/compile.ts::CommandLineTesting)=>packages/tsts/src/internal/execute/tsc/diagnostics.ts::DiagnosticReporter","tsSignature":"func(packages/tsts/src/internal/execute/tsc/compile.ts::System,packages/tsts/src/internal/locale/locale.ts::Locale,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>,packages/tsts/src/internal/execute/tsc/compile.ts::CommandLineTesting|undefined)=>packages/tsts/src/internal/execute/tsc/diagnostics.ts::DiagnosticReporter"}
 *
 * Go source:
