...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/ast/nodeflags.go::type::NodeFlags","kind":"type","status":"implemented","sigHash":"1ab8cedf51e53d4d4a76535f180fa467201a4ee1d08d7a155aaeb2a90ab16ad7"}
 *
 * Go source:
 * NodeFlags uint32
 */
...
export const NodeFlagsBlockScoped: NodeFlags = NodeFlagsLet | NodeFlagsConst | NodeFlagsUsing;
export const NodeFlagsConstant: NodeFlags = NodeFlagsConst | NodeFlagsUsing;
export const NodeFlagsAwaitUsing: NodeFlags = NodeFlagsConst | NodeFlagsUsing;
export const NodeFlagsReachabilityCheckFlags: NodeFlags = NodeFlagsHasImplicitReturn | NodeFlagsHasExplicitReturn;
export const NodeFlagsReachabilityAndEmitFlags: NodeFlags = NodeFlagsReachabilityCheckFlags | NodeFlagsHasAsyncFunctions;
