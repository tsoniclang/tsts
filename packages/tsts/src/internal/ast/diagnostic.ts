 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"A zero-value DiagnosticsCollection begins with a nil fileDiagnostics map and nil nonFileDiagnostics slice. Add allocates the map only for the first file diagnostic and appends the first global diagnostic from nil; all getters and sorting paths treat those absent values as empty, so undefined preserves the observable zero-value state.","goSignature":"interface{count:packages/tsts/src/go/scalars.ts::int;fileDiagnostics:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/diagnostic.ts::Diagnostic>>>;fileDiagnosticsSorted:packages/tsts/src/internal/collections/set.ts::Set<string>;mu:packages/tsts/src/go/sync.ts::Mutex;nonFileDiagnostics:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/diagnostic.ts::Diagnostic>>;nonFileDiagnosticsSorted:packages/tsts/src/go/scalars.ts::bool}","tsSignature":"interface{count:packages/tsts/src/go/scalars.ts::int;fileDiagnostics:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/diagnostic.ts::Diagnostic>>>|undefined;fileDiagnosticsSorted:packages/tsts/src/internal/collections/set.ts::Set<string>;mu:packages/tsts/src/go/sync.ts::Mutex;nonFileDiagnostics:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/diagnostic.ts::Diagnostic>>|undefined;nonFileDiagnosticsSorted:packages/tsts/src/go/scalars.ts::bool}"}
 *
 * Go source:
