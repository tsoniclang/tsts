...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/ast/positionmap.go::type::PositionMap","kind":"type","status":"implemented","sigHash":"93e2eea0070b4da82e80eaad61950136ca088819c05d8f39d199cb5ca6474979"}
 *
 * Go source:
 * PositionMap struct {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/ast/positionmap.go::type::positionMapEntry","kind":"type","status":"implemented","sigHash":"d245f4272a4966401a728176db2f224b292afe693ded61f19caeb45f9f902f67"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/ast/positionmap.go::func::ComputePositionMap","kind":"func","status":"implemented","sigHash":"5e0ac0f0ca501aaee7eee09b4ad18047089354c6b88dda4cfdf4da8b2da299da"}
 *
 * Go source:
...
export function ComputePositionMap(text: string): GoPtr<PositionMap> {
  ...
  while (i < n) {
    ...
    delta += size - utf16Size;
    entries = GoAppend(entries, { utf8Pos: i + size, delta: delta });
    i += size;
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/ast/positionmap.go::method::PositionMap.IsAsciiOnly","kind":"method","status":"implemented","sigHash":"d8ef8a138dcae1d2f55676838832c57491a503b95713e1632ee0f947085dd55f"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/ast/positionmap.go::method::PositionMap.UTF8ToUTF16","kind":"method","status":"implemented","sigHash":"99597dbae1cb7a14ed5a2128325a80f2e05ba1c0a160c6bd38a0091d0b900791"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/ast/positionmap.go::method::PositionMap.UTF16ToUTF8","kind":"method","status":"implemented","sigHash":"b850c9713fc0bcead39524d3b4194a90e46d3938d3f204453eea34025d5607c6"}
 *
 * Go source:
