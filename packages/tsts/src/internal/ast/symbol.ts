 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Go symbols begin with nil declaration slices and nil member/export maps and allocate each only when populated; GoPtr preserves those zero-value states without changing populated ordering or lookup semantics.","goSignature":"interface{CheckFlags:packages/tsts/src/internal/ast/checkflags.ts::CheckFlags;Declarations:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;ExportSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;Exports:packages/tsts/src/internal/ast/symbol.ts::SymbolTable;Flags:packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags;Members:packages/tsts/src/internal/ast/symbol.ts::SymbolTable;Name:string;Parent:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;ValueDeclaration:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;id:packages/tsts/src/go/sync/atomic.ts::Uint64}","tsSignature":"interface{CheckFlags:packages/tsts/src/internal/ast/checkflags.ts::CheckFlags;Declarations:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>>;ExportSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;Exports:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::SymbolTable>;Flags:packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags;Members:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::SymbolTable>;Name:string;Parent:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;ValueDeclaration:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;id:packages/tsts/src/go/sync/atomic.ts::Uint64}"}
 *
 * Go source:
 * Symbol struct {
 * 	Flags            SymbolFlags
