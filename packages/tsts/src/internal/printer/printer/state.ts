...
export interface Printer {
  ...
  inExtends: bool;
  nameGenerator: NameGenerator;
  makeFileLevelOptimisticUniqueName: GoPtr<(arg0: string) => string>;
...
export function Printer_Writer(receiver: GoPtr<Printer>): EmitTextWriter {
  if (receiver === undefined || receiver.writer === undefined) {
    throw new globalThis.Error("nil Printer.writer");
  }
  return receiver.writer;
}

export function Printer_SourceMapSource(receiver: GoPtr<Printer>): Source {
  if (receiver === undefined || receiver.sourceMapSource === undefined) {
    throw new globalThis.Error("nil Printer.sourceMapSource");
  }
  return receiver.sourceMapSource;
}

export function Printer_MakeFileLevelOptimisticUniqueName(receiver: GoPtr<Printer>, name: string): string {
  if (receiver === undefined || receiver.makeFileLevelOptimisticUniqueName === undefined) {
    throw new globalThis.Error("nil Printer.makeFileLevelOptimisticUniqueName");
  }
  return receiver.makeFileLevelOptimisticUniqueName(name);
}
