 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"EmitHelper has two independent Go zero-value sentinels: TextCallback is nil for helpers backed by static Text, and Dependencies is nil for helpers with no prerequisites. Emission tests TextCallback before calling it and ranges Dependencies as an empty list, while helper declarations exercise both nil and populated states.","goSignature":"interface{Dependencies:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/printer/helpers.ts::EmitHelper>>;ImportName:string;Name:string;Priority:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/printer/helpers.ts::Priority>;Scoped:packages/tsts/src/go/scalars.ts::bool;Text:string;TextCallback:((string)=>string)=>string}","tsSignature":"interface{Dependencies:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/printer/helpers.ts::EmitHelper>>>;ImportName:string;Name:string;Priority:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/printer/helpers.ts::Priority>;Scoped:packages/tsts/src/go/scalars.ts::bool;Text:string;TextCallback:packages/tsts/src/go/compat.ts::GoPtr<((string)=>string)=>string>}"}
 *
 * Go source:
 * EmitHelper struct {
