// Mirror of internal/printer/printer_test.go TestEmit (full table), with
// testutil/parsetestutil.ParseTypeScript and testutil/emittestutil.CheckEmit
// inlined (testutil is suite-side in TSTS). Entries commented out upstream
// (trailing-comma preservation TODOs) stay commented out here. The
// TestParenthesize* / transform tests build synthetic AST via the factory and
...
const data: Array<{ title: string; input: string; output: string; jsx?: boolean }> = [
