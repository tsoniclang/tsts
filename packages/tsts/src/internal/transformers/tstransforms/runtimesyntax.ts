 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"TS-Go uses a nil first-declaration map outside runtime-syntax scopes and returns/restores that nil value across pushScope/popScope; TypeScript represents the nil map as undefined because JavaScript Map has no Go nil map value. Scope transitions and populated entries remain identical.","goSignature":"interface{__tsgoEmbedded0?:packages/tsts/src/internal/transformers/transformer.ts::Transformer;compilerOptions:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>;currentEnum:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::EnumDeclarationNode>;currentNamespace:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::ModuleDeclarationNode>;currentNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;currentScope:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;currentScopeFirstDeclarationsOfName:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;currentSourceFile:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;emitResolver:packages/tsts/src/internal/printer/emitresolver.ts::EmitResolver;parentNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;resolver:packages/tsts/src/internal/binder/referenceresolver.ts::ReferenceResolver}","tsSignature":"interface{__tsgoEmbedded0?:packages/tsts/src/internal/transformers/transformer.ts::Transformer;compilerOptions:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>;currentEnum:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::EnumDeclarationNode>;currentNamespace:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::ModuleDeclarationNode>;currentNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;currentScope:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;currentScopeFirstDeclarationsOfName:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>|undefined;currentSourceFile:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;emitResolver:packages/tsts/src/internal/printer/emitresolver.ts::EmitResolver;parentNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;resolver:packages/tsts/src/internal/binder/referenceresolver.ts::ReferenceResolver}"}
 *
 * Go source:
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"pushScope returns the prior first-declaration map so popScope can restore it; the prior value is nil at the outermost scope. TypeScript returns undefined for that outer no-scope state and a Map for nested scopes.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/transformers/tstransforms/runtimesyntax.ts::RuntimeSyntaxTransformer>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>)=>[packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>]","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/transformers/tstransforms/runtimesyntax.ts::RuntimeSyntaxTransformer>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>)=>[packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>|undefined]"}
 *
 * Go source:
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"The saved first-declaration map can be nil when pushScope entered from outside any runtime-syntax scope. popScope restores that exact no-scope state; TypeScript uses undefined for the saved nil map and otherwise restores the original Map identity.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/transformers/tstransforms/runtimesyntax.ts::RuntimeSyntaxTransformer>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>)=>void","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/transformers/tstransforms/runtimesyntax.ts::RuntimeSyntaxTransformer>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>|undefined)=>void"}
 *
 * Go source:
