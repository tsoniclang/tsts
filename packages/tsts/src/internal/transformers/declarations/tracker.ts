 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"NewDeclarationTransformer allocates shared state before assigning the reportExpandoFunctionErrors closure that captures the transformer; no tracker path calls it before assignment, and all later isolated-declaration paths require it. TypeScript uses undefined only during that constructor staging interval.","goSignature":"interface{currentSourceFile:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>;diagnostics:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/diagnostic.ts::Diagnostic>>;errorNameNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;getSymbolAccessibilityDiagnostic:packages/tsts/src/internal/transformers/declarations/diagnostics.ts::GetSymbolAccessibilityDiagnostic;isolatedDeclarations:packages/tsts/src/go/scalars.ts::bool;lateMarkedStatements:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;reportExpandoFunctionErrors:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>)=>void;resolver:packages/tsts/src/internal/printer/emitresolver.ts::EmitResolver;stripInternal:packages/tsts/src/go/scalars.ts::bool}","tsSignature":"interface{currentSourceFile:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>;diagnostics:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/diagnostic.ts::Diagnostic>>;errorNameNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;getSymbolAccessibilityDiagnostic:packages/tsts/src/internal/transformers/declarations/diagnostics.ts::GetSymbolAccessibilityDiagnostic;isolatedDeclarations:packages/tsts/src/go/scalars.ts::bool;lateMarkedStatements:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;reportExpandoFunctionErrors:packages/tsts/src/go/compat.ts::GoPtr<(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>)=>void>;resolver:packages/tsts/src/internal/printer/emitresolver.ts::EmitResolver;stripInternal:packages/tsts/src/go/scalars.ts::bool}"}
 *
 * Go source:
