 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"NameResolver has three intentional construction profiles: referenceResolver lazily creates a fallback with only CompilerOptions, the checker creates the complete resolver, and suggestion lookup omits only the three reporting callbacks. Every receiver helper checks a missing callback or uses the upstream default before invocation; symbol/map fields retain Go zero values, and Lookup additionally accepts nil SymbolTable for unallocated scopes.","goSignature":"interface{ArgumentsSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;CompilerOptions:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>;Error:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/diagnostics/diagnostics.ts::Message>,...unknown[])=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/diagnostic.ts::Diagnostic>;GetRequiresScopeChangeCache:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>)=>packages/tsts/src/internal/core/tristate.ts::Tristate;GetSymbolOfDeclaration:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;Globals:packages/tsts/src/internal/ast/symbol.ts::SymbolTable;Lookup:(packages/tsts/src/internal/ast/symbol.ts::SymbolTable,string,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;OnFailedToResolveSymbol:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,string,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/diagnostics/diagnostics.ts::Message>)=>void;OnPropertyWithInvalidInitializer:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>)=>packages/tsts/src/go/scalars.ts::bool;OnSuccessfullyResolvedSymbol:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/scalars.ts::bool)=>void;RequireSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;SetRequiresScopeChangeCache:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/core/tristate.ts::Tristate)=>void;SymbolReferenced:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags)=>void}","tsSignature":"interface{ArgumentsSymbol?:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;CompilerOptions:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>;Error?:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/diagnostics/diagnostics.ts::Message>,...unknown[])=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/diagnostic.ts::Diagnostic>;GetRequiresScopeChangeCache?:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>)=>packages/tsts/src/internal/core/tristate.ts::Tristate;GetSymbolOfDeclaration?:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;Globals?:packages/tsts/src/internal/ast/symbol.ts::SymbolTable;Lookup?:(packages/tsts/src/internal/ast/symbol.ts::SymbolTable|undefined,string,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;OnFailedToResolveSymbol?:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,string,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/diagnostics/diagnostics.ts::Message>)=>void;OnPropertyWithInvalidInitializer?:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>)=>packages/tsts/src/go/scalars.ts::bool;OnSuccessfullyResolvedSymbol?:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/scalars.ts::bool)=>void;RequireSymbol?:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;SetRequiresScopeChangeCache?:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/core/tristate.ts::Tristate)=>void;SymbolReferenced?:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags)=>void}"}
 *
 * Go source:
 * NameResolver struct {
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"NameResolver.lookup receives a nil SymbolTable for scopes with no locals or exports; optional map access returns the nil symbol result exactly as lookup on a Go nil map does.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/binder/nameresolver.ts::NameResolver>,packages/tsts/src/internal/ast/symbol.ts::SymbolTable,string,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/binder/nameresolver.ts::NameResolver>,packages/tsts/src/internal/ast/symbol.ts::SymbolTable|undefined,string,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>"}
 *
 * Go source:
