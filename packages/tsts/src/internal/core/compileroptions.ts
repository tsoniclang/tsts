...
type compilerOptionsJsonFields = JsonFieldNamesForGoStructContract<
  ...
  {
    AllowJs: { name: "allowJs", omitZero: true },
    AllowArbitraryExtensions: { name: "allowArbitraryExtensions", omitZero: true },
    AllowImportingTsExtensions: { name: "allowImportingTsExtensions", omitZero: true },
    AllowNonTsExtensions: { name: "allowNonTsExtensions", omitZero: true },
    AllowUmdGlobalAccess: { name: "allowUmdGlobalAccess", omitZero: true },
    AllowUnreachableCode: { name: "allowUnreachableCode", omitZero: true },
    AllowUnusedLabels: { name: "allowUnusedLabels", omitZero: true },
    AssumeChangesOnlyAffectDirectDependencies: { name: "assumeChangesOnlyAffectDirectDependencies", omitZero: true },
    CheckJs: { name: "checkJs", omitZero: true },
    CustomConditions: { name: "customConditions", omitZero: true },
    Composite: { name: "composite", omitZero: true },
    EmitDeclarationOnly: { name: "emitDeclarationOnly", omitZero: true },
    EmitBOM: { name: "emitBOM", omitZero: true },
    EmitDecoratorMetadata: { name: "emitDecoratorMetadata", omitZero: true },
    Declaration: { name: "declaration", omitZero: true },
    DeclarationDir: { name: "declarationDir", omitZero: true },
    DeclarationMap: { name: "declarationMap", omitZero: true },
    DeduplicatePackages: { name: "deduplicatePackages", omitZero: true },
    DisableSizeLimit: { name: "disableSizeLimit", omitZero: true },
    DisableSourceOfProjectReferenceRedirect: { name: "disableSourceOfProjectReferenceRedirect", omitZero: true },
    DisableSolutionSearching: { name: "disableSolutionSearching", omitZero: true },
    DisableReferencedProjectLoad: { name: "disableReferencedProjectLoad", omitZero: true },
    ErasableSyntaxOnly: { name: "erasableSyntaxOnly", omitZero: true },
    ExactOptionalPropertyTypes: { name: "exactOptionalPropertyTypes", omitZero: true },
    ExperimentalDecorators: { name: "experimentalDecorators", omitZero: true },
    ForceConsistentCasingInFileNames: { name: "forceConsistentCasingInFileNames", omitZero: true },
    IsolatedModules: { name: "isolatedModules", omitZero: true },
    IsolatedDeclarations: { name: "isolatedDeclarations", omitZero: true },
    IgnoreConfig: { name: "ignoreConfig", omitZero: true },
    IgnoreDeprecations: { name: "ignoreDeprecations", omitZero: true },
    ImportHelpers: { name: "importHelpers", omitZero: true },
    InlineSourceMap: { name: "inlineSourceMap", omitZero: true },
    InlineSources: { name: "inlineSources", omitZero: true },
    Init: { name: "init", omitZero: true },
    Incremental: { name: "incremental", omitZero: true },
    Jsx: { name: "jsx", omitZero: true },
    JsxFactory: { name: "jsxFactory", omitZero: true },
    JsxFragmentFactory: { name: "jsxFragmentFactory", omitZero: true },
    JsxImportSource: { name: "jsxImportSource", omitZero: true },
    Lib: { name: "lib", omitZero: true },
    LibReplacement: { name: "libReplacement", omitZero: true },
    Locale: { name: "locale", omitZero: true },
    MapRoot: { name: "mapRoot", omitZero: true },
    Module: { name: "module", omitZero: true },
    ModuleResolution: { name: "moduleResolution", omitZero: true },
    ModuleSuffixes: { name: "moduleSuffixes", omitZero: true },
    ModuleDetection: { name: "moduleDetection", omitZero: true },
    NewLine: { name: "newLine", omitZero: true },
    NoEmit: { name: "noEmit", omitZero: true },
    NoCheck: { name: "noCheck", omitZero: true },
    NoErrorTruncation: { name: "noErrorTruncation", omitZero: true },
    NoFallthroughCasesInSwitch: { name: "noFallthroughCasesInSwitch", omitZero: true },
    NoImplicitAny: { name: "noImplicitAny", omitZero: true },
    NoImplicitThis: { name: "noImplicitThis", omitZero: true },
    NoImplicitReturns: { name: "noImplicitReturns", omitZero: true },
    NoEmitHelpers: { name: "noEmitHelpers", omitZero: true },
    NoLib: { name: "noLib", omitZero: true },
    NoPropertyAccessFromIndexSignature: { name: "noPropertyAccessFromIndexSignature", omitZero: true },
    NoUncheckedIndexedAccess: { name: "noUncheckedIndexedAccess", omitZero: true },
    NoEmitOnError: { name: "noEmitOnError", omitZero: true },
    NoUnusedLocals: { name: "noUnusedLocals", omitZero: true },
    NoUnusedParameters: { name: "noUnusedParameters", omitZero: true },
    NoResolve: { name: "noResolve", omitZero: true },
    NoImplicitOverride: { name: "noImplicitOverride", omitZero: true },
    NoUncheckedSideEffectImports: { name: "noUncheckedSideEffectImports", omitZero: true },
    OutDir: { name: "outDir", omitZero: true },
    Paths: { name: "paths", omitZero: true },
    PreserveConstEnums: { name: "preserveConstEnums", omitZero: true },
    PreserveSymlinks: { name: "preserveSymlinks", omitZero: true },
    Project: { name: "project", omitZero: true },
    ResolveJsonModule: { name: "resolveJsonModule", omitZero: true },
    ResolvePackageJsonExports: { name: "resolvePackageJsonExports", omitZero: true },
    ResolvePackageJsonImports: { name: "resolvePackageJsonImports", omitZero: true },
    RemoveComments: { name: "removeComments", omitZero: true },
    RewriteRelativeImportExtensions: { name: "rewriteRelativeImportExtensions", omitZero: true },
    ReactNamespace: { name: "reactNamespace", omitZero: true },
    RootDir: { name: "rootDir", omitZero: true },
    RootDirs: { name: "rootDirs", omitZero: true },
    SkipLibCheck: { name: "skipLibCheck", omitZero: true },
    StableTypeOrdering: { name: "stableTypeOrdering", omitZero: true },
    Strict: { name: "strict", omitZero: true },
    StrictBindCallApply: { name: "strictBindCallApply", omitZero: true },
    StrictBuiltinIteratorReturn: { name: "strictBuiltinIteratorReturn", omitZero: true },
    StrictFunctionTypes: { name: "strictFunctionTypes", omitZero: true },
    StrictNullChecks: { name: "strictNullChecks", omitZero: true },
    StrictPropertyInitialization: { name: "strictPropertyInitialization", omitZero: true },
    StripInternal: { name: "stripInternal", omitZero: true },
    SkipDefaultLibCheck: { name: "skipDefaultLibCheck", omitZero: true },
    SourceMap: { name: "sourceMap", omitZero: true },
    SourceRoot: { name: "sourceRoot", omitZero: true },
    SuppressOutputPathCheck: { name: "suppressOutputPathCheck", omitZero: true },
    Target: { name: "target", omitZero: true },
    TraceResolution: { name: "traceResolution", omitZero: true },
    TsBuildInfoFile: { name: "tsBuildInfoFile", omitZero: true },
    TypeRoots: { name: "typeRoots", omitZero: true },
    Types: { name: "types", omitZero: true },
    UseDefineForClassFields: { name: "useDefineForClassFields", omitZero: true },
    UseUnknownInCatchVariables: { name: "useUnknownInCatchVariables", omitZero: true },
    VerbatimModuleSyntax: { name: "verbatimModuleSyntax", omitZero: true },
    MaxNodeModuleJsDepth: { name: "maxNodeModuleJsDepth", omitZero: true },
    AllowSyntheticDefaultImports: { name: "allowSyntheticDefaultImports", omitZero: true },
    AlwaysStrict: { name: "alwaysStrict", omitZero: true },
    BaseUrl: { name: "baseUrl", omitZero: true },
    DownlevelIteration: { name: "downlevelIteration", omitZero: true },
    ESModuleInterop: { name: "esModuleInterop", omitZero: true },
    OutFile: { name: "outFile", omitZero: true },
    ConfigFilePath: { name: "configFilePath", omitZero: true },
    NoDtsResolution: { name: "noDtsResolution", omitZero: true },
    PathsBasePath: { name: "pathsBasePath", omitZero: true },
    Diagnostics: { name: "diagnostics", omitZero: true },
    ExtendedDiagnostics: { name: "extendedDiagnostics", omitZero: true },
    GenerateCpuProfile: { name: "generateCpuProfile", omitZero: true },
    GenerateTrace: { name: "generateTrace", omitZero: true },
    ListEmittedFiles: { name: "listEmittedFiles", omitZero: true },
    ListFiles: { name: "listFiles", omitZero: true },
    ExplainFiles: { name: "explainFiles", omitZero: true },
    ListFilesOnly: { name: "listFilesOnly", omitZero: true },
    NoEmitForJsFiles: { name: "noEmitForJsFiles", omitZero: true },
    PreserveWatchOutput: { name: "preserveWatchOutput", omitZero: true },
    Pretty: { name: "pretty", omitZero: true },
    Version: { name: "version", omitZero: true },
    Watch: { name: "watch", omitZero: true },
    ShowConfig: { name: "showConfig", omitZero: true },
    Build: { name: "build", omitZero: true },
    Help: { name: "help", omitZero: true },
    All: { name: "all", omitZero: true },
    PprofDir: { name: "pprofDir", omitZero: true },
    SingleThreaded: { name: "singleThreaded", omitZero: true },
    Quiet: { name: "quiet", omitZero: true },
    Checkers: { name: "checkers", omitZero: true },
  },
  "source-metadata",
  "Compiler-option JSON identities are consumed by the explicit option declaration and serialization machinery rather than generic struct marshaling."
>;
