 ...
 * @tsgo-override {"category":"extension-host","allow":["body"],"reason":"Provider virtual modules are compiler-owned in-memory TypeScript source created by source declaration provider resolution, not arbitrary physical extensions; physical module diagnostics stay on the exact TS-Go switch."}
 *
 * Go source:
