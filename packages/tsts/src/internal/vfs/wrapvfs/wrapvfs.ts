 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Either the replacement Stat function or the wrapped FS may return nil FileInfo for a missing path; wrappedFS_Stat selects the configured source and preserves its undefined result.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/vfs/wrapvfs/wrapvfs.ts::wrappedFS>,string)=>packages/tsts/src/internal/vfs/vfs.ts::FileInfo","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/vfs/wrapvfs/wrapvfs.ts::wrappedFS>,string)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/vfs/vfs.ts::FileInfo>"}
 *
 * Go source:
