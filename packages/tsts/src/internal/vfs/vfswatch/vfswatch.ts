...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::constGroup::debounceWait","kind":"constGroup","status":"stub","sigHash":"f0405f6968bf836178ce5e5c5e3f83bc8b5b5bbbc33835ceb58da9e6c56eb481","bodyHash":"ae5f9b4ae4d34fa60e4748a322897faaa08a33a74736f79a582dec36d40d8589"}
 *
 * Go source:
 * const debounceWait = 250 * time.Millisecond
 */
export const debounceWait: int = undefined as never;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::func::NewFileWatcher","kind":"func","status":"stub","sigHash":"10afa4c03f3ccb0b237a2e915cc834d6d05f87de4b7e5bbe2b05376dfe28c1b3","bodyHash":"d03787ca678ca7d03c0cd632c86a58f6159c0903ff9795d87eb63e99b549e67b"}
 *
 * Go source:
...
export function NewFileWatcher(fs: FS, pollInterval: Duration, testing: bool, callback: () => void): GoPtr<FileWatcher> {
  throw new globalThis.Error("TSGO_UNIMPLEMENTED github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::func::NewFileWatcher");
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.SetPollInterval","kind":"method","status":"stub","sigHash":"27aa3f4b2a0e07e417f528ae8c35e8365dd1ce79419ca90db18121ed6d407beb","bodyHash":"fa63f0d83b38b66d12998e751bec28e9f363282cf3c04c6458124dd4fdb3abad"}
 *
 * Go source:
...
export function FileWatcher_SetPollInterval(receiver: GoPtr<FileWatcher>, d: Duration): void {
  throw new globalThis.Error("TSGO_UNIMPLEMENTED github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.SetPollInterval");
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.WatchStateEntry","kind":"method","status":"stub","sigHash":"fe8c18bdf086fd12d9320b289ed74ac6f29c37949ea71a2cf985da85392fbc2f","bodyHash":"dfa5fb20cd1662a2e51eaa767104d5d155258cbed41378a5b8cc3f4201e0cfa2"}
 *
 * Go source:
...
export function FileWatcher_WatchStateEntry(receiver: GoPtr<FileWatcher>, path: string): [WatchEntry, bool] {
  throw new globalThis.Error("TSGO_UNIMPLEMENTED github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.WatchStateEntry");
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.WatchStateUninitialized","kind":"method","status":"stub","sigHash":"05661da46b39b7f1625c47ec6c7deb31e13c478253cfd1faa89b259b150e0944","bodyHash":"056c64de4e8684a03a4939dc4c82b0e1f6dac0194399b88a9abf0dfa1adc17a6"}
 *
 * Go source:
...
export function FileWatcher_WatchStateUninitialized(receiver: GoPtr<FileWatcher>): bool {
  throw new globalThis.Error("TSGO_UNIMPLEMENTED github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.WatchStateUninitialized");
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.UpdateWatchState","kind":"method","status":"stub","sigHash":"4726091c9178cc8696fab06d1b2c0ba8eae5ed435c793a9770e091ed1368aa88","bodyHash":"13a8d742c728fbfafc034fc2658cbc5b64996a13bcd72f6988683f27afd6c774"}
 *
 * Go source:
...
export function FileWatcher_UpdateWatchState(receiver: GoPtr<FileWatcher>, paths: GoSlice<string>, wildcardDirs: GoMap<string, bool>): void {
  throw new globalThis.Error("TSGO_UNIMPLEMENTED github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.UpdateWatchState");
}
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.currentState","kind":"method","status":"stub","sigHash":"e699601aad1c3327fcf2dea6db5764e23b457dc14bfbce637cb8fde2c7badd2e","bodyHash":"25dac90f1b10436fc7e60990368d10ad39b9c70f39c4a9856a4923c3199da4da"}
 *
 * Go source:
...
export function FileWatcher_currentState(receiver: GoPtr<FileWatcher>): GoMap<string, WatchEntry> {
  throw new globalThis.Error("TSGO_UNIMPLEMENTED github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.currentState");
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::func::snapshotPaths","kind":"func","status":"stub","sigHash":"829cea8f9a62c884ef701bac6e6c559cdcba8e9a52e482c4ba762671e4122051","bodyHash":"2058defb385da3410cddb0643f9120b1728b72a52b7a74daa100e885be8361db"}
 *
 * Go source:
...
export function snapshotPaths(fs: FS, paths: GoSlice<string>, wildcardDirs: GoMap<string, bool>): GoMap<string, WatchEntry> {
  throw new globalThis.Error("TSGO_UNIMPLEMENTED github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::func::snapshotPaths");
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::func::snapshotDirEntry","kind":"func","status":"stub","sigHash":"796a868c70c3beb292fff1b17ee3c1d4f1c47c84337f555b42b5a2cd494ff2bb","bodyHash":"bd604718e71f74ef56a01b43aada0b7b870246d1104e090fcf5a7d489f1f3eed"}
 *
 * Go source:
...
export function snapshotDirEntry(fs: FS, state: GoMap<string, WatchEntry>, dir: string): void {
  throw new globalThis.Error("TSGO_UNIMPLEMENTED github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::func::snapshotDirEntry");
}
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::func::dirChanged","kind":"func","status":"stub","sigHash":"fd6315920a54dee4293ccbc5ed20aa339f1159daff4abb261512a36cef4044c8","bodyHash":"27d3ee0ebcffb8710614531515990414cf27778989bff583dd3a8ac3b38e2047"}
 *
 * Go source:
...
export function dirChanged(fs: FS, baseline: GoMap<string, WatchEntry>, dir: string): bool {
  throw new globalThis.Error("TSGO_UNIMPLEMENTED github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::func::dirChanged");
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.hasChanges","kind":"method","status":"stub","sigHash":"68dcd45225e9be413b6fe3fcbc136fd044c4352599484f955756f33c08d79a74","bodyHash":"02d2105bfbb745aa31dab48e68c5871ed93724df998ab6b576ad3b231ff042af"}
 *
 * Go source:
...
export function FileWatcher_hasChanges(receiver: GoPtr<FileWatcher>, baseline: GoMap<string, WatchEntry>, wildcardDirs: GoMap<string, bool>): bool {
  throw new globalThis.Error("TSGO_UNIMPLEMENTED github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.hasChanges");
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.HasChangesFromWatchState","kind":"method","status":"stub","sigHash":"24e1f71273f5c54332955f9e73552aff791d3e3e4a82af46bc2119a71b1bdb1f","bodyHash":"ed8ac896a69b0c841d6773e99fb3a101eb55d1717279fc0106a5a66535fe3fca"}
 *
 * Go source:
...
export function FileWatcher_HasChangesFromWatchState(receiver: GoPtr<FileWatcher>): bool {
  throw new globalThis.Error("TSGO_UNIMPLEMENTED github.com/microsoft/typescript-go::internal/vfs/vfswatch/vfswatch.go::method::FileWatcher.HasChangesFromWatchState");
}
