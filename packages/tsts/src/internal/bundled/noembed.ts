...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/bundled/noembed.go::varGroup::executableDir","kind":"varGroup","status":"stub","sigHash":"aa8e3ebfca7d9cccb7ab7ee05165d0f86d20f1ef76c330b62a12e5bcba7feaf9","bodyHash":"1c4791ecc0bf4e25207c73785b83638b9b67990b9ce569bda195ded6ab995441"}
 *
 * Go source:
 ...
 * })
 */
export let executableDir: unknown = undefined as never;

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/bundled/noembed.go::varGroup::libPath","kind":"varGroup","status":"stub","sigHash":"ad0b589440958694bb78420c9845cb5295abbbd5d5d968a09b8ae66a4d24a2c9","bodyHash":"0805855c17fc690731ad6e7d79f21032892bcbd537bf8726c27fa086d4d5d613"}
 *
 * Go source:
 ...
 * })
 */
export let libPath: unknown = undefined as never;
