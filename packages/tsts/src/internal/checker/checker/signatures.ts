...
import type { ConstrainedType, ContextFlags, DeclaredTypeLinks, IndexInfo, ObjectFlags, Signature, SignatureFlags, SignatureKind, SignatureLinks, SymbolReferenceLinks, TupleElementInfo, Type, TypeAliasLinks, TypeComparer, TypeData, TypeFlags, TypeNodeLinks, TypeParameter, TypePredicate, TypeReference, ValueSymbolLinks } from "../types.js";
...
import type { CacheHashKey, CachedSignatureKey, CachedTypeKey, CallState, Checker, CheckMode, InferenceContext, InferenceInfo, InferencePriority, IterationTypeKind, IterationTypes, IterationUse, thisAssignmentDeclarationKind } from "./state.js";
...
import { GoSliceLoad, GoSliceValueOps, GoStringValueOps } from "../../../go/compat.js";
...
function goZeroSignatureLinks(): SignatureLinks {
  return {
...
function goZeroSignature(): Signature {
  return {
    ...
    typeParameters: GoNilSlice<GoPtr<Type>>(),
    parameters: GoNilSlice<GoPtr<Symbol>>(),
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.GetTypeAliasTypeParameters","kind":"method","status":"implemented","sigHash":"0b4f54cda41fb6e460b50792c13ecf63a5a90b07e65ca4c27484c2ebd3b2b5d9"}
 *
 * Go source:
...
export function Checker_GetTypeAliasTypeParameters(receiver: GoPtr<Checker>, symbol_: GoPtr<Symbol>): GoSlice<GoPtr<Type>> {
  ...
  return LinkStore_Get(receiver!.typeAliasLinks, symbol_, goZeroTypeAliasLinks, goSymbolPointerKey)!.v.typeParameters;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkTypeParameter","kind":"method","status":"implemented","sigHash":"524f6a368c829b48b95b04c38b139953ecebf792da7193fae57f76c74e3fae3e"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkTypeParameterDeferred","kind":"method","status":"implemented","sigHash":"b3bcbc71da94c565b8c0e264a97f8d1688c649e5898dba9ee12f6ee1f8c07d93"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkParameter","kind":"method","status":"implemented","sigHash":"ec485e18152549b84e14fd75537f34082f0e0977872c1234da46ae067b4147bf"}
 *
 * Go source:
...
export function Checker_checkParameter(receiver: GoPtr<Checker>, node: GoPtr<Node>): void {
  ...
  if (paramName === "this" || paramName === "new") {
    if (slices.Index(Node_Parameters(fn) ?? [], node, GoEqualStrict<GoPtr<Node>>) !== 0) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkPropertySignature","kind":"method","status":"implemented","sigHash":"65dd4330bba7198bffacacd361e8c652907aa800257cb7ac73d46e954910a4f0"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkSignatureDeclaration","kind":"method","status":"implemented","sigHash":"2a254eb72fc561201fb1f4d1545b11eb0e8531c4d6974eca781602945c69a83e"}
 *
 * Go source:
...
export function Checker_checkSignatureDeclaration(receiver: GoPtr<Checker>, node: GoPtr<Node>): void {
  ...
  Checker_checkTypeParameters(receiver, Node_TypeParameters(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()));
  Checker_checkUnmatchedJSDocParameters(receiver, node);
  Checker_checkSourceElements(receiver, Node_Parameters(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()));
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkAsyncFunctionReturnType","kind":"method","status":"implemented","sigHash":"d7176f199d4b54a18165f94ed38a576a5557365f30a838554f882472d50a49bd"}
 *
 * Go source:
...
export function Checker_checkAsyncFunctionReturnType(receiver: GoPtr<Checker>, node: GoPtr<Node>, returnTypeNode: GoPtr<Node>): void {
  ...
  if (globalPromiseType !== receiver!.emptyGenericType && !Checker_isReferenceToType(receiver, returnType, globalPromiseType)) {
    Checker_error(
      ...
      returnTypeNode,
      The_return_type_of_an_async_function_or_method_must_be_the_global_Promise_T_type_Did_you_mean_to_write_Promise_0,
      Checker_TypeToString(receiver, core.OrElse(Checker_getAwaitedTypeNoAlias(receiver, returnType), receiver!.voidType, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>)),
    );
    return;
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkConstructorDeclaration","kind":"method","status":"implemented","sigHash":"07e6c9b9b3b1076ce12fadeda9df28d44ff389367c0aa5542c1a15c61ce0d996"}
 *
 * Go source:
...
export function Checker_checkConstructorDeclaration(receiver: GoPtr<Checker>, node: GoPtr<Node>): void {
  ...
  if (superCall !== undefined) {
    ...
    const superCallShouldBeRootLevel = (!receiver!.emitStandardClassFields &&
      (core.Some(Node_Members(node!.Parent) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), isInstancePropertyWithInitializerOrPrivateIdentifierProperty) ||
        core.Some(Node_Parameters(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), (p: GoPtr<Node>): bool => HasSyntacticModifier(p, ModifierFlagsParameterPropertyModifier)))) as bool;
    if (superCallShouldBeRootLevel) {
      if (!superCallIsRootLevelInConstructor(superCall, Node_Body(node))) {
        ...
        for (
          let __goRangeSlice = Node_Statements(Node_Body(node)) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()),
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.findFirstSuperCall","kind":"method","status":"implemented","sigHash":"73fbff4d7b96acba4102b12439c63e3be86bc89577599858b01610d57214d87f"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkTypeArgumentConstraints","kind":"method","status":"implemented","sigHash":"28dc343409929afc2516c002594a37bec3b6d87f8cc31d7d7a740b0554cf1837"}
 *
 * Go source:
...
export function Checker_checkTypeArgumentConstraints(receiver: GoPtr<Checker>, node: GoPtr<Node>, typeParameters: GoSlice<GoPtr<Type>>): bool {
  let typeArguments = GoNilSlice<GoPtr<Type>>();
  ...
  for (let i = 0; i < typeParameters.length; i++) {
    ...
    if (constraint !== undefined) {
      if (GoSliceIsNil(typeArguments)) {
        typeArguments = Checker_getEffectiveTypeArguments(receiver, node, typeParameters);
        mapper = newTypeMapper(typeParameters, typeArguments);
      }
      result = result && Checker_checkTypeAssignableTo(receiver, GoSliceLoad(typeArguments, i, GoPointerValueOps<Type>()), Checker_instantiateType(receiver, constraint, mapper), core.ElementOrNil(Node_TypeArguments(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), i, GoZeroPointer<Node>), Type_0_does_not_satisfy_the_constraint_1);
    }
  }
  return result;
}
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkThisType","kind":"method","status":"implemented","sigHash":"f78b1caa034ccf114c32a231424550e99fad4ce9cb21e2ecd159399c2ec6ca95"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkFunctionOrConstructorSymbol","kind":"method","status":"implemented","sigHash":"1b4530229bf7da86f4197961be72f1d1d5249ea0c40134ad7e364410234856eb"}
 *
 * Go source:
...
export function Checker_checkFunctionOrConstructorSymbol(receiver: GoPtr<Checker>, symbol_: GoPtr<Symbol>): void {
  const links = LinkStore_Get(receiver!.valueSymbolLinks, symbol_, goZeroValueSymbolLinks, goSymbolPointerKey)!.v;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkFunctionOrConstructorSymbolWorker","kind":"method","status":"implemented","sigHash":"850fa2d05d385c6304ee812c65af6ab74a67ee326345a813710e3ad7a1b0642f"}
 *
 * Go source:
...
export function Checker_checkFunctionOrConstructorSymbolWorker(receiver: GoPtr<Checker>, symbol_: GoPtr<Symbol>): void {
  ...
  let functionDeclarations: GoSlice<GoPtr<Node>> = GoNilSlice();

  const getCanonicalOverload = (overloads: GoSlice<GoPtr<Node>>, implementation: GoPtr<Node>): GoPtr<Node> => {
    const implementationSharesContainerWithFirstOverload = (implementation !== undefined && implementation!.Parent === GoSliceLoad(overloads, 0, GoPointerValueOps<Node>())!.Parent) as bool;
    if (implementationSharesContainerWithFirstOverload) {
      return implementation;
    }
    return GoSliceLoad(overloads, 0, GoPointerValueOps<Node>());
  };
  ...
  const checkFlagAgreementBetweenOverloads = (
    ...
    if (someButNotAllOverloadFlags !== 0) {
      ...
      for (
        ...
        const overload = GoSliceLoad(__goRangeSlice, __goRangeIndex, __goRangeValueOps);
      ...
      for (const overloadsInFile of groups.values()) {
        ...
        for (
          let __goRangeSlice = overloadsInFile,
            __goRangeLength = __goRangeSlice.length,
            __goRangeValueOps = GoPointerValueOps<Node>(),
            __goRangeIndex = 0;
          __goRangeIndex < __goRangeLength;
          ...
          if ((deviationInFile & ModifierFlagsExport) !== 0) {
            ...
            Checker_error(receiver, core.OrElse(GetNameOfDeclaration(overload), overload, GoZeroPointer<Node>, GoEqualStrict<GoPtr<Node>>), Overload_signatures_must_all_be_public_private_or_protected);
  ...
  const reportImplementationExpectedError = (node: GoPtr<Node>): void => {
    ...
    if (subsequentNode.node !== undefined && Node_Pos(subsequentNode.node) === Node_End(node)) {
      if (subsequentNode.node!.Kind === node!.Kind) {
        ...
        const errorNode = core.OrElse(subsequentName, subsequentNode.node, GoZeroPointer<Node>, GoEqualStrict<GoPtr<Node>>);
    ...
    const errorNode = core.OrElse(name, node, GoZeroPointer<Node>, GoEqualStrict<GoPtr<Node>>);
    if (isConstructor) {
  ...
  if (multipleConstructorImplementation) {
    for (
      let __goRangeSlice = functionDeclarations,
        __goRangeLength = __goRangeSlice.length,
        __goRangeValueOps = GoPointerValueOps<Node>(),
        __goRangeIndex = 0;
      __goRangeIndex < __goRangeLength;
  ...
  if (duplicateFunctionDeclaration) {
    for (
      ...
      const declaration = GoSliceLoad(__goRangeSlice, __goRangeIndex, __goRangeValueOps);
      Checker_error(receiver, core.OrElse(GetNameOfDeclaration(declaration), declaration, GoZeroPointer<Node>, GoEqualStrict<GoPtr<Node>>), Duplicate_function_implementation);
    }
  }
  if (hasNonAmbientClass && !isConstructor && (symbol_!.Flags & SymbolFlagsFunction) !== 0 && declarations.length !== 0) {
    ...
    for (
      ...
      if (diagnostic !== undefined) {
        const err = Checker_error(receiver, core.OrElse(GetNameOfDeclaration(declaration), declaration, GoZeroPointer<Node>, GoEqualStrict<GoPtr<Node>>), diagnostic, symbol_!.Name);
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isImplementationCompatibleWithOverload","kind":"method","status":"implemented","sigHash":"d7a65f77f03a1a63060e5195929592ba010d31aa18f00e204cef2f322e136c70"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isUnwrappedReturnTypeUndefinedVoidOrAny","kind":"method","status":"implemented","sigHash":"640e1c1a9d9e8ecd46bd2830e7a37b3463dd91601518812bd4b0f1ecfd8b5a7d"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkTypeParameterListsIdentical","kind":"method","status":"implemented","sigHash":"9857b0b3adca9c7d85668028e9115141454565ff666e86ee5b1d16f6df7755f5"}
 *
 * Go source:
...
export function Checker_checkTypeParameterListsIdentical(receiver: GoPtr<Checker>, symbol_: GoPtr<Symbol>): void {
  ...
  if (!links!.typeParametersChecked) {
    ...
    if (!Checker_areTypeParametersIdentical(receiver, declarations, InterfaceType_LocalTypeParameters(Type_AsInterfaceType(t)), (declaration) => Node_TypeParameters(declaration) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()))) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.areTypeParametersIdentical","kind":"method","status":"implemented","sigHash":"e3a9b991f2321fca155e1dc770711ae577237296fc681460bdd7b0e871f86e02"}
 *
 * Go source:
...
export function Checker_areTypeParametersIdentical(receiver: GoPtr<Checker>, declarations: GoSlice<GoPtr<Node>>, targetParameters: GoSlice<GoPtr<Type>>, getTypeParameterDeclarations: GoFunc<(node: GoPtr<Node>) => GoSlice<GoPtr<Node>>>): bool {
  ...
  for (
    ...
    for (let i = 0; i < sourceParameters.length; i++) {
      const source = GoSliceLoad(sourceParameters, i, GoPointerValueOps<Node>());
      const target = GoSliceLoad(targetParameters, i, GoPointerValueOps<Type>());
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeWithoutSignatures","kind":"method","status":"implemented","sigHash":"5d30783d099102293b3748ac432439c3532f2e1e23028b45ef797a2456df33ac"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkIndexConstraintForIndexSignature","kind":"method","status":"implemented","sigHash":"e3d2305fd7b80f6fcb0eaf35ee942d97acc8a2780f18bf2b197ed3cfe439621d"}
 *
 * Go source:
...
export function Checker_checkIndexConstraintForIndexSignature(receiver: GoPtr<Checker>, t: GoPtr<Type>, checkInfo: GoPtr<IndexInfo>): void {
  ...
  for (
    ...
    let errorNode = core.OrElse(localCheckDeclaration, localIndexDeclaration, GoZeroPointer<Node>, GoEqualStrict<GoPtr<Node>>);
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkClassOrInterfaceForDuplicateIndexSignatures","kind":"method","status":"implemented","sigHash":"fe6caf9d5762493cda36096b2daacce64ef80b2369e6f11d9a9ce0170b057586"}
 *
 * Go source:
...
export function Checker_checkClassOrInterfaceForDuplicateIndexSignatures(receiver: GoPtr<Checker>, node: GoPtr<Node>): void {
  const links = LinkStore_Get<GoPtr<Symbol>, DeclaredTypeLinks>(receiver!.declaredTypeLinks as LinkStore<GoPtr<Symbol>, DeclaredTypeLinks>, Checker_getSymbolOfDeclaration(receiver, node), goZeroDeclaredTypeLinks, goSymbolPointerKey);
  if (!links!.v.indexSignaturesChecked) {
    links!.v.indexSignaturesChecked = true;
    Checker_checkTypeForDuplicateIndexSignatures(receiver, node);
  }
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkTypeForDuplicateIndexSignatures","kind":"method","status":"implemented","sigHash":"4df2ab3d536108adc31c823d484c0e0755228e599b6b5d69ec19984f4a7ce8a3"}
 *
 * Go source:
...
export function Checker_checkTypeForDuplicateIndexSignatures(receiver: GoPtr<Checker>, node: GoPtr<Node>): void {
  ...
  for (const declaration of indexDeclarations) {
    if (IsIndexSignatureDeclaration(declaration)) {
      ...
      if (parameters.length === 1 && Node_Type(GoSliceLoad(parameters, 0, GoPointerValueOps<Node>())) !== undefined) {
        for (
          let __goRangeSlice = Type_Distributed(Checker_getTypeFromTypeNode(receiver, Node_Type(GoSliceLoad(parameters, 0, GoPointerValueOps<Node>())))),
            __goRangeLength = __goRangeSlice.length,
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isPropertyInitializedInConstructor","kind":"method","status":"implemented","sigHash":"8f3b80d7dd926d45756da262af59834299e78350b71fa9aea50e77a4da08dc88"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getIterationTypeOfGeneratorFunctionReturnType","kind":"method","status":"implemented","sigHash":"79fe6b07f5e2bb0deccab8738727be93130413bc3a92ff076da345820d480f53"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getIterationTypesOfGeneratorFunctionReturnType","kind":"method","status":"implemented","sigHash":"e6a1d1153c5904db2858682ff86ad002b5cedc1b85bc58da557a2360428590e6"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getBuiltinIteratorReturnType","kind":"method","status":"implemented","sigHash":"7ce2a1bb8d97fc6c15141b53264a370a1cbab6331ee8caaf85409040679aa1c8"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkTypeParameters","kind":"method","status":"implemented","sigHash":"505712a390dc9a1e623e442ba068ac5422f2a1719b8cbb57c2b64a2eec75ec8c"}
 *
 * Go source:
...
export function Checker_checkTypeParameters(receiver: GoPtr<Checker>, typeParameterDeclarations: GoSlice<GoPtr<Node>>): void {
  ...
  for (let i = 0; i < typeParameterDeclarations.length; i++) {
    const node = GoSliceLoad(typeParameterDeclarations, i, GoPointerValueOps<Node>());
    ...
    for (let j = 0; j < i; j++) {
      if (Node_Symbol(GoSliceLoad(typeParameterDeclarations, j, GoPointerValueOps<Node>())) === Node_Symbol(node)) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkTypeParametersNotReferenced","kind":"method","status":"implemented","sigHash":"eb985a4bbf09b712554aef832da4b754fcac349d664fdcef397314a677b1a357"}
 *
 * Go source:
    ...
    if (IsTypeReferenceNode(node)) {
      ...
      if ((t!.flags & TypeFlagsTypeParameter) !== 0) {
        for (let i = index; i < typeParameters.length; i++) {
          if (t!.symbol === Checker_getSymbolOfDeclaration(receiver, GoSliceLoad(typeParameters, i, GoPointerValueOps<Node>()))) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkUnusedLocalsAndParameters","kind":"method","status":"implemented","sigHash":"f0ee324d76d3a40ed628a3719c51fc6c285f190086d7322f4e06ba21e7116d96"}
 *
 * Go source:
...
export function Checker_checkUnusedLocalsAndParameters(receiver: GoPtr<Checker>, node: GoPtr<Node>): void {
  ...
  for (const local of Node_Locals(node)?.values() ?? []) {
    const referenceKinds = LinkStore_Get(receiver!.symbolReferenceLinks, local, goZeroSymbolReferenceLinks, goSymbolPointerKey)!.v.referenceKinds ?? SymbolFlagsNone;
    ...
    for (
      let __goRangeSlice = local!.Declarations ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()),
        __goRangeLength = __goRangeSlice.length,
        __goRangeValueOps = GoPointerValueOps<Node>(),
        __goRangeIndex = 0;
      __goRangeIndex < __goRangeLength;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.reportUnusedParameters","kind":"method","status":"implemented","sigHash":"c9549c6d268577819cbe80d43c756c36423ca96001f9579e36a455dc1a6d2f35"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkUnusedInferTypeParameter","kind":"method","status":"implemented","sigHash":"4f74196346a558843da08ba5df4dd82c71c6d08326a973d58fcbf614167d562b"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkUnusedTypeParameters","kind":"method","status":"implemented","sigHash":"b6d8a4142285dae0d6b67e4e57ebfbb6555cd4e596e0ea9f7c959a3ae2157d2a"}
 *
 * Go source:
...
export function Checker_checkUnusedTypeParameters(receiver: GoPtr<Checker>, node: GoPtr<Node>): void {
  ...
  if (typeParameterList.Nodes.length > 1 && core.Every(typeParameterList.Nodes, (typeParameter) => Checker_isUnreferencedTypeParameter(receiver, typeParameter))) {
    ...
    for (
      let __goRangeSlice = typeParameterList.Nodes,
        __goRangeLength = __goRangeSlice.length,
        __goRangeValueOps = GoPointerValueOps<Node>(),
        __goRangeIndex = 0;
      __goRangeIndex < __goRangeLength;
      ...
      const typeParameter = GoSliceLoad(__goRangeSlice, __goRangeIndex, __goRangeValueOps);
      if (Checker_isUnreferencedTypeParameter(receiver, typeParameter)) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isUnreferencedTypeParameter","kind":"method","status":"implemented","sigHash":"02ccf1180aad9dfe739ab1c9b2ebca4ae342168b613ad68c93aa57018ce72eeb"}
 *
 * Go source:
...
export function Checker_isUnreferencedTypeParameter(receiver: GoPtr<Checker>, typeParameter: GoPtr<Node>): bool {
  return ((LinkStore_Get<GoPtr<Symbol>, SymbolReferenceLinks>(receiver!.symbolReferenceLinks as LinkStore<GoPtr<Symbol>, SymbolReferenceLinks>, Checker_getMergedSymbol(receiver, Node_Symbol(typeParameter)), goZeroSymbolReferenceLinks, goSymbolPointerKey)!.v.referenceKinds ?? SymbolFlagsNone) & SymbolFlagsTypeParameter) === 0 &&
    !isIdentifierThatStartsWithUnderscore(Node_Name(typeParameter));
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getReturnTypeOfSingleNonGenericSignature","kind":"method","status":"implemented","sigHash":"634265b2499ff0fa08dbc9c77c54ac798489972178d50b9c61e24e01ad649a15"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getReturnTypeOfSingleNonGenericSignatureOfCallChain","kind":"method","status":"implemented","sigHash":"1545326b6ac4f232440c012950a3c5f61b4a1fceabe729404bf9f5323d89a672"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.instantiateTypeWithSingleGenericCallSignature","kind":"method","status":"implemented","sigHash":"b8376c4fb85c499c6c29aaf68c5562a54749f159b47f7ec3c6a98f323aa5c0fe"}
 *
 * Go source:
...
export function Checker_instantiateTypeWithSingleGenericCallSignature(receiver: GoPtr<Checker>, node: GoPtr<Node>, t: GoPtr<Type>, checkMode: CheckMode): GoPtr<Type> {
  ...
  const signature = core.OrElse(callSignature, constructSignature, GoZeroPointer<Signature>, GoEqualStrict<GoPtr<Signature>>);
  if (signature === undefined || signature!.typeParameters.length === 0) {
    return t;
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getOuterInferenceTypeParameters","kind":"method","status":"implemented","sigHash":"d3dd0cc0f251d7a363d1528eaacd1a53b60d22fddc280838a080dafc88b97f9d"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getUniqueTypeParameters","kind":"method","status":"implemented","sigHash":"a8f6b7a7ba6f542459d9d14e38d9b94b70bbb7d6b677186930b0066041be13d4"}
 *
 * Go source:
...
export function Checker_getUniqueTypeParameters(receiver: GoPtr<Checker>, context: GoPtr<InferenceContext>, typeParameters: GoSlice<GoPtr<Type>>): GoSlice<GoPtr<Type>> {
  let oldTypeParameters: GoSlice<GoPtr<Type>> = GoNilSlice();
  let newTypeParameters: GoSlice<GoPtr<Type>> = GoNilSlice();
  let result: GoSlice<GoPtr<Type>> = GoSliceMake(0, 0, GoPointerValueOps<Type>());
  for (
    let __goRangeSlice = (typeParameters ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())),
      __goRangeLength = __goRangeSlice.length,
      __goRangeValueOps = GoPointerValueOps<Type>(),
      __goRangeIndex = 0;
    __goRangeIndex < __goRangeLength;
  ...
  if ((newTypeParameters ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())).length !== 0) {
    const mapper = newTypeMapper(oldTypeParameters!, newTypeParameters!);
    for (
      let __goRangeSlice = (newTypeParameters ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())),
        __goRangeLength = __goRangeSlice.length,
        __goRangeValueOps = GoPointerValueOps<Type>(),
        __goRangeIndex = 0;
      __goRangeIndex < __goRangeLength;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isInConstructorArgumentInitializer","kind":"method","status":"implemented","sigHash":"2ed887a4548993c664d9cf4eebbf23958e2b1784013ab6daf45dad9190ee80b6"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkImportCallExpression","kind":"method","status":"implemented","sigHash":"6ada5a782d519c0f6c50d7815b56e60ba99aec2e68d60b094f34b9cd1823f96a"}
 *
 * Go source:
...
export function Checker_checkImportCallExpression(receiver: GoPtr<Checker>, node: GoPtr<Node>): GoPtr<Type> {
  ...
  const specifier = GoSliceLoad(args, 0, GoPointerValueOps<Node>());
  const specifierType = Checker_checkExpressionCached(receiver, specifier);
  let optionsType: GoPtr<Type>;
  if (args.length > 1) {
    optionsType = Checker_checkExpressionCached(receiver, GoSliceLoad(args, 1, GoPointerValueOps<Node>()));
  }
  for (let index = 2; index < args.length; index++) {
    Checker_checkExpressionCached(receiver, GoSliceLoad(args, index, GoPointerValueOps<Node>()));
  }
  ...
  if (optionsType !== undefined) {
    ...
    if (importCallOptionsType !== receiver!.emptyObjectType) {
      Checker_checkTypeAssignableTo(receiver, optionsType, Checker_getNullableType(receiver, importCallOptionsType, TypeFlagsUndefined), GoSliceLoad(args, 1, GoPointerValueOps<Node>()), undefined);
    }
    if (IsObjectLiteralExpression(GoSliceLoad(args, 1, GoPointerValueOps<Node>()))) {
      for (
        let __goRangeSlice = Node_Properties(GoSliceLoad(args, 1, GoPointerValueOps<Node>())) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()),
          __goRangeLength = __goRangeSlice.length,
          __goRangeValueOps = GoPointerValueOps<Node>(),
          __goRangeIndex = 0;
        __goRangeIndex < __goRangeLength;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkCallExpression","kind":"method","status":"implemented","sigHash":"9a61a5829ba06be10bd3dac1064cb257686ad9b2ef91e9ca15c7b904ebe04b40"}
 *
 * Go source:
...
export function Checker_checkCallExpression(receiver: GoPtr<Checker>, node: GoPtr<Node>, checkMode: CheckMode): GoPtr<Type> {
  ...
  if (IsInJSFile(node) && Checker_isCommonJSRequire(receiver, node)) {
    return Checker_resolveExternalModuleTypeByLiteral(receiver, GoSliceLoad((Node_Arguments(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>())), 0, GoPointerValueOps<Node>()));
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isSymbolOrSymbolForCall","kind":"method","status":"implemented","sigHash":"97c1f029804c5ad9117ef305bc1e441ab0306b099cb4b93af1f6f8d0789ba8af"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getResolvedSignature","kind":"method","status":"implemented","sigHash":"4c7a5bc01f50199e92b8f44ab43a0f815a371775968d6971c1c8520498ea3eaf"}
 *
 * Go source:
...
export function Checker_getResolvedSignature(receiver: GoPtr<Checker>, node: GoPtr<Node>, candidatesOutArray: GoRef<GoSlice<GoPtr<Signature>>>, checkMode: CheckMode): GoPtr<Signature> {
  const links = LinkStore_Get(receiver!.signatureLinks, node, goZeroSignatureLinks, goNodePointerKey)!.v;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.resolveSignature","kind":"method","status":"implemented","sigHash":"3f5f24d8b322f3d2262569dc0fad3eb979984d3500a3322bee3b45508bd47345"}
 *
 * Go source:
 ...
 * }
 */
export function Checker_resolveSignature(receiver: GoPtr<Checker>, node: GoPtr<Node>, candidatesOutArray: GoRef<GoSlice<GoPtr<Signature>>>, checkMode: CheckMode): GoPtr<Signature> {
  switch (node!.Kind) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.resolveCallExpression","kind":"method","status":"implemented","sigHash":"c7b5867f2eec833277bb9e32e3697824bf56540407f05569487a0dd36b4f8c44"}
 *
 * Go source:
 ...
 * }
 */
export function Checker_resolveCallExpression(receiver: GoPtr<Checker>, node: GoPtr<Node>, candidatesOutArray: GoRef<GoSlice<GoPtr<Signature>>>, checkMode: CheckMode): GoPtr<Signature> {
  if (Node_Expression(node)!.Kind === KindSuperKeyword) {
    const superType = Checker_checkSuperExpression(receiver, Node_Expression(node));
    if (IsTypeAny(superType)) {
      for (
        let __goRangeSlice = Node_Arguments(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()),
          __goRangeLength = __goRangeSlice.length,
          __goRangeValueOps = GoPointerValueOps<Node>(),
          __goRangeIndex = 0;
        __goRangeIndex < __goRangeLength;
    ...
    if (!Checker_isErrorType(receiver, superType)) {
      ...
      if (baseTypeNode !== undefined) {
        const baseConstructors = Checker_getInstantiatedConstructorsForTypeArguments(receiver, superType, Node_TypeArguments(baseTypeNode) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), baseTypeNode);
  ...
  if (callSignatures.length === 0) {
    if (numConstructSignatures !== 0) {
      ...
      if ((Node_Arguments(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>())).length === 1) {
  ...
  if ((checkMode & CheckModeSkipGenericFunctions) !== 0 && (Node_TypeArguments(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>())).length === 0 && core.Some(callSignatures, (signature) => Checker_isGenericFunctionReturningFunction(receiver, signature))) {
    Checker_skippedGenericFunction(receiver, node, checkMode);
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isConstructorAccessible","kind":"method","status":"implemented","sigHash":"08733b3be47d5f962517bd2ff7291f4439a94f22e926cd00859f19e2d83f5601"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.resolveCall","kind":"method","status":"implemented","sigHash":"64f4eaeeec3a8408011f9d18d2a9e533c91d5a6b983cdd9a4da4b213c9e49193"}
 *
 * Go source:
 ...
 * }
 */
export function Checker_resolveCall(receiver: GoPtr<Checker>, node: GoPtr<Node>, signatures: GoSlice<GoPtr<Signature>>, candidatesOutArray: GoRef<GoSlice<GoPtr<Signature>>>, checkMode: CheckMode, callChainFlags: SignatureFlags, headMessage: GoPtr<Message>): GoPtr<Signature> {
  ...
  const typeArguments = !isDecorator && !isInstanceof && !isSuperCall(node) && node!.Kind !== KindJsxOpeningFragment ? Node_TypeArguments(node) : GoNilSlice<GoPtr<Node>>();
  ...
  if (candidatesOutArray !== undefined) {
    candidatesOutArray.v = candidates;
  }
  ...
  const callState = {
    ...
    argCheckMode,
    candidatesForArgumentError: GoNilSlice(),
  ...
  LinkStore_Get(receiver!.signatureLinks, node, goZeroSignatureLinks, goNodePointerKey)!.v.resolvedSignature = result;
  if (reportErrors) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.reorderCandidates","kind":"method","status":"implemented","sigHash":"35ebf926781ad9829f89337e383e4c3e53de8d5dfae3d53aa2ac291bcd5998f8"}
 *
 * Go source:
...
export function Checker_reorderCandidates(receiver: GoPtr<Checker>, signatures: GoSlice<GoPtr<Signature>>, callChainFlags: SignatureFlags): GoSlice<GoPtr<Signature>> {
  ...
  let result: GoSlice<GoPtr<Signature>> = GoSliceMake(0, 0, GoPointerValueOps<Signature>());
  for (
    let __goRangeSlice = signatures,
      __goRangeLength = __goRangeSlice.length,
      __goRangeValueOps = GoPointerValueOps<Signature>(),
    ...
    let signature = GoSliceLoad(__goRangeSlice, __goRangeIndex, __goRangeValueOps);
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getOptionalCallSignature","kind":"method","status":"implemented","sigHash":"f83bac10efc05aeff180ece199b9b74a9bb21c8f96c6afdf27a82c379b0cbb98"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.chooseOverload","kind":"method","status":"implemented","sigHash":"35dba3b0efe4936419b69fa992defebeee5d256f458d7f9e4380a90f01ebf523"}
 *
 * Go source:
...
export function Checker_chooseOverload(receiver: GoPtr<Checker>, s: GoPtr<CallState>, relation: GoPtr<Relation>): GoPtr<Signature> {
  s!.candidatesForArgumentError = GoNilSlice();
  s!.candidateForArgumentArityError = undefined;
  s!.candidateForTypeArgumentError = undefined;
  if (s!.isSingleNonGenericCandidate) {
    const candidate = GoSliceLoad(s!.candidates, 0, GoPointerValueOps<Signature>());
    ...
    if (!Checker_isSignatureApplicable(receiver, s!.node, s!.args, candidate, relation, CheckModeNormal, false as bool, undefined)) {
      s!.candidatesForArgumentError = GoSliceBuild(1, 1, GoPointerValueOps<Signature>(), (__goSliceLiteral) => {
  ...
  for (let candidateIndex = 0; candidateIndex < s!.candidates.length; candidateIndex++) {
    const candidate = GoSliceLoad(s!.candidates, candidateIndex, GoPointerValueOps<Signature>());
    ...
    if (candidate!.typeParameters.length !== 0) {
      let typeArgumentTypes: GoSlice<GoPtr<Type>> = GoNilSlice();
      ...
      let inferredTypeParameters = GoNilSlice<GoPtr<Type>>();
    ...
    GoSliceStore(s!.candidates, candidateIndex, checkCandidate, GoPointerValueOps<Signature>());
    return checkCandidate;
  }
  return undefined;
}
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.hasCorrectArity","kind":"method","status":"implemented","sigHash":"30e8b730a6be4f649430cfc5856b8c9a52b7f5b9f94e28ea3cfd7834540d1536"}
 *
 * Go source:
...
export function Checker_hasCorrectArity(receiver: GoPtr<Checker>, node: GoPtr<Node>, args: GoSlice<GoPtr<Node>>, signature: GoPtr<Signature>, signatureHelpTrailingComma: bool): bool {
  ...
  const callArgs = args ?? GoSliceMake(0, 0, GoPointerValueOps<Node>());
  let argCount = 0;
  ...
  if (IsTaggedTemplateExpression(node)) {
    ...
    if (IsTemplateExpression(template)) {
      const lastSpan = core.LastOrNil(AsTemplateExpression(template)!.TemplateSpans!.Nodes, GoZeroPointer<Node>);
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getDecoratorArgumentCount","kind":"method","status":"implemented","sigHash":"dfc05388538f27c517ba2c23e8685565a0a69cc004e740f6894b02f226c5c4bf"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getLegacyDecoratorArgumentCount","kind":"method","status":"implemented","sigHash":"500c9ebf95c2ce3dff5294cf1ca98d4968ad48de02ef7de693293b899ca895c9"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.hasCorrectTypeArgumentArity","kind":"method","status":"implemented","sigHash":"4dd131e96696a0af360cc023089aeaf061a869c2c35838376d51be9bb24f0a51"}
 *
 * Go source:
...
export function Checker_hasCorrectTypeArgumentArity(receiver: GoPtr<Checker>, signature: GoPtr<Signature>, typeArguments: GoSlice<GoPtr<Node>>): bool {
  const numTypeParameters = (signature!.typeParameters ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())).length;
  const minTypeArgumentCount = Checker_getMinTypeArgumentCount(receiver, signature!.typeParameters);
  return (typeArguments ?? GoSliceMake(0, 0, GoPointerValueOps<Node>())).length === 0 ||
    (typeArguments ?? GoSliceMake(0, 0, GoPointerValueOps<Node>())).length >= minTypeArgumentCount && (typeArguments ?? GoSliceMake(0, 0, GoPointerValueOps<Node>())).length <= numTypeParameters;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkTypeArguments","kind":"method","status":"implemented","sigHash":"87040d2eb38d587de694a2f8ddf509392a46dd9f4d347fa49ea8898d05aba2b1"}
 *
 * Go source:
...
export function Checker_checkTypeArguments(receiver: GoPtr<Checker>, signature: GoPtr<Signature>, typeArgumentNodes: GoSlice<GoPtr<Node>>, reportErrors: bool, headMessage: GoPtr<Message>): GoSlice<GoPtr<Type>> {
  ...
  for (let index = 0; index < typeArgumentNodes.length; index++) {
    const constraint = Checker_getConstraintOfTypeParameter(receiver, GoSliceLoad(typeParameters, index, GoPointerValueOps<Type>()));
    if (constraint !== undefined) {
      const typeArgumentHeadMessage = core.OrElse(headMessage, Type_0_does_not_satisfy_the_constraint_1, GoZeroPointer<Message>, GoEqualStrict<GoPtr<Message>>);
      if (mapper === undefined) {
        mapper = newTypeMapper(typeParameters, typeArgumentTypes);
      }
      const typeArgument = GoSliceLoad(typeArgumentTypes, index, GoPointerValueOps<Type>());
      const errorNode = reportErrors ? GoSliceLoad(typeArgumentNodes, index, GoPointerValueOps<Node>()) : undefined;
      ...
      if (!Checker_checkTypeAssignableToEx(
        ...
        if (diags.length !== 0) {
          let diagnostic = GoSliceLoad(diags, 0, GoPointerValueOps<Diagnostic>());
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isSignatureApplicable","kind":"method","status":"implemented","sigHash":"5707b58d565ca9504f11871fcfeff062bb8599288f1d09c6e802f1443961906e"}
 *
 * Go source:
 ...
 * }
 */
export function Checker_isSignatureApplicable(receiver: GoPtr<Checker>, node: GoPtr<Node>, args: GoSlice<GoPtr<Node>>, signature: GoPtr<Signature>, relation: GoPtr<Relation>, checkMode: CheckMode, reportErrors: bool, diagnosticOutput: GoRef<GoSlice<GoPtr<Diagnostic>>>): bool {
  ...
  for (let index = 0; index < argCount; index++) {
    const arg = GoSliceLoad(args, index, GoPointerValueOps<Node>());
  ...
  if (restType !== undefined) {
    ...
    if (reportErrors) {
      if (restArgCount === 0) {
        ...
        errorNode = Checker_getEffectiveCheckNode(receiver, GoSliceLoad(args, argCount, GoPointerValueOps<Node>()));
      } else {
        errorNode = Checker_createSyntheticExpression(receiver, node, spreadType, false as bool, undefined);
        errorNode!.Loc = NewTextRange(Node_Pos(GoSliceLoad(args, argCount, GoPointerValueOps<Node>())), Node_End(GoSliceLoad(args, args.length - 1, GoPointerValueOps<Node>())));
      }
    }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getThisArgumentOfCall","kind":"method","status":"implemented","sigHash":"20f606627de22c9aacaa57de14444b6bd1a939eb55d0217278a3ad08f9b1c8ea"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getThisArgumentType","kind":"method","status":"implemented","sigHash":"cae19bedb34c356338ca98d5a1fd8a01f0199805eee88ef8acbb90124fb58b4a"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.inferTypeArguments","kind":"method","status":"implemented","sigHash":"e5de0a3f508ed64b0fa803c836037202e1ea7e1af1c50646566e8848e36615c2"}
 *
 * Go source:
...
export function Checker_inferTypeArguments(receiver: GoPtr<Checker>, node: GoPtr<Node>, signature: GoPtr<Signature>, args: GoSlice<GoPtr<Node>>, checkMode: CheckMode, context: GoPtr<InferenceContext>): GoSlice<GoPtr<Type>> {
  ...
  if (restType !== undefined && (restType!.flags & TypeFlagsTypeParameter) !== 0) {
    const info = core.Find(context!.inferences, (inference: GoPtr<InferenceInfo>): bool => inference!.typeParameter === restType, GoZeroPointer<InferenceInfo>);
    if (info !== undefined) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getCandidateForOverloadFailure","kind":"method","status":"implemented","sigHash":"60cbbadfd8e8de9afd21058a76ee60650a683031550db73c90ce320f491b18a1"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.pickLongestCandidateSignature","kind":"method","status":"implemented","sigHash":"c16caa097d4952ada11619bd0659a818746c68e4a934ca13111ea719764b8f88"}
 *
 * Go source:
...
export function Checker_pickLongestCandidateSignature(receiver: GoPtr<Checker>, node: GoPtr<Node>, candidates: GoSlice<GoPtr<Signature>>, args: GoSlice<GoPtr<Node>>, checkMode: CheckMode): GoPtr<Signature> {
  // Go: len(nil) == 0.
  let argCount = (args ?? GoSliceMake(0, 0, GoPointerValueOps<Node>())).length;
  if (receiver!.apparentArgumentCount !== undefined) {
    argCount = receiver!.apparentArgumentCount.v;
  }
  ...
  if (Checker_callLikeExpressionMayHaveTypeArguments(receiver, node)) {
    typeArgumentNodes = Node_TypeArguments(node) ?? GoNilSlice();
  }
  ...
  GoSliceStore(candidates, bestIndex, instantiated, GoPointerValueOps<Signature>());
  return instantiated;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getLongestCandidateIndex","kind":"method","status":"implemented","sigHash":"f8487c2f27473a6379f7a918bdfecbbb96e7509a26930ed003e46e472369399b"}
 *
 * Go source:
...
export function Checker_getLongestCandidateIndex(receiver: GoPtr<Checker>, candidates: GoSlice<GoPtr<Signature>>, argsCount: int): int {
  ...
  let maxParams = -1;
  for (let i = 0; i < (candidates ?? GoSliceMake(0, 0, GoPointerValueOps<Signature>())).length; i++) {
    const candidate = GoSliceLoad((candidates ?? GoSliceMake(0, 0, GoPointerValueOps<Signature>())), i, GoPointerValueOps<Signature>());
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeArgumentsFromNodes","kind":"method","status":"implemented","sigHash":"175b82662258236838122affbda94e8625a90c22003385e776266dcf20f9bc77"}
 *
 * Go source:
...
export function Checker_getTypeArgumentsFromNodes(receiver: GoPtr<Checker>, typeArgumentNodes: GoSlice<GoPtr<Node>>, typeParameters: GoSlice<GoPtr<Type>>): GoSlice<GoPtr<Type>> {
  ...
  while (result.length < (typeParameters ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())).length) {
    let t = Checker_getDefaultFromTypeParameter(receiver, GoSliceLoad((typeParameters ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())), result.length, GoPointerValueOps<Type>()));
    if (t === undefined) {
      t = Checker_getConstraintOfTypeParameter(receiver, GoSliceLoad((typeParameters ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())), result.length, GoPointerValueOps<Type>()));
      if (t === undefined) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.inferSignatureInstantiationForOverloadFailure","kind":"method","status":"implemented","sigHash":"e55d2ffad4c11aab49154f5c16b5187a4fc508c3bfe4e17ba9939e883ea5d3ae"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.createUnionOfSignaturesForOverloadFailure","kind":"method","status":"implemented","sigHash":"057ae6581f91a2ef4941f1a22b22792aee26f23961584da8f51173b2ee9773f6"}
 *
 * Go source:
...
export function Checker_createUnionOfSignaturesForOverloadFailure(receiver: GoPtr<Checker>, candidates: GoSlice<GoPtr<Signature>>): GoPtr<Signature> {
  const thisParameters = core.MapNonNil(candidates, (candidate: GoPtr<Signature>) => candidate!.thisParameter, GoZeroPointer<Symbol>, GoEqualStrict<GoPtr<Symbol>>);
  ...
  let parameters: GoSlice<GoPtr<Symbol>> = GoSliceMake(0, 0, GoPointerValueOps<Symbol>());
    ...
    const symbols = core.MapNonNil(candidates, (signature: GoPtr<Signature>) => {
      if (signatureHasRestParameter(signature)) {
        if (index < signature!.parameters.length - 1) {
          return GoSliceLoad(signature!.parameters, index, GoPointerValueOps<Symbol>());
        }
        return core.LastOrNil(signature!.parameters, GoZeroPointer<Symbol>);
      }
  ...
  return Checker_newSignature(receiver, flags, GoSliceLoad(candidates, 0, GoPointerValueOps<Signature>())!.declaration, GoNilSlice(), thisParameter, parameters, Checker_getIntersectionType(receiver, core.Map(candidates, (signature: GoPtr<Signature>) => Checker_getReturnTypeOfSignature(receiver, signature))), undefined, minArgumentCount);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.createCombinedSymbolForOverloadFailure","kind":"method","status":"implemented","sigHash":"822daf1cf621be165ccb32287376da529708305fdd165316e95c69e38fb09f4c"}
 *
 * Go source:
...
export function Checker_createCombinedSymbolForOverloadFailure(receiver: GoPtr<Checker>, sources: GoSlice<GoPtr<Symbol>>, t: GoPtr<Type>): GoPtr<Symbol> {
  return Checker_createSymbolWithType(receiver, core.FirstOrNil(sources, GoZeroPointer<Symbol>), t);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getRestTypeOfSignature","kind":"method","status":"implemented","sigHash":"76f68d3a8adac3bb68f10d1a84f3cac3fefaeb3cf51231adb650007352ef5459"}
 *
 * Go source:
...
export function Checker_getRestTypeOfSignature(receiver: GoPtr<Checker>, signature: GoPtr<Signature>): GoPtr<Type> {
  return core.OrElse(Checker_tryGetRestTypeOfSignature(receiver, signature), receiver!.anyType, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.tryGetRestTypeOfSignature","kind":"method","status":"implemented","sigHash":"8fb89747698eb0db5dae0adc6ceee4cea5a7327fabd9fb674668fba11f336282"}
 *
 * Go source:
...
export function Checker_tryGetRestTypeOfSignature(receiver: GoPtr<Checker>, signature: GoPtr<Signature>): GoPtr<Type> {
  ...
  let restType = Checker_getTypeOfSymbol(receiver, GoSliceLoad(signature!.parameters, signature!.parameters.length - 1, GoPointerValueOps<Symbol>()));
  if (isTupleType(restType)) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.resolveUntypedCall","kind":"method","status":"implemented","sigHash":"7e3b1eb3dae3b2231aa77ec38dadd33d60d96079e8cb00b31a91db6368be1c2d"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isUntypedFunctionCall","kind":"method","status":"implemented","sigHash":"c5cdcfd141bef7691d33b0c497e9207a713863ed10409308414efa9583a2256e"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.inferFromAnnotatedParametersAndReturn","kind":"method","status":"implemented","sigHash":"74fdce54c2adde046a52bd5968ba76b1becbdc3842674d83359d69192092a9b4"}
 *
 * Go source:
...
export function Checker_inferFromAnnotatedParametersAndReturn(receiver: GoPtr<Checker>, sig: GoPtr<Signature>, context: GoPtr<Signature>, inferenceContext: GoPtr<InferenceContext>): void {
  ...
  for (let i = 0; i < length; i++) {
    const declaration = GoSliceLoad(sig!.parameters, i, GoPointerValueOps<Symbol>())!.ValueDeclaration;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getContextualSignature","kind":"method","status":"implemented","sigHash":"8403487670cede66bce544e678ff366e1fc502bcdce3b1239cda6c452eea1b91"}
 *
 * Go source:
...
export function Checker_getContextualSignature(receiver: GoPtr<Checker>, node: GoPtr<Node>): GoPtr<Signature> {
  ...
  let signatureList: GoSlice<GoPtr<Signature>> = GoNilSlice();
  for (
    ...
    if (signature !== undefined) {
      if (signatureList.length !== 0 && Checker_compareSignaturesIdentical(receiver, GoSliceLoad(signatureList, 0, GoPointerValueOps<Signature>()), signature, false, true, true, (source: GoPtr<Type>, target: GoPtr<Type>) => Checker_compareTypesIdentical(receiver, source, target)) === TernaryFalse) {
        return undefined;
      }
  ...
  switch (signatureList.length) {
    case 0:
      return undefined;
    case 1:
      return GoSliceLoad(signatureList, 0, GoPointerValueOps<Signature>());
  }
  return Checker_createUnionSignature(receiver, GoSliceLoad(signatureList, 0, GoPointerValueOps<Signature>()), signatureList);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.createUnionSignature","kind":"method","status":"implemented","sigHash":"20dc122192f12b73d9428047380d9de1846a14d4240e73d7b7f27ec45aee75ce"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getContextualCallSignature","kind":"method","status":"implemented","sigHash":"3aa24517f7fdc819c79bb18b23d0d98472a3c5e80897bbc7e56820072c5c3a5b"}
 *
 * Go source:
...
export function Checker_getContextualCallSignature(receiver: GoPtr<Checker>, t: GoPtr<Type>, node: GoPtr<Node>): GoPtr<Signature> {
  ...
  if (applicableByArity.length === 1) {
    return GoSliceLoad(applicableByArity, 0, GoPointerValueOps<Signature>());
  }
  return Checker_getIntersectedSignatures(receiver, applicableByArity);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getIntersectedSignatures","kind":"method","status":"implemented","sigHash":"71b59e29273af8d3465ac7cbc1bce59b9cc9e4e589684edd069b23dcd0270665"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isAritySmaller","kind":"method","status":"implemented","sigHash":"1738c4ba4c547509d7bdc963a1ba12f6cf680ce6a24c8f94d3137de169568646"}
 *
 * Go source:
...
export function Checker_isAritySmaller(receiver: GoPtr<Checker>, signature: GoPtr<Signature>, target: GoPtr<Node>): bool {
  ...
  while (targetParameterCount < parameters.length) {
    const param = GoSliceLoad(parameters, targetParameterCount, GoPointerValueOps<Node>());
    if (Node_Initializer(param) !== undefined || Node_QuestionToken(param) !== undefined || hasDotDotDotToken(param)) {
      break;
    }
    targetParameterCount++;
  }
  if (parameters.length !== 0 && IsThisParameter(GoSliceLoad(parameters, 0, GoPointerValueOps<Node>()))) {
    targetParameterCount--;
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.assignContextualParameterTypes","kind":"method","status":"implemented","sigHash":"bbefc7f80d9a8753e19615f445d86cf3fcd3592c29d416e55e6d2d28a96c404f"}
 *
 * Go source:
...
export function Checker_assignContextualParameterTypes(receiver: GoPtr<Checker>, sig: GoPtr<Signature>, context: GoPtr<Signature>): void {
  ...
  const length = sig!.parameters.length - core.IfElse(signatureHasRestParameter(sig), 1, 0);
  for (let i = 0; i < length; i++) {
    const parameter = GoSliceLoad(sig!.parameters, i, GoPointerValueOps<Symbol>());
  ...
  if (signatureHasRestParameter(sig)) {
    const parameter = core.LastOrNil(sig!.parameters, GoZeroPointer<Symbol>);
    if (
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.assignNonContextualParameterTypes","kind":"method","status":"implemented","sigHash":"c7d64612feb4416a1fcfc9efc2c34b6d4bef9b69eaeb719684a1b4228b2b9079"}
 *
 * Go source:
...
export function Checker_assignNonContextualParameterTypes(receiver: GoPtr<Checker>, signature: GoPtr<Signature>): void {
  ...
  for (
    let __goRangeSlice = signature!.parameters,
      __goRangeLength = __goRangeSlice.length,
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.assignParameterType","kind":"method","status":"implemented","sigHash":"92473fb34c97092c5518902e164889e98bfa2d2495be4d3250edab4a7cd53170"}
 *
 * Go source:
...
export function Checker_assignParameterType(receiver: GoPtr<Checker>, parameter: GoPtr<Symbol>, contextualType: GoPtr<Type>): void {
  const links = LinkStore_Get(receiver!.valueSymbolLinks, parameter, goZeroValueSymbolLinks, goSymbolPointerKey)!.v;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkExpressionWithTypeArguments","kind":"method","status":"implemented","sigHash":"7af60f8586f24d4e03c7dd8c4ee31384245225c03b67700531d956b3b4326422"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isMethodAccessForCall","kind":"method","status":"implemented","sigHash":"49915d12d5da293aedc638bcabe2f8df92cd78908eb9dd655bb22f9fede178e6"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getEnclosingClassFromThisParameter","kind":"method","status":"implemented","sigHash":"347c987444e5675afc15ec06dc7721b515dd43edaad3f01312443e2947bc213b"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getContextualThisParameterType","kind":"method","status":"implemented","sigHash":"331f7922e6c535e2499162188a5f221e5f782095090c5107ce17a82a9fe6f833"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.tryGetThisTypeAt","kind":"method","status":"implemented","sigHash":"30d3a6424ec33dc60086c1fde3f84e4a97bf2917d6e25bd5f67a5e7dc9229799"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.TryGetThisTypeAtEx","kind":"method","status":"implemented","sigHash":"134cd1c540dc04be62156fd68e50449ff6e633ef4aa8da36b642024da4653e96"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.tryGetThisTypeAtEx","kind":"method","status":"implemented","sigHash":"3db4ed577040e6b50f06d77cbf412d6415042a181659831c0bac4ffce104aab8"}
 *
 * Go source:
 * func (c *Checker) tryGetThisTypeAtEx(node *ast.Node, includeGlobalThis bool, container *ast.Node) *Type {
 * 	if container == nil {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isInParameterInitializerBeforeContainingFunction","kind":"method","status":"implemented","sigHash":"a311fa03ba4ce3ae61509041242facf7149e73145e0f660738a6feaba720e1d4"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isIndirectCall","kind":"method","status":"implemented","sigHash":"54fa710940d8ae32f8c7cd980bfc7a3ce7e42ac181fbfb9980943c0db3e86950"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isValidConstAssertionArgument","kind":"method","status":"implemented","sigHash":"e2878f11ba8f9dea130576a497ea7308e7dcafedaaf5823fe5d17517690abd25"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.newParameter","kind":"method","status":"implemented","sigHash":"4f45a98e35c0a184597db1219c45a0d52d30f8de881ac6e314bc5c16c7f603da"}
 *
 * Go source:
...
export function Checker_newParameter(receiver: GoPtr<Checker>, name: string, t: GoPtr<Type>): GoPtr<Symbol> {
  ...
  LinkStore_Get(receiver!.valueSymbolLinks, symbol_, goZeroValueSymbolLinks, goSymbolPointerKey)!.v.resolvedType = t;
  return symbol_;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.hasSignatures","kind":"method","status":"implemented","sigHash":"7f2abb22d876c2d46c799cbb51b3268cc35906e2fa785bd005e45bfde0960806"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.lateBindIndexSignature","kind":"method","status":"implemented","sigHash":"29470d6353635374a94694a289f27501a1172e1c5738b4060b65d49a16bdc8ca"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeOfVariableOrParameterOrProperty","kind":"method","status":"implemented","sigHash":"2ba7b0a2657917a34db885aad9978e6756e0bb6df93b91a92895ac8d3f76859d"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isParameterOfContextSensitiveSignature","kind":"method","status":"implemented","sigHash":"f284921a62e3f5e326b33d6d96009fce090c8154590b9ff17070c64f0bed4fdb"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeOfVariableOrParameterOrPropertyWorker","kind":"method","status":"implemented","sigHash":"ba24615b142afe80d09de3281fc0f58e9a00888b99861164453ecd2f508c1ef8"}
 *
 * Go source:
...
export function Checker_getTypeOfVariableOrParameterOrPropertyWorker(receiver: GoPtr<Checker>, symbol_: GoPtr<Symbol>): GoPtr<Type> {
  ...
  if (IsSourceFile(declaration) && IsJsonSourceFile(AsSourceFile(declaration))) {
    const statements = Node_Statements(declaration) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>());
    if (statements.length === 0) {
      return receiver!.emptyObjectType;
    }
    return Checker_getWidenedType(receiver, Checker_getWidenedLiteralType(receiver, Checker_checkExpression(receiver, Node_Expression(GoSliceLoad(statements, 0, GoPointerValueOps<Node>())))));
  }
  ...
  if ((symbol_!.Flags & SymbolFlagsModuleExports) !== 0) {
    ...
    return Checker_newAnonymousType(receiver, symbol_, symbol_!.Members, GoNilSlice<GoPtr<Signature>>(), GoNilSlice<GoPtr<Signature>>(), GoNilSlice<GoPtr<IndexInfo>>());
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getBaseConstructorTypeOfClass","kind":"method","status":"implemented","sigHash":"dc7128aab3fe01769f5267a616e7d36b1b949eecfc582b1ab41d3329e1531efc"}
 *
 * Go source:
    ...
    if ((baseConstructorType!.flags & TypeFlagsTypeParameter) !== 0) {
      ...
      if (constraint !== undefined) {
        ...
        if (ctorSigs.length !== 0) {
          ctorReturn = Checker_getReturnTypeOfSignature(receiver, GoSliceLoad(ctorSigs, 0, GoPointerValueOps<Signature>()));
        }
      }
      if (!GoSliceIsNil(baseConstructorType!.symbol!.Declarations)) {
        Diagnostic_AddRelatedInfo(
          err,
          NewDiagnosticForNode(
            GoSliceLoad(baseConstructorType!.symbol!.Declarations, 0, GoPointerValueOps<Node>()),
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isConstructorType","kind":"method","status":"implemented","sigHash":"25be20db339f5b391ac6fa80e8c0651d8385fa084348a2e949054875924f55e3"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isMixinConstructorType","kind":"method","status":"implemented","sigHash":"b93799953523390c7e9d5941390006a5ad5208857473a902b4c8c22a39822b57"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeOfParameter","kind":"method","status":"implemented","sigHash":"4d1c32e15f262b8b95b1d208d96b19ed4d1ee072c75a63e7ed33540f85389202"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getConstraintOfTypeParameter","kind":"method","status":"implemented","sigHash":"65be89218217782db9bd47d5e334653918b4b5446bc5902a7a9e0c057f5395ba"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getConstraintFromTypeParameter","kind":"method","status":"implemented","sigHash":"9b170b65058adfa82b8116a11d08d6c6ed0f50474999e87512635c2235f81796"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getConstraintOrUnknownFromTypeParameter","kind":"method","status":"implemented","sigHash":"e4268b32f6e2fce067f32091c498cc6ce2155bcd547dbb1ea15dd0e86100de36"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getInferredTypeParameterConstraint","kind":"method","status":"implemented","sigHash":"9d5ff3fc573e9c23b24e4acb6193c8520b6030bb29e3c2862d65058f56567d40"}
 *
 * Go source:
...
export function Checker_getInferredTypeParameterConstraint(receiver: GoPtr<Checker>, t: GoPtr<Type>, omitTypeReferences: bool): GoPtr<Type> {
  let inferences: GoSlice<GoPtr<Type>> = GoNilSlice();
      ...
      if (IsInferTypeNode(declaration!.Parent)) {
        ...
        if (IsTypeReferenceNode(parent) && !omitTypeReferences) {
          ...
          if (!GoSliceIsNil(typeParameters)) {
            const index = slices.Index(Node_TypeArguments(parent), child, GoEqualStrict<GoPtr<Node>>);
            if (index >= 0 && index < typeParameters.length) {
              const declaredConstraint = Checker_getConstraintOfTypeParameter(receiver, GoSliceLoad(typeParameters, index, GoPointerValueOps<Type>()));
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeParametersForTypeReferenceOrImport","kind":"method","status":"implemented","sigHash":"eb4b7686442df2a9f4f6e1cc76013b36743411a03cdf12ee61befa0b6334489f"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeParametersForTypeAndSymbol","kind":"method","status":"implemented","sigHash":"0dfc26500632ab828792a9d844a72b09cfba39fa10a89434c5a0b3b912d7da97"}
 *
 * Go source:
...
export function Checker_getTypeParametersForTypeAndSymbol(receiver: GoPtr<Checker>, t: GoPtr<Type>, symbol_: GoPtr<Symbol>): GoSlice<GoPtr<Type>> {
  if (!Checker_isErrorType(receiver, t)) {
    if ((symbol_!.Flags & SymbolFlagsTypeAlias) !== 0) {
      const typeParameters = LinkStore_Get<GoPtr<Symbol>, TypeAliasLinks>(receiver!.typeAliasLinks, symbol_, goZeroTypeAliasLinks, goSymbolPointerKey)!.v.typeParameters;
      if ((typeParameters ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())).length !== 0) {
        return typeParameters;
      }
    }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getEffectiveTypeArgumentAtIndex","kind":"method","status":"implemented","sigHash":"9368c1241078c7c9d7cd8ca876a208e69423119288a7d115984ca99916783719"}
 *
 * Go source:
...
export function Checker_getEffectiveTypeArgumentAtIndex(receiver: GoPtr<Checker>, node: GoPtr<Node>, typeParameters: GoSlice<GoPtr<Type>>, index: int): GoPtr<Type> {
  ...
  if (index < (typeArguments ?? GoSliceMake(0, 0, GoPointerValueOps<Node>())).length) {
    return Checker_getTypeFromTypeNode(receiver, GoSliceLoad(typeArguments!, index, GoPointerValueOps<Node>()));
  }
  return GoSliceLoad(Checker_getEffectiveTypeArguments(receiver, node, typeParameters), index, GoPointerValueOps<Type>());
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getRestType","kind":"method","status":"implemented","sigHash":"32a32535061c5c2137388fdea266e7494b721ae45ce4d133e940454d2a62bd3f"}
 *
 * Go source:
...
export function Checker_getRestType(receiver: GoPtr<Checker>, source: GoPtr<Type>, properties: GoSlice<GoPtr<Node>>, symbol_: GoPtr<Symbol>): GoPtr<Type> {
  ...
  let spreadableProperties: GoSlice<GoPtr<Symbol>> = GoNilSlice();
  let unspreadableToRestKeys: GoSlice<GoPtr<Type>> = GoNilSlice();
  for (
    let __goRangeSlice = Checker_getPropertiesOfType(receiver, source),
      __goRangeLength = __goRangeSlice.length,
      __goRangeValueOps = GoPointerValueOps<Symbol>(),
      __goRangeIndex = 0;
    __goRangeIndex < __goRangeLength;
  ...
  if (Checker_isGenericObjectType(receiver, source) || Checker_isGenericIndexType(receiver, omitKeyType)) {
    ...
    return Checker_getTypeAliasInstantiation(receiver, omitTypeAlias, GoSliceBuild(2, 2, GoPointerValueOps<Type>(), (__goSliceLiteral) => {
      GoSliceStore(__goSliceLiteral, 0, source, GoPointerValueOps<Type>());
      GoSliceStore(__goSliceLiteral, 1, omitKeyType, GoPointerValueOps<Type>());
    }), undefined);
  }
  const members: SymbolTable = new globalThis.Map<string, GoPtr<Symbol>>();
  for (
    let __goRangeSlice = spreadableProperties,
      __goRangeLength = __goRangeSlice.length,
      __goRangeValueOps = GoPointerValueOps<Symbol>(),
      __goRangeIndex = 0;
    __goRangeIndex < __goRangeLength;
  ...
  const result = Checker_newAnonymousType(receiver, symbol_, members, GoNilSlice(), GoNilSlice(), Checker_getIndexInfosOfType(receiver, source));
  result!.objectFlags = (result!.objectFlags | ObjectFlagsObjectRestType) as ObjectFlags;
  return result;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isConstructorDeclaredThisProperty","kind":"method","status":"implemented","sigHash":"cb17cbfc38c3ff79b0321ae8f25e2dbc648c25f66cfb8369f73786ea0d95a8d7"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isGlobalSymbolConstructor","kind":"method","status":"implemented","sigHash":"18328612f88f78b7a833ef710e15b0dbf06ac5e4572f0092bf789d72fdefc0a7"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSignaturesOfType","kind":"method","status":"implemented","sigHash":"50516a040707d550bebf1933c979d6c88fa4c021222a40f2b646811f12db420c"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSignaturesOfStructuredType","kind":"method","status":"implemented","sigHash":"34db2c00f2b9b0f54322d04da591540b9fa3b3749cc98db010353f4a89509b1b"}
 *
 * Go source:
...
export function Checker_getSignaturesOfStructuredType(receiver: GoPtr<Checker>, t: GoPtr<Type>, kind: SignatureKind): GoSlice<GoPtr<Signature>> {
  ...
  const resolved = Checker_resolveStructuredTypeMembers(receiver, t);
  if (kind === SignatureKindCall) {
    return StructuredType_CallSignatures(resolved);
  }
  return StructuredType_ConstructSignatures(resolved);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getApplicableIndexInfo","kind":"method","status":"implemented","sigHash":"0e929585b24365682b9fa0b24f6a7b760d2a27a49175a56380d049cf0ed7726f"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getApplicableIndexInfoForName","kind":"method","status":"implemented","sigHash":"3af8b79071c0e6cb6d0495dd631e419bbe21b373019b353ba487f85657677f61"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.findApplicableIndexInfo","kind":"method","status":"implemented","sigHash":"37bc60135b8c12225c8c34a171d329b3e6487738b1ece89449e5031b10c1bc89"}
 *
 * Go source:
...
export function Checker_findApplicableIndexInfo(receiver: GoPtr<Checker>, indexInfos: GoSlice<GoPtr<IndexInfo>>, keyType: GoPtr<Type>): GoPtr<IndexInfo> {
  ...
  let applicableInfos: GoSlice<GoPtr<IndexInfo>> = GoSliceMake(0, 0, GoPointerValueOps<IndexInfo>());
  for (
    let __goRangeSlice = (indexInfos ?? GoSliceMake(0, 0, GoPointerValueOps<IndexInfo>())),
      __goRangeLength = __goRangeSlice.length,
      __goRangeValueOps = GoPointerValueOps<IndexInfo>(),
      __goRangeIndex = 0;
    __goRangeIndex < __goRangeLength;
  ...
  if (applicableInfos.length === 1) {
    return GoSliceLoad(applicableInfos, 0, GoPointerValueOps<IndexInfo>());
  }
  let isReadonly = true;
  ...
  return Checker_newIndexInfo(receiver, receiver!.unknownType, Checker_getIntersectionType(receiver, types), isReadonly, undefined, GoNilSlice());
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isApplicableIndexType","kind":"method","status":"implemented","sigHash":"16b0b8d353b8525fdf8ade7276fcbfd685c3c671a2a845183c9d0cf17c5bae97"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getInstantiatedConstructorsForTypeArguments","kind":"method","status":"implemented","sigHash":"b184f761d715e78402b38709f0cb09704f776a86564b48966bb0e0a79ad76856"}
 *
 * Go source:
...
export function Checker_getInstantiatedConstructorsForTypeArguments(receiver: GoPtr<Checker>, t: GoPtr<Type>, typeArgumentNodes: GoSlice<GoPtr<Node>>, location: GoPtr<Node>): GoSlice<GoPtr<Signature>> {
  ...
  return core.SameMap(signatures, (sig: GoPtr<Signature>) => {
    if (sig!.typeParameters.length !== 0) {
      return Checker_getSignatureInstantiation(receiver, sig, typeArguments, IsInJSFile(location), GoNilSlice<GoPtr<Type>>());
    }
    return sig;
  }, GoEqualStrict<GoPtr<Signature>>);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getConstructorsForTypeArguments","kind":"method","status":"implemented","sigHash":"d3563ca7958e8270c22563b209046a4db9388807625d557b3a4854b2ca60cf9d"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSignatureInstantiation","kind":"method","status":"implemented","sigHash":"c644227b7797d9527e44f59ac8691746d09a02195ccd36e9d90982c6b7bf87ef"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.cloneSignature","kind":"method","status":"implemented","sigHash":"8af0f1860c9a904b18cbaf6085e763141df33b52a9b03ed6a70a611c2f9d8914"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSignatureInstantiationWithoutFillingInTypeArguments","kind":"method","status":"implemented","sigHash":"b17d88b595cefe5cf56615ab4609d0d91cf9f92411ce71cb2241805af9ea4758"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.createSignatureInstantiation","kind":"method","status":"implemented","sigHash":"630f00305534cb7148da172e49f25a030b1f38eb2941c2020bc236b3220cc346"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.createSignatureTypeMapper","kind":"method","status":"implemented","sigHash":"f64f28afca514f4d3a0818c941b3f83f5d96b0d610b5331ac900e9adf458e2f5"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeParametersForMapper","kind":"method","status":"implemented","sigHash":"7c8402a9f1b6c625f05c97025ae6007a3b02a7b0b934090b9d24a58008597fb7"}
 *
 * Go source:
...
export function Checker_getTypeParametersForMapper(receiver: GoPtr<Checker>, sig: GoPtr<Signature>): GoSlice<GoPtr<Type>> {
  return core.SameMap(sig!.typeParameters, (tp: GoPtr<Type>) => Checker_instantiateType(receiver, tp, Type_Mapper(tp)), GoEqualStrict<GoPtr<Type>>);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSingleCallSignature","kind":"method","status":"implemented","sigHash":"c93d70b0832c957a048799f30321cc4acbf1f56ec42360885d675ee6889368f0"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSingleCallOrConstructSignature","kind":"method","status":"implemented","sigHash":"92013c0ea077bb39333b18b4fb281dbe53004570a448804eab0f033ae53bf13d"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSingleSignature","kind":"method","status":"implemented","sigHash":"7e22b62c0304062f3158dca7e9887bdd2f85f7e392a3d27c22a34779e7ebff00"}
 *
 * Go source:
  ...
  if ((t!.flags & TypeFlagsObject) !== 0) {
    ...
    if (allowMembers || (resolved!.properties.length === 0 && resolved!.indexInfos.length === 0)) {
      if (kind === SignatureKindCall && callSignatures.length === 1 && constructSignatures.length === 0) {
        return GoSliceLoad(callSignatures, 0, GoPointerValueOps<Signature>());
      }
      if (kind === SignatureKindConstruct && constructSignatures.length === 1 && callSignatures.length === 0) {
        return GoSliceLoad(constructSignatures, 0, GoPointerValueOps<Signature>());
      }
    }
  }
  return undefined;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getOrCreateTypeFromSignature","kind":"method","status":"implemented","sigHash":"07e8e120451c03e87dbbc9f7cd823b90e9915ce423d6d7c68c81fa31ed3826c2"}
 *
 * Go source:
...
export function Checker_getOrCreateTypeFromSignature(receiver: GoPtr<Checker>, sig: GoPtr<Signature>): GoPtr<Type> {
  if (sig!.isolatedSignatureType === undefined) {
    ...
    if (isConstructor) {
      Checker_setStructuredTypeMembers(receiver, t, GoNilMap<string, GoPtr<Symbol>>(), GoNilSlice<GoPtr<Signature>>(), GoSliceBuild(1, 1, GoPointerValueOps<Signature>(), (__goSliceLiteral) => {
        GoSliceStore(__goSliceLiteral, 0, sig, GoPointerValueOps<Signature>());
      }), GoNilSlice<GoPtr<IndexInfo>>());
    } else {
      Checker_setStructuredTypeMembers(receiver, t, GoNilMap<string, GoPtr<Symbol>>(), GoSliceBuild(1, 1, GoPointerValueOps<Signature>(), (__goSliceLiteral) => {
        GoSliceStore(__goSliceLiteral, 0, sig, GoPointerValueOps<Signature>());
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getErasedSignature","kind":"method","status":"implemented","sigHash":"fedbb8f99106887c9043f8aed2ec0a1d2c2735a347b2c879a87ee0504d80c0d7"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getCanonicalSignature","kind":"method","status":"implemented","sigHash":"c67f9d9003e262ecaaf0f6da34c2762847b1de7c29aa29f72f0abb464fae51aa"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.createCanonicalSignature","kind":"method","status":"implemented","sigHash":"f2a151f8882084afdb1dad47e16e51b89b979864a907b92766cb434274b46413"}
 *
 * Go source:
...
export function Checker_createCanonicalSignature(receiver: GoPtr<Checker>, signature: GoPtr<Signature>): GoPtr<Signature> {
  ...
  return Checker_getSignatureInstantiation(receiver, signature, typeArguments, IsInJSFile(signature!.declaration), GoNilSlice<GoPtr<Type>>());
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getBaseSignature","kind":"method","status":"implemented","sigHash":"dad4d349d561e4a742b1d6a2433a1c3d7b739120db9cc49ff5578600578d9ee8"}
 *
 * Go source:
...
export function Checker_getBaseSignature(receiver: GoPtr<Checker>, signature: GoPtr<Signature>): GoPtr<Signature> {
  ...
  const baseConstraintMapper = newTypeMapper(typeParameters, core.Map(typeParameters, (tp: GoPtr<Type>) => core.OrElse(Checker_getConstraintOfTypeParameter(receiver, tp), receiver!.unknownType, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>)));
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.instantiateSignatureInContextOf","kind":"method","status":"implemented","sigHash":"d4109d974c468503e82ac33ce61d07bd048171513968417025cee85095fcd050"}
 *
 * Go source:
...
export function Checker_instantiateSignatureInContextOf(receiver: GoPtr<Checker>, signature: GoPtr<Signature>, contextualSignature: GoPtr<Signature>, inferenceContext: GoPtr<InferenceContext>, compareTypes: TypeComparer): GoPtr<Signature> {
  ...
  return Checker_getSignatureInstantiation(receiver, signature, Checker_getInferredTypes(receiver, context), IsInJSFile(contextualSignature!.declaration), GoNilSlice<GoPtr<Type>>());
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.areAllOuterTypeParametersApplied","kind":"method","status":"implemented","sigHash":"f33f7fce6e563a5d25bb4c42e06facf91b9246e26083188387d9fb479219ff81"}
 *
 * Go source:
...
export function Checker_areAllOuterTypeParametersApplied(receiver: GoPtr<Checker>, t: GoPtr<Type>): bool {
  ...
  if ((outerTypeParameters ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())).length !== 0) {
    const last = outerTypeParameters!.length - 1;
    const typeArguments = Checker_getTypeArguments(receiver, t);
    return GoSliceLoad(outerTypeParameters!, last, GoPointerValueOps<Type>())!.symbol !== GoSliceLoad(typeArguments, last, GoPointerValueOps<Type>())!.symbol;
  }
  return true;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeWithThisArgument","kind":"method","status":"implemented","sigHash":"7d06ee979b4d360d3ac69112a2ddb97f8033ace7817ab4bc6808e132966e87a3"}
 *
 * Go source:
...
export function Checker_getTypeWithThisArgument(receiver: GoPtr<Checker>, t: GoPtr<Type>, thisArgument: GoPtr<Type>, needApparentType: bool): GoPtr<Type> {
  if ((t!.objectFlags & ObjectFlagsReference) !== 0) {
    ...
    const typeArguments = Checker_getTypeArguments(receiver, t);
    if ((InterfaceType_TypeParameters(Type_AsInterfaceType(target)) ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())).length === typeArguments.length) {
      const thisArg = core.OrElse(thisArgument, Type_AsInterfaceType(target)!.thisType, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>);
      return Checker_createTypeReference(receiver, target, core.Concatenate(typeArguments, GoSliceBuild(1, 1, GoPointerValueOps<Type>(), (__goSliceLiteral) => {
        GoSliceStore(__goSliceLiteral, 0, thisArg, GoPointerValueOps<Type>());
      })));
    }
    return t;
  } else if ((t!.flags & TypeFlagsIntersection) !== 0) {
    const types = Type_Types(t);
    const newTypes = core.SameMap(types, (t2: GoPtr<Type>) => Checker_getTypeWithThisArgument(receiver, t2, thisArgument, needApparentType), GoEqualStrict<GoPtr<Type>>);
    if (core.Same(newTypes, types)) {
      return t;
    }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSignaturesOfSymbol","kind":"method","status":"implemented","sigHash":"081addefada23b2ac3735f3c1719b5761d0db69db6245b8747952e9571c42f0d"}
 *
 * Go source:
...
export function Checker_getSignaturesOfSymbol(receiver: GoPtr<Checker>, symbol_: GoPtr<Symbol>): GoSlice<GoPtr<Signature>> {
  ...
  let result = GoNilSlice<GoPtr<Signature>>();
  const declarations = symbol_!.Declarations ?? GoSliceMake(0, 0, GoPointerValueOps<Node>());
  for (let i = 0; i < declarations.length; i++) {
    const decl = GoSliceLoad(declarations, i, GoPointerValueOps<Node>());
    if (!IsFunctionLike(decl)) {
      continue;
    }
    if (i > 0 && Node_Body(decl) !== undefined) {
      const previous = GoSliceLoad(declarations, i - 1, GoPointerValueOps<Node>());
      if (decl!.Parent === previous!.Parent && decl!.Kind === previous!.Kind &&
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSignatureFromDeclaration","kind":"method","status":"implemented","sigHash":"ee770b9980969ab7ab7012ac9a1714c1d871e9c3f83494c8d6cff09c8370c9f8"}
 *
 * Go source:
...
export function Checker_getSignatureFromDeclaration(receiver: GoPtr<Checker>, declaration: GoPtr<Node>): GoPtr<Signature> {
  const links = LinkStore_Get(receiver!.signatureLinks, declaration, goZeroSignatureLinks, goNodePointerKey)!.v;
  if (links!.resolvedSignature !== undefined) {
    return links!.resolvedSignature;
  }
  let parameters = GoNilSlice<GoPtr<Symbol>>();
  ...
  for (const [i, param] of (Node_Parameters(declaration) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>())).entries()) {
    ...
    const isOptionalParameter = isOptionalDeclaration(param)
      ...
      || isRestParameter(param)
      || (iife !== undefined && parameters.length > (Node_Arguments(iife) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>())).length && typeNode === undefined);
    if (!isOptionalParameter) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeParametersFromDeclaration","kind":"method","status":"implemented","sigHash":"a063b0e90c2bc824e1e6da60e669447516b9613d791411b2f0339d17a0a24b63"}
 *
 * Go source:
...
export function Checker_getTypeParametersFromDeclaration(receiver: GoPtr<Checker>, declaration: GoPtr<Node>): GoSlice<GoPtr<Type>> {
  ...
  let result = GoNilSlice<GoPtr<Type>>();
  for (
    let __goRangeSlice = Node_TypeParameters(declaration) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()),
      __goRangeLength = __goRangeSlice.length,
      __goRangeValueOps = GoPointerValueOps<Node>(),
      __goRangeIndex = 0;
    __goRangeIndex < __goRangeLength;
    ...
    const node = GoSliceLoad(__goRangeSlice, __goRangeIndex, __goRangeValueOps);
    result = core.AppendIfUnique(result, Checker_getDeclaredTypeOfTypeParameter(receiver, Node_Symbol(node)), GoEqualStrict<GoPtr<Type>>);
  }
  return result;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getAnnotatedAccessorThisParameter","kind":"method","status":"implemented","sigHash":"e11a7bce63956029fa477b2060a7db44b6862df1690c92e2ea9eae66e8d5cfdb"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getAccessorThisParameter","kind":"method","status":"implemented","sigHash":"8f92422cd97ba50bebe0ad7cdad6f9a705c19a1823f3a8c277d433e5e23e4dde"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.hasLateBindableIndexSignature","kind":"method","status":"implemented","sigHash":"8340a9b041cf06f3be6fafff63e4971dbdbc0dc4a71ae4ac6c66af17944f883c"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isLateBindableIndexSignature","kind":"method","status":"implemented","sigHash":"a5d739ba1fad244d682fb0c01f2e31c9a0704e07853b66bb4b4000fb9d6d109b"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isTypeUsableAsIndexSignatureDeclaration","kind":"method","status":"implemented","sigHash":"d02a784a762fd058fc6380b28bb73c284cd47a355e615e3823f705648df917f3"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getReturnTypeOfSignature","kind":"method","status":"implemented","sigHash":"33410e1515531741a40c86e3ab02b0193f46da481fafe969678dcb2bf8d7deed"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getNonCircularReturnTypeOfSignature","kind":"method","status":"implemented","sigHash":"d0801936cd6491f24fcb7580847fd22c4177dc24ab088d45828e2fd19cfc8ffe"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getReturnTypeFromAnnotation","kind":"method","status":"implemented","sigHash":"e2a8bdf7fc0cc1762cda4b184d381d18fd19c5e26c5ac56bf76191e06e14d295"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSignatureOfFullSignatureType","kind":"method","status":"implemented","sigHash":"4faf1dacbb3511e10486711666811131b4110d8492023da54129b1602769cb2c"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getParameterTypeOfFullSignature","kind":"method","status":"implemented","sigHash":"9b6638b1e7364aca889bcb1880a308306d9a54eb49ad60c532ff89bb503262e6"}
 *
 * Go source:
...
export function Checker_getParameterTypeOfFullSignature(receiver: GoPtr<Checker>, node: GoPtr<Node>, parameter: GoPtr<ParameterDeclarationNode>): GoPtr<Type> {
  ...
  if (signature !== undefined) {
    const pos = slices.Index(Node_Parameters(node), parameter, GoEqualStrict<GoPtr<Node>>);
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getReturnTypeOfFullSignature","kind":"method","status":"implemented","sigHash":"a80fcde458b0e599023d1b95f61fea07f99ce0b933d059caaf4faa2f17a94003"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getReturnTypeFromBody","kind":"method","status":"implemented","sigHash":"bdc5379186bfb9cb1e7f5fc54f549e30d73d828d4eb210d522c93fca044bcc91"}
 *
 * Go source:
...
export function Checker_getReturnTypeFromBody(receiver: GoPtr<Checker>, fn: GoPtr<Node>, checkMode: CheckMode): GoPtr<Type> {
  ...
  if (!IsBlock(body)) {
    ...
    } else if ((returnTypes ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())).length !== 0) {
    ...
    if ((types ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())).length === 0) {
      ...
      const emptyReturnType = contextualReturnType !== undefined &&
        someType(core.OrElse(Checker_unwrapReturnType(receiver, contextualReturnType, functionFlags), receiver!.voidType, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>), (t: GoPtr<Type>): bool => (t!.flags & TypeFlagsUndefined) !== 0)
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.createPromiseReturnType","kind":"method","status":"implemented","sigHash":"d9c4e358d60ad12b99bf0796a913da290700cf496486bde867e8ec3fb993dd7e"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.unwrapReturnType","kind":"method","status":"implemented","sigHash":"142fb709106bce6407d505d865fa5a7f03446a49dddc24ccd456d60ed1afd4a5"}
 *
 * Go source:
...
export function Checker_unwrapReturnType(receiver: GoPtr<Checker>, returnType: GoPtr<Type>, functionFlags: FunctionFlags): GoPtr<Type> {
  ...
  if (isAsync) {
    return core.OrElse(Checker_getAwaitedTypeNoAlias(receiver, returnType), receiver!.errorType, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>);
  }
  return returnType;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getWidenedLiteralLikeTypeForContextualReturnTypeIfNeeded","kind":"method","status":"implemented","sigHash":"fc31453aa19698365bd4fa3dcf5dd7ffe74288c9137660378eb70bbc1700bb42"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkIfExpressionRefinesAnyParameter","kind":"method","status":"implemented","sigHash":"612a6ab061e2c25ed4112030f6e2fa7041e8db2ddfbaa1d76c12359f7f21602d"}
 *
 * Go source:
...
export function Checker_checkIfExpressionRefinesAnyParameter(receiver: GoPtr<Checker>, fn: GoPtr<Node>, expr: GoPtr<Node>): GoPtr<TypePredicate> {
  ...
  for (let i = 0; i < parameters.length; i++) {
    const param = GoSliceLoad(parameters, i, GoPointerValueOps<Node>());
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkIfExpressionRefinesParameter","kind":"method","status":"implemented","sigHash":"71e2338fab62cfacd2df5e5fd6cd45f1c5026e998ac8e92a741afbe8575e6f4f"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.instantiateSignature","kind":"method","status":"implemented","sigHash":"0c24cd9a94d314d24b9cc23b3940ed992476091121651a25805df250df5108bc"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.instantiateSignatureEx","kind":"method","status":"implemented","sigHash":"e80862e53012f4cee5dd56ba1e2fc5f06c3144351fab423715142fe48ce5470c"}
 *
 * Go source:
...
export function Checker_instantiateSignatureEx(receiver: GoPtr<Checker>, sig: GoPtr<Signature>, m: GoPtr<TypeMapper>, eraseTypeParameters: bool): GoPtr<Signature> {
  let freshTypeParameters = GoNilSlice<GoPtr<Type>>();
  if (sig!.typeParameters.length !== 0 && !eraseTypeParameters) {
    ...
    for (
      let __goRangeSlice = freshTypeParameters,
        __goRangeLength = __goRangeSlice.length,
        __goRangeValueOps = GoPointerValueOps<Type>(),
        __goRangeIndex = 0;
      __goRangeIndex < __goRangeLength;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getDefaultConstructSignatures","kind":"method","status":"implemented","sigHash":"cc919b19751b29ec5b20ad9cf22bd40304a02ebc1680bfddbe916b7ad2c3f650"}
 *
 * Go source:
...
export function Checker_getDefaultConstructSignatures(receiver: GoPtr<Checker>, classType: GoPtr<Type>): GoSlice<GoPtr<Signature>> {
  ...
  if (baseSignatures.length === 0) {
    ...
    return GoSliceBuild(1, 1, GoPointerValueOps<Signature>(), (__goSliceLiteral) => {
      GoSliceStore(__goSliceLiteral, 0, Checker_newSignature(receiver, flags as SignatureFlags, undefined, InterfaceType_LocalTypeParameters(Type_AsInterfaceType(classType)), undefined, GoNilSlice(), classType, undefined, 0), GoPointerValueOps<Signature>());
    });
  }
  ...
  let result: GoSlice<GoPtr<Signature>> = GoNilSlice();
  for (
    let __goRangeSlice = baseSignatures,
      __goRangeLength = __goRangeSlice.length,
      __goRangeValueOps = GoPointerValueOps<Signature>(),
      __goRangeIndex = 0;
    __goRangeIndex < __goRangeLength;
    ...
    const baseSig = GoSliceLoad(__goRangeSlice, __goRangeIndex, __goRangeValueOps);
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getArrayMemberCallSignatures","kind":"method","status":"implemented","sigHash":"3210399b2151444fc4a8e6c3f84c8a55440010c73bc0d7b1c8663fb21c9baa5a"}
 *
 * Go source:
...
export function Checker_getArrayMemberCallSignatures(receiver: GoPtr<Checker>, t: GoPtr<Type>): GoSlice<GoPtr<Signature>> {
  ...
  for (let i = 0; i < types.length; i++) {
    const type_ = GoSliceLoad(types, i, GoPointerValueOps<Type>())!;
  ...
  const arrayArg = Checker_mapType(receiver, t, (type_: GoPtr<Type>): GoPtr<Type> => {
    ...
    return TypeMapper_Map(Type_Mapper(type_), GoSliceLoad(InterfaceType_TypeParameters(Type_AsInterfaceType(arrayTarget)), 0, GoPointerValueOps<Type>())!);
  });
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getUnionSignatures","kind":"method","status":"implemented","sigHash":"15bcf59e14ac4a1c8747e7cfaf299276b4d2cb88007c622fdb12e226e90bf0b3"}
 *
 * Go source:
...
export function Checker_getUnionSignatures(receiver: GoPtr<Checker>, signatureLists: GoSlice<GoSlice<GoPtr<Signature>>>): GoSlice<GoPtr<Signature>> {
  ...
  for (let i = 0; i < signatureLists.length; i++) {
    if (GoSliceLoad(signatureLists, i, GoSliceValueOps<GoPtr<Signature>>())!.length === 0) {
      return GoNilSlice<GoPtr<Signature>>();
    }
    if (GoSliceLoad(signatureLists, i, GoSliceValueOps<GoPtr<Signature>>())!.length > 1) {
      indexWithLengthOverOne = i as int;
      countLengthOverOne++;
    }
    for (
      let __goRangeSlice = GoSliceLoad(signatureLists, i, GoSliceValueOps<GoPtr<Signature>>())!,
        __goRangeLength = __goRangeSlice.length,
        __goRangeValueOps = GoPointerValueOps<Signature>(),
        __goRangeIndex = 0;
      __goRangeIndex < __goRangeLength;
      ...
      const signature = GoSliceLoad(__goRangeSlice, __goRangeIndex, __goRangeValueOps);
      // Only process signatures with parameter lists that aren't already in the result list
      if (GoSliceIsNil(result) || Checker_findMatchingSignature(receiver, result, signature, false, false, true) === undefined) {
        const unionSignatures = Checker_findMatchingSignatures(receiver, signatureLists, signature, i as int);
        if (!GoSliceIsNil(unionSignatures)) {
          let s = signature;
          // Union the result types when more than one signature matches
          if (unionSignatures.length > 1) {
            ...
            if (firstThisParameterOfUnionSignatures !== undefined) {
              const thisType = Checker_getIntersectionType(receiver, core.MapNonNil(unionSignatures, (sig: GoPtr<Signature>): GoPtr<Type> => {
                ...
                return undefined;
              }, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>));
  ...
  if (result.length === 0 && countLengthOverOne <= 1) {
    ...
    // nature and having overloads in multiple constituents would necessitate making a power set of signatures from the type, whose
    // ordering would be non-obvious)
    const masterList = GoSliceLoad(signatureLists, indexWithLengthOverOne, GoSliceValueOps<GoPtr<Signature>>())!;
    let results = slices.Clone(masterList);
    for (
      let __goRangeSlice = signatureLists,
        __goRangeLength = __goRangeSlice.length,
        __goRangeValueOps = GoSliceValueOps<GoPtr<Signature>>(),
        __goRangeIndex = 0;
      __goRangeIndex < __goRangeLength;
      __goRangeIndex++
    ) {
      const signatures = GoSliceLoad(__goRangeSlice, __goRangeIndex, __goRangeValueOps);
      if (!core.Same(signatures, masterList)) {
        ...
        if (signature.typeParameters.length !== 0 && core.Some(results, (s: GoPtr<Signature>): bool => {
          ...
          results = GoNilSlice<GoPtr<Signature>>();
        } else {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.combineUnionOrIntersectionMemberSignatures","kind":"method","status":"implemented","sigHash":"de6844df9e05862ba295f4daad8ed1b0eb336022be9ab5bb7860082383845b40"}
 *
 * Go source:
...
export function Checker_combineUnionOrIntersectionMemberSignatures(receiver: GoPtr<Checker>, left: GoPtr<Signature>, right: GoPtr<Signature>, isUnion: bool): GoPtr<Signature> {
  ...
  const lastParam = core.LastOrNil(params, GoZeroPointer<Symbol>);
  ...
  if (left!.composite !== undefined && left!.composite.isUnion) {
    ...
    leftSignatures = GoSliceBuild(1, 1, GoPointerValueOps<Signature>(), (__goSliceLiteral) => {
      GoSliceStore(__goSliceLiteral, 0, left, GoPointerValueOps<Signature>());
    });
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.combineUnionOrIntersectionParameters","kind":"method","status":"implemented","sigHash":"72ea8e5cc81eeb6245823f316712b77c0199ee3a8bf4d1bfaa14f9301923c2fc"}
 *
 * Go source:
...
export function Checker_combineUnionOrIntersectionParameters(receiver: GoPtr<Checker>, left: GoPtr<Signature>, right: GoPtr<Signature>, mapper: GoPtr<TypeMapper>, isUnion: bool): GoSlice<GoPtr<Symbol>> {
  ...
  for (let i = 0; i < longestCount; i++) {
    ...
    let shorterParamType = core.OrElse(Checker_tryGetTypeAtPosition(receiver, shorter, i as int), receiver!.unknownType, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>);
    if (shorter === right) {
      shorterParamType = Checker_instantiateType(receiver, shorterParamType, mapper);
    }
    const combinedParamType = Checker_getUnionOrIntersectionType(receiver, GoSliceBuild(2, 2, GoPointerValueOps<Type>(), (__goSliceLiteral) => {
      GoSliceStore(__goSliceLiteral, 0, longestParamType, GoPointerValueOps<Type>());
      GoSliceStore(__goSliceLiteral, 1, shorterParamType, GoPointerValueOps<Type>());
    ...
    const links = LinkStore_Get(receiver!.valueSymbolLinks, paramSymbol, goZeroValueSymbolLinks, goSymbolPointerKey)!.v;
    if (isRestParam) {
      links!.resolvedType = Checker_createArrayType(receiver, combinedParamType);
    } else {
      links!.resolvedType = combinedParamType;
    }
    GoSliceStore(params, i, paramSymbol, GoPointerValueOps<Symbol>());
  }
  if (needsExtraRestElement) {
    ...
    const links = LinkStore_Get(receiver!.valueSymbolLinks, restParamSymbol, goZeroValueSymbolLinks, goSymbolPointerKey)!.v;
    ...
    GoSliceStore(params, longestCount, restParamSymbol, GoPointerValueOps<Symbol>());
  }
  return params;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.appendSignatures","kind":"method","status":"implemented","sigHash":"5c3fa0c2ecdf16edcebf284c72274319cdda4a79a191179ae327b923d4a4b8ed"}
 *
 * Go source:
...
export function Checker_appendSignatures(receiver: GoPtr<Checker>, signatures: GoSlice<GoPtr<Signature>>, newSignatures: GoSlice<GoPtr<Signature>>): GoSlice<GoPtr<Signature>> {
  for (
    let __goRangeSlice = newSignatures,
      __goRangeLength = __goRangeSlice.length,
      __goRangeValueOps = GoPointerValueOps<Signature>(),
      __goRangeIndex = 0;
    __goRangeIndex < __goRangeLength;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeArguments","kind":"method","status":"implemented","sigHash":"3c7691036560484008d07192ef2d8716f3171561be9cfbe8b8c5854121ba87f8"}
 *
 * Go source:
    ...
    if (node !== undefined) {
      switch (node.Kind) {
        case KindTypeReference:
          ...
          break;
        case KindArrayType:
          typeArguments = GoSliceBuild(1, 1, GoPointerValueOps<Type>(), (__goSliceLiteral) => {
            GoSliceStore(__goSliceLiteral, 0, Checker_getTypeFromTypeNode(receiver, AsArrayTypeNode(node)!.ElementType), GoPointerValueOps<Type>());
          });
          break;
        case KindTupleType:
          typeArguments = core.Map(Node_Elements(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), (element: GoPtr<Node>) => Checker_getTypeFromTypeNode(receiver, element));
          break;
        default:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getEffectiveTypeArguments","kind":"method","status":"implemented","sigHash":"02e479812dd0eb4e62a29ee97c7db5885a4135552e5eabdf9afffc3f992557bf"}
 *
 * Go source:
...
export function Checker_getEffectiveTypeArguments(receiver: GoPtr<Checker>, node: GoPtr<Node>, typeParameters: GoSlice<GoPtr<Type>>): GoSlice<GoPtr<Type>> {
  return Checker_fillMissingTypeArguments(receiver, core.Map(Node_TypeArguments(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), (n: GoPtr<Node>) => Checker_getTypeFromTypeNode(receiver, n)), typeParameters, Checker_getMinTypeArgumentCount(receiver, typeParameters), IsInJSFile(node));
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getMinTypeArgumentCount","kind":"method","status":"implemented","sigHash":"425b8512371c9a1e34793893846b40a2a095d68f623669e176946b1f8cba6d9b"}
 *
 * Go source:
...
export function Checker_getMinTypeArgumentCount(receiver: GoPtr<Checker>, typeParameters: GoSlice<GoPtr<Type>>): int {
  ...
  for (let i = 0; i < typeParameters.length; i++) {
    if (!Checker_hasTypeParameterDefault(receiver, GoSliceLoad(typeParameters, i, GoPointerValueOps<Type>()))) {
      minTypeArgumentCount = i + 1;
    }
  }
  return minTypeArgumentCount;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.hasTypeParameterDefault","kind":"method","status":"implemented","sigHash":"e9cce9e048ed33dc9ed8c075a145c4214a0ab0f84854c1f7352688311c73de56"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.fillMissingTypeArguments","kind":"method","status":"implemented","sigHash":"90119f31e42b5b3c6483f74a4486a50d2c36e8e47fd66a2b2a63c01cf4ffbd18"}
 *
 * Go source:
...
export function Checker_fillMissingTypeArguments(receiver: GoPtr<Checker>, typeArguments: GoSlice<GoPtr<Type>>, typeParameters: GoSlice<GoPtr<Type>>, minTypeArgumentCount: int, isJavaScriptImplicitAny: bool): GoSlice<GoPtr<Type>> {
  const numTypeParameters = (typeParameters ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())).length;
  if (numTypeParameters === 0) {
    return GoNilSlice<GoPtr<Type>>();
  }
  const numTypeArguments = (typeArguments ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())).length;
  if (isJavaScriptImplicitAny || numTypeArguments < numTypeParameters) {
    const result: GoPtr<Type>[] = new Array(numTypeParameters);
    for (let i = 0; i < numTypeArguments; i++) {
      result[i] = GoSliceLoad(typeArguments!, i, GoPointerValueOps<Type>());
    }
    // Map invalid forward references in default types to the error type
    ...
    for (let i = numTypeArguments; i < numTypeParameters; i++) {
      let defaultType = Checker_getDefaultFromTypeParameter(receiver, GoSliceLoad(typeParameters!, i, GoPointerValueOps<Type>()));
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getDefaultTypeArgumentType","kind":"method","status":"implemented","sigHash":"3c192613eb0fc4db43cea8c8d583f463f0ca886275cc03b3d0bc695c0b734731"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getDefaultFromTypeParameter","kind":"method","status":"implemented","sigHash":"61a693788195961b268345d33803df04c2757ae752165c8a562a0ff6844d28e6"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getResolvedTypeParameterDefault","kind":"method","status":"implemented","sigHash":"df0b5f27b5a3ad3a7f7e37bc9b455d7dc3215612a0d28be3e13b5ebb30fa4f7d"}
 *
 * Go source:
  ...
  if (d!.resolvedDefaultType === undefined) {
    if (d!.target !== undefined) {
      ...
      if (t!.symbol !== undefined) {
        const defaultDeclaration = core.FirstNonNil(t!.symbol!.Declarations ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), (decl: GoPtr<Node>) => {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getDefaultOrUnknownFromTypeParameter","kind":"method","status":"implemented","sigHash":"61be3bb8c19975f78659be69aee347f6aec3ec58e973f087c3be72e99c11c5a7"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isTypeParameterPossiblyReferenced","kind":"method","status":"implemented","sigHash":"c3efe8d0da236c675a357508c8dbd5538d1d43effe74befd2c2ec54b868f964c"}
 *
 * Go source:
...
export function Checker_isTypeParameterPossiblyReferenced(receiver: GoPtr<Checker>, tp: GoPtr<Type>, node: GoPtr<Node>): bool {
    ...
    switch (current!.Kind) {
      ...
      case KindTypeQuery: {
        ...
        if (!IsThisIdentifier(firstIdentifier)) {
          ...
          const typeParameterDeclaration = GoSliceLoad(tp!.symbol!.Declarations!, 0, GoPointerValueOps<Node>())!;
          ...
          if (typeParameterScope !== undefined) {
            return (
              core.Some(firstIdentifierSymbol!.Declarations ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), (declaration: GoPtr<Node>): bool =>
  ...
  if (tp!.symbol !== undefined && tp!.symbol.Declarations.length === 1) {
    const container = GoSliceLoad(tp!.symbol.Declarations!, 0, GoPointerValueOps<Node>())!.Parent;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.cloneTypeParameter","kind":"method","status":"implemented","sigHash":"b84cdc9b143ac359efd137b150a5b35c99c68195dd9f4b5e2424230fec3295ae"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeParameterFromMappedType","kind":"method","status":"implemented","sigHash":"643ec895f9675933995ffc972567ef3af732d268ffdf49fa89b9fda16b8a4914"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.forEachMappedTypePropertyKeyTypeAndIndexSignatureKeyType","kind":"method","status":"implemented","sigHash":"1842580a5020f1e9a9f02c5e415e7f99106426ec0a76e065c38578183b599f02"}
 *
 * Go source:
 ...
 * }
 */
export function Checker_forEachMappedTypePropertyKeyTypeAndIndexSignatureKeyType(receiver: GoPtr<Checker>, t: GoPtr<Type>, include: TypeFlags, stringsOnly: bool, cb: GoFunc<(keyType: GoPtr<Type>) => void>): void {
  for (
  ...
  if ((t!.flags & TypeFlagsAny) !== 0) {
    ...
    for (
      let __goRangeSlice = Checker_getIndexInfosOfType(receiver, t),
        __goRangeLength = __goRangeSlice.length,
        __goRangeValueOps = GoPointerValueOps<IndexInfo>(),
        __goRangeIndex = 0;
      __goRangeIndex < __goRangeLength;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.instantiateSignatures","kind":"method","status":"implemented","sigHash":"70ea0024c54c635fbe299ad597b08754a958f150df83d80538bdb6d53ba46dd1"}
 *
 * Go source:
...
export function Checker_instantiateSignatures(receiver: GoPtr<Checker>, signatures: GoSlice<GoPtr<Signature>>, m: GoPtr<TypeMapper>): GoSlice<GoPtr<Signature>> {
  return instantiateList(receiver, signatures, m, Checker_instantiateSignature, GoEqualStrict<GoPtr<Signature>>);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeFromThisTypeNode","kind":"method","status":"implemented","sigHash":"bebbe3308850a39404b9bbb496151206cc51c7e59aa77ed3c94871708a44c007"}
 *
 * Go source:
...
export function Checker_getTypeFromThisTypeNode(receiver: GoPtr<Checker>, node: GoPtr<Node>): GoPtr<Type> {
  ...
  if (links!.v.resolvedType === undefined) {
    links!.v.resolvedType = Checker_getThisType(receiver, node);
  }
  return links!.v.resolvedType;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getThisType","kind":"method","status":"implemented","sigHash":"d376c1bb26cc632cac687f0042954d9da53aac86b671125440feaf5135ee8b76"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeFromTypeLiteralOrFunctionOrConstructorTypeNode","kind":"method","status":"implemented","sigHash":"120386fe2a99dc1fa48790b1fa7a8f2f264f33f141f1d00f297ce6e8d6dea77d"}
 *
 * Go source:
...
export function Checker_getTypeFromTypeLiteralOrFunctionOrConstructorTypeNode(receiver: GoPtr<Checker>, node: GoPtr<Node>): GoPtr<Type> {
  ...
  if (links!.v.resolvedType === undefined) {
    ...
    if (sym === undefined || (Checker_getMembersOfSymbol(receiver, sym).size === 0 && alias === undefined)) {
      links!.v.resolvedType = receiver!.emptyTypeLiteralType;
    } else {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeArgumentsFromNode","kind":"method","status":"implemented","sigHash":"8fd9ba781c432f0e42c64db4d4bc010029344697e077baa76e577537edfb103b"}
 *
 * Go source:
...
export function Checker_getTypeArgumentsFromNode(receiver: GoPtr<Checker>, node: GoPtr<Node>): GoSlice<GoPtr<Type>> {
  return core.Map(Node_TypeArguments(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), (n: GoPtr<Node>) => Checker_getTypeFromTypeNode(receiver, n));
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkNoTypeArguments","kind":"method","status":"implemented","sigHash":"26b770b167eb332efded578de3deecedcd829e8b8e09873ff33eabe99a14eca1"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeReferenceArity","kind":"method","status":"implemented","sigHash":"9a84ea9c4f37c7a1bcf1f5339b3483403079422f5d9dec0e685a56edce05de01"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeArgumentsForAliasSymbol","kind":"method","status":"implemented","sigHash":"5a5629ce621d723b41e693a9da5be742080e2dee6041c344947278e950b09fbf"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getOuterTypeParametersOfClassOrInterface","kind":"method","status":"implemented","sigHash":"43d3086fd5015e18cf822cb63f7f6206f9cfa3cd02e59aa78d00794b3e275928"}
 *
 * Go source:
...
export function Checker_getOuterTypeParametersOfClassOrInterface(receiver: GoPtr<Checker>, symbol_: GoPtr<Symbol>): GoSlice<GoPtr<Type>> {
  ...
  if ((symbol_!.Flags & (SymbolFlagsClass | SymbolFlagsFunction)) === 0) {
    declaration = core.Find(symbol_!.Declarations ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), (d: GoPtr<Node>) => {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getOuterTypeParameters","kind":"method","status":"implemented","sigHash":"3b59e0658d42a9d47ce0c9cddb69d8ed981ba92b3bd0108b258e6a8c333b1662"}
 *
 * Go source:
    ...
    switch (kind) {
      ...
      case KindConditionalType: {
        ...
        if ((kind === KindFunctionExpression || kind === KindArrowFunction || IsObjectLiteralMethod(cur)) && Checker_isContextSensitive(receiver, cur)) {
          ...
          if (signature !== undefined && (signature!.typeParameters ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())).length !== 0) {
        ...
        const outerAndOwnTypeParameters = Checker_appendTypeParameters(receiver, outerTypeParameters, Node_TypeParameters(cur) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()));
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getInferTypeParameters","kind":"method","status":"implemented","sigHash":"ae4a3da196ac2ebc4baa6500b53dd9f982a9c81863dadfdeefbfa7354fd13293"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getLocalTypeParametersOfClassOrInterfaceOrTypeAlias","kind":"method","status":"implemented","sigHash":"5b2af1238460848c2f2636f1a7207fe68216541370f5a9b0815a69fac20bb3e9"}
 *
 * Go source:
...
export function Checker_getLocalTypeParametersOfClassOrInterfaceOrTypeAlias(receiver: GoPtr<Checker>, symbol_: GoPtr<Symbol>): GoSlice<GoPtr<Type>> {
  return Checker_appendLocalTypeParametersOfClassOrInterfaceOrTypeAlias(receiver, GoNilSlice<GoPtr<Type>>(), symbol_);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.appendLocalTypeParametersOfClassOrInterfaceOrTypeAlias","kind":"method","status":"implemented","sigHash":"0e49f06fd5f213428d2abe5e9ea2367a9a532cba05b0e51fc627c7125d85d4bf"}
 *
 * Go source:
...
export function Checker_appendLocalTypeParametersOfClassOrInterfaceOrTypeAlias(receiver: GoPtr<Checker>, types: GoSlice<GoPtr<Type>>, symbol_: GoPtr<Symbol>): GoSlice<GoPtr<Type>> {
  ...
  for (
    ...
    if (NodeKindIs(node, KindInterfaceDeclaration, KindClassDeclaration, KindClassExpression) || isTypeAlias(node)) {
      result = Checker_appendTypeParameters(receiver, result, Node_TypeParameters(node) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()));
    }
  }
  return result;
}
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.appendTypeParameters","kind":"method","status":"implemented","sigHash":"62786ed2b16fa3c4ea6d2cc12e4787fb20142023a71622215e872697cf4ead17"}
 *
 * Go source:
...
export function Checker_appendTypeParameters(receiver: GoPtr<Checker>, typeParameters: GoSlice<GoPtr<Type>>, declarations: GoSlice<GoPtr<Node>>): GoSlice<GoPtr<Type>> {
  ...
  for (
    ...
    const declaration = GoSliceLoad(__goRangeSlice, __goRangeIndex, __goRangeValueOps);
    result = core.AppendIfUnique(result, Checker_getDeclaredTypeOfTypeParameter(receiver, Checker_getSymbolOfDeclaration(receiver, declaration)), GoEqualStrict<GoPtr<Type>>);
  }
  return result;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getDeclaredTypeOfTypeParameter","kind":"method","status":"implemented","sigHash":"517fb865feadd036621a14083c0f76a0c689904ac34595e6b33a478857eb4a37"}
 *
 * Go source:
...
export function Checker_getDeclaredTypeOfTypeParameter(receiver: GoPtr<Checker>, symbol_: GoPtr<Symbol>): GoPtr<Type> {
  const links = LinkStore_Get<GoPtr<Symbol>, DeclaredTypeLinks>(receiver!.declaredTypeLinks as LinkStore<GoPtr<Symbol>, DeclaredTypeLinks>, symbol_, goZeroDeclaredTypeLinks, goSymbolPointerKey);
  if (links!.v.declaredType === undefined) {
    links!.v.declaredType = Checker_newTypeParameter(receiver, symbol_);
  }
  return links!.v.declaredType;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeFromRestTypeNode","kind":"method","status":"implemented","sigHash":"08e670b400d3daf49f6b406f7f799f2e9478374d6762599fcfab3a259c940e13"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getRestrictiveTypeParameter","kind":"method","status":"implemented","sigHash":"b1004dce8902aef8a198db32c0d8195c4fa76710d00be3b9e79188ab4864a66a"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getRestTypeOfTupleType","kind":"method","status":"implemented","sigHash":"7e9a7bf280d0732c5caf1eb7d8891b3925c7af54257bb9117f4e450825e077e6"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getUniqueLiteralTypeForTypeParameter","kind":"method","status":"implemented","sigHash":"84c895977e842a54d52f2ad2b0ae42e30c39bc9e34207e7acf16acca80925fe1"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.newTypeParameter","kind":"method","status":"implemented","sigHash":"2a29c57fac2bfff1773b35cf041820c22cb927e065a0ac7b69e39020c02f3384"}
 *
 * Go source:
...
export function Checker_newTypeParameter(receiver: GoPtr<Checker>, symbol_: GoPtr<Symbol>): GoPtr<Type> {
  const data = new TypeParameterData();
  const t = Checker_newType(receiver, TypeFlagsTypeParameter, ObjectFlagsNone, data);
  t!["symbol"] = symbol_;
  return t;
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.newSignature","kind":"method","status":"implemented","sigHash":"0705401fb9577a843532c59e2aa1c1a769ceeffe13f757fde471312170e710eb"}
 *
 * Go source:
...
export function Checker_newSignature(receiver: GoPtr<Checker>, flags: SignatureFlags, declaration: GoPtr<Node>, typeParameters: GoSlice<GoPtr<Type>>, thisParameter: GoPtr<Symbol>, parameters: GoSlice<GoPtr<Symbol>>, resolvedReturnType: GoPtr<Type>, resolvedTypePredicate: GoPtr<TypePredicate>, minArgumentCount: int): GoPtr<Signature> {
  const sig = Arena_New(receiver!.signatureArena, goZeroSignature);
  sig!.v = {
    flags,
    minArgumentCount,
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSuggestionForNonexistentIndexSignature","kind":"method","status":"implemented","sigHash":"7fa94a79522b003108f57cc105a2a11840a6223a896d83ce9f25d56a44020030"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isThisPropertyAccessInConstructor","kind":"method","status":"implemented","sigHash":"b871ed063e29e790d9c40c894aca2df6f9af760186a50895e4e4f5e65a814c9e"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getDeclaringConstructor","kind":"method","status":"implemented","sigHash":"bd91440e14fcf77953406a37832c5355497ed517064245d102397538a0835ba7"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isStringIndexSignatureOnlyTypeWorker","kind":"method","status":"implemented","sigHash":"33c0e745dee09b50d3bf0820f13a098d31c25acb6ca51f0b236a12bed9c4e496"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.expandSignatureParametersWithTupleMembers","kind":"method","status":"implemented","sigHash":"8bd7d98d36cfcdfbb40c520d56b7500e30739ae0812609bee9823102687ecaf0"}
 *
 * Go source:
...
export function Checker_expandSignatureParametersWithTupleMembers(receiver: GoPtr<Checker>, signature: GoPtr<Signature>, restType: GoPtr<TypeReference>, restIndex: int, restSymbol: GoPtr<Symbol>): GoSlice<GoPtr<Symbol>> {
  ...
  for (let i = 0; i < elementTypes.length; i++) {
    const type_ = GoSliceLoad(elementTypes, i, GoPointerValueOps<Type>());
    ...
    const symbol_ = Checker_newSymbolEx(receiver, SymbolFlagsFunctionScopedVariable, GoSliceLoad(associatedNames, i, GoStringValueOps)!, checkFlags);
    const links = LinkStore_Get(receiver!.valueSymbolLinks, symbol_, goZeroValueSymbolLinks, goSymbolPointerKey)!.v;
    if ((flags & ElementFlagsRest) !== 0) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.typeHasCallOrConstructSignatures","kind":"method","status":"implemented","sigHash":"a71ef1b0cae83f47fc8b35ddc24a9369f61af582ffc01d0dd6678d191e39f627"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getParameterTypeNodeForDecoratorCheck","kind":"method","status":"implemented","sigHash":"021354f7072638b3c19a8458e7e01d7762efcb2666a970ccc06c41e972c07d2a"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeOfFirstParameterOfSignature","kind":"method","status":"implemented","sigHash":"5b1f7294d6e14af0a7470e029f2b696a71b118352887b0b2af5df13fc7939620"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeOfFirstParameterOfSignatureWithFallback","kind":"method","status":"implemented","sigHash":"614e7b7a906ea75cf49240823cb5c160d26d33267825014a6024ebf9d73f1895"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getTypeOfPropertyOrIndexSignatureOfType","kind":"method","status":"implemented","sigHash":"f0a1f4dc3c768f56840d581f52987db74d37e03c6b19e04b53acbf7ef3fb19f8"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getContextuallyTypedParameterType","kind":"method","status":"implemented","sigHash":"7681ab9be46b8fecd776d88d424f7a76980eae92b0bc27e1fe1cd0240a57d8c5"}
 *
 * Go source:
...
export function Checker_getContextuallyTypedParameterType(receiver: GoPtr<Checker>, parameter: GoPtr<Node>): GoPtr<Type> {
  ...
  if (iife !== undefined) {
    ...
    const indexOfParameter = slices.Index(Node_Parameters(fn), parameter, GoEqualStrict<GoPtr<Node>>);
    if (hasDotDotDotToken(parameter)) {
    ...
    const links = LinkStore_Get(receiver!.signatureLinks, iife, goZeroSignatureLinks, goNodePointerKey)!.v;
    const cached = links!.resolvedSignature;
    links!.resolvedSignature = receiver!.anySignature;
    let t: GoPtr<Type>;
    if (indexOfParameter < args.length) {
      t = Checker_getWidenedLiteralType(receiver, Checker_checkExpression(receiver, GoSliceLoad(args, indexOfParameter, GoPointerValueOps<Node>())));
  ...
  const contextualSignature = Checker_getContextualSignature(receiver, fn);
  if (contextualSignature !== undefined) {
    const index = slices.Index(Node_Parameters(fn), parameter, GoEqualStrict<GoPtr<Node>>) - core.IfElse(GetThisParameter(fn) !== undefined, 1, 0);
    if (hasDotDotDotToken(parameter) && core.LastOrNil(Node_Parameters(fn), GoZeroPointer<Node>) === parameter) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSpreadArgumentType","kind":"method","status":"implemented","sigHash":"4e8f6dbb44b876df7d02f68dd625421f501897189f1a55fc170732f038c7dcc2"}
 *
 * Go source:
...
export function Checker_getSpreadArgumentType(receiver: GoPtr<Checker>, args: GoSlice<GoPtr<Node>>, index: int, argCount: int, restType: GoPtr<Type>, context: GoPtr<InferenceContext>, checkMode: CheckMode): GoPtr<Type> {
  ...
  if (argCount > 0 && index >= argCount - 1) {
    let arg = GoSliceLoad(args, argCount - 1, GoPointerValueOps<Node>());
    if (isSpreadArgument(arg)) {
  ...
  let infos: GoSlice<TupleElementInfo> = GoNilSlice();
  for (let argIndex = index; argIndex < argCount; argIndex++) {
    let arg = GoSliceLoad(args, argIndex, GoPointerValueOps<Node>());
    let t: GoPtr<Type>;
    ...
    if (isSpreadArgument(arg)) {
      ...
      let contextualType: GoPtr<Type>;
      if (isTupleType(restType)) {
        contextualType = core.OrElse(Checker_getContextualTypeForElementExpression(receiver, restType, argIndex - index, argCount - index, -1, -1), receiver!.unknownType, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>);
      } else {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getContextualReturnType","kind":"method","status":"implemented","sigHash":"2500b052ad2750ae701921b1386b8351136a576f52327f4e6f92aa93f2168721"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.checkGeneratorInstantiationAssignabilityToReturnType","kind":"method","status":"implemented","sigHash":"5ba5dd9a6e43b6b5c554e9b8c7fc492a7edd26fd4f49aa7a1d54dd5a76ad2933"}
 *
 * Go source:
...
export function Checker_checkGeneratorInstantiationAssignabilityToReturnType(receiver: GoPtr<Checker>, returnType: GoPtr<Type>, functionFlags: FunctionFlags, errorNode: GoPtr<Node>): bool {
  ...
  const generatorYieldType = core.OrElse(Checker_getIterationTypeOfGeneratorFunctionReturnType(receiver, IterationTypeKindYield, returnType, isAsyncGenerator), receiver!.anyType, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>);
  const generatorReturnType = core.OrElse(Checker_getIterationTypeOfGeneratorFunctionReturnType(receiver, IterationTypeKindReturn, returnType, isAsyncGenerator), generatorYieldType, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>);
  const generatorNextType = core.OrElse(Checker_getIterationTypeOfGeneratorFunctionReturnType(receiver, IterationTypeKindNext, returnType, isAsyncGenerator), receiver!.unknownType, GoZeroPointer<Type>, GoEqualStrict<GoPtr<Type>>);
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getContextualSignatureForFunctionLikeDeclaration","kind":"method","status":"implemented","sigHash":"35758be4620771266ab25f1da378b6ade26818064b82230598f59dd70c81ed75"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getContextualTypeForArgument","kind":"method","status":"implemented","sigHash":"0d0a4f881dee56756b147f024a4e1091e6087e96962f52d2c24fefd809486c35"}
 *
 * Go source:
...
export function Checker_getContextualTypeForArgument(receiver: GoPtr<Checker>, callTarget: GoPtr<Node>, arg: GoPtr<Node>): GoPtr<Type> {
  ...
  const argIndex = slices.Index(args, arg, GoEqualStrict<GoPtr<Node>>);
  if (argIndex === -1) {
    return undefined;
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getContextualTypeForArgumentAtIndex","kind":"method","status":"implemented","sigHash":"f848375396a19a264e7787c95d8b737b2fd157a30580e8d9991c7edd2cd3f3d4"}
 *
 * Go source:
...
export function Checker_getContextualTypeForArgumentAtIndex(receiver: GoPtr<Checker>, callTarget: GoPtr<Node>, argIndex: int): GoPtr<Type> {
  ...
  if (LinkStore_Get(receiver!.signatureLinks, callTarget, goZeroSignatureLinks, goNodePointerKey)!.v.resolvedSignature === receiver!.resolvingSignature) {
  ...
  if (signatureHasRestParameter(signature) && argIndex >= restIndex) {
    return Checker_getIndexedAccessTypeEx(receiver, Checker_getTypeOfSymbol(receiver, GoSliceLoad(signature!.parameters, restIndex, GoPointerValueOps<Symbol>())), Checker_getNumberLiteralType(receiver, argIndex - restIndex), AccessFlagsContextual, undefined, undefined);
  }
  return Checker_getTypeAtPosition(receiver, signature, argIndex);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getEffectiveCallArguments","kind":"method","status":"implemented","sigHash":"93a070986bc36bee3e8824245645f332fdfd3b6f6f69f2ac02ffe967c5305715"}
 *
 * Go source:
...
export function Checker_getEffectiveCallArguments(receiver: GoPtr<Checker>, node: GoPtr<Node>): GoSlice<GoPtr<Node>> {
  if (IsJsxOpeningFragment(node)) {
    return GoSliceBuild(1, 1, GoPointerValueOps<Node>(), (__goSliceLiteral) => {
      GoSliceStore(__goSliceLiteral, 0, Checker_createSyntheticExpression(receiver, node, receiver!.emptyFreshJsxObjectType, false, undefined), GoPointerValueOps<Node>());
    });
  }
  if (IsTaggedTemplateExpression(node)) {
    ...
    if (!IsTemplateExpression(template)) {
      return GoSliceBuild(1, 1, GoPointerValueOps<Node>(), (__goSliceLiteral) => {
        GoSliceStore(__goSliceLiteral, 0, firstArg, GoPointerValueOps<Node>());
      });
    }
  ...
  if (IsBinaryExpression(node)) {
    return GoSliceBuild(1, 1, GoPointerValueOps<Node>(), (__goSliceLiteral) => {
      GoSliceStore(__goSliceLiteral, 0, AsBinaryExpression(node)!.Left as GoPtr<Node>, GoPointerValueOps<Node>());
    });
  }
  if (IsJsxOpeningLikeElement(node)) {
    if ((Node_Properties(Node_Attributes(node))?.length ?? 0) !== 0 || (IsJsxOpeningElement(node) && (Node_Children(node!.Parent)!.Nodes.length !== 0))) {
      return GoSliceBuild(1, 1, GoPointerValueOps<Node>(), (__goSliceLiteral) => {
        GoSliceStore(__goSliceLiteral, 0, Node_Attributes(node), GoPointerValueOps<Node>());
      });
    }
    ...
    for (let i = spreadIndex; i < args.length; i++) {
      ...
      if (spreadType !== undefined && isTupleType(spreadType)) {
        ...
        for (let elementIndex = 0; elementIndex < elementTypes.length; elementIndex++) {
          ...
          let syntheticType = GoSliceLoad(elementTypes, elementIndex, GoPointerValueOps<Type>());
          if ((flags & ElementFlagsRest) !== 0) {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getSpreadArgumentIndex","kind":"method","status":"implemented","sigHash":"a67588e206ef1eb54cc01ae81d5144aef4dd2920669d5677b9bed712972038d0"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getEffectiveDecoratorArguments","kind":"method","status":"implemented","sigHash":"219fd26bd8d1e5ed77e7320f0c492a058efe72945720650a4f8c36453f48a2a2"}
 *
 * Go source:
...
export function Checker_getEffectiveDecoratorArguments(receiver: GoPtr<Checker>, node: GoPtr<Node>): GoSlice<GoPtr<Node>> {
  ...
  if (signature !== undefined) {
    ...
    for (let i = 0; i < signature!.parameters.length; i++) {
      args[i] = Checker_createSyntheticExpression(receiver, expr, Checker_getTypeOfSymbol(receiver, GoSliceLoad(signature!.parameters, i, GoPointerValueOps<Symbol>())), false, undefined);
    }
    return args;
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getDecoratorCallSignature","kind":"method","status":"implemented","sigHash":"1058d93d4dfbd277bf8447a3e176c0b14b6c3f6ecb2e65981ef6b5ffe7a23be3"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getLegacyDecoratorCallSignature","kind":"method","status":"implemented","sigHash":"d28506e9845bb9ae20c9db2d69b076f76641e24b1769f9e8107c5e122df0b7e7"}
 *
 * Go source:
  ...
  if (links!.decoratorSignature === undefined) {
    ...
    switch (node!.Kind) {
      ...
      case KindClassExpression: {
        ...
        links!.decoratorSignature = Checker_newCallSignature(receiver, GoNilSlice<GoPtr<Type>>(), undefined, GoSliceBuild(1, 1, GoPointerValueOps<Symbol>(), (__goSliceLiteral) => {
          GoSliceStore(__goSliceLiteral, 0, targetParam, GoPointerValueOps<Symbol>());
        }), Checker_getUnionType(receiver, GoSliceBuild(2, 2, GoPointerValueOps<Type>(), (__goSliceLiteral) => {
          GoSliceStore(__goSliceLiteral, 0, targetType, GoPointerValueOps<Type>());
      ...
      case KindParameter: {
        ...
        const parameters = Node_Parameters(node!.Parent) ?? GoSliceMake(0, 0, GoPointerValueOps<Node>());
        ...
        links!.decoratorSignature = Checker_newCallSignature(receiver, GoNilSlice<GoPtr<Type>>(), undefined, GoSliceBuild(3, 3, GoPointerValueOps<Symbol>(), (__goSliceLiteral) => {
          GoSliceStore(__goSliceLiteral, 0, targetParam, GoPointerValueOps<Symbol>());
          GoSliceStore(__goSliceLiteral, 1, keyParam, GoPointerValueOps<Symbol>());
          GoSliceStore(__goSliceLiteral, 2, indexParam, GoPointerValueOps<Symbol>());
        }), receiver!.voidType);
        break;
      }
      case KindMethodDeclaration:
      ...
      case KindPropertyDeclaration: {
        ...
        if (hasPropDesc) {
          ...
          links!.decoratorSignature = Checker_newCallSignature(receiver, GoNilSlice<GoPtr<Type>>(), undefined, GoSliceBuild(3, 3, GoPointerValueOps<Symbol>(), (__goSliceLiteral) => {
            GoSliceStore(__goSliceLiteral, 0, targetParam, GoPointerValueOps<Symbol>());
            GoSliceStore(__goSliceLiteral, 1, keyParam, GoPointerValueOps<Symbol>());
            GoSliceStore(__goSliceLiteral, 2, descriptorParam, GoPointerValueOps<Symbol>());
          }), Checker_getUnionType(receiver, GoSliceBuild(2, 2, GoPointerValueOps<Type>(), (__goSliceLiteral) => {
            GoSliceStore(__goSliceLiteral, 0, returnType, GoPointerValueOps<Type>());
            GoSliceStore(__goSliceLiteral, 1, receiver!.voidType, GoPointerValueOps<Type>());
          })));
        } else {
          links!.decoratorSignature = Checker_newCallSignature(receiver, GoNilSlice<GoPtr<Type>>(), undefined, GoSliceBuild(2, 2, GoPointerValueOps<Symbol>(), (__goSliceLiteral) => {
            GoSliceStore(__goSliceLiteral, 0, targetParam, GoPointerValueOps<Symbol>());
            GoSliceStore(__goSliceLiteral, 1, keyParam, GoPointerValueOps<Symbol>());
          }), Checker_getUnionType(receiver, GoSliceBuild(2, 2, GoPointerValueOps<Type>(), (__goSliceLiteral) => {
            GoSliceStore(__goSliceLiteral, 0, returnType, GoPointerValueOps<Type>());
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getESDecoratorCallSignature","kind":"method","status":"implemented","sigHash":"f0210643764b83d1958ec858b35ad1d648744c98abad136f4a48f514e1c45ae0"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.newESDecoratorCallSignature","kind":"method","status":"implemented","sigHash":"261c29046f893afab2f89c349ebf64de0e8c96f038b2c4744b32ee25f4dc88e1"}
 *
 * Go source:
...
export function Checker_newESDecoratorCallSignature(receiver: GoPtr<Checker>, targetType: GoPtr<Type>, contextType: GoPtr<Type>, nonOptionalReturnType: GoPtr<Type>): GoPtr<Signature> {
  ...
  const returnType = Checker_getUnionType(receiver, GoSliceBuild(2, 2, GoPointerValueOps<Type>(), (__goSliceLiteral) => {
    GoSliceStore(__goSliceLiteral, 0, nonOptionalReturnType, GoPointerValueOps<Type>());
    GoSliceStore(__goSliceLiteral, 1, receiver!.voidType, GoPointerValueOps<Type>());
  }));
  return Checker_newCallSignature(receiver, GoNilSlice(), undefined, GoSliceBuild(2, 2, GoPointerValueOps<Symbol>(), (__goSliceLiteral) => {
    GoSliceStore(__goSliceLiteral, 0, targetParam, GoPointerValueOps<Symbol>());
    GoSliceStore(__goSliceLiteral, 1, contextParam, GoPointerValueOps<Symbol>());
  }), returnType);
}

/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.newCallSignature","kind":"method","status":"implemented","sigHash":"e540d6f2c0fcef3e3f0a5785ae9a4fcdb2972b60aea21cd981b9a76ca3f1bd83"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getIndexSignaturesAtLocation","kind":"method","status":"implemented","sigHash":"6113503a2d4a4c270ebb1ae9557e3b78913db52a231615bb944e349683ee5b06"}
 *
 * Go source:
...
export function Checker_getIndexSignaturesAtLocation(receiver: GoPtr<Checker>, node: GoPtr<Node>): GoSlice<GoPtr<Node>> {
  let signatures: GoSlice<GoPtr<Node>> = GoNilSlice();
    ...
    for (
      ...
      for (
        ...
        if (info!.declaration !== undefined) {
          signatures = core.AppendIfUnique(signatures, info!.declaration, GoEqualStrict<GoPtr<Node>>);
        }
      }
    }
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.isThisPropertyAndThisTyped","kind":"method","status":"implemented","sigHash":"a7884962d081ce51fa7dd6ed39efe0fa0740e3b307a33fa6190179b70c5807f7"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getThisTypeOfObjectLiteralFromContextualType","kind":"method","status":"implemented","sigHash":"8f81b707d95da893ac2e909acab23493ce8851e7c64db00704a0f9a970cff1d9"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getThisTypeFromContextualType","kind":"method","status":"implemented","sigHash":"81d63c55f9fd5cc8ffeae110e6d7567e3d41dab804aeec0cf6cc423761ba9e0b"}
 *
 * Go source:
...
export function Checker_getThisTypeFromContextualType(receiver: GoPtr<Checker>, t: GoPtr<Type>): GoPtr<Type> {
  return Checker_mapType(receiver, t, (t: GoPtr<Type>): GoPtr<Type> => {
    if ((t!.flags & TypeFlagsIntersection) !== 0) {
      for (
        let __goRangeSlice = (Type_Types(t) ?? GoSliceMake(0, 0, GoPointerValueOps<Type>())),
          __goRangeLength = __goRangeSlice.length,
          __goRangeValueOps = GoPointerValueOps<Type>(),
          __goRangeIndex = 0;
        __goRangeIndex < __goRangeLength;
        ...
        const inner = GoSliceLoad(__goRangeSlice, __goRangeIndex, __goRangeValueOps);
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getThisTypeArgument","kind":"method","status":"implemented","sigHash":"5db476b7e6f38964aa4848a7aafc1c13e0e3ac4cfcdc2b96e0009bcce959966d"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getApplicableIndexInfos","kind":"method","status":"implemented","sigHash":"611093a791ef932f8efdf7f9d26046bc23b5a50c32e25a9c23eb01e0134c6511"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.getApplicableIndexSymbol","kind":"method","status":"implemented","sigHash":"a40817fe1af41ea59c2da8e72d9850088ef890ade45f2e789374df947fa9e7c5"}
 *
 * Go source:
...
export function Checker_getApplicableIndexSymbol(receiver: GoPtr<Checker>, t: GoPtr<Type>, keyType: GoPtr<Type>): GoPtr<Symbol> {
  ...
  if (info !== undefined && info !== receiver!.anyBaseTypeIndexInfo) {
    if (info!.indexSymbol === undefined) {
      let declarations: GoSlice<GoPtr<Node>> = GoNilSlice();
      if (info!.declaration !== undefined) {
        declarations = GoSliceBuild(1, 1, GoPointerValueOps<Node>(), (__goSliceLiteral) => {
          GoSliceStore(__goSliceLiteral, 0, info!.declaration, GoPointerValueOps<Node>());
        });
      } else {
        for (
          let __goRangeSlice = (Checker_getIndexInfosOfType(receiver, t) ?? GoSliceMake(0, 0, GoPointerValueOps<IndexInfo>())),
            __goRangeLength = __goRangeSlice.length,
            __goRangeValueOps = GoPointerValueOps<IndexInfo>(),
            __goRangeIndex = 0;
          __goRangeIndex < __goRangeLength;
          ...
          const inf = GoSliceLoad(__goRangeSlice, __goRangeIndex, __goRangeValueOps);
      ...
      if ((declarations ?? GoSliceMake(0, 0, GoPointerValueOps<Node>())).length !== 0) {
        ...
        symbol_!.ValueDeclaration = GoSliceLoad(declarations!, 0, GoPointerValueOps<Node>());
        symbol_!.Parent = t!["symbol"];
        LinkStore_Get(receiver!.valueSymbolLinks, symbol_, goZeroValueSymbolLinks, goSymbolPointerKey)!.v.resolvedType = info!.valueType;
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/checker.go::method::Checker.containsArgumentsReference","kind":"method","status":"implemented","sigHash":"d4ce4269801db06d19db13e54b586d39a519483923f2b47cb713e8f8c7ccd862"}
 *
 * Go source:
