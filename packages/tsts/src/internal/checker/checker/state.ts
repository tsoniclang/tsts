...
export interface InferenceInfo {
  ...
  candidates: GoPtr<GoSlice<GoPtr<Type>>>;
  candidateDepths: GoPtr<GoSlice<int>>;
  contraCandidates: GoPtr<GoSlice<GoPtr<Type>>>;
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Go nil container, callable, interface, or object-backed zero values require an explicit GoPtr carrier because JavaScript has no equivalent nil runtime value; the implementation preserves Go len, range, lookup, and panic behavior without normalization.","goSignature":"interface{childContexts:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::WideningContext>>;parent:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::WideningContext>;propertyName:string;resolvedProperties:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;siblings:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;widenedTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>}","tsSignature":"interface{childContexts:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::WideningContext>>>;parent:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::WideningContext>;propertyName:string;resolvedProperties:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>>;siblings:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>>;widenedTypes:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>>}"}
 *
 * Go source:
...
export interface WideningContext {
  ...
  propertyName: string;
  siblings: GoPtr<GoSlice<GoPtr<Type>>>;
  resolvedProperties: GoPtr<GoSlice<GoPtr<Symbol>>>;
  childContexts: GoPtr<GoMap<string, GoPtr<WideningContext>>>;
  widenedTypes: GoPtr<GoMap<GoPtr<Type>, GoPtr<Type>>>;
}
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Resolved-module maps store ModeAwareCache interface values, and a Go interface value can be nil; GoPtr on each cache value preserves that possibility without changing the enclosing map contract.","goSignature":"interface{BindSourceFiles:()=>void;CommonSourceDirectory:()=>string;FileExists:(string)=>packages/tsts/src/go/scalars.ts::bool;GetCurrentDirectory?:()=>string;GetDefaultResolutionModeForFile?:(packages/tsts/src/internal/ast/ast.ts::HasFileName)=>packages/tsts/src/internal/core/compileroptions.ts::ResolutionMode;GetEmitModuleFormatOfFile:(packages/tsts/src/internal/ast/ast.ts::HasFileName)=>packages/tsts/src/internal/core/compileroptions.ts::ModuleKind;GetEmitSyntaxForUsageLocation:(packages/tsts/src/internal/ast/ast.ts::HasFileName,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::StringLiteralLikeNode>)=>packages/tsts/src/internal/core/compileroptions.ts::ResolutionMode;GetGlobalTypingsCacheLocation?:()=>string;GetImpliedNodeFormatForEmit:(packages/tsts/src/internal/ast/ast.ts::HasFileName)=>packages/tsts/src/internal/core/compileroptions.ts::ModuleKind;GetImportHelpersImportSpecifier:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;GetJSXRuntimeImportSpecifier:(packages/tsts/src/internal/tspath/path.ts::Path)=>[string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>];GetModeForUsageLocation?:(packages/tsts/src/internal/ast/ast.ts::HasFileName,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::StringLiteralLikeNode>)=>packages/tsts/src/internal/core/compileroptions.ts::ResolutionMode;GetNearestAncestorDirectoryWithPackageJson?:(string)=>string;GetPackageJsonInfo?:(string)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/packagejson/cache.ts::InfoCacheEntry>;GetPackagesMap:()=>packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/scalars.ts::bool>;GetProjectReferenceFromOutputDts:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::SourceOutputAndProjectReference>;GetProjectReferenceFromSource?:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::SourceOutputAndProjectReference>;GetRedirectForResolution:(packages/tsts/src/internal/ast/ast.ts::HasFileName)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::ParsedCommandLine>;GetRedirectTargets?:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/go/compat.ts::GoSlice<string>;GetResolvedModule:(packages/tsts/src/internal/ast/ast.ts::HasFileName,string,packages/tsts/src/internal/core/compileroptions.ts::ResolutionMode)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/module/types.ts::ResolvedModule>;GetResolvedModuleFromModuleSpecifier?:(packages/tsts/src/internal/ast/ast.ts::HasFileName,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::StringLiteralLikeNode>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/module/types.ts::ResolvedModule>;GetResolvedModules:()=>packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/internal/module/cache.ts::ModeAwareCache<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/module/types.ts::ResolvedModule>>>;GetSourceFile:(string)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>;GetSourceFileForResolvedModule:(string)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>;GetSourceFileMetaData:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/internal/ast/ast.ts::SourceFileMetaData;GetSourceOfProjectReferenceIfOutputIncluded?:(packages/tsts/src/internal/ast/ast.ts::HasFileName)=>string;GetSymlinkCache?:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/symlinks/knownsymlinks.ts::KnownSymlinks>;IsSourceFileDefaultLibrary:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/go/scalars.ts::bool;Options:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>;SourceFileMayBeEmitted:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>,packages/tsts/src/go/scalars.ts::bool)=>packages/tsts/src/go/scalars.ts::bool;SourceFiles:()=>packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>>;UseCaseSensitiveFileNames?:()=>packages/tsts/src/go/scalars.ts::bool;__tsgoEmbedded0?:packages/tsts/src/internal/checker/checker/state.ts::Host}","tsSignature":"interface{BindSourceFiles:()=>void;CommonSourceDirectory:()=>string;FileExists:(string)=>packages/tsts/src/go/scalars.ts::bool;GetCurrentDirectory:()=>string;GetDefaultResolutionModeForFile:(packages/tsts/src/internal/ast/ast.ts::HasFileName)=>packages/tsts/src/internal/core/compileroptions.ts::ResolutionMode;GetEmitModuleFormatOfFile:(packages/tsts/src/internal/ast/ast.ts::HasFileName)=>packages/tsts/src/internal/core/compileroptions.ts::ModuleKind;GetEmitSyntaxForUsageLocation:(packages/tsts/src/internal/ast/ast.ts::HasFileName,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::StringLiteralLikeNode>)=>packages/tsts/src/internal/core/compileroptions.ts::ResolutionMode;GetGlobalTypingsCacheLocation:()=>string;GetImpliedNodeFormatForEmit:(packages/tsts/src/internal/ast/ast.ts::HasFileName)=>packages/tsts/src/internal/core/compileroptions.ts::ModuleKind;GetImportHelpersImportSpecifier:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;GetJSXRuntimeImportSpecifier:(packages/tsts/src/internal/tspath/path.ts::Path)=>[string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>];GetModeForUsageLocation:(packages/tsts/src/internal/ast/ast.ts::HasFileName,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::StringLiteralLikeNode>)=>packages/tsts/src/internal/core/compileroptions.ts::ResolutionMode;GetNearestAncestorDirectoryWithPackageJson:(string)=>string;GetPackageJsonInfo:(string)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/packagejson/cache.ts::InfoCacheEntry>;GetPackagesMap:()=>packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/scalars.ts::bool>;GetProjectReferenceFromOutputDts:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::SourceOutputAndProjectReference>;GetProjectReferenceFromSource:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::SourceOutputAndProjectReference>;GetRedirectForResolution:(packages/tsts/src/internal/ast/ast.ts::HasFileName)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/tsoptions/parsedcommandline.ts::ParsedCommandLine>;GetRedirectTargets:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/go/compat.ts::GoSlice<string>;GetResolvedModule:(packages/tsts/src/internal/ast/ast.ts::HasFileName,string,packages/tsts/src/internal/core/compileroptions.ts::ResolutionMode)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/module/types.ts::ResolvedModule>;GetResolvedModuleFromModuleSpecifier:(packages/tsts/src/internal/ast/ast.ts::HasFileName,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::StringLiteralLikeNode>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/module/types.ts::ResolvedModule>;GetResolvedModules:()=>packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/tspath/path.ts::Path,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/module/cache.ts::ModeAwareCache<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/module/types.ts::ResolvedModule>>>>;GetSourceFile:(string)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>;GetSourceFileForResolvedModule:(string)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>;GetSourceFileMetaData:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/internal/ast/ast.ts::SourceFileMetaData;GetSourceOfProjectReferenceIfOutputIncluded:(packages/tsts/src/internal/ast/ast.ts::HasFileName)=>string;GetSymlinkCache:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/symlinks/knownsymlinks.ts::KnownSymlinks>;IsSourceFileDefaultLibrary:(packages/tsts/src/internal/tspath/path.ts::Path)=>packages/tsts/src/go/scalars.ts::bool;Options:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>;SourceFileMayBeEmitted:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>,packages/tsts/src/go/scalars.ts::bool)=>packages/tsts/src/go/scalars.ts::bool;SourceFiles:()=>packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>>;UseCaseSensitiveFileNames:()=>packages/tsts/src/go/scalars.ts::bool;__tsgoEmbedded0?:packages/tsts/src/internal/checker/checker/state.ts::Host}"}
 *
 * Go source:
 * Program interface {
 * 	Host
...
export interface Program {
  ...
  GetResolvedModules(): GoMap<Path, GoPtr<ModeAwareCache<GoPtr<ResolvedModule>>>>;
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"TS-Go relies on nil zero values for lazily allocated checker maps and slices, including class-expression tables, deferred diagnostics, and cached alias inventories; GoPtr preserves nil independently from allocated empty containers.","goSignature":"interface{ReverseMappedSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::ReverseMappedSymbolLinks>;SignatureCount:packages/tsts/src/go/scalars.ts::uint;SymbolCount:packages/tsts/src/go/scalars.ts::uint;TotalInstantiationCount:packages/tsts/src/go/scalars.ts::uint;TypeCount:packages/tsts/src/go/scalars.ts::uint;_jsxFactoryEntity:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;_jsxNamespace:string;activeMappers:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>>;activeTypeMappersCaches:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>>;aliasSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::AliasSymbolLinks>;ambientModules:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;ambientModulesOnce:packages/tsts/src/go/sync.ts::Once;antecedentTypes:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;anyArrayType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;anyBaseTypeIndexInfo:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::IndexInfo>;anyFunctionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;anyReadonlyArrayType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;anySignature:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;anyType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;apparentArgumentCount:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/scalars.ts::int>;argumentsSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;arrayLiteralLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::ArrayLiteralLinks>;arrayVariances:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/types.ts::VarianceFlags>;assertionLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::AssertionLinks>;assignableRelation:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relation>;assignmentReducedTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::AssignmentReducedKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;asyncIterationTypesResolver:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::IterationTypesResolver>;autoArrayType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;autoType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;awaitedTypeStack:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;bigintLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/jsnum/pseudobigint.ts::PseudoBigInt,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;bigintType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;blockedStringType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;booleanType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;cachedArgumentsReferenced:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/scalars.ts::bool>;cachedSignatures:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CachedSignatureKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>>;cachedTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CachedTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;canCollectSymbolAliasAccessibilityData:packages/tsts/src/go/scalars.ts::bool;circularConstraintType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;classExpressionNameTables:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/ast/ids.ts::NodeId,packages/tsts/src/internal/ast/symbol.ts::SymbolTable>;comparableRelation:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relation>;compareSymbolChains:(packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>,packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>)=>packages/tsts/src/go/scalars.ts::int;compareSymbols:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>)=>packages/tsts/src/go/scalars.ts::int;compareTypesAssignable:packages/tsts/src/internal/checker/types.ts::TypeComparer;compilerOptions:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>;conditionalConstraintDepth:packages/tsts/src/go/scalars.ts::uint;containsMissingType:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>)=>packages/tsts/src/go/scalars.ts::bool;contextFreeTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;contextualBindingPatterns:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;contextualInfos:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/checker/state.ts::ContextualInfo>;couldContainTypeVariables:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>)=>packages/tsts/src/go/scalars.ts::bool;ctx:packages/tsts/src/go/context.ts::Context;currentNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;declaredTypeLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::DeclaredTypeLinks>;deferredDiagnosticCallbacks:packages/tsts/src/go/compat.ts::GoSlice<()=>void>;deferredGlobalImportMetaExpressionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;deferredSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::DeferredSymbolLinks>;diagnostics:packages/tsts/src/internal/ast/diagnostic.ts::DiagnosticsCollection;discriminatedContextualTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::DiscriminatedContextualTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;emitResolver:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/emitresolver.ts::EmitResolver>;emitResolverOnce:packages/tsts/src/go/sync.ts::Once;emitStandardClassFields:packages/tsts/src/go/scalars.ts::bool;emptyFreshJsxObjectType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;emptyGenericType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;emptyJsxObjectType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;emptyObjectType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;emptyStringType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;emptyTypeLiteralType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;enumLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::EnumLiteralKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;enumMemberLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::EnumMemberLinks>;enumNaNLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;enumNumberIndexInfo:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::IndexInfo>;enumRelation:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::EnumRelationKey,packages/tsts/src/internal/checker/relater.ts::RelationComparisonResult>;errorType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;errorTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;esSymbolType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;evaluate:packages/tsts/src/internal/evaluator/evaluator.ts::Evaluator;exactOptionalPropertyTypes:packages/tsts/src/go/scalars.ts::bool;exportTypeLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::ExportTypeLinks>;factory:packages/tsts/src/internal/ast/generated/factory.ts::NodeFactory;falseType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;fileIndexMap:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>,packages/tsts/src/go/scalars.ts::int>;files:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>>;flowAnalysisDisabled:packages/tsts/src/go/scalars.ts::bool;flowInvocationCount:packages/tsts/src/go/scalars.ts::int;flowLoopCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::FlowLoopKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;flowLoopStack:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/checker/state.ts::FlowLoopInfo>;flowNodePostSuper:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/flow.ts::FlowNode>,packages/tsts/src/go/scalars.ts::bool>;flowNodeReachable:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/flow.ts::FlowNode>,packages/tsts/src/go/scalars.ts::bool>;flowTypeCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;freeFlowState:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/flow.ts::FlowState>;freeRelater:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relater>;freeinferenceState:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/inference.ts::InferenceState>;getGlobalAsyncDisposableType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncGeneratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIterableIteratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIterableIteratorTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIterableType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIterableTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIteratorObjectType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIteratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAwaitedSymbol:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalAwaitedSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalBigIntType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassAccessorDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassAccessorDecoratorContxtType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassAccessorDecoratorResultType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassAccessorDecoratorTargetType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassFieldDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassGetterDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassMethodDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassSetterDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalDisposableType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalESSymbolConstructorSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalESSymbolConstructorTypeSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalESSymbolType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalExtractSymbol:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalGeneratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalImportAttributesType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalImportAttributesTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalImportCallOptionsType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalImportCallOptionsTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalImportMetaType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIterableIteratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIterableIteratorTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIterableType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIterableTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIteratorObjectType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIteratorReturnResultType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIteratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIteratorYieldResultType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalNaNSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalNoInferSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalNonNullableTypeAliasOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalOmitSymbol:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalPromiseConstructorSymbol:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalPromiseConstructorSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalPromiseLikeType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalPromiseType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalPromiseTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalRecordSymbol:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalTemplateStringsArrayType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalTypedPropertyDescriptorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalArrayType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalBooleanType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalCallableFunctionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalFunctionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalNewableFunctionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalNumberType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalObjectType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalReadonlyArrayType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalRegExpType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalStringType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalThisSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;globalThisType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globals:packages/tsts/src/internal/ast/symbol.ts::SymbolTable;id:packages/tsts/src/go/scalars.ts::uint;identityRelation:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relation>;implicitNeverType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;inVarianceComputation:packages/tsts/src/go/scalars.ts::bool;indexInfoArena:packages/tsts/src/internal/core/arena.ts::Arena<packages/tsts/src/internal/checker/types.ts::IndexInfo>;indexedAccessTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;inferenceContextInfos:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/checker/state.ts::InferenceContextInfo>;inlineLevel:packages/tsts/src/go/scalars.ts::int;instantiationCount:packages/tsts/src/go/scalars.ts::uint;instantiationDepth:packages/tsts/src/go/scalars.ts::uint;instantiationExpressionTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::InstantiationExpressionKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;intersectionTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;intrinsicMarkerType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;isInferencePartiallyBlocked:packages/tsts/src/go/scalars.ts::bool;isPrimitiveOrObjectOrEmptyType:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>)=>packages/tsts/src/go/scalars.ts::bool;isStringIndexSignatureOnlyType:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>)=>packages/tsts/src/go/scalars.ts::bool;iterationTypesCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::IterationTypesKey,packages/tsts/src/internal/checker/checker/state.ts::IterationTypes>;jsxElementLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/jsx.ts::JsxElementLinks>;languageVersion:packages/tsts/src/internal/core/compileroptions.ts::ScriptTarget;lastFlowNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/flow.ts::FlowNode>;lastFlowNodeReachable:packages/tsts/src/go/scalars.ts::bool;lastGetCombinedModifierFlagsNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;lastGetCombinedModifierFlagsResult:packages/tsts/src/internal/ast/modifierflags.ts::ModifierFlags;lastGetCombinedNodeFlagsNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;lastGetCombinedNodeFlagsResult:packages/tsts/src/internal/ast/generated/flags.ts::NodeFlags;lateBoundLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::LateBoundLinks>;legacyDecorators:packages/tsts/src/go/scalars.ts::bool;mappedSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::MappedSymbolLinks>;markNodeAssignments:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>)=>packages/tsts/src/go/scalars.ts::bool;markedAssignmentSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::MarkedAssignmentSymbolLinks>;markerOtherType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;markerSubType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;markerSubTypeForCheck:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;markerSuperType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;markerSuperTypeForCheck:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;markerTypes:packages/tsts/src/internal/collections/set.ts::Set<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;membersAndExportsLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::MembersAndExportsLinks>;mergedSymbols:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;missingType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;moduleKind:packages/tsts/src/internal/core/compileroptions.ts::ModuleKind;moduleResolutionKind:packages/tsts/src/internal/core/compileroptions.ts::ModuleResolutionKind;moduleSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::ModuleSymbolLinks>;moduleSymbols:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;mu:packages/tsts/src/go/sync.ts::Mutex;nanType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;narrowedTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::NarrowedTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;neverType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;noConstraintType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;noImplicitAny:packages/tsts/src/go/scalars.ts::bool;noImplicitThis:packages/tsts/src/go/scalars.ts::bool;noTypePredicate:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::TypePredicate>;nodeLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::NodeLinks>;nonExistentProperties:packages/tsts/src/internal/collections/set.ts::Set<packages/tsts/src/internal/checker/checker/state.ts::NonExistentPropertyKey>;nonInferrableAnyType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;nonPrimitiveType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;nullType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;nullWideningType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;numberLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/jsnum/jsnum.ts::Number,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;numberOrBigIntType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;numberType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;numericStringType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;optionalType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;packagesMap:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/scalars.ts::bool>;patternAmbientModuleAugmentations:packages/tsts/src/internal/ast/symbol.ts::SymbolTable;patternAmbientModules:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/ast.ts::PatternAmbientModule>>;patternForType:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;permissiveMapper:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>;program:packages/tsts/src/internal/checker/checker/state.ts::Program;propertiesTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::PropertiesTypesKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;regExpScanner:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/scanner/scanner.ts::Scanner>;regularFalseType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;regularTrueType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;reliabilityFlags:packages/tsts/src/internal/checker/relater.ts::RelationComparisonResult;renamedBindingElementsInTypes:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;reportUnmeasurableMapper:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>;reportUnreliableMapper:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>;reportedUnreachableNodes:packages/tsts/src/internal/collections/set.ts::Set<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;requireSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;resolutionStart:packages/tsts/src/go/scalars.ts::int;resolveName:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,string,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/diagnostics/diagnostics.ts::Message>,packages/tsts/src/go/scalars.ts::bool,packages/tsts/src/go/scalars.ts::bool)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;resolveNameForSymbolSuggestion:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,string,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/diagnostics/diagnostics.ts::Message>,packages/tsts/src/go/scalars.ts::bool,packages/tsts/src/go/scalars.ts::bool)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;resolvingDefaultType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;resolvingSignature:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;restrictiveMapper:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>;reverseExpandingFlags:packages/tsts/src/internal/checker/relater.ts::ExpandingFlags;reverseHomomorphicMappedCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::ReverseMappedTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;reverseMappedCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::ReverseMappedTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;reverseMappedSourceStack:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;reverseMappedTargetStack:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;saveDeferredDiagnostics:packages/tsts/src/go/scalars.ts::bool;serializationLevel:packages/tsts/src/go/scalars.ts::int;sharedFlows:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/flow.ts::SharedFlow>;signatureArena:packages/tsts/src/internal/core/arena.ts::Arena<packages/tsts/src/internal/checker/types.ts::Signature>;signatureLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::SignatureLinks>;silentNeverSignature:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;silentNeverType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;skipDirectInferenceNodes:packages/tsts/src/internal/collections/set.ts::Set<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;sourceFileLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>,packages/tsts/src/internal/checker/types.ts::SourceFileLinks>;spreadLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::SpreadLinks>;strictBindCallApply:packages/tsts/src/go/scalars.ts::bool;strictBuiltinIteratorReturn:packages/tsts/src/go/scalars.ts::bool;strictFunctionTypes:packages/tsts/src/go/scalars.ts::bool;strictNullChecks:packages/tsts/src/go/scalars.ts::bool;strictPropertyInitialization:packages/tsts/src/go/scalars.ts::bool;strictSubtypeRelation:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relation>;stringLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;stringMappingTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::StringMappingKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;stringNumberSymbolType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;stringOrNumberType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;stringType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;substitutionTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::SubstitutionTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;subtypeReductionCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>>;subtypeRelation:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relation>;suggestionDiagnostics:packages/tsts/src/internal/ast/diagnostic.ts::DiagnosticsCollection;switchStatementLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::SwitchStatementLinks>;symbolArena:packages/tsts/src/internal/core/arena.ts::Arena<packages/tsts/src/internal/ast/symbol.ts::Symbol>;symbolContainerLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::ContainingSymbolLinks>;symbolNodeLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::SymbolNodeLinks>;symbolReferenceLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::SymbolReferenceLinks>;symbolTableAliasCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/symbolaccessibility.ts::symbolTableID,packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>>;syncIterationTypesResolver:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::IterationTypesResolver>;templateConstraintType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;templateLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;thisExpandoKinds:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/checker/state.ts::thisAssignmentDeclarationKind>;thisExpandoLocations:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;tracer:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/tracer.ts::Tracer>;trueType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;tupleTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;typeAliasLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::TypeAliasLinks>;typeNodeLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::TypeNodeLinks>;typeResolutions:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/checker/state.ts::TypeResolution>;typeToStringNodebuilder:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>;typeofType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;undefinedOrMissingType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;undefinedProperties:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;undefinedSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;undefinedType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;undefinedWideningType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unionOfUnionTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::UnionOfUnionKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;unionTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;uniqueESSymbolTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;uniqueLiteralMapper:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>;uniqueLiteralType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unknownEmptyObjectType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unknownSignature:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;unknownSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;unknownType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unknownUnionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unreachableNeverType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unresolvedSymbols:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;unresolvedType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;useUnknownInCatchVariables:packages/tsts/src/go/scalars.ts::bool;valueSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::ValueSymbolLinks>;varianceLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::VarianceLinks>;varianceTypeParameter:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;voidType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;wasCanceled:packages/tsts/src/go/scalars.ts::bool;wildcardType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;withinUnreachableCode:packages/tsts/src/go/scalars.ts::bool;zeroBigIntType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;zeroType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>}","tsSignature":"interface{ReverseMappedSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::ReverseMappedSymbolLinks>;SignatureCount:packages/tsts/src/go/scalars.ts::uint;SymbolCount:packages/tsts/src/go/scalars.ts::uint;TotalInstantiationCount:packages/tsts/src/go/scalars.ts::uint;TypeCount:packages/tsts/src/go/scalars.ts::uint;_jsxFactoryEntity:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;_jsxNamespace:string;activeMappers:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>>;activeTypeMappersCaches:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>>;aliasSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::AliasSymbolLinks>;ambientModules:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;ambientModulesOnce:packages/tsts/src/go/sync.ts::Once;antecedentTypes:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;anyArrayType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;anyBaseTypeIndexInfo:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::IndexInfo>;anyFunctionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;anyReadonlyArrayType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;anySignature:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;anyType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;apparentArgumentCount:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/scalars.ts::int>;argumentsSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;arrayLiteralLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::ArrayLiteralLinks>;arrayVariances:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/types.ts::VarianceFlags>;assertionLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::AssertionLinks>;assignableRelation:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relation>;assignmentReducedTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::AssignmentReducedKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;asyncIterationTypesResolver:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::IterationTypesResolver>;autoArrayType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;autoType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;awaitedTypeStack:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;bigintLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/jsnum/pseudobigint.ts::PseudoBigInt,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;bigintType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;blockedStringType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;booleanType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;cachedArgumentsReferenced:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/scalars.ts::bool>;cachedSignatures:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CachedSignatureKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>>;cachedTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CachedTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;canCollectSymbolAliasAccessibilityData:packages/tsts/src/go/scalars.ts::bool;circularConstraintType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;classExpressionNameTables:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/ast/ids.ts::NodeId,packages/tsts/src/internal/ast/symbol.ts::SymbolTable>|undefined;comparableRelation:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relation>;compareSymbolChains:(packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>,packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>)=>packages/tsts/src/go/scalars.ts::int;compareSymbols:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>)=>packages/tsts/src/go/scalars.ts::int;compareTypesAssignable:packages/tsts/src/internal/checker/types.ts::TypeComparer;compilerOptions:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>;conditionalConstraintDepth:packages/tsts/src/go/scalars.ts::uint;containsMissingType:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>)=>packages/tsts/src/go/scalars.ts::bool;contextFreeTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;contextualBindingPatterns:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;contextualInfos:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/checker/state.ts::ContextualInfo>;couldContainTypeVariables:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>)=>packages/tsts/src/go/scalars.ts::bool;ctx:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/context.ts::Context>;currentNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;declaredTypeLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::DeclaredTypeLinks>;deferredDiagnosticCallbacks:packages/tsts/src/go/compat.ts::GoSlice<()=>void>|undefined;deferredGlobalImportMetaExpressionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;deferredSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::DeferredSymbolLinks>;diagnostics:packages/tsts/src/internal/ast/diagnostic.ts::DiagnosticsCollection;discriminatedContextualTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::DiscriminatedContextualTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;emitResolver:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/emitresolver.ts::EmitResolver>;emitResolverOnce:packages/tsts/src/go/sync.ts::Once;emitStandardClassFields:packages/tsts/src/go/scalars.ts::bool;emptyFreshJsxObjectType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;emptyGenericType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;emptyJsxObjectType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;emptyObjectType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;emptyStringType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;emptyTypeLiteralType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;enumLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::EnumLiteralKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;enumMemberLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::EnumMemberLinks>;enumNaNLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;enumNumberIndexInfo:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::IndexInfo>;enumRelation:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::EnumRelationKey,packages/tsts/src/internal/checker/relater.ts::RelationComparisonResult>;errorType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;errorTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;esSymbolType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;evaluate:packages/tsts/src/internal/evaluator/evaluator.ts::Evaluator;exactOptionalPropertyTypes:packages/tsts/src/go/scalars.ts::bool;exportTypeLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::ExportTypeLinks>;factory:packages/tsts/src/internal/ast/generated/factory.ts::NodeFactory;falseType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;fileIndexMap:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>,packages/tsts/src/go/scalars.ts::int>;files:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>>;flowAnalysisDisabled:packages/tsts/src/go/scalars.ts::bool;flowInvocationCount:packages/tsts/src/go/scalars.ts::int;flowLoopCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::FlowLoopKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;flowLoopStack:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/checker/state.ts::FlowLoopInfo>;flowNodePostSuper:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/flow.ts::FlowNode>,packages/tsts/src/go/scalars.ts::bool>;flowNodeReachable:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/flow.ts::FlowNode>,packages/tsts/src/go/scalars.ts::bool>;flowTypeCache:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>>;freeFlowState:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/flow.ts::FlowState>;freeRelater:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relater>;freeinferenceState:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/inference.ts::InferenceState>;getGlobalAsyncDisposableType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncGeneratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIterableIteratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIterableIteratorTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIterableType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIterableTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIteratorObjectType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAsyncIteratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalAwaitedSymbol:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalAwaitedSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalBigIntType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassAccessorDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassAccessorDecoratorContxtType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassAccessorDecoratorResultType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassAccessorDecoratorTargetType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassFieldDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassGetterDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassMethodDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalClassSetterDecoratorContextType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalDisposableType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalESSymbolConstructorSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalESSymbolConstructorTypeSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalESSymbolType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalExtractSymbol:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalGeneratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalImportAttributesType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalImportAttributesTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalImportCallOptionsType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalImportCallOptionsTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalImportMetaType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIterableIteratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIterableIteratorTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIterableType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIterableTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIteratorObjectType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIteratorReturnResultType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIteratorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalIteratorYieldResultType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalNaNSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalNoInferSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalNonNullableTypeAliasOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalOmitSymbol:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalPromiseConstructorSymbol:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalPromiseConstructorSymbolOrNil:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalPromiseLikeType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalPromiseType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalPromiseTypeChecked:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalRecordSymbol:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;getGlobalTemplateStringsArrayType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;getGlobalTypedPropertyDescriptorType:()=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalArrayType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalBooleanType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalCallableFunctionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalFunctionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalNewableFunctionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalNumberType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalObjectType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalReadonlyArrayType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalRegExpType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalStringType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globalThisSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;globalThisType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;globals:packages/tsts/src/internal/ast/symbol.ts::SymbolTable;id:packages/tsts/src/go/scalars.ts::uint;identityRelation:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relation>;implicitNeverType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;inVarianceComputation:packages/tsts/src/go/scalars.ts::bool;indexInfoArena:packages/tsts/src/internal/core/arena.ts::Arena<packages/tsts/src/internal/checker/types.ts::IndexInfo>;indexedAccessTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;inferenceContextInfos:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/checker/state.ts::InferenceContextInfo>;inlineLevel:packages/tsts/src/go/scalars.ts::int;instantiationCount:packages/tsts/src/go/scalars.ts::uint;instantiationDepth:packages/tsts/src/go/scalars.ts::uint;instantiationExpressionTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::InstantiationExpressionKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;intersectionTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;intrinsicMarkerType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;isInferencePartiallyBlocked:packages/tsts/src/go/scalars.ts::bool;isPrimitiveOrObjectOrEmptyType:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>)=>packages/tsts/src/go/scalars.ts::bool;isStringIndexSignatureOnlyType:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>)=>packages/tsts/src/go/scalars.ts::bool;iterationTypesCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::IterationTypesKey,packages/tsts/src/internal/checker/checker/state.ts::IterationTypes>;jsxElementLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/jsx.ts::JsxElementLinks>;languageVersion:packages/tsts/src/internal/core/compileroptions.ts::ScriptTarget;lastFlowNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/flow.ts::FlowNode>;lastFlowNodeReachable:packages/tsts/src/go/scalars.ts::bool;lastGetCombinedModifierFlagsNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;lastGetCombinedModifierFlagsResult:packages/tsts/src/internal/ast/modifierflags.ts::ModifierFlags;lastGetCombinedNodeFlagsNode:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;lastGetCombinedNodeFlagsResult:packages/tsts/src/internal/ast/generated/flags.ts::NodeFlags;lateBoundLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::LateBoundLinks>;legacyDecorators:packages/tsts/src/go/scalars.ts::bool;mappedSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::MappedSymbolLinks>;markNodeAssignments:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>)=>packages/tsts/src/go/scalars.ts::bool;markedAssignmentSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::MarkedAssignmentSymbolLinks>;markerOtherType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;markerSubType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;markerSubTypeForCheck:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;markerSuperType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;markerSuperTypeForCheck:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;markerTypes:packages/tsts/src/internal/collections/set.ts::Set<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;membersAndExportsLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::MembersAndExportsLinks>;mergedSymbols:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;missingType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;moduleKind:packages/tsts/src/internal/core/compileroptions.ts::ModuleKind;moduleResolutionKind:packages/tsts/src/internal/core/compileroptions.ts::ModuleResolutionKind;moduleSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::ModuleSymbolLinks>;moduleSymbols:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;mu:packages/tsts/src/go/sync.ts::Mutex;nanType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;narrowedTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::NarrowedTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;neverType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;noConstraintType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;noImplicitAny:packages/tsts/src/go/scalars.ts::bool;noImplicitThis:packages/tsts/src/go/scalars.ts::bool;noTypePredicate:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::TypePredicate>;nodeLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::NodeLinks>;nonExistentProperties:packages/tsts/src/internal/collections/set.ts::Set<packages/tsts/src/internal/checker/checker/state.ts::NonExistentPropertyKey>;nonInferrableAnyType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;nonPrimitiveType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;nullType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;nullWideningType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;numberLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/jsnum/jsnum.ts::Number,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;numberOrBigIntType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;numberType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;numericStringType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;optionalType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;packagesMap:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/scalars.ts::bool>;patternAmbientModuleAugmentations:packages/tsts/src/internal/ast/symbol.ts::SymbolTable;patternAmbientModules:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/ast.ts::PatternAmbientModule>>;patternForType:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;permissiveMapper:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>;program:packages/tsts/src/internal/checker/checker/state.ts::Program;propertiesTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::PropertiesTypesKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;regExpScanner:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/scanner/scanner.ts::Scanner>;regularFalseType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;regularTrueType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;reliabilityFlags:packages/tsts/src/internal/checker/relater.ts::RelationComparisonResult;renamedBindingElementsInTypes:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;reportUnmeasurableMapper:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>;reportUnreliableMapper:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>;reportedUnreachableNodes:packages/tsts/src/internal/collections/set.ts::Set<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;requireSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;resolutionStart:packages/tsts/src/go/scalars.ts::int;resolveName:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,string,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/diagnostics/diagnostics.ts::Message>,packages/tsts/src/go/scalars.ts::bool,packages/tsts/src/go/scalars.ts::bool)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;resolveNameForSymbolSuggestion:(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,string,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/diagnostics/diagnostics.ts::Message>,packages/tsts/src/go/scalars.ts::bool,packages/tsts/src/go/scalars.ts::bool)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;resolvingDefaultType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;resolvingSignature:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;restrictiveMapper:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>;reverseExpandingFlags:packages/tsts/src/internal/checker/relater.ts::ExpandingFlags;reverseHomomorphicMappedCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::ReverseMappedTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;reverseMappedCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::ReverseMappedTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;reverseMappedSourceStack:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;reverseMappedTargetStack:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;saveDeferredDiagnostics:packages/tsts/src/go/scalars.ts::bool;serializationLevel:packages/tsts/src/go/scalars.ts::int;sharedFlows:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/flow.ts::SharedFlow>;signatureArena:packages/tsts/src/internal/core/arena.ts::Arena<packages/tsts/src/internal/checker/types.ts::Signature>;signatureLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::SignatureLinks>;silentNeverSignature:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;silentNeverType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;skipDirectInferenceNodes:packages/tsts/src/internal/collections/set.ts::Set<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;sourceFileLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/generated/unions.ts::SourceFileNode>,packages/tsts/src/internal/checker/types.ts::SourceFileLinks>;spreadLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::SpreadLinks>;strictBindCallApply:packages/tsts/src/go/scalars.ts::bool;strictBuiltinIteratorReturn:packages/tsts/src/go/scalars.ts::bool;strictFunctionTypes:packages/tsts/src/go/scalars.ts::bool;strictNullChecks:packages/tsts/src/go/scalars.ts::bool;strictPropertyInitialization:packages/tsts/src/go/scalars.ts::bool;strictSubtypeRelation:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relation>;stringLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;stringMappingTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::StringMappingKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;stringNumberSymbolType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;stringOrNumberType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;stringType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;substitutionTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::SubstitutionTypeKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;subtypeReductionCache:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>>;subtypeRelation:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/relater.ts::Relation>;suggestionDiagnostics:packages/tsts/src/internal/ast/diagnostic.ts::DiagnosticsCollection;switchStatementLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::SwitchStatementLinks>;symbolArena:packages/tsts/src/internal/core/arena.ts::Arena<packages/tsts/src/internal/ast/symbol.ts::Symbol>;symbolContainerLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::ContainingSymbolLinks>;symbolNodeLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::SymbolNodeLinks>;symbolReferenceLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::SymbolReferenceLinks>;symbolTableAliasCache:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/symbolaccessibility.ts::symbolTableID,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>>>>;syncIterationTypesResolver:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::IterationTypesResolver>;templateConstraintType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;templateLiteralTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;thisExpandoKinds:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/checker/state.ts::thisAssignmentDeclarationKind>;thisExpandoLocations:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;tracer:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/tracer.ts::Tracer>;trueType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;tupleTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;typeAliasLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::TypeAliasLinks>;typeNodeLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/checker/types.ts::TypeNodeLinks>;typeResolutions:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/checker/state.ts::TypeResolution>;typeToStringNodebuilder:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>;typeofType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;undefinedOrMissingType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;undefinedProperties:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;undefinedSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;undefinedType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;undefinedWideningType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unionOfUnionTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::UnionOfUnionKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;unionTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;uniqueESSymbolTypes:packages/tsts/src/go/compat.ts::GoMap<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>;uniqueLiteralMapper:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>;uniqueLiteralType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unknownEmptyObjectType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unknownSignature:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;unknownSymbol:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>;unknownType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unknownUnionType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unreachableNeverType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;unresolvedSymbols:packages/tsts/src/go/compat.ts::GoMap<string,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;unresolvedType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;useUnknownInCatchVariables:packages/tsts/src/go/scalars.ts::bool;valueSymbolLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::ValueSymbolLinks>;varianceLinks:packages/tsts/src/internal/core/linkstore.ts::LinkStore<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/checker/types.ts::VarianceLinks>;varianceTypeParameter:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;voidType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;wasCanceled:packages/tsts/src/go/scalars.ts::bool;wildcardType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;withinUnreachableCode:packages/tsts/src/go/scalars.ts::bool;zeroBigIntType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>;zeroType:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>}"}
 *
 * Go source:
 * Checker struct {
 * 	id                                          uint32
...
export interface Checker {
  ...
  symbolTableAliasCache: GoPtr<GoMap<symbolTableID, GoPtr<GoSlice<GoPtr<Symbol>>>>>;
  classExpressionNameTables: GoMap<NodeId, SymbolTable> | undefined;
  ...
  flowAnalysisDisabled: bool;
  flowInvocationCount: int;
  flowTypeCache: GoPtr<GoMap<GoPtr<Node>, GoPtr<Type>>>;
...
export function NewChecker(program: Program, tracer: GoPtr<Tracer>): [GoPtr<Checker>, GoPtr<Mutex>] {
  ...
  checker.classExpressionNameTables = undefined;
  ...
  const nilSymbolTable = undefined;
  ...
  checker.subtypeRelation = { results: undefined };
  checker.strictSubtypeRelation = { results: undefined };
  checker.assignableRelation = { results: undefined };
  checker.comparableRelation = { results: undefined };
  checker.identityRelation = { results: undefined };
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Go nil container, callable, interface, or object-backed zero values require an explicit GoPtr carrier because JavaScript has no equivalent nil runtime value; the implementation preserves Go len, range, lookup, and panic behavior without normalization.","goSignature":"interface{argCheckMode:packages/tsts/src/internal/checker/checker/state.ts::CheckMode;args:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>;candidateForArgumentArityError:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;candidateForTypeArgumentError:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;candidates:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>>;candidatesForArgumentError:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>>;isSingleNonGenericCandidate:packages/tsts/src/go/scalars.ts::bool;node:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;signatureHelpTrailingComma:packages/tsts/src/go/scalars.ts::bool;typeArguments:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>}","tsSignature":"interface{argCheckMode:packages/tsts/src/internal/checker/checker/state.ts::CheckMode;args:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>>;candidateForArgumentArityError:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;candidateForTypeArgumentError:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>;candidates:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>>;candidatesForArgumentError:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>>>;isSingleNonGenericCandidate:packages/tsts/src/go/scalars.ts::bool;node:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>;signatureHelpTrailingComma:packages/tsts/src/go/scalars.ts::bool;typeArguments:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>}"}
 *
 * Go source:
 * CallState struct {
 * 	node                           *ast.Node
...
export interface CallState {
  ...
  args: GoPtr<GoSlice<GoPtr<Node>>>;
  candidates: GoSlice<GoPtr<Signature>>;
  argCheckMode: CheckMode;
  isSingleNonGenericCandidate: bool;
  signatureHelpTrailingComma: bool;
  candidatesForArgumentError: GoPtr<GoSlice<GoPtr<Signature>>>;
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"The ~int32|~uint32 values are represented by exact JavaScript numbers and encoded with Go's uint32 truncation; the local carrier intersection makes that runtime representation explicit.","goSignature":"func<T0 extends raw(~int32 | ~uint32)>(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/github.com/zeebo/xxh3.ts::Hasher>,T0)=>void","tsSignature":"func<T0 extends number&packages/tsts/src/go/compat.ts::GoConstraint<\"~int32 | ~uint32\">>(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/github.com/zeebo/xxh3.ts::Hasher>,T0)=>void"}
 *
 * Go source:
...
export function hashWrite32<T extends GoConstraint<"~int32 | ~uint32"> & number>(h: GoPtr<Hasher>, value: T): void {
  const v = globalThis.Number(value) >>> 0;
  h!.Write([
    v & 0xff,
    (v >> 8) & 0xff,
    (v >> 16) & 0xff,
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"The Go constraint spans number-backed int, uint, and int64 plus the bigint-backed exact uint64 carrier; the local number|bigint intersection preserves every admitted runtime representation and the body normalizes both to the same uint64 bytes.","goSignature":"func<T0 extends raw(~int | ~uint | ~int64 | ~uint64)>(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/github.com/zeebo/xxh3.ts::Hasher>,T0)=>void","tsSignature":"func<T0 extends bigint|number&packages/tsts/src/go/compat.ts::GoConstraint<\"~int | ~uint | ~int64 | ~uint64\">>(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/github.com/zeebo/xxh3.ts::Hasher>,T0)=>void"}
 *
 * Go source:
 ...
 * }
 */
export function hashWrite64<T extends GoConstraint<"~int | ~uint | ~int64 | ~uint64"> & (number | bigint)>(h: GoPtr<Hasher>, value: T): void {
  if (typeof value === "number") {
    const low = value >>> 0;
    const high = globalThis.Math.floor(value / 0x1_0000_0000) >>> 0;
    h!.Write([
      low & 0xff,
      (low >>> 8) & 0xff,
      (low >>> 16) & 0xff,
  ...
  const v = globalThis.BigInt.asUintN(64, value);
  h!.Write([
    globalThis.Number(v & 0xffn) as byte,
    globalThis.Number((v >> 8n) & 0xffn) as byte,
    globalThis.Number((v >> 16n) & 0xffn) as byte,
    globalThis.Number((v >> 24n) & 0xffn) as byte,
    globalThis.Number((v >> 32n) & 0xffn) as byte,
    globalThis.Number((v >> 40n) & 0xffn) as byte,
    globalThis.Number((v >> 48n) & 0xffn) as byte,
    globalThis.Number((v >> 56n) & 0xffn) as byte,
  ]);
}
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Go nil container, callable, interface, or object-backed zero values require an explicit GoPtr carrier because JavaScript has no equivalent nil runtime value; the implementation preserves Go len, range, lookup, and panic behavior without normalization.","goSignature":"func(packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>)=>packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>>)=>packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey"}
 *
 * Go source:
 ...
 * }
 */
export function getTypeListKey(types: GoPtr<GoSlice<GoPtr<Type>>>): CacheHashKey {
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Go nil container, callable, interface, or object-backed zero values require an explicit GoPtr carrier because JavaScript has no equivalent nil runtime value; the implementation preserves Go len, range, lookup, and panic behavior without normalization.","goSignature":"func(packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/types.ts::TupleElementInfo>,packages/tsts/src/go/scalars.ts::bool)=>packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/internal/checker/types.ts::TupleElementInfo>>,packages/tsts/src/go/scalars.ts::bool)=>packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey"}
 *
 * Go source:
 ...
 * }
 */
export function getTupleKey(elementInfos: GoPtr<GoSlice<TupleElementInfo>>, readonly: bool): CacheHashKey {
  const b: keyBuilder = { h: xxh3.New() as unknown as Hasher };
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Go nil container, callable, interface, or object-backed zero values require an explicit GoPtr carrier because JavaScript has no equivalent nil runtime value; the implementation preserves Go len, range, lookup, and panic behavior without normalization.","goSignature":"func(packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::TypeAlias>)=>packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::TypeAlias>)=>packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey"}
 *
 * Go source:
 ...
 * }
 */
export function getTypeAliasInstantiationKey(typeArguments: GoPtr<GoSlice<GoPtr<Type>>>, alias: GoPtr<TypeAlias>): CacheHashKey {
  return getTypeInstantiationKey(typeArguments, alias, false);
}
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Go nil container, callable, interface, or object-backed zero values require an explicit GoPtr carrier because JavaScript has no equivalent nil runtime value; the implementation preserves Go len, range, lookup, and panic behavior without normalization.","goSignature":"func(packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::TypeAlias>,packages/tsts/src/go/scalars.ts::bool)=>packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>>>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::TypeAlias>,packages/tsts/src/go/scalars.ts::bool)=>packages/tsts/src/internal/checker/checker/state.ts::CacheHashKey"}
 *
 * Go source:
 ...
 * }
 */
export function getTypeInstantiationKey(typeArguments: GoPtr<GoSlice<GoPtr<Type>>>, alias: GoPtr<TypeAlias>, singleSignature: bool): CacheHashKey {
  const b: keyBuilder = { h: xxh3.New() as unknown as Hasher };
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Go nil container, callable, interface, or object-backed zero values require an explicit GoPtr carrier because JavaScript has no equivalent nil runtime value; the implementation preserves Go len, range, lookup, and panic behavior without normalization.","goSignature":"func(packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::IndexInfo>>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::IndexInfo>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::IndexInfo>>>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::IndexInfo>"}
 *
 * Go source:
 ...
 * }
 */
export function findIndexInfo(indexInfos: GoPtr<GoSlice<GoPtr<IndexInfo>>>, keyType: GoPtr<Type>): GoPtr<IndexInfo> {
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Go slices have a nil zero value distinct from an allocated JavaScript Array; GoPtr explicitly carries that nil state through unchanged instantiation instead of normalizing it to an empty array.","goSignature":"func<T0 extends name::comparable>(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::Checker>,packages/tsts/src/go/compat.ts::GoSlice<T0>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>,(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::Checker>,T0,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>)=>T0)=>packages/tsts/src/go/compat.ts::GoSlice<T0>","tsSignature":"func<T0 extends packages/tsts/src/go/compat.ts::GoComparable>(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::Checker>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<T0>>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>,(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::Checker>,T0,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/mapper.ts::TypeMapper>)=>T0)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<T0>>"}
 *
 * Go source:
 ...
 * }
 */
export function instantiateList<T extends GoComparable>(c: GoPtr<Checker>, values: GoPtr<GoSlice<T>>, m: GoPtr<TypeMapper>, instantiator: (c: GoPtr<Checker>, value: T, m: GoPtr<TypeMapper>) => T): GoPtr<GoSlice<T>> {
  if (values === undefined) {
    return undefined;
  }
  let index = 0;
  for (const value of values) {
    ...
    if (mapped !== value) {
      ...
      for (const remaining of values.slice(remainingIndex)) {
        result[remainingIndex] = instantiator(c, remaining, m);
        remainingIndex++;
      }
      return result;
    }
...
export function hasRestParameter(signature: GoPtr<Node>): bool {
  ...
  const last = parameters === undefined ? undefined : LastOrNil(parameters, () => undefined);
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Go nil slices and maps have distinct zero values that JavaScript arrays and maps cannot represent; GoPtr preserves nil while allocated empty containers remain allocated.","goSignature":"interface{c:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::Checker>;members:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>;props:packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>}","tsSignature":"interface{c:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/checker/state.ts::Checker>;members:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>>>;props:packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/go/compat.ts::GoSlice<packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>>>}"}
 *
 * Go source:
...
export interface ObjectLiteralDiscriminator {
  c: GoPtr<Checker>;
  props: GoPtr<GoSlice<GoPtr<Node>>>;
  members: GoPtr<GoSlice<GoPtr<Symbol>>>;
}
