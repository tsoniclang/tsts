...
import { GoMapIsNil, GoNilSlice, GoStringKey, GoZeroPointer, type GoPtr, type GoSlice } from "../../go/compat.js";
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::func::isExpanding","kind":"func","status":"implemented","sigHash":"ff5ed54d41ed742afcb7984870631435c99e3a7f3c8c9d689251ee75929f0764"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.expandSymbolForHover","kind":"method","status":"implemented","sigHash":"8e6af259a56d939b4af991bfbb1b665fede5beb1327b9fe95dc5398143a0bd32"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.expandEnumDecl","kind":"method","status":"implemented","sigHash":"02faf902875d16e415a29d8d08b6d1b7405bd802e7ddc5cd04c33d48b4071286"}
 *
 * Go source:
...
export function NodeBuilderImpl_expandEnumDecl(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>): GoPtr<Node> {
  ...
  for (let i = 0; i < memberProps.length; i++) {
    ...
    const memberDecl = Find(p!.Declarations ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), IsEnumMember, GoZeroPointer<Node>);
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.expandClassDecl","kind":"method","status":"implemented","sigHash":"3525051b8120a5fd4a0e6d142222c4ee31b8e7bde24ea414524739ebc2155a9d"}
 *
 * Go source:
...
export function NodeBuilderImpl_expandClassDecl(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>): GoPtr<Node> {
  const name = SymbolName(symbol_);
  receiver!.ctx!.approximateLength += 9 + name.length;
  const classLikeDeclarations = Filter(symbol_!.Declarations ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), IsClassLike);
  ...
  let instanceMembers: GoSlice<GoPtr<Node>> = GoNilSlice();
  ...
  let staticMembers: GoSlice<GoPtr<Node>> = GoNilSlice();
  ...
  let privateMembers: GoSlice<GoPtr<Node>> = GoNilSlice();
  if (hasPrivate) {
  ...
  let allMembers: GoSlice<GoPtr<Node>> = GoSliceMake(0, 0, GoPointerValueOps<Node>());
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.addClassModifiers","kind":"method","status":"implemented","sigHash":"5906233f2b364eed25f0d8557c21e5abc0abf9fd926b5745ed30a18db2cc5b6c"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::func::typeElementsToClassElements","kind":"func","status":"implemented","sigHash":"e71648ff4b70b3dbd016599bcb2f0056fb0c9a6e467e5566a74d33bff8da5ffe"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.expandInterfaceDecl","kind":"method","status":"implemented","sigHash":"6ee7bfab8f06e7c618346ea397311a21eab34b0999eae11c670e3e5ded36739c"}
 *
 * Go source:
...
export function NodeBuilderImpl_expandInterfaceDecl(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>): GoPtr<Node> {
  ...
  const interfaceDeclarations = Filter(symbol_!.Declarations ?? GoSliceMake(0, 0, GoPointerValueOps<Node>()), IsInterfaceDeclaration);
  const localParams = Checker_getLocalTypeParametersOfClassOrInterfaceOrTypeAlias(receiver!.ch, symbol_);
  const typeParamDecls = Map(localParams, (p) => NodeBuilderImpl_typeParameterToDeclaration(receiver, p));
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.serializePropertiesWithTruncation","kind":"method","status":"implemented","sigHash":"2558410142ee892dd29ba40343f973444f45534ee9d4a3042a83e4353b0dfab6"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.serializeConstructors","kind":"method","status":"implemented","sigHash":"325e0e28afd68af90aef9b6f35bd1e61bb23124d52e2b3d09615c73afc049368"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.serializeIndexSignaturesOfType","kind":"method","status":"implemented","sigHash":"137b5b7cbf978c9f5187d29002feac1941509f0704dfd62efde06e008334f6c8"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.serializeNamespaceMember","kind":"method","status":"implemented","sigHash":"b2c781f5aa6e0b24c2c547f3d5badac20ac26c0e3735bf541a7ae4f8bbb42e37"}
 *
 * Go source:
    ...
    return NewVariableStatement(
      ...
      NewVariableDeclarationList(
        ...
        NodeFactory_NewNodeList(receiver!.f, GoSliceBuild(1, 1, GoPointerValueOps<Node>(), (__goSliceLiteral) => {
          GoSliceStore(__goSliceLiteral, 0, NewVariableDeclaration(receiver!.f, NewIdentifier(receiver!.f, name), undefined, NodeBuilderImpl_serializeTypeForDeclaration(receiver, undefined, t, resolved, true as bool), undefined), GoPointerValueOps<Node>());
        })),
        NodeFlagsLet,
      ),
    );
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.expandModuleDecl","kind":"method","status":"implemented","sigHash":"842e46ea0555233cd9bfd7d31590aa0a5c72e0e54d51c849e0c6bf63d9077415"}
 *
 * Go source:
...
export function NodeBuilderImpl_expandModuleDecl(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>): GoPtr<Node> {
  ...
  let members: GoSlice<GoPtr<Symbol>> = GoNilSlice();
  ...
  for (let i = 0; i < members.length; i++) {
    ...
    if ((m!.Flags & SymbolFlagsAlias) !== 0) {
      ...
      if (target !== undefined) {
          ...
          if (Set_AddIfAbsent(emittedLocals, target, goSymbolPointerKey)) {
            ...
            const localStmt = NewVariableStatement(
              ...
              NewVariableDeclarationList(
                receiver!.f,
                NodeFactory_NewNodeList(receiver!.f, GoSliceBuild(1, 1, GoPointerValueOps<Node>(), (__goSliceLiteral) => {
                  GoSliceStore(__goSliceLiteral, 0, NewVariableDeclaration(receiver!.f, NewIdentifier(receiver!.f, target!.Name), undefined, NodeBuilderImpl_serializeTypeForDeclaration(receiver, undefined, localType, target, true as bool), undefined), GoPointerValueOps<Node>());
                })),
                NodeFlagsLet,
              ),
            );
            bodyStmts = GoAppend(bodyStmts, { node: localStmt, isLocal: true as bool });
          }
        }
        ...
        const stmt = NewExportDeclaration(
          ...
          undefined,
          false as bool,
          NewNamedExports(receiver!.f, NodeFactory_NewNodeList(receiver!.f, GoSliceBuild(1, 1, GoPointerValueOps<Node>(), (__goSliceLiteral) => {
            GoSliceStore(__goSliceLiteral, 0, NewExportSpecifier(receiver!.f, false as bool, propertyName, NewIdentifier(receiver!.f, m!.Name)), GoPointerValueOps<Node>());
          }))),
          undefined,
          undefined,
        );
        bodyStmts = GoAppend(bodyStmts, { node: stmt, isLocal: false as bool });
        continue;
      }
    }
    ...
    if ((resolved!.Flags & (SymbolFlagsFunction | SymbolFlagsMethod)) !== 0) {
      ...
      const hasModuleExports = (merged!.Flags & (SymbolFlagsValueModule | SymbolFlagsNamespaceModule)) !== 0 && !GoMapIsNil(merged!.Exports) && merged!.Exports.size !== 0;
      if (!hasModuleExports) {
        bodyStmts = GoAppend(bodyStmts, { node: NewModuleDeclaration(receiver!.f, undefined, KindNamespaceKeyword, NewIdentifier(receiver!.f, m!.Name), NewModuleBlock(receiver!.f, NodeFactory_NewNodeList(receiver!.f, GoNilSlice()))), isLocal: false as bool });
      }
      continue;
    }
    const node = NodeBuilderImpl_serializeNamespaceMember(receiver, resolved, m!.Name);
    if (node !== undefined) {
      bodyStmts = GoAppend(bodyStmts, { node, isLocal: false as bool });
    }
  }
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.serializeTypeAliasForNamespace","kind":"method","status":"implemented","sigHash":"fb07e71b7278276c9960881ac495961b1abae8717aaff3f8b06318d26d89918e"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder_hover.go::method::NodeBuilderImpl.filterInheritedProperties","kind":"method","status":"implemented","sigHash":"eb9e3eb58ec1b264e803a85d5874982c6b52e2b9d55a937d06bed427c78d4ce1"}
 *
 * Go source:
...
export function NodeBuilderImpl_filterInheritedProperties(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>, baseTypes: GoSlice<GoPtr<Type>>, properties: GoSlice<GoPtr<Symbol>>): GoSlice<GoPtr<Symbol>> {
  ...
  return Filter(properties, (p) => !Set_Has(inherited, p!.Name));
}
