...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::type::NodeBuilder","kind":"type","status":"implemented","sigHash":"76a4249a51e647678e92bd7c18d47a4d92028cf7abbb788a146426ab06fb85df","bodyHash":"6fcf1319a4842fb1bcb0a230468ec341db26d90927a86af02e647e4defeb93a8"}
 *
 * Go source:
 * NodeBuilder struct {
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::type::VerbosityContext","kind":"type","status":"implemented","sigHash":"768294ed85e1b6ff242af3a1a28d7e00e5f4e4afd1646c5e2daba03846a5a482","bodyHash":"305b03e108baa26a0dd7287062e8806242ad19bc5e67ca2a7b0ebe9c87cf3fb9"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::method::NodeBuilder.EmitContext","kind":"method","status":"implemented","sigHash":"1ff78c0bddbb4e896fdbd7a13ee0d0b77a9dec7ba7c4960411e7095f9a909493","bodyHash":"ae4eeaf92647528a5e7c22200be44ae49f7d220781ee62996ad47d09edfb6adb"}
 *
 * Go source:
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Public node-builder APIs pass nil when no external SymbolTracker is requested. enterContext stores that zero interface while constructing the context, immediately wraps it with NewSymbolTrackerImpl, and replaces the context field before serialization; TypeScript uses undefined for the same transient and inner-sink state.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>void","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>void"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::method::NodeBuilder.propagateVerbosityOut","kind":"method","status":"implemented","sigHash":"f8e35b80a31c5801fc9836e183e5b64d15df9d8e8e273f86b74c0652ff6da479","bodyHash":"d1130585f7ec258679e7ea2cce38af83916d81c8da4052ee1d3f20bddd5d7274"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::method::NodeBuilder.popContext","kind":"method","status":"implemented","sigHash":"dbeeac6da32b15dabda40999da44174dd713394667de6af076af7e2aca991376","bodyHash":"725f682404304e970772aad644a745ac48c1e6b0723295572ceee1216f4ea7e9"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::method::NodeBuilder.exitContext","kind":"method","status":"implemented","sigHash":"1c6e2b513829dfb9d095c46904312bd19dfcd887813883bf8ce59a662f50de02","bodyHash":"d2595749e6e7601709be50558398e702c70be6db10b9d91f4edcbe3228f02ee3"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::method::NodeBuilder.exitContextCheck","kind":"method","status":"implemented","sigHash":"62c8da6a257100a367ebb4c22486f10e136b3539723503ab78c567fb0ebdba94","bodyHash":"25ddd02df561c709e8eaf5c2cb0b7e19fc65d1aa9ce87e8a28d9772c0690604a"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::method::NodeBuilder.IndexInfoToIndexSignatureDeclaration","kind":"method","status":"implemented","sigHash":"39389f93d15a3f17627fd2af630ad37d7cd132583ab50e6c85b2dd19d48ae37a","bodyHash":"bb0467ba4ceed911280814934b571185ee19d35ec513abf56fb61f8480803a75"}
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Index-signature code actions invoke this serialization entry point with a nil SymbolTracker when no external tracking sink is requested. The tracker is forwarded to enterContext, which installs an internal SymbolTrackerImpl; TypeScript uses undefined for the absent outer sink.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::IndexInfo>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::IndexInfo>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Declaration emit may call this serialization entry point without an external SymbolTracker. The nil tracker is forwarded to enterContext and wrapped by the internal tracker before return-type work begins; TypeScript represents only that absent outer sink as undefined.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Declaration emit may serialize a declaration type with no external SymbolTracker. The nil tracker is forwarded to enterContext and replaced by an internal SymbolTrackerImpl before type serialization; TypeScript uses undefined for the absent outer sink.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::method::NodeBuilder.SerializeTypeForExpression","kind":"method","status":"implemented","sigHash":"b42a0228efc62205f9134231e3e6faf8b5373614b8682bde0ae0c95cd3d30f73","bodyHash":"b7399961ff473908ffffb01e20f34acfcf17b2d63371fda75ff84944839962c5"}
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Declaration emit may serialize an expression type with no external SymbolTracker. The nil tracker is forwarded to enterContext and replaced by an internal SymbolTrackerImpl before expression-type serialization; TypeScript uses undefined for the absent outer sink.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::method::NodeBuilder.SignatureToSignatureDeclaration","kind":"method","status":"implemented","sigHash":"d877a315dba25a0bb6536f726a3e87eeaac43265cad67ff28217e25fb156c4c2","bodyHash":"d23bb9bcc5746baab16ffed68773e01edf438c24ad07be9030a5d3e0b978e297"}
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Checker printer, hover, and code-action callers invoke this API with a nil tracker when they only need syntax. enterContext wraps that nil outer sink in SymbolTrackerImpl before signature conversion; TypeScript uses undefined for the same API state.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>,packages/tsts/src/internal/ast/generated/kinds.ts::Kind,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Signature>,packages/tsts/src/internal/ast/generated/kinds.ts::Kind,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Checker symbol printing selects SymbolToEntityName and calls it with a nil tracker when no external symbol diagnostics are requested. enterContext installs the internal tracker before entity-name construction; TypeScript uses undefined for the absent outer sink.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Emit-resolution callers may omit the external SymbolTracker while converting a symbol to an expression. enterContext wraps the nil sink before conversion, so TypeScript uses undefined only for the caller-facing tracker state.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Checker symbol printing selects SymbolToNode and calls it with a nil tracker when arbitrary syntax is requested without external tracking. enterContext installs SymbolTrackerImpl before node construction; TypeScript uses undefined for the absent outer sink.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/internal/ast/generated/flags.ts::SymbolFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Signature-help callers invoke parameter serialization with a nil tracker because they do not provide an external diagnostic sink. enterContext installs the internal tracker before parameter-node construction; TypeScript uses undefined for that omitted sink.","goSignature":"func(packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/symbol.ts::Symbol>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::method::NodeBuilder.TypeParameterToDeclaration","kind":"method","status":"implemented","sigHash":"887c1a98669dc43b6a6a3ebc929c86464abde42532cb5d4c5a31b2efe554aa18","bodyHash":"136d71fcd2e3afee83eeba42a0ffbca86aa9aaa627449348bf05ef11e717751f"}
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Checker printer and signature-help callers serialize type parameters with a nil tracker when no external tracking is needed. enterContext wraps that nil sink before building the declaration; TypeScript uses undefined for the same caller-facing state.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::method::NodeBuilder.TypePredicateToTypePredicateNode","kind":"method","status":"implemented","sigHash":"e538c39c3c9ca6a0af1e55552a1736d012822ca7a5333755c22707c0a26cf1ef","bodyHash":"0b760d0e3cdc3cb7b7629ee89b88c6af944b43300375b2c04be567a40b6a500a"}
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Checker printer and code-action callers may serialize a type predicate with no external SymbolTracker. enterContext installs the internal tracker before conversion; TypeScript uses undefined for that omitted outer sink.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::TypePredicate>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::TypePredicate>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
...
/**
 * @tsgo-unit {"id":"github.com/microsoft/typescript-go::internal/checker/nodebuilder.go::method::NodeBuilder.TypeToTypeNode","kind":"method","status":"implemented","sigHash":"2e85aaa331e9855bd57b73fffecba12b40d76ecd64b799680fa4a2cec193ef2f","bodyHash":"b6a111a38f34876e0646ccac0d94e73b6d038766c8d1c6226f748e28f0493413"}
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Checker printer, language-service, API, and baseline callers routinely pass a nil tracker when they need only the type node. enterContext wraps the nil outer sink in SymbolTrackerImpl before serialization; TypeScript uses undefined for exactly that API state.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/types.ts::Type>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"Declaration emit forwards an optional external SymbolTracker when attempting JSDoc type-node reuse; callers may provide nil. enterContext installs the internal tracker before the attempt, and TypeScript uses undefined only for the absent outer sink.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/checker/nodebuilder.ts::NodeBuilder>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>,packages/tsts/src/internal/nodebuilder/types.ts::Flags,packages/tsts/src/internal/nodebuilder/types.ts::InternalFlags,packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/nodebuilder/types.ts::SymbolTracker>)=>packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/ast/spine.ts::Node>"}
 *
 * Go source:
