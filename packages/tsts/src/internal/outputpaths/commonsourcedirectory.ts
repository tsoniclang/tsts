 ...
 * @tsgo-override {"category":"runtime-representation","allow":["signature"],"reason":"The path-membership callback is intentionally nil when no source-containment diagnostic is requested; both RootDir and ConfigFilePath branches test undefined before invoking it.","goSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>,()=>packages/tsts/src/go/compat.ts::GoSlice<string>,string,packages/tsts/src/go/scalars.ts::bool,(packages/tsts/src/go/compat.ts::GoSlice<string>,string)=>packages/tsts/src/go/scalars.ts::bool)=>string","tsSignature":"func(packages/tsts/src/go/compat.ts::GoPtr<packages/tsts/src/internal/core/compileroptions.ts::CompilerOptions>,()=>packages/tsts/src/go/compat.ts::GoSlice<string>,string,packages/tsts/src/go/scalars.ts::bool,(packages/tsts/src/go/compat.ts::GoSlice<string>,string)=>packages/tsts/src/go/scalars.ts::bool|undefined)=>string"}
 *
 * Go source:
