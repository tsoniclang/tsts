/**
 * Unicode property name / value tables for regex `\p{...}` validation.
 *
 * Port of TS-Go `internal/scanner/unicodeproperties.go` (162 LoC).
 * All data from ECMA-262 tables 66–68 and Unicode 15.1 script values.
 */

/**
 * Non-binary Unicode property aliases → canonical names.
 * ECMA-262 table 66.
 */
export const nonBinaryUnicodeProperties: ReadonlyMap<string, string> = new Map([
...
/** Binary Unicode property aliases. ECMA-262 table 67. */
export const binaryUnicodeProperties: ReadonlySet<string> = new Set([
...
/** Binary Unicode properties of strings. ECMA-262 table 68. */
export const binaryUnicodePropertiesOfStrings: ReadonlySet<string> = new Set([
  "Basic_Emoji", "Emoji_Keycap_Sequence", "RGI_Emoji_Modifier_Sequence",
  "RGI_Emoji_Flag_Sequence", "RGI_Emoji_Tag_Sequence",
  "RGI_Emoji_ZWJ_Sequence", "RGI_Emoji",
]);

/** Unicode 15.1 script values (both ISO codes and full names). */
export const scriptValues: ReadonlySet<string> = new Set([
...
/** Values accepted for each non-binary property name. */
export const valuesOfNonBinaryUnicodeProperties: ReadonlyMap<string, ReadonlySet<string>> = new Map([
  [
    "General_Category",
    new Set([
