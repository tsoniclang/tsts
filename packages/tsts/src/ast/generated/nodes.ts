...
export type ModifierFlags = int;
export type TokenFlags = int;
export type TransformFlags = int;
export type CheckFlags = int;
export type FunctionFlags = int;
...
export interface KeywordExpression extends ExpressionBase, FlowNodeBase {
  readonly kind: KeywordExpressionSyntaxKind;
}
...
export interface KeywordTypeNode extends TypeNodeBase {
  readonly kind: KeywordTypeSyntaxKind;
}
...
export interface EndOfFile extends Token {
  readonly kind: Kind.EndOfFile;
}
export interface DotToken extends Token {
  readonly kind: Kind.DotToken;
}
export interface DotDotDotToken extends Token {
  readonly kind: Kind.DotDotDotToken;
}
export interface QuestionToken extends Token {
  readonly kind: Kind.QuestionToken;
}
export interface ExclamationToken extends Token {
  readonly kind: Kind.ExclamationToken;
}
export interface ColonToken extends Token {
  readonly kind: Kind.ColonToken;
}
export interface EqualsToken extends Token {
  readonly kind: Kind.EqualsToken;
}
export interface AsteriskToken extends Token {
  readonly kind: Kind.AsteriskToken;
}
export interface EqualsGreaterThanToken extends Token {
  readonly kind: Kind.EqualsGreaterThanToken;
}
export interface PlusToken extends Token {
  readonly kind: Kind.PlusToken;
}
export interface MinusToken extends Token {
  readonly kind: Kind.MinusToken;
}
export interface QuestionDotToken extends Token {
  readonly kind: Kind.QuestionDotToken;
}
export interface AssertsKeyword extends Token {
  readonly kind: Kind.AssertsKeyword;
}
export interface AssertKeyword extends Token {
  readonly kind: Kind.AssertKeyword;
}
export interface AwaitKeyword extends Token {
  readonly kind: Kind.AwaitKeyword;
}
export interface CaseKeyword extends Token {
  readonly kind: Kind.CaseKeyword;
}
export interface AbstractKeyword extends Token {
  readonly kind: Kind.AbstractKeyword;
}
export interface AccessorKeyword extends Token {
  readonly kind: Kind.AccessorKeyword;
}
export interface AsyncKeyword extends Token {
  readonly kind: Kind.AsyncKeyword;
}
export interface ConstKeyword extends Token {
  readonly kind: Kind.ConstKeyword;
}
export interface DeclareKeyword extends Token {
  readonly kind: Kind.DeclareKeyword;
}
export interface DefaultKeyword extends Token {
  readonly kind: Kind.DefaultKeyword;
}
export interface ExportKeyword extends Token {
  readonly kind: Kind.ExportKeyword;
}
export interface InKeyword extends Token {
  readonly kind: Kind.InKeyword;
}
export interface PrivateKeyword extends Token {
  readonly kind: Kind.PrivateKeyword;
}
export interface ProtectedKeyword extends Token {
  readonly kind: Kind.ProtectedKeyword;
}
export interface PublicKeyword extends Token {
  readonly kind: Kind.PublicKeyword;
}
export interface ReadonlyKeyword extends Token {
  readonly kind: Kind.ReadonlyKeyword;
}
export interface OutKeyword extends Token {
  readonly kind: Kind.OutKeyword;
}
export interface OverrideKeyword extends Token {
  readonly kind: Kind.OverrideKeyword;
}
export interface StaticKeyword extends Token {
  readonly kind: Kind.StaticKeyword;
}
export interface BinaryOperatorToken extends Token {
  readonly kind: BinaryOperator;
}
export interface AssignmentOperatorToken extends Token {
  readonly kind: AssignmentOperator;
}
export interface NullLiteral extends KeywordExpression {
  readonly kind: Kind.NullKeyword;
}
export interface TrueLiteral extends KeywordExpression {
  readonly kind: Kind.TrueKeyword;
}
export interface FalseLiteral extends KeywordExpression {
  readonly kind: Kind.FalseKeyword;
}
export interface ThisExpression extends KeywordExpression {
  readonly kind: Kind.ThisKeyword;
}
export interface SuperExpression extends KeywordExpression {
  readonly kind: Kind.SuperKeyword;
}
export interface ImportExpression extends KeywordExpression {
  readonly kind: Kind.ImportKeyword;
}
